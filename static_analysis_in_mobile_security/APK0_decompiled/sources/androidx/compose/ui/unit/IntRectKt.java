...
public final class IntRectKt {
    ...
    public static final IntRect m5424IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5392getXimpl(offset), IntOffset.m5393getYimpl(offset), IntOffset.m5392getXimpl(offset) + IntSize.m5434getWidthimpl(size), IntOffset.m5393getYimpl(offset) + IntSize.m5433getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5423IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5392getXimpl(topLeft), IntOffset.m5393getYimpl(topLeft), IntOffset.m5392getXimpl(bottomRight), IntOffset.m5393getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5425IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5392getXimpl(center) - radius, IntOffset.m5393getYimpl(center) - radius, IntOffset.m5392getXimpl(center) + radius, IntOffset.m5393getYimpl(center) + radius);
    }
