...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4225measureBRTryo0(long constraints) {
            ...
            this_$iv.m4283setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5206boximpl(constraints);
            ...
            this_$iv.set_measureResult($this$measure_BRTryo0_u24lambda_u241_u24lambda_u240.mo239measure3p2s80s(this, lookaheadDelegate, constraints));
            return this_$iv;
        }
    ...
    /* renamed from: measure-BRTryo0 */
    public Placeable mo4225measureBRTryo0(long constraints) {
        MeasureResult mo239measure3p2s80s;
        ...
        if ($this$measure_BRTryo0_u24lambda_u242_u24lambda_u241 instanceof IntermediateLayoutModifierNode) {
            ...
            mo239measure3p2s80s = ((IntermediateLayoutModifierNode) $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241).m4227intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, IntSize, constraints2.getValue());
        } else {
            mo239measure3p2s80s = $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241.mo239measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(mo239measure3p2s80s);
        onMeasured();
        return this;
    }
    ...
    protected void mo4226placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo4226placeAtf8xVGno(position, zIndex, layerBlock);
        if (getIsShallowPlacing()) {
            return;
        }
        onPlaced();
        Placeable.PlacementScope.Companion this_$iv = Placeable.PlacementScope.INSTANCE;
        int parentWidth$iv = IntSize.m5434getWidthimpl(getMeasuredSize());
    ...
    static {
        ...
        paint.mo2852setColor8_81llA(Color.INSTANCE.m2998getBlue0d7_KjU());
        paint.setStrokeWidth(1.0f);
        paint.mo2856setStylek9PVt8s(PaintingStyle.INSTANCE.m3239getStrokeTiuSbCo());
