    ...
    */
    public /* synthetic */ Font(android.os.ParcelFileDescriptor r7, androidx.compose.ui.text.font.FontWeight r8, int r9, androidx.compose.ui.text.font.FontVariation.Settings r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        Ld:
            ...
            int r9 = r8.m4872getNormal_LCdwA()
            r3 = r9
            goto L1a
        L19:
            r3 = r9
    ...
    public String toString() {
        return "Font(fileDescriptor=" + this.fileDescriptor + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4869toStringimpl(getStyle())) + ')';
    }
}
ad$ui_text_release(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4869toStringimpl(getStyle())) + ')';
    }
