...
public final class TooltipDefaults {
    ...
    public final RichTooltipColors m1994richTooltipColorsro_MJ88(long containerColor, long contentColor, long titleContentColor, long actionContentColor, Composer $composer, int $changed, int i) {
        ...
        long contentColor2 = (i & 2) != 0 ? ColorSchemeKt.toColor(RichTooltipTokens.INSTANCE.getSupportingTextColor(), $composer, 6) : contentColor;
        long titleContentColor2 = (i & 4) != 0 ? ColorSchemeKt.toColor(RichTooltipTokens.INSTANCE.getSubheadColor(), $composer, 6) : titleContentColor;
        long actionContentColor2 = (i & 8) != 0 ? ColorSchemeKt.toColor(RichTooltipTokens.INSTANCE.getActionLabelTextColor(), $composer, 6) : actionContentColor;
        if (ComposerKt.isTraceInProgress()) {
