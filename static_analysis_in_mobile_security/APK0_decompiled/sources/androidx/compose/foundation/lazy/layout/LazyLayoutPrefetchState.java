...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo655schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m654schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle mo655schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (mo655schedulePrefetch0kLqBqw = prefetcher.mo655schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : mo655schedulePrefetch0kLqBqw;
    }
}
