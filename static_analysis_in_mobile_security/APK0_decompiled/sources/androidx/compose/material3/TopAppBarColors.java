...
public final class TopAppBarColors {
    ...
    public final long m2000containerColorXeAY9LY$material3_release(float colorTransitionFraction, Composer $composer, int $changed) {
        ...
        long m3022lerpjxsXWHM = ColorKt.m3022lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m2972equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m2972equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m2972equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m2972equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m2972equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m2978hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2978hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2978hashCodeimpl(this.titleContentColor)) * 31) + Color.m2978hashCodeimpl(this.actionIconContentColor);
    }
}
