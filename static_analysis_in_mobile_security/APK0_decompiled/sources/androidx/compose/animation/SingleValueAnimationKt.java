...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m68animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        Object key1$iv = Color.m2975getColorSpaceimpl(targetValue);
        ...
        State<Color> animateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m2961boximpl(targetValue), converter, animationSpec2, null, label2, finishedListener, $composer, ($changed & 14) | 576 | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m67animateColorAsStateKTwxG1Y(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = m68animateColorAsStateeuL9pac(targetValue, animationSpec, null, finishedListener, $composer, ($changed & 14) | 64 | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final Animatable<Color, AnimationVector4D> m66Animatable8_81llA(long initialValue) {
        return new Animatable<>(Color.m2961boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m2975getColorSpaceimpl(initialValue)), null, null, 12, null);
    }
}
