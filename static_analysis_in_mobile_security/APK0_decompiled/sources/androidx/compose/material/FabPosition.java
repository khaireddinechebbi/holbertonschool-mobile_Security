...
public final class FabPosition {
    ...
    private static final int Center = m1112constructorimpl(0);
    private static final int End = m1112constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1111boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1118getCenter5ygKITE() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-5ygKITE, reason: not valid java name */
        public final int m1119getEnd5ygKITE() {
    ...
    public static String m1116toStringimpl(int arg0) {
        return m1114equalsimpl0(arg0, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}
