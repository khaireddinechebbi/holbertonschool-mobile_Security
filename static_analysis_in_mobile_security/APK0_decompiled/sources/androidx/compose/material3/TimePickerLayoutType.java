...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1915constructorimpl(0);
    private static final int Vertical = m1915constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1914boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1915constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1916equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1917equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1918hashCodeimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m1921getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE, reason: not valid java name */
        public final int m1922getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1919toStringimpl(int arg0) {
        return m1917equalsimpl0(arg0, Horizontal) ? "Horizontal" : m1917equalsimpl0(arg0, Vertical) ? "Vertical" : "Unknown";
    }
