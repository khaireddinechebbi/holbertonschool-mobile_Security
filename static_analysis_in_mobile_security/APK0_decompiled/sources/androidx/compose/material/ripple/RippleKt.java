...
public final class RippleKt {
    ...
    public static final Indication m1298rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        float radius2 = (i & 2) != 0 ? Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM() : radius;
        long color2 = (i & 4) != 0 ? Color.INSTANCE.m3007getUnspecified0d7_KjU() : color;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:76)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(color2), $composer, ($changed >> 6) & 14);
        Object key1$iv = Boolean.valueOf(bounded2);
        Object key2$iv = Dp.m5272boximpl(radius2);
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new PlatformRipple(bounded2, radius2, colorState, null);
