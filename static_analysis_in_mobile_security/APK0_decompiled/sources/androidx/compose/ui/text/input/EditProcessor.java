...
public final class EditProcessor {
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder append = $this$generateBatchErrorMessage_u24lambda_u241.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4912getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4771toStringimpl(this.mBuffer.m4913getSelectiond9O1mEE$ui_text_release())) + "):");
