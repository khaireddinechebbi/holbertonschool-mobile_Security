...
public final class PagerKt {
    ...
    public static final void m706HorizontalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i18 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty13 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                contentPadding2 = i11 != 0 ? PaddingKt.m480PaddingValues0680j_4(Dp.m5274constructorimpl(0)) : contentPadding;
                PageSize pageSize4 = i12 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                int beyondBoundsPageCount3 = i13 != 0 ? 0 : i2;
                float pageSpacing3 = i14 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                ...
                if ((i & 128) != 0) {
                    ...
                    i7 = 1491175841;
                    i8 = i18;
                    flingBehavior2 = PagerDefaults.INSTANCE.m704flingBehaviorPfoAEA0(state, null, null, null, null, 0.0f, 0.0f, $composer3, ($dirty & 14) | 12582912, 126);
                    $dirty &= -29360129;
                } else {
                    $dirty1 = $dirty13;
                    $composer2 = $composer3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$1
            ...
            public final void invoke(Composer composer, int i21) {
                PagerKt.m706HorizontalPagerxYaah8o(PagerState.this, modifier5, paddingValues, pageSize5, i20, f, vertical2, snapFlingBehavior, z, z2, function12, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m705HorizontalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((i & 1) != 0) {
            ...
            $dirty4 |= $composer2.changed(pageCount) ? 4 : 2;
        }
        int i13 = i & 2;
        if (i13 != 0) {
            $dirty4 |= 48;
        ...
        if (i14 != 0) {
            ...
            $dirty4 |= $composer2.changed(contentPadding) ? 2048 : 1024;
        }
        int i15 = i & 16;
        if (i15 != 0) {
            $dirty4 |= 24576;
            ...
            pageSize2 = pageSize;
            $dirty4 |= $composer2.changed(pageSize2) ? 16384 : 8192;
        } else {
            pageSize2 = pageSize;
        }
        int i16 = i & 32;
        if (i16 != 0) {
            ...
            $dirty4 |= $composer2.changed(beyondBoundsPageCount) ? 131072 : 65536;
        }
        int i17 = i & 64;
        if (i17 != 0) {
            $dirty4 |= 1572864;
        } else if (($changed & 3670016) == 0) {
            $dirty4 |= $composer2.changed(pageSpacing) ? 1048576 : 524288;
        }
        int i18 = i & 128;
        if (i18 != 0) {
            $dirty4 |= 12582912;
            ...
            i2 = i18;
            $dirty4 |= $composer2.changed(verticalAlignment) ? 8388608 : 4194304;
        } else {
            i2 = i18;
        }
        ...
        if (i19 != 0) {
            ...
            i3 = i19;
            $dirty4 |= $composer2.changed(userScrollEnabled) ? 536870912 : 268435456;
        } else {
            i3 = i19;
        }
        int i20 = i & 1024;
        ...
        int $dirty13 = $dirty12;
        if (i22 == 4096 && (1533916891 & $dirty4) == 306783378 && ($dirty13 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                contentPadding2 = i14 != 0 ? PaddingKt.m480PaddingValues0680j_4(Dp.m5274constructorimpl(0)) : contentPadding;
                pageSize3 = i15 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                beyondBoundsPageCount2 = i16 != 0 ? 0 : beyondBoundsPageCount;
                pageSpacing2 = i17 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                verticalAlignment2 = i7 != 0 ? Alignment.INSTANCE.getCenterVertically() : verticalAlignment;
                if ((i & 256) != 0) {
                    flingBehavior2 = PagerDefaults.INSTANCE.m704flingBehaviorPfoAEA0(state3, null, null, null, null, 0.0f, 0.0f, $composer2, (($dirty >> 6) & 14) | 12582912, 126);
                    $dirty &= -234881025;
                } else {
                    flingBehavior2 = flingBehavior;
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$3
            ...
            public final void invoke(Composer composer, int i25) {
                PagerKt.m705HorizontalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i24, f, vertical, snapFlingBehavior2, z, z2, function12, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* renamed from: VerticalPager-xYaah8o, reason: not valid java name */
    public static final void m708VerticalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PageSize pageSize2;
        int i2;
        ...
        if (i18 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty13 & 731) == 146 && $composer3.getSkipping()) {
            ...
            LazyLayoutPagerKt.m700Pagerfs30GE4(modifier3, state, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, key, horizontalAlignment2, Alignment.INSTANCE.getCenterVertically(), pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), (($dirty12 << 3) & 112) | 3080 | (($dirty2 >> 12) & 896) | (($dirty12 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$1
            ...
            public final void invoke(Composer composer, int i21) {
                PagerKt.m708VerticalPagerxYaah8o(PagerState.this, modifier5, paddingValues, pageSize5, i20, f, horizontal2, snapFlingBehavior, z, z2, function12, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m707VerticalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PagerState state2;
        PageSize pageSize2;
        int i2;
        ...
        if (i18 != 0) {
            ...
            i2 = i18;
            $dirty4 |= $composer2.changed(horizontalAlignment) ? 8388608 : 4194304;
        } else {
            i2 = i18;
        }
        if (($changed & 234881024) == 0) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$3
            ...
            public final void invoke(Composer composer, int i25) {
                PagerKt.m707VerticalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i24, f, horizontal, snapFlingBehavior2, z, z2, function12, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final float dragGestureDelta(PagerState $this$dragGestureDelta) {
        if ($this$dragGestureDelta.getLayoutInfo$foundation_release().getOrientation() == Orientation.Horizontal) {
            return Offset.m2731getXimpl($this$dragGestureDelta.m716getUpDownDifferenceF1C5BW0$foundation_release());
        }
        return Offset.m2732getYimpl($this$dragGestureDelta.m716getUpDownDifferenceF1C5BW0$foundation_release());
    }
}
