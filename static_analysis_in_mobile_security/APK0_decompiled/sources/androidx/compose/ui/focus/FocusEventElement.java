...
final /* data */ class FocusEventElement extends ModifierNodeElement<FocusEventNode> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public FocusEventElement(Function1<? super FocusState, Unit> onFocusEvent) {
        Intrinsics.checkNotNullParameter(onFocusEvent, "onFocusEvent");
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.setName("onFocusEvent");
        $this$inspectableProperties.getProperties().set("onFocusEvent", this.onFocusEvent);
    }
}
