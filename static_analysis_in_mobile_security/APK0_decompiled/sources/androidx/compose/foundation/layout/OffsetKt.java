...
public final class OffsetKt {
    ...
    public static final Modifier m447offsetVpY3zN4(Modifier offset, final float x, final float y) {
        ...
        return offset.then(new OffsetModifierElement(x, y, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("x", Dp.m5272boximpl(x));
                $receiver.getProperties().set("y", Dp.m5272boximpl(y));
            }
        }, null));
    }

    /* renamed from: offset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m448offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m447offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m445absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float x, final float y) {
    ...
    public static /* synthetic */ Modifier m446absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5274constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m445absoluteOffsetVpY3zN4(modifier, f, f2);
    }
