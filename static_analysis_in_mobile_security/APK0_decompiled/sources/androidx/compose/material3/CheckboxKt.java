...
public final class CheckboxKt {
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    colors2 = CheckboxDefaults.INSTANCE.m1352colors5tl4gsc(0L, 0L, 0L, 0L, 0L, 0L, $composer2, 1572864, 63);
                }
                if (i5 != 0) {
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                int m4611getCheckboxo7Vup1c = Role.INSTANCE.m4611getCheckboxo7Vup1c();
                float arg0$iv = CheckboxTokens.INSTANCE.m2039getStateLayerSizeD9Ej5fM();
                $dirty2 = $dirty;
                companion = ToggleableKt.m727triStateToggleableO2vRcR0(companion2, state, interactionSource2, RippleKt.m1298rememberRipple9IZ8Weo(false, Dp.m5274constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled2, Role.m4603boximpl(m4611getCheckboxo7Vup1c), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m487padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors3, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void CheckboxImpl(final boolean enabled, final ToggleableState value, final Modifier modifier, final CheckboxColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2007131616, $dirty3, -1, "androidx.compose.material3.CheckboxImpl (Checkbox.kt:229)");
            }
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State checkColor = colors.checkmarkColor$material3_release(value, $composer2, (($dirty3 >> 3) & 14) | (($dirty3 >> 6) & 112));
                    final State boxColor = colors.boxColor$material3_release(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    final State borderColor = colors.borderColor$material3_release(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    ...
                    if (invalid$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                long m2981unboximpl = boxColor.getValue().m2981unboximpl();
                                long m2981unboximpl2 = borderColor.getValue().m2981unboximpl();
                                f6 = CheckboxKt.RadiusSize;
                                CheckboxKt.m1355drawBox1wkBAMs(Canvas, m2981unboximpl, m2981unboximpl2, Canvas.mo327toPx0680j_4(f6), strokeWidthPx);
                                CheckboxKt.m1356drawCheck3IgeMak(Canvas, checkColor.getValue().m2981unboximpl(), checkDrawFraction.getValue().floatValue(), checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    } else {
    ...
    public static final void m1355drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
    ...
    public static final void m1356drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
