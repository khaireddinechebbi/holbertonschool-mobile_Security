...
final class RequiredMinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo440calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long constraints) {
        ...
        int height = measurable.minIntrinsicHeight(Constraints.m5218getMaxWidthimpl(constraints));
