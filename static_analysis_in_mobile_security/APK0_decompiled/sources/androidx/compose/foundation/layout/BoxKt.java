...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo11measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long constraints) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.CC.layout$default(MeasurePolicy, Constraints.m5220getMinWidthimpl(constraints), Constraints.m5219getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean propagateMinConstraints) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            ...
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo11measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long constraints) {
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.CC.layout$default(MeasurePolicy, Constraints.m5220getMinWidthimpl(constraints), Constraints.m5219getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(Placeable.PlacementScope placementScope) {
                            invoke2(placementScope);
                            return Unit.INSTANCE;
                ...
                long contentConstraints = m5208copyZbe2FdA;
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
                    if (!matchesParentSize3) {
                        placeable = measurable.mo4225measureBRTryo0(contentConstraints);
                        boxWidth = Math.max(Constraints.m5220getMinWidthimpl(constraints), placeable.getWidth());
                        boxHeight = Math.max(Constraints.m5219getMinHeightimpl(constraints), placeable.getHeight());
                    } else {
                        boxWidth = Constraints.m5220getMinWidthimpl(constraints);
                        boxHeight = Constraints.m5219getMinHeightimpl(constraints);
                        placeable = measurable.mo4225measureBRTryo0(Constraints.INSTANCE.m5226fixedJhjzzOo(Constraints.m5220getMinWidthimpl(constraints), Constraints.m5219getMinHeightimpl(constraints)));
                    }
                    final Alignment alignment2 = alignment;
                    final Placeable placeable2 = placeable;
                    final int i = boxWidth;
                    final int i2 = boxHeight;
                    return MeasureScope.CC.layout$default(MeasurePolicy, boxWidth, boxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                ...
                boxWidth2.element = Constraints.m5220getMinWidthimpl(constraints);
                final Ref.IntRef boxHeight2 = new Ref.IntRef();
                boxHeight2.element = Constraints.m5219getMinHeightimpl(constraints);
                ...
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    ...
                    if (matchesParentSize2) {
                        ...
                        Placeable placeable3 = measurable2.mo4225measureBRTryo0(contentConstraints);
                ...
                if (hasMatchParentSizeChildren) {
                    ...
                    for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                        ...
                        if (matchesParentSize) {
                            placeables[index2] = measurable3.mo4225measureBRTryo0(matchParentSizeConstraints);
                        }
                    }
                }
                ...
                return MeasureScope.CC.layout$default(MeasurePolicy, i3, i4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$5
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public static final void placeInBox(Placeable.PlacementScope $this$placeInBox, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int boxWidth, int boxHeight, Alignment alignment) {
        ...
        long position = childAlignment.mo2621alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(boxWidth, boxHeight), layoutDirection);
        Placeable.PlacementScope.m4284place70tqf50$default($this$placeInBox, placeable, position, 0.0f, 2, null);
    }
