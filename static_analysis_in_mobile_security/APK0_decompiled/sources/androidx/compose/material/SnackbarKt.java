...
public final class SnackbarKt {
    ...
    public static final void m1193SnackbarsPrSdHI(final SnackbarData snackbarData, Modifier modifier, boolean actionOnNewLine, Shape shape, long backgroundColor, long contentColor, long actionColor, float elevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            if (actionLabel != null) {
                ...
                actionComposable = ComposableLambdaKt.composableLambda($composer2, 1843479216, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        ButtonColors m1022textButtonColorsRGew2ao = ButtonDefaults.INSTANCE.m1022textButtonColorsRGew2ao(0L, j, 0L, $composer3, ((i9 >> 15) & 112) | 3072, 5);
                        ...
                        ButtonKt.TextButton(function0, null, false, null, null, null, null, m1022textButtonColorsRGew2ao, null, ComposableLambdaKt.composableLambda($composer3, -929149933, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$actionComposable$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
            ...
            m1192Snackbar7zSek6w(PaddingKt.m487padding3ABfNKs(modifier2, Dp.m5274constructorimpl(12)), actionComposable, actionOnNewLine2, shape3, actionColor4, contentColor2, elevation2, ComposableLambdaKt.composableLambda($composer2, -261845785, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$3
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    TextKt.m1270Text4IGK_g(SnackbarData.this.getMessage(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer3, 0, 0, 131070);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarKt$Snackbar$4
            ...
            public final void invoke(Composer composer, int i10) {
                SnackbarKt.m1193SnackbarsPrSdHI(SnackbarData.this, modifier4, z2, shape5, j2, j3, j4, f, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:66:0x03c7 A[ADDED_TO_REGION] */
