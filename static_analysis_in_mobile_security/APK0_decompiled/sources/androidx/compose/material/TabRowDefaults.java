...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m5274constructorimpl(1);
    private static final float IndicatorHeight = Dp.m5274constructorimpl(2);
    ...
    public final void m1234Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    color3 = Color.m2969copywmQWz5c(r16, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r16) : 0.12f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r16) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r16) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(((Color) consume).m2981unboximpl()) : 0.0f);
                    $dirty &= -897;
                    color2 = color3;
                }
            } else {
            ...
            DividerKt.m1083DivideroMI9zvI(modifier3, color2, thickness2, 0.0f, $composer2, ($dirty & 14) | (($dirty >> 3) & 112) | (($dirty << 3) & 896), 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                TabRowDefaults.this.m1234Divider9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: Indicator-9IZ8Weo, reason: not valid java name */
    public final void m1235Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $dirty &= -897;
                    color2 = ((Color) consume).m2981unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Indicator$1
            ...
            public final void invoke(Composer composer, int i5) {
                TabRowDefaults.this.m1235Indicator9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public final Modifier tabIndicatorOffset(Modifier $this$tabIndicatorOffset, final TabPosition currentTabPosition) {
        ...
        return ComposedModifierKt.composed($this$tabIndicatorOffset, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.TabRowDefaults$tabIndicatorOffset$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                State currentTabWidth$delegate = AnimateAsStateKt.m80animateDpAsStateAjpBEmI(TabPosition.this.getWidth(), AnimationSpecKt.tween$default(250, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, $composer, 0, 12);
                State indicatorOffset$delegate = AnimateAsStateKt.m80animateDpAsStateAjpBEmI(TabPosition.this.getLeft(), AnimationSpecKt.tween$default(250, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, $composer, 0, 12);
                Modifier m539width3ABfNKs = SizeKt.m539width3ABfNKs(OffsetKt.m448offsetVpY3zN4$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(composed, 0.0f, 1, null), Alignment.INSTANCE.getBottomStart(), false, 2, null), invoke$lambda$1(indicatorOffset$delegate), 0.0f, 2, null), invoke$lambda$0(currentTabWidth$delegate));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m539width3ABfNKs;
            }
    ...
    public final float m1236getDividerThicknessD9Ej5fM() {
        return DividerThickness;
    }

    /* renamed from: getIndicatorHeight-D9Ej5fM, reason: not valid java name */
    public final float m1237getIndicatorHeightD9Ej5fM() {
        return IndicatorHeight;
    }

    /* renamed from: getScrollableTabRowPadding-D9Ej5fM, reason: not valid java name */
    public final float m1238getScrollableTabRowPaddingD9Ej5fM() {
