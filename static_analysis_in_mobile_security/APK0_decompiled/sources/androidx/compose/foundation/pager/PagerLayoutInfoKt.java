...
public final class PagerLayoutInfoKt {
    ...
    public static final int getMainAxisViewportSize(PagerLayoutInfo $this$mainAxisViewportSize) {
        Intrinsics.checkNotNullParameter($this$mainAxisViewportSize, "<this>");
        return $this$mainAxisViewportSize.getOrientation() == Orientation.Vertical ? IntSize.m5433getHeightimpl($this$mainAxisViewportSize.mo709getViewportSizeYbymL2g()) : IntSize.m5434getWidthimpl($this$mainAxisViewportSize.mo709getViewportSizeYbymL2g());
    }
}
