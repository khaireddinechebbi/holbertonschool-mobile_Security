...
public final class LazyGridState implements ScrollableState {
    ...
    */
    ...
    public final Object scrollToItem(int index, int scrollOffset, Continuation<? super Unit> continuation) {
        Object scroll$default = ScrollableState.CC.scroll$default(this, null, new LazyGridState$scrollToItem$2(this, index, scrollOffset, null), continuation, 1, null);
            ...
            if (lineToPrefetch != closestNextItemToPrefetch2) {
                ...
                if (z) {
                    ...
                    while (index$iv < size) {
                        ...
                        this.currentLinePrefetchHandles.add(prefetchState.m654schedulePrefetch0kLqBqw(it3.getFirst().intValue(), it3.getSecond().getValue()));
                        index$iv++;
                        info = info;
