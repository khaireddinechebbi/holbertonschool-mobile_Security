    ...
    public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
        ...
        Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1.1
            ...
            public final long m964invokeF1C5BW0() {
                return TextFieldSelectionManagerKt.m963calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager.this, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$1(magnifierSize$delegate));
            }
        };
            ...
            value$iv$iv2 = new Function1<Function0<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1
                ...
                public final Modifier invoke2(final Function0<Offset> center) {
                    ...
                    Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                        ...
                        public final long m965invoketuRUvjQ(Density magnifier2) {
                    ...
                    magnifier = MagnifierKt.magnifier(companion, function1, (r12 & 2) != 0 ? new Function1<Density, Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$1
                    ...
                    } : null, (r12 & 4) != 0 ? Float.NaN : 0.0f, (r12 & 8) != 0 ? MagnifierStyle.INSTANCE.getDefault() : textDefault, (r12 & 16) != 0 ? null : new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void m966invokeEaSLcWc(long size) {
                            ...
                            TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$2(mutableState2, IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo321roundToPx0680j_4(DpSize.m5372getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo321roundToPx0680j_4(DpSize.m5370getHeightD9Ej5fM(size))));
                        }
                    });
                    return magnifier;
                }
