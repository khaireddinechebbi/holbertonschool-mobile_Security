...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2972equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m2972equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m2972equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m2972equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m2972equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m2972equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m2972equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m2972equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m2972equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.backgroundColor);
        return (((((((((((((((result * 31) + Color.m2978hashCodeimpl(this.contentColor)) * 31) + Color.m2978hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2978hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2978hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2978hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2978hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m2978hashCodeimpl(this.selectedContentColor)) * 31) + Color.m2978hashCodeimpl(this.selectedLeadingIconColor);
    }
}
