...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1577constructorimpl(0);
    private static final int StartDateInput = m1577constructorimpl(1);
    private static final int EndDateInput = m1577constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1576boximpl(int i) {
    ...
    private /* synthetic */ InputIdentifier(int value) {
        this.value = value;
    }
    ...
    public static final class Companion {
        ...
        public final int m1584getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m1585getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m1583getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1581toStringimpl(int arg0) {
        return m1579equalsimpl0(arg0, SingleDateInput) ? "SingleDateInput" : m1579equalsimpl0(arg0, StartDateInput) ? "StartDateInput" : m1579equalsimpl0(arg0, EndDateInput) ? "EndDateInput" : "Unknown";
    }
