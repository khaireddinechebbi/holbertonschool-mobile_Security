    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Offset m2720boximpl = Offset.m2720boximpl(this.$offset);
                ...
                Function1<AnimationScope<Offset, AnimationVector2D>, Unit> function1 = new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                    ...
                    public final void invoke2(AnimationScope<Offset, AnimationVector2D> animateTo2) {
                        ...
                        long delta = Offset.m2735minusMKHz9U(animateTo2.getValue().getPackedValue(), Ref.LongRef.this.element);
                ...
                this.label = 1;
                animateTo = SuspendAnimationKt.animateTo(animationState, m2720boximpl, (r12 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (r12 & 4) != 0 ? false : false, (r12 & 8) != 0 ? new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt$animateTo$2
                    @Override // kotlin.jvm.functions.Function1
