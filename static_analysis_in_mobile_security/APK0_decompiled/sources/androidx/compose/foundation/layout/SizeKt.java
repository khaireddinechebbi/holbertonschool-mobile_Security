...
public final class SizeKt {
    ...
    public static final Modifier m539width3ABfNKs(Modifier width, final float width2) {
        ...
        return width.then(new SizeElement(width2, 0.0f, width2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(width2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m520height3ABfNKs(Modifier height, final float height2) {
        ...
        return height.then(new SizeElement(0.0f, height2, 0.0f, height2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$height-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(height2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 5, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m534size3ABfNKs(Modifier size, final float size2) {
        ...
        return size.then(new SizeElement(size2, size2, size2, size2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(size2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: size-VpY3zN4, reason: not valid java name */
    public static final Modifier m536sizeVpY3zN4(Modifier size, final float width, final float height) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeElement(width, height, width, height, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                $this$null.setName("size");
                $this$null.getProperties().set("width", Dp.m5272boximpl(width));
                $this$null.getProperties().set("height", Dp.m5272boximpl(height));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: size-6HolHcs, reason: not valid java name */
    public static final Modifier m535size6HolHcs(Modifier size, long size2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return m536sizeVpY3zN4(size, DpSize.m5372getWidthD9Ej5fM(size2), DpSize.m5370getHeightD9Ej5fM(size2));
    }

    /* renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m541widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m540widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m540widthInVpY3zN4(Modifier widthIn, final float min, final float max) {
        ...
        return widthIn.then(new SizeElement(min, 0.0f, max, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("min", Dp.m5272boximpl(min));
                $this$null.getProperties().set("max", Dp.m5272boximpl(max));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m522heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m521heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m521heightInVpY3zN4(Modifier heightIn, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m538sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        return m537sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m537sizeInqDBjuR0(Modifier sizeIn, final float minWidth, final float minHeight, final float maxWidth, final float maxHeight) {
        ...
        return sizeIn.then(new SizeElement(minWidth, minHeight, maxWidth, maxHeight, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("minWidth", Dp.m5272boximpl(minWidth));
                $this$null.getProperties().set("minHeight", Dp.m5272boximpl(minHeight));
                $this$null.getProperties().set("maxWidth", Dp.m5272boximpl(maxWidth));
                $this$null.getProperties().set("maxHeight", Dp.m5272boximpl(maxHeight));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m531requiredWidth3ABfNKs(Modifier requiredWidth, final float width) {
        ...
        return requiredWidth.then(new SizeElement(width, 0.0f, width, 0.0f, false, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$requiredWidth-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(width));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: requiredHeight-3ABfNKs, reason: not valid java name */
    public static final Modifier m523requiredHeight3ABfNKs(Modifier requiredHeight, final float height) {
        ...
        return requiredHeight.then(new SizeElement(0.0f, height, 0.0f, height, false, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$requiredHeight-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(height));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 5, null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m526requiredSize3ABfNKs(Modifier requiredSize, final float size) {
        ...
        return requiredSize.then(new SizeElement(size, size, size, size, false, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$requiredSize-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5272boximpl(size));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m528requiredSizeVpY3zN4(Modifier requiredSize, final float width, final float height) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
    ...
    public static final Modifier m527requiredSize6HolHcs(Modifier requiredSize, long size) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
        return m528requiredSizeVpY3zN4(requiredSize, DpSize.m5372getWidthD9Ej5fM(size), DpSize.m5370getHeightD9Ej5fM(size));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m533requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m532requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m532requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m525requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m524requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m524requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m530requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m529requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m529requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float minWidth, final float minHeight, final float maxWidth, final float maxHeight) {
    ...
    public static /* synthetic */ Modifier m519defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m518defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m518defaultMinSizeVpY3zN4(Modifier defaultMinSize, float minWidth, float minHeight) {
