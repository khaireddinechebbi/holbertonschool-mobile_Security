...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m2646searchBeyondBoundsOMvw8(FocusTargetNode searchBeyondBounds, int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
                ...
                while (parent != null) {
                    if ((parent.getKindSet() & m4443constructorimpl) != 0) {
                        ...
                        while (node2 != null) {
                            ...
                            if (((node2.getKindSet() & m4443constructorimpl) != 0 ? 1 : 0) == 0 || !(node2 instanceof DelegatingNode)) {
                                focusTargetNode2 = focusTargetNode4;
                                i4 = m4443constructorimpl;
                                i5 = i9;
                            } else {
                                int i10 = 0;
                                ...
                                while (delegate != null) {
                                    ...
                                    if ((node3.getKindSet() & m4443constructorimpl) != 0) {
                                        i10++;
                                        focusTargetNode3 = focusTargetNode4;
                                        if (i10 == 1) {
                                            node2 = node3;
                                            i6 = m4443constructorimpl;
                                            i7 = i9;
                                        } else {
        ...
        if (FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2667getUpdhqQ8s())) {
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4209getAbovehoxUOeE();
        } else if (FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2658getDowndhqQ8s())) {
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4212getBelowhoxUOeE();
        } else if (FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2662getLeftdhqQ8s())) {
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4213getLefthoxUOeE();
        } else if (FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2666getRightdhqQ8s())) {
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4214getRighthoxUOeE();
        } else if (FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2663getNextdhqQ8s())) {
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4210getAfterhoxUOeE();
        } else {
            if (!FocusDirection.m2650equalsimpl0(i, FocusDirection.INSTANCE.m2665getPreviousdhqQ8s())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            m4211getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m4211getBeforehoxUOeE();
        }
        return (T) beyondBoundsLayoutParent.mo641layouto7g1Pn8(m4211getBeforehoxUOeE, block);
    }
}
