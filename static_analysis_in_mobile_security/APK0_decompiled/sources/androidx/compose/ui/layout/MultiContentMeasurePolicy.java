...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m4276measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MultiContentMeasurePolicy _this, IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            ...
            MeasureResult layoutResult = _this.m4276measure3p2s80s(layoutReceiver, mapped, constraints);
            return layoutResult.getWidth();
        }

        public static int $default$minIntrinsicHeight(MultiContentMeasurePolicy _this, IntrinsicMeasureScope $this$minIntrinsicHeight, List measurables, int width) {
        ...
        public static int $default$maxIntrinsicWidth(MultiContentMeasurePolicy _this, IntrinsicMeasureScope $this$maxIntrinsicWidth, List measurables, int height) {
        ...
        public static int $default$maxIntrinsicHeight(MultiContentMeasurePolicy _this, IntrinsicMeasureScope $this$maxIntrinsicHeight, List measurables, int width) {
