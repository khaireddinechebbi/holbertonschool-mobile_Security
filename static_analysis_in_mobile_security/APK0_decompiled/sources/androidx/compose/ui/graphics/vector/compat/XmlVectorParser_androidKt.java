...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3628getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3324getButtKaPHkGw();
        }
        return m3627getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3627getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m3324getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m3325getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m3326getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m3630getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3335getMiterLxFBmk8();
        }
        return m3629getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3629getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m3335getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m3336getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m3334getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type == 2) {
                tintColor = Color.INSTANCE.m3007getUnspecified0d7_KjU();
            } else {
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m2915getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m2913getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m2912getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m2904getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m2909getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m2907getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m2913getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m5274constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m5274constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m3627getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m3324getButtKaPHkGw());
        ...
        int strokeLineJoin = m3629getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m3334getBevelLxFBmk8());
        ...
        int lineJoin2 = fillRule == 0 ? companion.m3255getNonZeroRgk1Os() : companion.m3254getEvenOddRgk1Os();
        builder.m3607addPathoIyEayM(pathData, lineJoin2, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
