...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        public static TextForegroundStyle $default$merge(final TextForegroundStyle _this, TextForegroundStyle other) {
            float takeOrElse;
            Intrinsics.checkNotNullParameter(other, "other");
            if (!(other instanceof BrushStyle) || !(_this instanceof BrushStyle)) {
                return (!(other instanceof BrushStyle) || (_this instanceof BrushStyle)) ? ((other instanceof BrushStyle) || !(_this instanceof BrushStyle)) ? other.takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.style.TextForegroundStyle$merge$2
                    {
                        super(0);
                    }
        ...
        public static TextForegroundStyle $default$takeOrElse(TextForegroundStyle _this, Function0 other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return !Intrinsics.areEqual(_this, Unspecified.INSTANCE) ? _this : (TextForegroundStyle) other.invoke();
        }
    }
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        @Override // androidx.compose.ui.text.style.TextForegroundStyle
        /* renamed from: getColor-0d7_KjU */
        public long mo5041getColor0d7_KjU() {
            return Color.INSTANCE.m3007getUnspecified0d7_KjU();
        }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m5153from8_81llA(long color) {
            return (color > Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 1 : (color == Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m5153from8_81llA(TextDrawStyleKt.m5152modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
