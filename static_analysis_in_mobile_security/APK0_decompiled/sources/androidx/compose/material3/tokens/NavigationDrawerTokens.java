...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5274constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5274constructorimpl((float) 336.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    ...
    public final float m2301getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2302getContainerWidthD9Ej5fM() {
    ...
    public final float m2303getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2304getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2305getStandardContainerElevationD9Ej5fM() {
