...
public interface DoubleState extends State<Double> {
    ...
    public final /* synthetic */ class CC {
        public static /* synthetic */ double access$getValue$jd(DoubleState $this) {
            return $default$getValue($this).doubleValue();
        }
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static Double getValue(DoubleState $this) {
            return Double.valueOf(CC.access$getValue$jd($this));
        }
    }
}
