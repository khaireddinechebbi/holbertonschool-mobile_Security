...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BorderStroke) && Dp.m5279equalsimpl0(this.width, ((BorderStroke) other).width) && Intrinsics.areEqual(this.brush, ((BorderStroke) other).brush);
    }

    public int hashCode() {
        int result = Dp.m5280hashCodeimpl(this.width);
        return (result * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m5285toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default, reason: not valid java name */
    public static /* synthetic */ BorderStroke m184copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m185copyD5KLDUw(f, brush);
    }

    /* renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m185copyD5KLDUw(float width, Brush brush) {
        Intrinsics.checkNotNullParameter(brush, "brush");
