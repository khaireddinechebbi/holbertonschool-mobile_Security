...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        while (true) {
            ...
            if (z) {
                placeables[index] = measurable.mo4225measureBRTryo0(constraints);
            }
            index$iv++;
        }
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo4225measureBRTryo0(constraints);
            }
        }
        ...
        this.rootScope.m36setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(maxWidth, maxHeight));
        return MeasureScope.CC.layout$default(measure, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr) {
                    if (placeable5 != null) {
                        long offset = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo2621alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m5392getXimpl(offset), IntOffset.m5393getYimpl(offset), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
