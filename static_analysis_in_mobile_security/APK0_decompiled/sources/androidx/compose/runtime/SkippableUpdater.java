...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m2594boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2595constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2596equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2597equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2598hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2599toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2596equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2598hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2599toStringimpl(this.composer);
    }
    ...
    public static final void m2600updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.startReplaceableGroup(509942095);
        block.invoke(Updater.m2602boximpl(Updater.m2603constructorimpl(arg0)));
