...
public final class SelectableKt {
    ...
    public static /* synthetic */ Modifier m722selectableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m721selectableXHw0xAI(modifier, z, z2, role, function0);
    }

    /* renamed from: selectable-XHw0xAI, reason: not valid java name */
    public static final Modifier m721selectableXHw0xAI(Modifier selectable, final boolean selected, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(selectable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Modifier m719selectableO2vRcR0 = SelectableKt.m719selectableO2vRcR0(companion, selected, (MutableInteractionSource) value$iv$iv, (Indication) consume, enabled, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m719selectableO2vRcR0;
            }
        });
    }

    /* renamed from: selectable-O2vRcR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m720selectableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function0 function0, int i, Object obj) {
        Role role2;
        ...
        return m719selectableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function0);
    }

    /* renamed from: selectable-O2vRcR0, reason: not valid java name */
    public static final Modifier m719selectableO2vRcR0(Modifier selectable, final boolean selected, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        m190clickableO2vRcR0 = ClickableKt.m190clickableO2vRcR0(Modifier.INSTANCE, interactionSource, indication, (r14 & 4) != 0 ? true : enabled, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : role, onClick);
        return InspectableValueKt.inspectableWrapper(selectable, inspectorInfo$iv, SemanticsModifierKt.semantics$default(m190clickableO2vRcR0, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable$4$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
