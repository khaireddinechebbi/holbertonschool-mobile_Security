...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public final Boolean m4523invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection focusDirection = AndroidComposeView.this.mo4497getFocusDirectionP8AzH3I(it);
                ...
                return Boolean.valueOf(AndroidComposeView.this.getFocusOwner().mo2668moveFocus3ESFkO8(focusDirection.getValue()));
            }
        });
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r1 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r4) {
                            /*
                                ...
                                r1 = 0
                                r2 = 8
                                int r1 = androidx.compose.ui.node.NodeKind.m4443constructorimpl(r2)
                                boolean r0 = r0.m4406hasH91voCI$ui_release(r1)
    ...
    public FocusDirection mo4497getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m3968getKeyZmokQxo = KeyEvent_androidKt.m3968getKeyZmokQxo(keyEvent);
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3896getTabEK5gGoQ())) {
        ...
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3737getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2647boximpl(FocusDirection.INSTANCE.m2666getRightdhqQ8s());
        }
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3736getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2647boximpl(FocusDirection.INSTANCE.m2662getLeftdhqQ8s());
        }
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3738getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2647boximpl(FocusDirection.INSTANCE.m2667getUpdhqQ8s());
        }
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3733getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2647boximpl(FocusDirection.INSTANCE.m2658getDowndhqQ8s());
        }
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3732getDirectionCenterEK5gGoQ()) ? true : Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3746getEnterEK5gGoQ()) ? true : Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3838getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2647boximpl(FocusDirection.INSTANCE.m2659getEnterdhqQ8s());
        }
        if (Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3675getBackEK5gGoQ()) ? true : Key.m3660equalsimpl0(m3968getKeyZmokQxo, Key.INSTANCE.m3749getEscapeEK5gGoQ())) {
    ...
    private final int m4519handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                boolean wasMouseEvent = lastEvent2 != null && lastEvent2.getToolType(0) == 3;
                if (lastEvent2 == null) {
                ...
                return m4521sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
