...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    private AndroidPreloadedFont(FontWeight weight, int style, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.INSTANCE.m4859getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, null);
