...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5433getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5434getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4740getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m4656getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m4742getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m4657getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4738copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4739copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m4739copyO0kMr_c(TextLayoutInput layoutInput, long size) {
        Intrinsics.checkNotNullParameter(layoutInput, "layoutInput");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual(this.layoutInput, ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual(this.multiParagraph, ((TextLayoutResult) other).multiParagraph) || !IntSize.m5432equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
        if (this.firstBaseline == ((TextLayoutResult) other).firstBaseline) {
            return ((this.lastBaseline > ((TextLayoutResult) other).lastBaseline ? 1 : (this.lastBaseline == ((TextLayoutResult) other).lastBaseline ? 0 : -1)) == 0) && Intrinsics.areEqual(this.placeholderRects, ((TextLayoutResult) other).placeholderRects);
        }
        return false;
    }

    public int hashCode() {
        int result = this.layoutInput.hashCode();
        return (((((((((result * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5435hashCodeimpl(this.size)) * 31) + Float.floatToIntBits(this.firstBaseline)) * 31) + Float.floatToIntBits(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m5437toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
