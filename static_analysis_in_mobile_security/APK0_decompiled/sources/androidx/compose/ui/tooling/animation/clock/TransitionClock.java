...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    public TransitionClock(TransitionBasedAnimation<T> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m5189getAnimationObject().getCurrentState(), getAnimation().m5189getAnimationObject().getTargetState());
    }
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = UtilsKt.allAnimations(getAnimation().m5189getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return UtilsKt.nanosToMillis(getAnimation().m5189getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Transition transition = getAnimation().m5189getAnimationObject();
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m5189getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
