...
public final class FilledTextFieldTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float DisabledActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float FocusActiveIndicatorHeight = Dp.m5274constructorimpl((float) 2.0d);
    ...
    private static final float HoverActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float LeadingIconSize = Dp.m5274constructorimpl((float) 20.0d);
    ...
    public final float m2233getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2234getContainerHeightD9Ej5fM() {
    ...
    public final float m2235getDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2236getFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2237getHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2238getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2239getTrailingIconSizeD9Ej5fM() {
