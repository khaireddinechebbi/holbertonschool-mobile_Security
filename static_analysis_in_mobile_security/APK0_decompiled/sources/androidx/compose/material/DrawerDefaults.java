...
public final class DrawerDefaults {
    ...
    public final float m1088getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        m2969copywmQWz5c = Color.m2969copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r1) : 0.32f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1047getOnSurface0d7_KjU()) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
