...
public final class TransformableStateKt {
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Offset offset, Float f2) {
                    m360invoked4ec7I(f.floatValue(), offset.getPackedValue(), f2.floatValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-d-4ec7I, reason: not valid java name */
                public final void m360invoked4ec7I(float z, long p, float r) {
                    lambdaState.getValue().invoke(Float.valueOf(z), Offset.m2720boximpl(p), Float.valueOf(r));
                }
            });
    ...
    public static final Object animateZoomBy(TransformableState $this$animateZoomBy, float zoomFactor, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        ...
        Object transform$default = TransformableState.CC.transform$default($this$animateZoomBy, null, new TransformableStateKt$animateZoomBy$3(previous, zoomFactor, animationSpec, null), continuation, 1, null);
    ...
    public static final Object animateRotateBy(TransformableState $this$animateRotateBy, float degrees, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Ref.FloatRef previous = new Ref.FloatRef();
        Object transform$default = TransformableState.CC.transform$default($this$animateRotateBy, null, new TransformableStateKt$animateRotateBy$2(previous, degrees, animationSpec, null), continuation, 1, null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    /* renamed from: animatePanBy-ubNVwUQ$default, reason: not valid java name */
    public static /* synthetic */ Object m358animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m357animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }

    /* renamed from: animatePanBy-ubNVwUQ, reason: not valid java name */
    public static final Object m357animatePanByubNVwUQ(TransformableState $this$animatePanBy_u2dubNVwUQ, long offset, AnimationSpec<Offset> animationSpec, Continuation<? super Unit> continuation) {
        Ref.LongRef previous = new Ref.LongRef();
        previous.element = Offset.INSTANCE.m2747getZeroF1C5BW0();
        Object transform$default = TransformableState.CC.transform$default($this$animatePanBy_u2dubNVwUQ, null, new TransformableStateKt$animatePanBy$2(previous, offset, animationSpec, null), continuation, 1, null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    public static final Object zoomBy(TransformableState $this$zoomBy, float zoomFactor, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.CC.transform$default($this$zoomBy, null, new TransformableStateKt$zoomBy$2(zoomFactor, null), continuation, 1, null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    public static final Object rotateBy(TransformableState $this$rotateBy, float degrees, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.CC.transform$default($this$rotateBy, null, new TransformableStateKt$rotateBy$2(degrees, null), continuation, 1, null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    /* renamed from: panBy-d-4ec7I, reason: not valid java name */
    public static final Object m359panByd4ec7I(TransformableState $this$panBy_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.CC.transform$default($this$panBy_u2dd_u2d4ec7I, null, new TransformableStateKt$panBy$2(offset, null), continuation, 1, null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }
