...
public final class InfiniteTransition {
    ...
    public InfiniteTransition(String label) {
        ...
        this.refreshChildNeeded = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
        this.startTimeNanos = Long.MIN_VALUE;
        this.isRunning = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(true, null, 2, null);
    }
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public TransitionAnimationState(InfiniteTransition this$0, T t, T t2, TwoWayConverter<T, V> typeConverter, AnimationSpec<T> animationSpec, String label) {
    ...
    public final void run$animation_core_release(Composer $composer, final int $changed) {
        Object value$iv$iv;
        ...
        if (isRunning() || getRefreshChildNeeded()) {
            EffectsKt.LaunchedEffect(this, new InfiniteTransition$run$1(toolingOverride, this, null), $composer2, 72);
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.core.InfiniteTransition$run$2
            ...
            public final void invoke(Composer composer, int i) {
                InfiniteTransition.this.run$animation_core_release(composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
