...
public final class VertexMode {
    ...
    private static final int Triangles = m3364constructorimpl(0);
    private static final int TriangleStrip = m3364constructorimpl(1);
    private static final int TriangleFan = m3364constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3363boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3364constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3365equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3366equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3367hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m3365equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3367hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3372getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m3371getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m3370getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3368toStringimpl(int arg0) {
        return m3366equalsimpl0(arg0, Triangles) ? "Triangles" : m3366equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m3366equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }

    public String toString() {
        return m3368toStringimpl(this.value);
    }
}
