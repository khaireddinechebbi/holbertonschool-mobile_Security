        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    int m4870unboximpl = m4791getFontStyle4Lr2A7w != null ? m4791getFontStyle4Lr2A7w.m4870unboximpl() : FontStyle.INSTANCE.m4872getNormal_LCdwA();
                    FontSynthesis m4792getFontSynthesisZQGJjVo = resolvedStyle.m4792getFontSynthesisZQGJjVo();
                    int $changed$iv = m4792getFontSynthesisZQGJjVo != null ? m4792getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4882getAllGVVA2EU();
                    value$iv$iv2 = fontFamilyResolver.mo4841resolveDPcqOEQ(fontFamily, fontWeight2, m4870unboximpl, $changed$iv);
                ...
                Modifier m521heightInVpY3zN4 = SizeKt.m521heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo324toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo324toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m521heightInVpY3zN4;
            }
        });
    }
