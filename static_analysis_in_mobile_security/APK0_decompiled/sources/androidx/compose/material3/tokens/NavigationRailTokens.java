...
public final class NavigationRailTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5274constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5274constructorimpl((float) 56.0d);
    ...
    private static final float ContainerWidth = Dp.m5274constructorimpl((float) 80.0d);
    ...
    private static final ColorSchemeKeyTokens MenuFocusIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final ColorSchemeKeyTokens MenuHoverIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final ColorSchemeKeyTokens MenuIconColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float MenuIconSize = Dp.m5274constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens MenuPressedIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final float NoLabelActiveIndicatorHeight = Dp.m5274constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens NoLabelActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    ...
    public final float m2306getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2307getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2309getContainerWidthD9Ej5fM() {
        return ContainerWidth;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2310getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2311getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m2312getNoLabelActiveIndicatorHeightD9Ej5fM() {
