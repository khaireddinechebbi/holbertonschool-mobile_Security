...
public final /* data */ class CalendarMonth {
    ...
    public int hashCode() {
        return (((((((this.year * 31) + this.month) * 31) + this.numberOfDays) * 31) + this.daysFromStartOfWeekToFirstOfMonth) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.startUtcTimeMillis);
    }
    ...
    public CalendarMonth(int year, int month, int numberOfDays, int daysFromStartOfWeekToFirstOfMonth, long startUtcTimeMillis) {
        ...
        this.endUtcTimeMillis = ((numberOfDays * CalendarModelKt.MillisecondsIn24Hours) + startUtcTimeMillis) - 1;
    }
