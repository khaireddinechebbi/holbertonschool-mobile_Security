...
final class VisibleModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (!this.visible) {
            return MeasureScope.CC.layout$default(measure, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.VisibleModifier$measure$1
        ...
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.VisibleModifier$measure$2
            {
                super(1);
            }
    ...
    public int hashCode() {
        return ClickableElement$$ExternalSyntheticBackport0.m(this.visible);
    }

    public boolean equals(Object other) {
        VisibleModifier otherModifier = other instanceof VisibleModifier ? (VisibleModifier) other : null;
        return otherModifier != null && this.visible == otherModifier.visible;
    }
}
