...
public class MutableDoubleState implements StateObject, androidx.compose.runtime.MutableDoubleState, SnapshotMutableState<Double> {
    ...
    public MutableDoubleState(double value) {
        this.next = new DoubleStateStateRecord(value);
    }
    ...
    public void setDoubleValue(double value) {
        ...
        if (!(it.getValue() == value)) {
            ...
            synchronized (lock$iv$iv$iv) {
                ...
                DoubleStateStateRecord $this$_set_doubleValue__u24lambda_u241_u24lambda_u240 = (DoubleStateStateRecord) SnapshotKt.overwritableRecord($this$overwritable$iv, this, current, it);
                $this$_set_doubleValue__u24lambda_u241_u24lambda_u240.setValue(value);
