...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m4645constructorimpl(0);
    private static final int None = m4645constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ EmojiSupportMatch m4644boximpl(int i) {
        return new EmojiSupportMatch(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4645constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4646equalsimpl(int i, Object obj) {
        return (obj instanceof EmojiSupportMatch) && i == ((EmojiSupportMatch) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4647equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4648hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m4646equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4648hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4649toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4649toStringimpl(int arg0) {
    ...
    public static final class Companion {
        ...
        public final int m4651getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y, reason: not valid java name */
        public final int m4652getNone_3YsG6Y() {
