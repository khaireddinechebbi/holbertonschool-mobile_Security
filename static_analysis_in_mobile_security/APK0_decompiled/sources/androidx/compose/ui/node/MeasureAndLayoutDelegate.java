...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4400updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!(constraints2 == null ? false : Constraints.m5211equalsimpl0(constraints2.getValue(), constraints))) {
            ...
            this.rootConstraints = Constraints.m5206boximpl(constraints);
    ...
    private final boolean m4397doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean lookaheadSizeChanged;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints == null) {
            lookaheadSizeChanged = LayoutNode.m4366lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        } else {
            lookaheadSizeChanged = layoutNode.m4370lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    private final boolean m4398doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean sizeChanged;
        if (constraints == null) {
            sizeChanged = LayoutNode.m4367remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        } else {
            sizeChanged = layoutNode.m4371remeasure_Sx5XlM$ui_release(constraints);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    public final void m4399measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean lookaheadSizeChanged = m4397doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5206boximpl(constraints));
                m4398doRemeasuresdFAvZA(layoutNode, Constraints.m5206boximpl(constraints));
        ...
        if (layoutNode.isPlaced() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
                ...
                if (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) {
                    lookaheadSizeChanged = m4397doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                }
                sizeChanged = m4398doRemeasuresdFAvZA(layoutNode, constraints);
            }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release()) {
            m4397doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        }
        m4398doRemeasuresdFAvZA(layoutNode, constraints);
    }
