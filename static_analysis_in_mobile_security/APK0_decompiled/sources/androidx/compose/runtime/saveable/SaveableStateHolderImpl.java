...
final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    public void SaveableStateProvider(final Object key, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1198538093, $changed, -1, "androidx.compose.runtime.saveable.SaveableStateHolderImpl.SaveableStateProvider (SaveableStateHolder.kt:74)");
        }
        ...
        int i = (8 >> 3) & 14;
        ComposerKt.sourceInformationMarkerStart($composer2, 1516495192, "C76@3023L321,83@3357L150,87@3520L360:SaveableStateHolder.kt#r2ddri");
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new RegistryHolder(this, key);
            $composer2.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        $composer2.endReplaceableGroup();
        final RegistryHolder registryHolder = (RegistryHolder) value$iv$iv;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{SaveableStateRegistryKt.getLocalSaveableStateRegistry().provides(registryHolder.getRegistry())}, content, $composer2, ($changed & 112) | 8);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderImpl$SaveableStateProvider$2
            ...
            public final void invoke(Composer composer, int i2) {
                SaveableStateHolderImpl.this.SaveableStateProvider(key, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
