...
public final /* data */ class CalendarDate implements Comparable<CalendarDate> {
    ...
    public int hashCode() {
        return (((((this.year * 31) + this.month) * 31) + this.dayOfMonth) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.utcTimeMillis);
    }
