...
public final class AnchoredDraggableState<T> {
    ...
    */
        ...
        if (!Intrinsics.areEqual(f, offset) && f != null) {
            if (f.floatValue() < offset) {
                if (velocity >= floatValue) {
                    closestAnchor4 = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, true);
                    return (T) closestAnchor4;
                }
                closestAnchor3 = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, true);
                T t = (T) closestAnchor3;
                ...
                if (velocity <= (-floatValue)) {
                    closestAnchor2 = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, false);
                    return (T) closestAnchor2;
                }
                closestAnchor = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, false);
                T t2 = (T) closestAnchor;
    ...
    public final T computeTargetWithoutThresholds(float offset, T currentValue) {
        ...
        if (f.floatValue() < offset) {
            closestAnchor2 = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, true);
            return (T) closestAnchor2;
        }
        closestAnchor = AnchoredDraggableKt.closestAnchor(anchors$material_release, offset, false);
