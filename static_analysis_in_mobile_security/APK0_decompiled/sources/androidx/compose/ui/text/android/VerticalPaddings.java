...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m4802boximpl(long j) {
        return new VerticalPaddings(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4803constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4804equalsimpl(long j, Object obj) {
        return (obj instanceof VerticalPaddings) && j == ((VerticalPaddings) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4805equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static String m4809toStringimpl(long j) {
        return "VerticalPaddings(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4804equalsimpl(this.packedValue, obj);
    }
    ...
    public static final int m4807getTopPaddingimpl(long arg0) {
        return (int) (arg0 >> 32);
    }

    /* renamed from: getBottomPadding-impl, reason: not valid java name */
    public static final int m4806getBottomPaddingimpl(long arg0) {
