...
.method public static final getLocationOn(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    .locals 42
    .param p0, "$this$LocationOn"    # Landroidx/compose/material/icons/Icons$Outlined;
    ...
    .line 29
    :cond_0
    const-string v0, "Outlined.LocationOn"
    ...
    .local v2, "$this$_get_LocationOn__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    const/4 v3, 0x0
    ...
    .local v35, "$this$_get_LocationOn__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v36, 0x0

    .line 31
    .local v36, "$i$a$-materialPath-YwgOQQI$default-LocationOnKt$LocationOn$1$1":I
    ...
    .end local v35    # "$this$_get_LocationOn__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v1, "$this$_get_LocationOn__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const/high16 v29, 0x40a80000    # 5.25f
    ...
    .line 34
    const/high16 v12, -0x3f080000    # -7.75f
    ...
    .local v41, "$i$a$-materialIcon-LocationOnKt$LocationOn$1":I
    const/high16 v3, 0x40e00000    # 7.0f

    invoke-virtual {v1, v3, v12, v3, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v1, v12, v3, v12, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 87
    .end local v1    # "$this$_get_LocationOn__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v36    # "$i$a$-materialPath-YwgOQQI$default-LocationOnKt$LocationOn$1$1":I
    nop
    ...
    .local v12, "$this$_get_LocationOn__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v13, 0x0

    .line 45
    .local v13, "$i$a$-materialPath-YwgOQQI$default-LocationOnKt$LocationOn$1$2":I
    ...
    .line 125
    .end local v12    # "$this$_get_LocationOn__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v13    # "$i$a$-materialPath-YwgOQQI$default-LocationOnKt$LocationOn$1$2":I
    nop
    ...
    .line 56
    .end local v2    # "$this$_get_LocationOn__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v41    # "$i$a$-materialIcon-LocationOnKt$LocationOn$1":I
