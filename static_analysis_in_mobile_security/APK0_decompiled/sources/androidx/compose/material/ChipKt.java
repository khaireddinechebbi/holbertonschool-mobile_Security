    ...
    */
    ...
    public static final void FilterChip(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, Shape shape, BorderStroke border, SelectableChipColors colors, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((1533916891 & $dirty2) == 306783378 && ($dirty12 & 91) == 18 && $composer3.getSkipping()) {
            ...
            long m2981unboximpl = colors3.backgroundColor(enabled3, selected, $composer3, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 15) & 896)).getValue().m2981unboximpl();
            m2969copywmQWz5c = Color.m2969copywmQWz5c(r0, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r0) : 1.0f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r0) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r0) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(contentColor.getValue().m2981unboximpl()) : 0.0f);
            ...
            modifier4 = modifier2;
            $composer2 = $composer3;
            SurfaceKt.m1212SurfaceNy5ogXk(selected, onClick, semantics$default, enabled4, shape3, m2981unboximpl, m2969copywmQWz5c, border2, 0.0f, interactionSource3, ComposableLambdaKt.composableLambda($composer3, 722126431, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ChipKt$FilterChip$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ProvidedValue[] providedValueArr = {ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2973getAlphaimpl(contentColor.getValue().m2981unboximpl())))};
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    TextKt.ProvideTextStyle(body2, ComposableLambdaKt.composableLambda($composer5, -1543702066, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ChipKt.FilterChip.3.1.1
                                        ...
                                        /* JADX WARN: Removed duplicated region for block: B:42:0x05cc  */
                                        ...
                                        /* JADX WARN: Removed duplicated region for block: B:61:0x0378 A[ADDED_TO_REGION] */
                                        ...
                                        */
                                        public final void invoke(androidx.compose.runtime.Composer r77, int r78) {
                                            /*
                                                ...
                                                To view this dump add '--comments-level debug' option
                                            */
                                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ChipKt$FilterChip$3.AnonymousClass1.C00271.invoke(androidx.compose.runtime.Composer, int):void");
                                        }
                                    }), $composer5, 48);
                                    if (ComposerKt.isTraceInProgress()) {
