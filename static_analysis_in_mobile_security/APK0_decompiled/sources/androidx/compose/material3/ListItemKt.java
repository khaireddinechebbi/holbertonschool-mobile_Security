...
public final class ListItemKt {
    ...
    public static final void m1589ListItemHXNGIdc(final Function2<? super Composer, ? super Integer, Unit> headlineContent, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, ListItemColors colors, float tonalElevation, float shadowElevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                tonalElevation2 = i8 != 0 ? ListItemDefaults.INSTANCE.m1587getElevationD9Ej5fM() : tonalElevation;
                shadowElevation2 = i9 != 0 ? ListItemDefaults.INSTANCE.m1587getElevationD9Ej5fM() : shadowElevation;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 64) != 0) {
                    $dirty &= -3670017;
            ...
            final Function2 decoratedHeadlineContent = ComposableLambdaKt.composableLambda($composer2, -403249643, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedHeadlineContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        ListItemKt.m1591ProvideTextStyleFromToken3JVO9M(ListItemColors.this.headlineColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2981unboximpl(), ListTokens.INSTANCE.getListItemLabelTextFont(), headlineContent, $composer3, (($dirty << 6) & 896) | 48);
                        if (ComposerKt.isTraceInProgress()) {
                ...
                decoratedSupportingContent = ComposableLambdaKt.composableLambda($composer2, -1020860251, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedSupportingContent$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1591ProvideTextStyleFromToken3JVO9M(ListItemColors.this.supportingColor$material3_release($composer3, ($dirty >> 18) & 14).getValue().m2981unboximpl(), ListTokens.INSTANCE.getListItemSupportingTextFont(), it, $composer3, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedOverlineContent = ComposableLambdaKt.composableLambda($composer2, -764441232, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedOverlineContent$1$1
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1591ProvideTextStyleFromToken3JVO9M(ListItemColors.this.overlineColor$material3_release($composer3, ($dirty >> 18) & 14).getValue().m2981unboximpl(), ListTokens.INSTANCE.getListItemOverlineFont(), it2, $composer3, 48);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedLeadingContent = ComposableLambdaKt.composableLambda($composer2, 1673725255, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedLeadingContent$1$1
                    ...
                    public final void invoke(RowScope $this$null, Composer $composer3, int $changed2) {
                        ...
                        if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1588LeadingContent3IgeMak($this$null, ListItemColors.this.leadingIconColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2981unboximpl(), ListItemType.m1601equalsimpl0(listItemType, ListItemType.INSTANCE.m1608getThreeLineAlXitO8()), it3, $composer3, $dirty2 & 14);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
                ...
                decoratedTrailingContent = ComposableLambdaKt.composableLambda($composer2, 1392069445, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$decoratedTrailingContent$1$1
                    ...
                    public final void invoke(RowScope $this$null, Composer $composer3, int $changed2) {
                        ...
                        if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                            ...
                            ListItemKt.m1592TrailingContent3IgeMak($this$null, ListItemColors.this.trailingIconColor$material3_release(true, $composer3, (($dirty >> 15) & 112) | 6).getValue().m2981unboximpl(), ListItemType.m1601equalsimpl0(listItemType, ListItemType.INSTANCE.m1608getThreeLineAlXitO8()), it4, $composer3, $dirty2 & 14);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            float minHeight = ListItemType.m1601equalsimpl0(listItemType, ListItemType.INSTANCE.m1607getOneLineAlXitO8()) ? ListTokens.INSTANCE.m2286getListItemOneLineContainerHeightD9Ej5fM() : ListItemType.m1601equalsimpl0(listItemType, ListItemType.INSTANCE.m1609getTwoLineAlXitO8()) ? ListTokens.INSTANCE.m2290getListItemTwoLineContainerHeightD9Ej5fM() : ListTokens.INSTANCE.m2288getListItemThreeLineContainerHeightD9Ej5fM();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ListItem$2
            ...
            public final void invoke(Composer composer, int i10) {
                ListItemKt.m1589ListItemHXNGIdc(headlineContent, modifier4, function29, function210, function211, function212, listItemColors, f, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    public static final void m1588LeadingContent3IgeMak(final RowScope $this$LeadingContent_u2d3IgeMak, final long contentColor, final boolean topAlign, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2961boximpl(contentColor))}, ComposableLambdaKt.composableLambda($composer2, 315166618, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = PaddingKt.m491paddingqDBjuR0$default(companion, 0.0f, 0.0f, f, 0.0f, 11, null).then(!topAlign ? $this$LeadingContent_u2d3IgeMak.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterVertically()) : Modifier.INSTANCE);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$2
            ...
            public final void invoke(Composer composer, int i) {
                ListItemKt.m1588LeadingContent3IgeMak(RowScope.this, contentColor, topAlign, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1592TrailingContent3IgeMak(final RowScope $this$TrailingContent_u2d3IgeMak, final long contentColor, final boolean topAlign, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier m489paddingVpY3zN4$default = PaddingKt.m489paddingVpY3zN4$default(Modifier.INSTANCE, TrailingHorizontalPadding, 0.0f, 2, null);
            Modifier.Companion companion = Modifier.INSTANCE;
            if (!topAlign) {
                companion = $this$TrailingContent_u2d3IgeMak.align(companion, Alignment.INSTANCE.getCenterVertically());
            }
            Modifier modifier$iv = m489paddingVpY3zN4$default.then(companion);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$TrailingContent$2
            ...
            public final void invoke(Composer composer, int i3) {
                ListItemKt.m1592TrailingContent3IgeMak(RowScope.this, contentColor, topAlign, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
