...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo437calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density $this$calculateLeftPadding_u2uoSUM_u24lambda_u240 = this.density;
        return $this$calculateLeftPadding_u2uoSUM_u24lambda_u240.mo324toDpu2uoSUM(this.insets.getLeft($this$calculateLeftPadding_u2uoSUM_u24lambda_u240, layoutDirection));
    }
    ...
    public float getTop() {
        ...
        return $this$calculateTopPadding_D9Ej5fM_u24lambda_u241.mo324toDpu2uoSUM(this.insets.getTop($this$calculateTopPadding_D9Ej5fM_u24lambda_u241));
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateRightPadding-u2uoSUM, reason: not valid java name */
    public float mo438calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density $this$calculateRightPadding_u2uoSUM_u24lambda_u242 = this.density;
        return $this$calculateRightPadding_u2uoSUM_u24lambda_u242.mo324toDpu2uoSUM(this.insets.getRight($this$calculateRightPadding_u2uoSUM_u24lambda_u242, layoutDirection));
    }
    ...
    public float getBottom() {
        ...
        return $this$calculateBottomPadding_D9Ej5fM_u24lambda_u243.mo324toDpu2uoSUM(this.insets.getBottom($this$calculateBottomPadding_D9Ej5fM_u24lambda_u243));
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof InsetsPaddingValues) && Intrinsics.areEqual(this.insets, ((InsetsPaddingValues) other).insets) && Intrinsics.areEqual(this.density, ((InsetsPaddingValues) other).density);
    }
