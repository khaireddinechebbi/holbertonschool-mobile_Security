...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5217getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m5218getMaxWidthimpl(constraints)) {
            m5208copyZbe2FdA = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : 0);
        } else {
            m5208copyZbe2FdA = constraints;
        }
        long childConstraints = m5208copyZbe2FdA;
        final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
        final int width = Math.min(placeable.getWidth(), Constraints.m5218getMaxWidthimpl(constraints));
        return MeasureScope.CC.layout$default(measure, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, placeable.getWidth());
