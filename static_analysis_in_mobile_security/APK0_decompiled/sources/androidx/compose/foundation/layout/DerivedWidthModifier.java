...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int width = this.widthCalc.invoke(getUnconsumedInsets(), measure.getLayoutDirection(), measure).intValue();
        if (width == 0) {
            return MeasureScope.CC.layout$default(measure, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$1
        ...
        childConstraints = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : width, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : width, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : 0);
        final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
        return MeasureScope.CC.layout$default(measure, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DerivedWidthModifier) && Intrinsics.areEqual(this.insets, ((DerivedWidthModifier) other).insets) && Intrinsics.areEqual(this.widthCalc, ((DerivedWidthModifier) other).widthCalc);
    }
