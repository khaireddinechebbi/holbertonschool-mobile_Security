...
final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public void Item(final int index, final Object key, Composer $composer, final int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1493551140, $changed, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item (LazyGridItemProvider.kt:74)");
        }
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems(), ComposableLambdaKt.composableLambda($composer2, 726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
            ...
            public final void invoke(Composer $composer3, int $changed2) {
                ...
                ComposerKt.sourceInformation($composer3, "C*77@3037L39:LazyGridItemProvider.kt#7791vq");
                if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(726189336, $changed2, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.<anonymous> (LazyGridItemProvider.kt:75)");
                    }
                    lazyLayoutIntervalContent = LazyGridItemProviderImpl.this.intervalContent;
                    ...
                    LazyGridInterval content = interval$iv.getValue();
                    content.getItem().invoke(LazyGridItemScopeImpl.INSTANCE, Integer.valueOf(localIntervalIndex$iv), $composer3, 6);
                    if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$2
            ...
            public final void invoke(Composer composer, int i) {
                LazyGridItemProviderImpl.this.Item(index, key, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
