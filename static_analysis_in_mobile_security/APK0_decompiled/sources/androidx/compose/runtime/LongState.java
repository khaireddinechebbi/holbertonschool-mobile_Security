...
public interface LongState extends State<Long> {
    ...
    public final /* synthetic */ class CC {
        public static /* synthetic */ long access$getValue$jd(LongState $this) {
            return $default$getValue($this).longValue();
        }
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static Long getValue(LongState $this) {
            return Long.valueOf(CC.access$getValue$jd($this));
        }
    }
}
