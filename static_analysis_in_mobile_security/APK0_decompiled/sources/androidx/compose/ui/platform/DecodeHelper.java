...
public final class DecodeHelper {
    ...
    public final long m4543decodeTextUnitXSAIIZE() {
        ...
        if (decodeByte == 1) {
            ...
            type = decodeByte == 2 ? TextUnitType.INSTANCE.m5487getEmUIouoOA() : TextUnitType.INSTANCE.m5489getUnspecifiedUIouoOA();
        }
    ...
    public final int m4541decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontStyle.INSTANCE.m4872getNormal_LCdwA() : decodeByte == 1 ? FontStyle.INSTANCE.m4871getItalic_LCdwA() : FontStyle.INSTANCE.m4872getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4542decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontSynthesis.INSTANCE.m4883getNoneGVVA2EU() : decodeByte == 1 ? FontSynthesis.INSTANCE.m4882getAllGVVA2EU() : decodeByte == 3 ? FontSynthesis.INSTANCE.m4884getStyleGVVA2EU() : decodeByte == 2 ? FontSynthesis.INSTANCE.m4885getWeightGVVA2EU() : FontSynthesis.INSTANCE.m4883getNoneGVVA2EU();
    }
