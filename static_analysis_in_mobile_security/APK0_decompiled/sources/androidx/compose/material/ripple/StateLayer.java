...
final class StateLayer {
    ...
    public final void m1301drawStateLayerH2RKhps(DrawScope drawStateLayer, float radius, long color) {
        ...
        if (alpha > 0.0f) {
            modulatedColor = Color.m2969copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color) : 0.0f);
            if (!this.bounded) {
