...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5439getZeroYbymL2g();
    ...
    public final void m3601drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (targetImage == null || targetCanvas == null || IntSize.m5434getWidthimpl(size) > targetImage.getWidth() || IntSize.m5433getHeightimpl(size) > targetImage.getHeight()) {
            targetImage = ImageBitmapKt.m3199ImageBitmapx__hDU$default(IntSize.m5434getWidthimpl(size), IntSize.m5433getHeightimpl(size), 0, false, null, 28, null);
        ...
        long size$iv = IntSizeKt.m5444toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m3511drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.CC.m3522drawRectnJ9OG0$default($this$clear, Color.INSTANCE.m2997getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2888getClear0nO6VwU(), 62, null);
    }
}
