...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    */
    public /* synthetic */ SimpleGraphicsLayerModifier(float r24, float r25, float r26, float r27, float r28, float r29, float r30, float r31, float r32, float r33, long r34, androidx.compose.ui.graphics.Shape r36, boolean r37, androidx.compose.ui.graphics.RenderEffect r38, long r39, long r41, int r43, int r44, kotlin.jvm.internal.DefaultConstructorMarker r45) {
        /*
            r23 = this;
            r0 = 65536(0x10000, float:9.1835E-41)
            r0 = r44 & r0
            if (r0 == 0) goto Lf
            androidx.compose.ui.graphics.CompositingStrategy$Companion r0 = androidx.compose.ui.graphics.CompositingStrategy.INSTANCE
            int r0 = r0.m3055getAutoNrFUSI()
            r21 = r0
            goto L11
        Lf:
            r21 = r43
    ...
    private SimpleGraphicsLayerModifier(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                ...
                $this$null.setScaleX(SimpleGraphicsLayerModifier.this.getScaleX());
                $this$null.setScaleY(SimpleGraphicsLayerModifier.this.getScaleY());
                $this$null.setAlpha(SimpleGraphicsLayerModifier.this.getAlpha());
                $this$null.setTranslationX(SimpleGraphicsLayerModifier.this.getTranslationX());
                $this$null.setTranslationY(SimpleGraphicsLayerModifier.this.getTranslationY());
                $this$null.setShadowElevation(SimpleGraphicsLayerModifier.this.getShadowElevation());
                $this$null.setRotationX(SimpleGraphicsLayerModifier.this.getRotationX());
                $this$null.setRotationY(SimpleGraphicsLayerModifier.this.getRotationY());
                $this$null.setRotationZ(SimpleGraphicsLayerModifier.this.getRotationZ());
                $this$null.setCameraDistance(SimpleGraphicsLayerModifier.this.getCameraDistance());
                $this$null.mo3140setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.getTransformOrigin());
                $this$null.setShape(SimpleGraphicsLayerModifier.this.getShape());
                $this$null.setClip(SimpleGraphicsLayerModifier.this.getClip());
                $this$null.setRenderEffect(SimpleGraphicsLayerModifier.this.getRenderEffect());
                $this$null.mo3137setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getAmbientShadowColor());
                $this$null.mo3139setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getSpotShadowColor());
                $this$null.mo3138setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.getCompositingStrategy());
            }
        };
    }
