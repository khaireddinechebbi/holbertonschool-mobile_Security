...
public interface ImmutableList<E> extends List<E>, ImmutableCollection<E>, KMappedMarker {
    ...
    public final /* synthetic */ class CC {
        public static ImmutableList $default$subList(ImmutableList _this, int fromIndex, int toIndex) {
            return new SubList(_this, fromIndex, toIndex);
        }
    }
    ...
    protected static final class SubList<E> extends AbstractList<E> implements ImmutableList<E> {
        private int _size;
        ...
        public SubList(ImmutableList<? extends E> source, int fromIndex, int toIndex) {
            Intrinsics.checkNotNullParameter(source, "source");
            this.source = source;
            this.fromIndex = fromIndex;
            this.toIndex = toIndex;
            ListImplementation.checkRangeIndexes$runtime_release(fromIndex, toIndex, source.size());
        ...
        public ImmutableList<E> subList(int fromIndex, int toIndex) {
            ...
            return new SubList(immutableList, i + fromIndex, i + toIndex);
        }
    }
}
