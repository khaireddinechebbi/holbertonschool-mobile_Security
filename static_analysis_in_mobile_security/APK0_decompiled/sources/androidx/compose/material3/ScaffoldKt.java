                    ...
                    public final MeasureResult m1691invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        return MeasureScope.CC.layout$default(SubcomposeLayout, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                int $i$f$map = 0;
                                Collection destination$iv$iv2 = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv2, i5));
                                for (Object item$iv$iv2 : $this$map$iv2) {
                                    ...
                                    destination$iv$iv2.add(it4.mo4225measureBRTryo0(ConstraintsKt.m5234offsetNN6EwU(j2, i6, leftInset2)));
                                ...
                                if (!((Collection) fabPlaceables).isEmpty()) {
                                    ...
                                    if (!FabPosition.m1532equalsimpl0(i3, FabPosition.INSTANCE.m1537getEndERTFSPs())) {
                                        ...
                                        fabLeftOffset = (i7 - subcomposeMeasureScope6.mo321roundToPx0680j_4(f4)) - fabWidth;
                                    } else {
                                        SubcomposeMeasureScope subcomposeMeasureScope7 = SubcomposeMeasureScope.this;
                                        f3 = ScaffoldKt.FabSpacing;
                                        fabLeftOffset = subcomposeMeasureScope7.mo321roundToPx0680j_4(f3);
                                    }
                                ...
                                Iterable $this$map$iv4 = subcomposeMeasureScope8.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(-1455477816, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer5, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer5.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(FabPlacement.this)}, function29, $composer5, ((i8 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                if (fabPlacement2 != null) {
                                    ...
                                    if (bottomBarHeight == null) {
                                        ...
                                        i4 = height + subcomposeMeasureScope9.mo321roundToPx0680j_4(f2) + windowInsets6.getBottom(subcomposeMeasureScope9);
                                    } else {
                                        int intValue = bottomBarHeight.intValue() + fabPlacement2.getHeight();
                                        f = ScaffoldKt.FabSpacing;
                                        i4 = intValue + subcomposeMeasureScope9.mo321roundToPx0680j_4(f);
                                    }
                                    ...
                                    public final void invoke(Composer $composer5, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer5.getSkipping()) {
                                            ...
                                            if (topBarPlaceables.isEmpty()) {
                                                ...
                                                f5 = subcomposeMeasureScope11.mo324toDpu2uoSUM(topBarHeight);
                                            }
                                            if (bottomBarPlaceables.isEmpty() || (num2 = bottomBarHeight) == null) {
                                                bottom = insets.getBottom();
                                            } else {
                                                bottom = subcomposeMeasureScope11.mo324toDpu2uoSUM(num2.intValue());
                                            }
                                            PaddingValues innerPadding = PaddingKt.m483PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(insets, subcomposeMeasureScope11.getLayoutDirection()), f5, PaddingKt.calculateEndPadding(insets, subcomposeMeasureScope11.getLayoutDirection()), bottom);
                                            function33.invoke(innerPadding, $composer5, Integer.valueOf((i9 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
