...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m4168boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    ...
    public static /* synthetic */ void m4591getKeyboardModifiersk7X9c1A$annotations() {
    }
    ...
    public int mo4588getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m4592setKeyboardModifiers5xRPYO0(int value) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m4168boximpl(value));
    }
