    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection it = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            ...
            public void mo4944onImeActionKlQnJC8(int imeAction) {
                ...
                function1.invoke(ImeAction.m4915boximpl(imeAction));
            }
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (needUpdateSelection) {
                ...
                int m4766getMinimpl = TextRange.m4766getMinimpl(newValue.getSelection());
                int m4765getMaximpl = TextRange.m4765getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int m4766getMinimpl2 = composition != null ? TextRange.m4766getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(m4766getMinimpl, m4765getMaximpl, m4766getMinimpl2, composition2 != null ? TextRange.m4765getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
