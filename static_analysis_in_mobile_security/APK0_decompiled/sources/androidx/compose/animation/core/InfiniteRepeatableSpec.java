    ...
    */
    public /* synthetic */ InfiniteRepeatableSpec(androidx.compose.animation.core.DurationBasedAnimationSpec r7, androidx.compose.animation.core.RepeatMode r8, long r9, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L9:
            ...
            r9 = 0
            r10 = 2
            long r9 = androidx.compose.animation.core.StartOffset.m112constructorimpl$default(r9, r9, r10, r8)
            r3 = r9
            goto L17
        L16:
            r3 = r9
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(animation, repeatMode, StartOffset.m112constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof InfiniteRepeatableSpec) && Intrinsics.areEqual(((InfiniteRepeatableSpec) other).animation, this.animation) && ((InfiniteRepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m114equalsimpl0(((InfiniteRepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }

    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m117hashCodeimpl(this.initialStartOffset);
    }
}
