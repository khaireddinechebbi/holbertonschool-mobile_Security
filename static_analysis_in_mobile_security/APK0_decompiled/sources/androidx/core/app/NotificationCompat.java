...
public class NotificationCompat {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (this.mPictureIcon != null) {
                if (Build.VERSION.SDK_INT >= 31) {
                    ...
                    style = Api16Impl.bigPicture(style, this.mPictureIcon.getBitmap());
                }
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage((Notification.MessagingStyle) frameworkStyle, it.next().toAndroidMessage());
                }
            ...
            Notification.BigTextStyle style = Api16Impl.createBigTextStyle(builder.getBuilder());
            Api16Impl.bigText(Api16Impl.setBigContentTitle(style, null), completeMessage);
        }
    ...
    public static class Action {
        ...
        Action(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual, boolean requireAuth) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m5521clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m5522clone() {
            WearableExtender that = new WearableExtender();
