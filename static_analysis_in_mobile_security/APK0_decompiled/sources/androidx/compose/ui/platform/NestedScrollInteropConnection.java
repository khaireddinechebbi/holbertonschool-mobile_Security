...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo337onPreScrollOzD1aCk(long available, int source) {
        int m4578getScrollAxesk4lQ0M;
        int m4580toViewTypeGyEprt8;
        int m4580toViewTypeGyEprt82;
        long m4579toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m4578getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m4578getScrollAxesk4lQ0M(available);
        m4580toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m4580toViewTypeGyEprt8(source);
        if (!nestedScrollingChildHelper.startNestedScroll(m4578getScrollAxesk4lQ0M, m4580toViewTypeGyEprt8)) {
        ...
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2731getXimpl(available));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2732getYimpl(available));
        int[] iArr = this.consumedScrollCache;
        m4580toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4580toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m4580toViewTypeGyEprt82);
        m4579toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4579toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m4579toOffsetUv8p0NA;
    }
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2731getXimpl(consumed));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2732getYimpl(consumed));
        int composeToViewOffset3 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2731getXimpl(available));
        int composeToViewOffset4 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2732getYimpl(available));
        m4580toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4580toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m4580toViewTypeGyEprt82, this.consumedScrollCache);
        m4579toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4579toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m4579toOffsetUv8p0NA;
    }
    ...
    public Object mo336onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        ...
        long result;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5499getXimpl(available));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5500getYimpl(available));
