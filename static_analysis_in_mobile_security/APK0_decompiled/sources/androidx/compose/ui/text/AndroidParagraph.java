...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m5219getMinHeightimpl(constraints) == 0 && Constraints.m5220getMinWidthimpl(constraints) == 0)) {
        ...
        shouldAttachIndentationFixSpan = AndroidParagraph_androidKt.shouldAttachIndentationFixSpan(style, ellipsis);
        ...
        alignment = AndroidParagraph_androidKt.m4638toLayoutAlignAMY3VfE(style.m4797getTextAlignbuA522U());
        TextAlign m4797getTextAlignbuA522U = style.m4797getTextAlignbuA522U();
        int justificationMode = m4797getTextAlignbuA522U == null ? false : TextAlign.m5130equalsimpl0(m4797getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m5136getJustifye0LSkKk()) ? 1 : 0;
        hyphens = AndroidParagraph_androidKt.m4640toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m4795getLineBreakLgCVezo = style.m4795getLineBreakLgCVezo();
        breakStrategy = AndroidParagraph_androidKt.m4639toLayoutBreakStrategyu6PBz3U(m4795getLineBreakLgCVezo != null ? LineBreak.Strategy.m5071boximpl(LineBreak.m5062getStrategyfcGXIks(m4795getLineBreakLgCVezo.getMask())) : null);
        LineBreak m4795getLineBreakLgCVezo2 = style.m4795getLineBreakLgCVezo();
        lineBreakStyle = AndroidParagraph_androidKt.m4641toLayoutLineBreakStyle4a2g8L8(m4795getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m5081boximpl(LineBreak.m5063getStrictnessusljTpc(m4795getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m4795getLineBreakLgCVezo3 = style.m4795getLineBreakLgCVezo();
        lineBreakWordStyle = AndroidParagraph_androidKt.m4642toLayoutLineBreakWordStylegvcdTPQ(m4795getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m5092boximpl(LineBreak.m5064getWordBreakjp8hJ3c(m4795getLineBreakLgCVezo3.getMask())) : null);
        if (ellipsis) {
            ellipsize = TextUtils.TruncateAt.END;
        } else {
            ellipsize = null;
        }
        TextLayout firstLayout = constructTextLayout(alignment, justificationMode, ellipsize, maxLines, hyphens, breakStrategy, lineBreakStyle, lineBreakWordStyle);
        if (ellipsis && firstLayout.getHeight() > Constraints.m5217getMaxHeightimpl(constraints) && maxLines > 1) {
            calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m5217getMaxHeightimpl(constraints));
        ...
        getTextPaint$ui_text_release().m5007setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m5026setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
        ...
        if ($this$placeholderRects_u24lambda_u246 instanceof Spanned) {
            ...
            int $i$f$mapTo2 = 0;
            int length = $this$mapTo$iv$iv2.length;
            int i4 = 0;
            while (i4 < length) {
                Object item$iv$iv = $this$mapTo$iv$iv2[i4];
    ...
    public float getWidth() {
        return Constraints.m5218getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4628getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m2732getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m2731getXimpl(position));
    }
    ...
    public final void m4626fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4766getMinimpl(range), TextRange.m4765getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4629getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4631paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m5008setColor8_81llA(color);
    ...
    public void mo4630paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m5005getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m5008setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m5006setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5006setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4632painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m5005getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m5007setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m5006setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5006setBlendModes9anfk8(currBlendMode);
    }
