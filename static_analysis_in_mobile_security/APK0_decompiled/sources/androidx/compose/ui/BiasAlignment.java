...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2621alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m5434getWidthimpl(space) - IntSize.m5434getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m5433getHeightimpl(space) - IntSize.m5433getHeightimpl(size)) / 2.0f;
