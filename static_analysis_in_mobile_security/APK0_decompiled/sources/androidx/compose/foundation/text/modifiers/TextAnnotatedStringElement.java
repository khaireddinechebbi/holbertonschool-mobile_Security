...
public final class TextAnnotatedStringElement extends ModifierNodeElement<TextAnnotatedStringNode> {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextAnnotatedStringElement) && Intrinsics.areEqual(this.color, ((TextAnnotatedStringElement) other).color) && Intrinsics.areEqual(this.text, ((TextAnnotatedStringElement) other).text) && Intrinsics.areEqual(this.style, ((TextAnnotatedStringElement) other).style) && Intrinsics.areEqual(this.placeholders, ((TextAnnotatedStringElement) other).placeholders) && Intrinsics.areEqual(this.fontFamilyResolver, ((TextAnnotatedStringElement) other).fontFamilyResolver) && Intrinsics.areEqual(this.onTextLayout, ((TextAnnotatedStringElement) other).onTextLayout) && TextOverflow.m5174equalsimpl0(this.overflow, ((TextAnnotatedStringElement) other).overflow) && this.softWrap == ((TextAnnotatedStringElement) other).softWrap && this.maxLines == ((TextAnnotatedStringElement) other).maxLines && this.minLines == ((TextAnnotatedStringElement) other).minLines && Intrinsics.areEqual(this.onPlaceholderLayout, ((TextAnnotatedStringElement) other).onPlaceholderLayout) && Intrinsics.areEqual(this.selectionController, ((TextAnnotatedStringElement) other).selectionController);
    }
