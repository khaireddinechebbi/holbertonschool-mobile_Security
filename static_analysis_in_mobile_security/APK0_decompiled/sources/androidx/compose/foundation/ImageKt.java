...
public final class ImageKt {
    ...
    public static final void m216Image5hnEew(ImageBitmap bitmap, String contentDescription, Modifier modifier, Alignment alignment, ContentScale contentScale, float alpha, ColorFilter colorFilter, int filterQuality, Composer $composer, int $changed, int i) {
        BitmapPainter m3596BitmapPainterQZhYCtY;
        Intrinsics.checkNotNullParameter(bitmap, "bitmap");
        ...
        if (invalid$iv$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            m3596BitmapPainterQZhYCtY = BitmapPainterKt.m3596BitmapPainterQZhYCtY(bitmap, (r12 & 2) != 0 ? IntOffset.INSTANCE.m5402getZeronOccac() : 0L, (r12 & 4) != 0 ? IntSizeKt.IntSize(bitmap.getWidth(), bitmap.getHeight()) : 0L, (r12 & 8) != 0 ? FilterQuality.INSTANCE.m3066getLowfv9h1I() : filterQuality2);
            value$iv$iv = m3596BitmapPainterQZhYCtY;
