...
public final class PagerMeasureResult implements PagerLayoutInfo, MeasureResult {
    ...
    public PagerMeasureResult(List<? extends PageInfo> visiblePagesInfo, int pagesCount, int pageSize, int pageSpacing, int afterContentPadding, Orientation orientation, int viewportStartOffset, int viewportEndOffset, boolean reverseLayout, float consumedScroll, MeasuredPage firstVisiblePage, PageInfo closestPageToSnapPosition, int firstVisiblePageOffset, boolean canScrollForward, MeasureResult measureResult) {
        ...
        this.closestPageToSnapPosition = closestPageToSnapPosition;
        this.firstVisiblePageOffset = firstVisiblePageOffset;
    ...
    public long mo709getViewportSizeYbymL2g() {
