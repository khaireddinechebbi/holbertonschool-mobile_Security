...
final /* data */ class FocusRequesterElement extends ModifierNodeElement<FocusRequesterNode> {
    ...
    public void update(FocusRequesterNode node) {
        ...
        MutableVector this_$iv = node.getFocusRequester().getFocusRequesterNodes$ui_release();
        this_$iv.remove(node);
        node.setFocusRequester(this.focusRequester);
        MutableVector this_$iv2 = node.getFocusRequester().getFocusRequesterNodes$ui_release();
        this_$iv2.add(node);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.setName("focusRequester");
        $this$inspectableProperties.getProperties().set("focusRequester", this.focusRequester);
    }
}
