...
public final class Selection {
    ...
    private static final int Hour = m1705constructorimpl(0);
    private static final int Minute = m1705constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Selection m1704boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1705constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1706equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1710unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1707equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1708hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1709toStringimpl(int i) {
    ...
    public final /* synthetic */ int m1710unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m1711getHourJiIwxys() {
            return Selection.Hour;
        }

        /* renamed from: getMinute-JiIwxys, reason: not valid java name */
        public final int m1712getMinuteJiIwxys() {
            return Selection.Minute;
        }
    }

    private /* synthetic */ Selection(int value) {
        this.value = value;
    }
