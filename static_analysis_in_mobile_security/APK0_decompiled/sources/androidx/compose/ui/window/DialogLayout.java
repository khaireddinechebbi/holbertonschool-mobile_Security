...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5517getLambda1$ui_release(), null, 2, null);
    }
    ...
    public void internalOnLayout$ui_release(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.usePlatformDefaultWidth || (child = getChildAt(0)) == null) {
            return;
        }
        getWindow().setLayout(child.getMeasuredWidth(), child.getMeasuredHeight());
    }
    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Content)269@10475L9:AndroidDialog.android.kt#2oxthz");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1735448596, $changed, -1, "androidx.compose.ui.window.DialogLayout.Content (AndroidDialog.android.kt:268)");
        }
