...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier $this$border, BorderStroke border, Shape shape) {
        ...
        return m173borderziNgDLE($this$border, border.getWidth(), border.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m172borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m171borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m171borderxT4_qwU(Modifier border, float width, long color, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m173borderziNgDLE(border, width, new SolidColor(color, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m173borderziNgDLE(Modifier border, float width, Brush brush, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    public static final DrawResult m174drawRectBorderNsqcLGU(CacheDrawScope $this$drawRectBorder_u2dNsqcLGU, final Brush brush, long topLeft, long borderSize, boolean fillArea, float strokeWidthPx) {
        final long rectTopLeft = fillArea ? Offset.INSTANCE.m2747getZeroF1C5BW0() : topLeft;
        final long size = fillArea ? $this$drawRectBorder_u2dNsqcLGU.m2637getSizeNHjbRc() : borderSize;
        ...
        return $this$drawRectBorder_u2dNsqcLGU.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.CC.m3521drawRectAsUm42w$default(onDrawWithContent, Brush.this, rectTopLeft, size, 0.0f, style, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            targetPath.mo2865opN5in7k0(targetPath, insetPath, PathOperation.INSTANCE.m3263getDifferenceb3I0S0c());
        }
        return targetPath;
    }

    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - widthPx, roundedRect.getHeight() - widthPx, m175shrinkKibmq7A(roundedRect.m2781getTopLeftCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2782getTopRightCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2780getBottomRightCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2779getBottomLeftCornerRadiuskKHJgLs(), widthPx), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m175shrinkKibmq7A(long $this$shrink_u2dKibmq7A, float value) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m2706getXimpl($this$shrink_u2dKibmq7A) - value), Math.max(0.0f, CornerRadius.m2707getYimpl($this$shrink_u2dKibmq7A) - value));
    }
}
