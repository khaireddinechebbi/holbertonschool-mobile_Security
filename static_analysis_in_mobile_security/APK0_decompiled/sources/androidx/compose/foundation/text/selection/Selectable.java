...
public interface Selectable {
    ...
    long mo890getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo891getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo892updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection);

    /* compiled from: Selectable.kt */
    /* renamed from: androidx.compose.foundation.text.selection.Selectable$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        /* renamed from: updateSelection-qCDeeow$default, reason: not valid java name */
        public static /* synthetic */ Pair m898updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
            ...
            return selectable.mo892updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, selection2);
        }
    }
}
