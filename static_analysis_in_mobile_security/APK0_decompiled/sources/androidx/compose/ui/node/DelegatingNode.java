...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    protected final <T extends DelegatableNode> T delegate(T delegatableNode) {
        ...
        if (getIsAttached()) {
            int value$iv = (delegatedKindSet & NodeKind.m4443constructorimpl(2)) != 0 ? 1 : 0;
            if (value$iv != 0) {
                isDelegatedToThisNode = (beforeKindSet & NodeKind.m4443constructorimpl(2)) != 0;
                if (!isDelegatedToThisNode) {
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        if (getIsAttached()) {
            int value$iv = (beforeKindSet & NodeKind.m4443constructorimpl(2)) != 0 ? 1 : 0;
            if (value$iv != 0) {
                if ((afterKindSet & NodeKind.m4443constructorimpl(2)) != 0) {
                    return;
                }
                NodeChain chain = DelegatableNodeKt.requireLayoutNode(this).getNodes();
                getNode().updateCoordinator$ui_release(null);
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        ...
        int value$iv = (delegateKindSet & NodeKind.m4443constructorimpl(2)) != 0 ? 1 : 0;
        if (value$iv != 0) {
            if (((current & NodeKind.m4443constructorimpl(2)) != 0) && !(this instanceof LayoutModifierNode)) {
