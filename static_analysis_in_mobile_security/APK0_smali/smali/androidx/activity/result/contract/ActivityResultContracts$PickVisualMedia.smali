...
.method public createIntent(Landroid/content/Context;Landroidx/activity/result/PickVisualMediaRequest;)Landroid/content/Intent;
    ...
    .local v2, "$this$createIntent_u24lambda_u240":Landroid/content/Intent;
    const/4 v3, 0x0
    ...
    .line 796
    .end local v2    # "$this$createIntent_u24lambda_u240":Landroid/content/Intent;
    ...
    .line 801
    .local v1, "fallbackPicker":Landroid/content/pm/ActivityInfo;
    ...
    .local v3, "$this$createIntent_u24lambda_u241":Landroid/content/Intent;
    const/4 v4, 0x0

    .line 802
    .local v4, "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$2":I
    ...
    invoke-virtual {v0, v5}, Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$Companion;->getVisualMimeType$activity_release(Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$VisualMediaType;)Ljava/lang/String;
    ...
    .line 801
    .end local v3    # "$this$createIntent_u24lambda_u241":Landroid/content/Intent;
    .end local v4    # "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$2":I
    move-object v1, v2

    .end local v1    # "fallbackPicker":Landroid/content/pm/ActivityInfo;
    goto :goto_0
    ...
    .line 807
    .local v1, "gmsPicker":Landroid/content/pm/ActivityInfo;
    new-instance v2, Landroid/content/Intent;

    const-string v3, "com.google.android.gms.provider.action.PICK_IMAGES"
    ...
    .line 808
    .local v4, "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$3":I
    iget-object v5, v1, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v4    # "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$3":I
    move-object v1, v2

    .end local v1    # "gmsPicker":Landroid/content/pm/ActivityInfo;
    goto :goto_0
    ...
    .line 816
    .local v3, "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$4":I
    invoke-virtual {p2}, Landroidx/activity/result/PickVisualMediaRequest;->getMediaType()Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$VisualMediaType;
    ...
    .end local v3    # "$i$a$-apply-ActivityResultContracts$PickVisualMedia$createIntent$4":I
    nop
