...
final class PointerIconModifierLocal implements PointerIcon, ModifierLocalProvider<PointerIconModifierLocal>, ModifierLocalConsumer {
    ...
    public PointerIconModifierLocal(PointerIcon icon, boolean overrideDescendants, Function1<? super PointerIcon, Unit> onSetIcon) {
        ...
        this.parentInfo = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(null, null, 2, null);
    ...
    private final PointerIconModifierLocal getParentInfo() {
        State $this$getValue$iv = this.parentInfo;
        return (PointerIconModifierLocal) $this$getValue$iv.getValue();
    }

    private final void setParentInfo(PointerIconModifierLocal pointerIconModifierLocal) {
        MutableState $this$setValue$iv = this.parentInfo;
        $this$setValue$iv.setValue(pointerIconModifierLocal);
    }
    ...
    public void onModifierLocalsUpdated(ModifierLocalReadScope scope) {
        ...
        if (oldParentInfo != null && getParentInfo() == null) {
            ...
            this.onSetIcon = new Function1<PointerIcon, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerIconModifierLocal$onModifierLocalsUpdated$1$1
                ...
                public final void invoke2(PointerIcon it) {
                }
            };
        }
    }
