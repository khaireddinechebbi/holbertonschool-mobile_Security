...
.method public final invoke(Landroidx/compose/foundation/gestures/DragScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v2, "this":Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;
    ...
    .line 218
    .end local v2    # "this":Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;
    ...
    .restart local v2    # "this":Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;
    move-object/from16 v5, p1

    .restart local v5    # "$result":Ljava/lang/Object;
    iget-object v6, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->L$0:Ljava/lang/Object;

    check-cast v6, Landroidx/compose/foundation/gestures/DragScope;

    .line 219
    .local v6, "$this$drag":Landroidx/compose/foundation/gestures/DragScope;
    new-instance v7, Lkotlin/jvm/internal/Ref$FloatRef;

    invoke-direct {v7}, Lkotlin/jvm/internal/Ref$FloatRef;-><init>()V

    .local v7, "prevValue":Lkotlin/jvm/internal/Ref$FloatRef;
    iget-object v8, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->this$0:Landroidx/compose/material3/SwipeableState;

    invoke-static {v8}, Landroidx/compose/material3/SwipeableState;->access$getAbsoluteOffset$p(Landroidx/compose/material3/SwipeableState;)Landroidx/compose/runtime/MutableState;
    ...
    invoke-static {v8}, Landroidx/compose/material3/SwipeableState;->access$getAnimationTarget$p(Landroidx/compose/material3/SwipeableState;)Landroidx/compose/runtime/MutableState;

    move-result-object v8

    iget v9, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->$target:F
    ...
    invoke-static {v8, v9}, Landroidx/compose/material3/SwipeableState;->access$setAnimationRunning(Landroidx/compose/material3/SwipeableState;Z)V
    ...
    invoke-static {v8, v10, v11, v4}, Landroidx/compose/animation/core/AnimatableKt;->Animatable$default(FFILjava/lang/Object;)Landroidx/compose/animation/core/Animatable;

    move-result-object v12

    iget v8, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->$target:F

    invoke-static {v8}, Lkotlin/coroutines/jvm/internal/Boxing;->boxFloat(F)Ljava/lang/Float;

    move-result-object v13

    iget-object v14, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->$spec:Landroidx/compose/animation/core/AnimationSpec;

    const/4 v15, 0x0

    new-instance v8, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2$1;

    invoke-direct {v8, v6, v7}, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2$1;-><init>(Landroidx/compose/foundation/gestures/DragScope;Lkotlin/jvm/internal/Ref$FloatRef;)V
    ...
    iput v9, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->label:I

    invoke-static/range {v12 .. v19}, Landroidx/compose/animation/core/Animatable;->animateTo$default(Landroidx/compose/animation/core/Animatable;Ljava/lang/Object;Landroidx/compose/animation/core/AnimationSpec;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;

    move-result-object v8
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .end local v6    # "$this$drag":Landroidx/compose/foundation/gestures/DragScope;
    ...
    :cond_0
    :goto_0
    iget-object v0, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->this$0:Landroidx/compose/material3/SwipeableState;
    ...
    .line 228
    :goto_1
    iget-object v6, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->this$0:Landroidx/compose/material3/SwipeableState;

    invoke-static {v6}, Landroidx/compose/material3/SwipeableState;->access$getAnimationTarget$p(Landroidx/compose/material3/SwipeableState;)Landroidx/compose/runtime/MutableState;
    ...
    .line 229
    iget-object v4, v2, Landroidx/compose/material3/SwipeableState$animateInternalToOffset$2;->this$0:Landroidx/compose/material3/SwipeableState;

    invoke-static {v4, v3}, Landroidx/compose/material3/SwipeableState;->access$setAnimationRunning(Landroidx/compose/material3/SwipeableState;Z)V
