...
public final class MinLinesConstrainer {
    ...
    private MinLinesConstrainer(LayoutDirection layoutDirection, TextStyle inputTextStyle, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        this.resolvedStyle = TextStyleKt.resolveDefaults(inputTextStyle, layoutDirection);
    ...
    public final long m857coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m4666ParagraphUdtVg6A;
        String str2;
        Paragraph m4666ParagraphUdtVg6A2;
        int minHeight;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            ...
            m4666ParagraphUdtVg6A = ParagraphKt.m4666ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            oneLineHeight = m4666ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m4666ParagraphUdtVg6A2 = ParagraphKt.m4666ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            float twoLineHeight = m4666ParagraphUdtVg6A2.getHeight();
            lineHeight = twoLineHeight - oneLineHeight;
            this.oneLineHeightCache = oneLineHeight;
            this.lineHeightCache = lineHeight;
        }
        if (minLines != 1) {
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(((minLines - 1) * lineHeight) + oneLineHeight), 0), Constraints.m5217getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m5219getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m5220getMinWidthimpl(inConstraints), Constraints.m5218getMaxWidthimpl(inConstraints), minHeight, Constraints.m5217getMaxHeightimpl(inConstraints));
    }
}
