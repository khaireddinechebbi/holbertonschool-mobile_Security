...
public final class ParagraphStyleKt {
    ...
    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float fraction) {
        ...
        long m4733lerpTextUnitInheritableC3pnCVY = SpanStyleKt.m4733lerpTextUnitInheritableC3pnCVY(start.getLineHeight(), stop.getLineHeight(), fraction);
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        ...
        TextAlign m5127boximpl = TextAlign.m5127boximpl(style.getTextAlignOrDefault());
        TextDirection m5140boximpl = TextDirection.m5140boximpl(TextStyleKt.m4800resolveTextDirectionYj3eThk(direction, style.getTextDirection()));
        ...
        LineBreak m5055boximpl = LineBreak.m5055boximpl(style.getLineBreakOrDefault());
        Hyphens m5046boximpl = Hyphens.m5046boximpl(style.getHyphensOrDefault());
        TextMotion textMotion = style.getTextMotion();
        if (textMotion == null) {
            textMotion = TextMotion.INSTANCE.getStatic();
        }
        return new ParagraphStyle(m5127boximpl, m5140boximpl, lineHeight, textIndent2, platformStyle, lineHeightStyle, m5055boximpl, m5046boximpl, textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:40:0x003e, code lost:
    
        if (androidx.compose.ui.unit.TextUnit.m5452equalsimpl0(r12, r26.getLineHeight()) != false) goto L14;
     */
