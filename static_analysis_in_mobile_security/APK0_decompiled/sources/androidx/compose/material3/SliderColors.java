...
public final class SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SliderColors) && Color.m2972equalsimpl0(this.thumbColor, ((SliderColors) other).thumbColor) && Color.m2972equalsimpl0(this.activeTrackColor, ((SliderColors) other).activeTrackColor) && Color.m2972equalsimpl0(this.activeTickColor, ((SliderColors) other).activeTickColor) && Color.m2972equalsimpl0(this.inactiveTrackColor, ((SliderColors) other).inactiveTrackColor) && Color.m2972equalsimpl0(this.inactiveTickColor, ((SliderColors) other).inactiveTickColor) && Color.m2972equalsimpl0(this.disabledThumbColor, ((SliderColors) other).disabledThumbColor) && Color.m2972equalsimpl0(this.disabledActiveTrackColor, ((SliderColors) other).disabledActiveTrackColor) && Color.m2972equalsimpl0(this.disabledActiveTickColor, ((SliderColors) other).disabledActiveTickColor) && Color.m2972equalsimpl0(this.disabledInactiveTrackColor, ((SliderColors) other).disabledInactiveTrackColor) && Color.m2972equalsimpl0(this.disabledInactiveTickColor, ((SliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((result * 31) + Color.m2978hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2978hashCodeimpl(this.activeTickColor)) * 31) + Color.m2978hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2978hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2978hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2978hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.disabledInactiveTickColor);
    }
}
