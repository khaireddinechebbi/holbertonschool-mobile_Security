    ...
    */
    public PopupLayout(kotlin.jvm.functions.Function0<kotlin.Unit> r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            kotlin.jvm.functions.Function2 r2 = r2.m2009getLambda1$material3_release()
    ...
    public final IntSize m2011getPopupContentSizebOM6tXw() {
        State $this$getValue$iv = this.popupContentSize;
        return (IntSize) $this$getValue$iv.getValue();
    }

    /* renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m2012setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize m2011getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m2011getPopupContentSizebOM6tXw = m2011getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = m2011getPopupContentSizebOM6tXw.getPackedValue();
