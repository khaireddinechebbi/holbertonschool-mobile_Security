...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m5274constructorimpl((float) 152.0d);
    ...
    public final float m2505getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2506getContainerHeightD9Ej5fM() {
    ...
    public final float m2507getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2508getTrailingIconSizeD9Ej5fM() {
