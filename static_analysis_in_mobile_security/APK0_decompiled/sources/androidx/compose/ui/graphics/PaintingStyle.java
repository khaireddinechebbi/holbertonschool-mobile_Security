...
public final class PaintingStyle {
    ...
    private static final int Fill = m3232constructorimpl(0);
    private static final int Stroke = m3232constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m3231boximpl(int i) {
    ...
    public static boolean m3233equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m3233equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3235hashCodeimpl(this.value);
    }
    ...
    private /* synthetic */ PaintingStyle(int value) {
        this.value = value;
    }
    ...
    public static final class Companion {
        ...
        public final int m3238getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m3239getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3236toStringimpl(int arg0) {
        return m3234equalsimpl0(arg0, Fill) ? "Fill" : m3234equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }

    public String toString() {
        return m3236toStringimpl(this.value);
    }
}
