...
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(Icons.Outlined $this$ShoppingCart) {
        ...
        ImageVector.Builder $this$_get_ShoppingCart__u24lambda_u241 = new ImageVector.Builder("Outlined.ShoppingCart", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(15.55f, 13.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.37f, -0.66f, -0.11f, -1.48f, -0.87f, -1.48f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-1.35f, 2.44f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.52f, 15.37f, 5.48f, 17.0f, 7.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(7.0f, 15.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(1.1f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(7.45f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(6.16f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(12.15f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.76f, 5.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.53f, 11.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(6.16f, 6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_ShoppingCart__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        _shoppingCart = build;
