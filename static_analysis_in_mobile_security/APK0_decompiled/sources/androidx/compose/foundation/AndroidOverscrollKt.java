        ...
        if (Build.VERSION.SDK_INT >= 31) {
            companion = LayoutModifierKt.layout(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1
                ...
                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                    return m157invoke3p2s80s(measureScope, measurable, constraints.getValue());
                }

                /* renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m157invoke3p2s80s(MeasureScope layout, Measurable measurable, long constraints) {
                    ...
                    final int extraSizePx = layout.mo321roundToPx0680j_4(Dp.m5274constructorimpl(2 * arg0$iv));
                    return MeasureScope.CC.layout$default(layout, placeable.getMeasuredWidth() - extraSizePx, placeable.getMeasuredHeight() - extraSizePx, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1.1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout2) {
                            ...
                            Placeable.PlacementScope.placeWithLayer$default(layout2, placeable2, ((-extraSizePx) / 2) - ((placeable2.getWidth() - Placeable.this.getMeasuredWidth()) / 2), ((-extraSizePx) / 2) - ((Placeable.this.getHeight() - Placeable.this.getMeasuredHeight()) / 2), 0.0f, null, 12, null);
                        }
                    }, 4, null);
                }
                ...
                @Override // kotlin.jvm.functions.Function3
                public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                    return m158invoke3p2s80s(measureScope, measurable, constraints.getValue());
                }

                /* renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m158invoke3p2s80s(MeasureScope layout, Measurable measurable, long constraints) {
                    Intrinsics.checkNotNullParameter(layout, "$this$layout");
                    Intrinsics.checkNotNullParameter(measurable, "measurable");
                    final Placeable placeable = measurable.mo4225measureBRTryo0(constraints);
                    float arg0$iv = ClipScrollableContainerKt.getMaxSupportedElevation();
                    ...
                    return MeasureScope.CC.layout$default(layout, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void invoke2(Placeable.PlacementScope layout2) {
                            ...
                            Placeable placeable2 = Placeable.this;
                            int i = extraSizePx;
                            Placeable.PlacementScope.place$default(layout2, placeable2, i / 2, i / 2, 0.0f, 4, null);
                        }
                    }, 4, null);
                }
            });
