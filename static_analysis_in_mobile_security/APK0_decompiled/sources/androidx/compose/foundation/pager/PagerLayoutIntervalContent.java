...
final class PagerLayoutIntervalContent extends LazyLayoutIntervalContent<PagerIntervalContent> {
    ...
    public PagerLayoutIntervalContent(Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Function1<? super Integer, ? extends Object> function1, int pageCount) {
        Intrinsics.checkNotNullParameter(pageContent, "pageContent");
        this.pageContent = pageContent;
        this.key = function1;
        this.pageCount = pageCount;
        MutableIntervalList $this$intervals_u24lambda_u240 = new MutableIntervalList();
        $this$intervals_u24lambda_u240.addInterval(pageCount, new PagerIntervalContent(function1, pageContent));
        this.intervals = $this$intervals_u24lambda_u240;
    }
