...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m1291draw4WTKRHQ(DrawScope draw, long color) {
        ...
        float m2731getXimpl = Offset.m2731getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp = MathHelpersKt.lerp(m2731getXimpl, Offset.m2731getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m2732getYimpl = Offset.m2732getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(lerp, MathHelpersKt.lerp(m2732getYimpl, Offset.m2732getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        modulatedColor = Color.m2969copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(color) : Color.m2973getAlphaimpl(color) * alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
