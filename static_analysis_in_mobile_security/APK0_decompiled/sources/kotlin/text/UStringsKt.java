...
public final class UStringsKt {
    ...
    public static final String m6875toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m6877toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m6876toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m6874toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5658constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m5575boximpl(UByte.m5581constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5658constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m5838boximpl(UShort.m5844constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m5658constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m5658constructorimpl(result * uradix);
            result = UInt.m5658constructorimpl(UInt.m5658constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m5652boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m5737constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (compare > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UByte$$ExternalSyntheticBackport4.m(-1L, uradix);
            ...
            long result2 = ULong.m5737constructorimpl(result * uradix);
            result = ULong.m5737constructorimpl(ULong.m5737constructorimpl(UInt.m5658constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m5731boximpl(result);
    }
}
