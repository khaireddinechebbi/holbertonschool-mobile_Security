...
public final class ToggleableKt {
    ...
    public static /* synthetic */ Modifier m726toggleableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m725toggleableXHw0xAI(modifier, z, z2, role, function1);
    }

    /* renamed from: toggleable-XHw0xAI, reason: not valid java name */
    public static final Modifier m725toggleableXHw0xAI(Modifier toggleable, final boolean value, final boolean enabled, final Role role, final Function1<? super Boolean, Unit> onValueChange) {
        ...
        return ComposedModifierKt.composed(toggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Modifier m723toggleableO2vRcR0 = ToggleableKt.m723toggleableO2vRcR0(companion, z, (MutableInteractionSource) value$iv$iv, (Indication) consume, enabled, role, onValueChange);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ Modifier m724toggleableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function1 function1, int i, Object obj) {
        Role role2;
        ...
        return m723toggleableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function1);
    }

    /* renamed from: toggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m723toggleableO2vRcR0(Modifier toggleable, final boolean value, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function1<? super Boolean, Unit> onValueChange) {
        Intrinsics.checkNotNullParameter(toggleable, "$this$toggleable");
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier $this$toggleable_O2vRcR0_u24lambda_u242 = m727triStateToggleableO2vRcR0(Modifier.INSTANCE, ToggleableStateKt.ToggleableState(value), interactionSource, indication, enabled, role, new Function0<Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable$4$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(0);
    ...
    public static /* synthetic */ Modifier m730triStateToggleableXHw0xAI$default(Modifier modifier, ToggleableState toggleableState, boolean z, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m729triStateToggleableXHw0xAI(modifier, toggleableState, z, role, function0);
    }

    /* renamed from: triStateToggleable-XHw0xAI, reason: not valid java name */
    public static final Modifier m729triStateToggleableXHw0xAI(Modifier triStateToggleable, final ToggleableState state, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(triStateToggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$triStateToggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Object consume = $composer.consume(localIndication);
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier m727triStateToggleableO2vRcR0 = ToggleableKt.m727triStateToggleableO2vRcR0(companion, toggleableState, (MutableInteractionSource) value$iv$iv, (Indication) consume, enabled, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
    ...
    public static /* synthetic */ Modifier m728triStateToggleableO2vRcR0$default(Modifier modifier, ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z, Role role, Function0 function0, int i, Object obj) {
        Role role2;
        ...
        return m727triStateToggleableO2vRcR0(modifier, toggleableState, mutableInteractionSource, indication, z2, role2, function0);
    }

    /* renamed from: triStateToggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m727triStateToggleableO2vRcR0(Modifier triStateToggleable, final ToggleableState state, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        m190clickableO2vRcR0 = ClickableKt.m190clickableO2vRcR0($this$triStateToggleable_O2vRcR0_u24lambda_u245, interactionSource, indication, (r14 & 4) != 0 ? true : enabled, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : role, onClick);
        Modifier $this$triStateToggleable_O2vRcR0_u24lambda_u2452 = SemanticsModifierKt.semantics$default(m190clickableO2vRcR0, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$triStateToggleable$4$1
            {
                super(1);
            }
