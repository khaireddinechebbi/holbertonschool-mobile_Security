...
final class Animatable$runAnimation$2<T, V> extends SuspendLambda implements Function1<Continuation<? super AnimationResult<T, V>>, Object> {
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [androidx.compose.animation.core.Animatable$runAnimation$2] */
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Animatable$runAnimation$2 animatable$runAnimation$2 = this.label;
        try {
            switch (animatable$runAnimation$2) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    Animatable$runAnimation$2<T, V> animatable$runAnimation$22 = this;
                    animatable$runAnimation$22.this$0.getInternalState$animation_core_release().setVelocityVector$animation_core_release((AnimationVector) animatable$runAnimation$22.this$0.getTypeConverter().getConvertToVector().invoke(animatable$runAnimation$22.$initialVelocity));
                    animatable$runAnimation$22.this$0.setTargetValue(animatable$runAnimation$22.$animation.getTargetValue());
                    animatable$runAnimation$22.this$0.setRunning(true);
                    copy$default = AnimationStateKt.copy$default((AnimationState) animatable$runAnimation$22.this$0.getInternalState$animation_core_release(), (Object) null, (AnimationVector) null, 0L, Long.MIN_VALUE, false, 23, (Object) null);
                    final Ref.BooleanRef booleanRef2 = new Ref.BooleanRef();
                    Animation<T, V> animation = animatable$runAnimation$22.$animation;
                    long j = animatable$runAnimation$22.$startTime;
                    final Animatable<T, V> animatable = animatable$runAnimation$22.this$0;
                    final Function1<Animatable<T, V>, Unit> function1 = animatable$runAnimation$22.$block;
                    animatable$runAnimation$22.L$0 = copy$default;
                    animatable$runAnimation$22.L$1 = booleanRef2;
                    animatable$runAnimation$22.label = 1;
                    ...
                    }, animatable$runAnimation$22) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    booleanRef = booleanRef2;
                    animatable$runAnimation$2 = animatable$runAnimation$22;
                    break;
                case 1:
                    Animatable$runAnimation$2<T, V> animatable$runAnimation$23 = this;
                    booleanRef = (Ref.BooleanRef) animatable$runAnimation$23.L$1;
                    copy$default = (AnimationState) animatable$runAnimation$23.L$0;
                    ResultKt.throwOnFailure(obj);
                    animatable$runAnimation$2 = animatable$runAnimation$23;
                    break;
                default:
