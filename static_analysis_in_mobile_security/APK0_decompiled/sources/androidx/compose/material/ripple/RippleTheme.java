...
public interface RippleTheme {
    ...
    long mo1133defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1300defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m3023luminance8_81llA(contentColor);
            if (!lightTheme && contentLuminance < 0.5d) {
                return Color.INSTANCE.m3008getWhite0d7_KjU();
            }
            return contentColor;
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m1299defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m3023luminance8_81llA(contentColor) > 0.5d) {
