...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m712measurePagerntgEbfI(final LazyLayoutMeasureScope measurePager, int pageCount, final PagerLazyLayoutItemProvider pagerItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenPages, int firstVisiblePage, int firstVisiblePageOffset, float scrollToBeConsumed, long constraints, final Orientation orientation, final Alignment.Vertical verticalAlignment, final Alignment.Horizontal horizontalAlignment, final boolean reverseLayout, final long visualPageOffset, final int pageAvailableSize, int beyondBoundsPageCount, List<Integer> pinnedPages, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        while (maxCrossAxis2 < 0 && currentFirstPage3 > 0) {
            ...
            visiblePages5.add(0, measuredPage);
        ...
        int currentFirstPageScrollOffset8 = maxCrossAxis2;
        ...
        if (currentFirstPageScrollOffset9 < minOffset4) {
            scrollDelta += currentFirstPageScrollOffset9;
            currentFirstPageScrollOffset9 = minOffset4;
        }
        int currentFirstPageScrollOffset10 = currentFirstPageScrollOffset9 - minOffset4;
        int index4 = currentFirstPage3;
        int index5 = maxOffset5;
        int maxMainAxis = RangesKt.coerceAtLeast(index5 + afterContentPadding, 0);
        ...
        if (index < maxOffset7) {
            ...
            int currentFirstPageScrollOffset12 = currentFirstPageScrollOffset11 - toScrollBack;
            while (true) {
                if (currentFirstPageScrollOffset12 >= beforeContentPadding) {
                    currentFirstPageScrollOffset3 = currentFirstPageScrollOffset12;
        ...
        if (beforeContentPadding > 0 || spaceBetweenPages < 0) {
            ...
            for (int i2 = 0; i2 < size2 && currentFirstPageScrollOffset != 0 && pageSizeWithSpacing <= currentFirstPageScrollOffset && i2 != CollectionsKt.getLastIndex(visiblePages2); i2++) {
                currentFirstPageScrollOffset -= pageSizeWithSpacing;
                firstPage2 = (MeasuredPage) visiblePages2.get(i2 + 1);
            }
        ...
        List extraPagesBefore = createPagesBeforeList(currentFirstPage, beyondBoundsPageCount, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int it) {
                ...
                m711getAndMeasureSGf7dI0 = PagerMeasureKt.m711getAndMeasureSGf7dI0(lazyLayoutMeasureScope, it, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, lazyLayoutMeasureScope.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        int layoutWidth = ConstraintsKt.m5232constrainWidthK40F9xA(constraints, orientation == Orientation.Vertical ? maxCrossAxis12 : currentMainAxisOffset4);
        int layoutHeight = ConstraintsKt.m5231constrainHeightK40F9xA(constraints, orientation == Orientation.Vertical ? currentMainAxisOffset4 : maxCrossAxis12);
        ...
        int i4 = maxOffset8 + afterContentPadding;
        if (index2 >= pageCount && currentMainAxisOffset4 <= maxOffset8) {
            z = false;
            return new PagerMeasureResult(visiblePagesInfo, pageCount, pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, i3, i4, reverseLayout, consumedScroll, firstPage3, closestPageToSnapPosition, currentFirstPageScrollOffset2, z, invoke);
        }
        z = true;
        return new PagerMeasureResult(visiblePagesInfo, pageCount, pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, i3, i4, reverseLayout, consumedScroll, firstPage3, closestPageToSnapPosition, currentFirstPageScrollOffset2, z, invoke);
    }
    ...
    public static final MeasuredPage m711getAndMeasureSGf7dI0(LazyLayoutMeasureScope $this$getAndMeasure_u2dSGf7dI0, int index, long childConstraints, PagerLazyLayoutItemProvider pagerItemProvider, long visualPageOffset, Orientation orientation, Alignment.Horizontal horizontalAlignment, Alignment.Vertical verticalAlignment, LayoutDirection layoutDirection, boolean reverseLayout, int pageAvailableSize) {
        ...
        List placeable = $this$getAndMeasure_u2dSGf7dI0.mo645measure0kLqBqw(index, childConstraints);
