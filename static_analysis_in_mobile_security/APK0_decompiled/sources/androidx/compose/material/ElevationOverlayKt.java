...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5272boximpl(m1108invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1108invokeD9Ej5fM() {
    ...
    public static final long m1107calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long baseForegroundColor = ColorsKt.m1066contentColorForek8zF_U(backgroundColor, $composer, $changed & 14);
        m2969copywmQWz5c = Color.m2969copywmQWz5c(baseForegroundColor, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(baseForegroundColor) : alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl(baseForegroundColor) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(baseForegroundColor) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(baseForegroundColor) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
