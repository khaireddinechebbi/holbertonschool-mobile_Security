...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4993getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4820getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4867equalsimpl0(fontStyle, FontStyle.INSTANCE.m4871getItalic_LCdwA()));
    }
}
