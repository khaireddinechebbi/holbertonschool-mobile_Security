...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    public DraggableElement(DraggableState state, Function1<? super PointerInputChange, Boolean> canDrag, Orientation orientation, boolean enabled, MutableInteractionSource interactionSource, Function0<Boolean> startDragImmediately, Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> onDragStarted, Function3<? super CoroutineScope, ? super Velocity, ? super Continuation<? super Unit>, ? extends Object> onDragStopped, boolean reverseDirection) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.state, ((DraggableElement) other).state) && Intrinsics.areEqual(this.canDrag, ((DraggableElement) other).canDrag) && this.orientation == ((DraggableElement) other).orientation && this.enabled == ((DraggableElement) other).enabled && Intrinsics.areEqual(this.interactionSource, ((DraggableElement) other).interactionSource) && Intrinsics.areEqual(this.startDragImmediately, ((DraggableElement) other).startDragImmediately) && Intrinsics.areEqual(this.onDragStarted, ((DraggableElement) other).onDragStarted) && Intrinsics.areEqual(this.onDragStopped, ((DraggableElement) other).onDragStopped) && this.reverseDirection == ((DraggableElement) other).reverseDirection;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.state.hashCode();
        int result2 = ((((((result * 31) + this.canDrag.hashCode()) * 31) + this.orientation.hashCode()) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        return ((((((((result2 + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0)) * 31) + this.startDragImmediately.hashCode()) * 31) + this.onDragStarted.hashCode()) * 31) + this.onDragStopped.hashCode()) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.reverseDirection);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("canDrag", this.canDrag);
