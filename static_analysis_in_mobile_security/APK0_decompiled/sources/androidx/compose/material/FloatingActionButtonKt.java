    ...
    */
    ...
    public static final void m1125ExtendedFloatingActionButtonwqdebIU(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, MutableInteractionSource interactionSource, Shape shape, long backgroundColor, long contentColor, FloatingActionButtonElevation elevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 191739611) == 38347922 && $composer3.getSkipping()) {
            ...
            icon3 = icon2;
            $composer2 = $composer3;
            m1126FloatingActionButtonbogVsAg(onClick, SizeKt.m538sizeInqDBjuR0$default(modifier3, f, f, 0.0f, 0.0f, 12, null), interactionSource3, shape3, backgroundColor3, contentColor3, elevation2, ComposableLambdaKt.composableLambda($composer3, 1418981691, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.FloatingActionButtonKt$ExtendedFloatingActionButton$2
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.FloatingActionButtonKt$ExtendedFloatingActionButton$3
            ...
            public final void invoke(Composer composer, int i11) {
                FloatingActionButtonKt.m1125ExtendedFloatingActionButtonwqdebIU(text, onClick, modifier4, function22, mutableInteractionSource, shape4, j, j2, floatingActionButtonElevation2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
