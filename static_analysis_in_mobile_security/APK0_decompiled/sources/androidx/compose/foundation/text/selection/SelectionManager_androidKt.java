...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m943isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo774mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
