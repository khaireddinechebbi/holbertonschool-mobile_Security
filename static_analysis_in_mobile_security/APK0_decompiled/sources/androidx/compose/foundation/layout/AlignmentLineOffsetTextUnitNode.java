...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m383setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m382setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        MeasureResult m363alignmentLineOffsetMeasuretjqqzMA;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        m363alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m363alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, !TextUnitKt.m5473isUnspecifiedR2X_6o(this.before) ? measure.mo322toDpGaN1DYA(this.before) : Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM(), !TextUnitKt.m5473isUnspecifiedR2X_6o(this.after) ? measure.mo322toDpGaN1DYA(this.after) : Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM(), measurable, constraints);
        return m363alignmentLineOffsetMeasuretjqqzMA;
    }
}
