...
public final class StateData {
    ...
    private StateData(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        CalendarMonth month;
        ...
        if (initialDisplayedMonthMillis != null) {
            month = CalendarModel.getMonth(initialDisplayedMonthMillis.longValue());
            if (!yearRange.contains(month.getYear())) {
                throw new IllegalArgumentException(("The initial display month's year (" + month.getYear() + ") is out of the years range of " + yearRange + '.').toString());
            }
        } else {
            month = getCurrentMonth();
        }
        this.displayedMonth = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(month, null, 2, null);
        this.displayMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1498boximpl(initialDisplayMode), null, 2, null);
    }
    ...
    public final CalendarMonth getDisplayedMonth() {
        State $this$getValue$iv = this.displayedMonth;
        return (CalendarMonth) $this$getValue$iv.getValue();
    }

    public final void setDisplayedMonth(CalendarMonth calendarMonth) {
        Intrinsics.checkNotNullParameter(calendarMonth, "<set-?>");
        MutableState $this$setValue$iv = this.displayedMonth;
        $this$setValue$iv.setValue(calendarMonth);
    }
    ...
    public final void setSelection(Long startDateMillis, Long endDateMillis) {
        ...
        if (startDateMillis != null) {
            startDate = this.calendarModel.getCanonicalDate(startDateMillis.longValue());
        } else {
            startDate = null;
        }
        if (endDateMillis != null) {
            endDate = this.calendarModel.getCanonicalDate(endDateMillis.longValue());
        }
        if (startDate != null) {
            CalendarDate it = startDate;
            if (!this.yearRange.contains(it.getYear())) {
                throw new IllegalArgumentException(("The provided start date year (" + it.getYear() + ") is out of the years range of " + this.yearRange + '.').toString());
            }
        }
        if (endDate != null) {
            CalendarDate it2 = endDate;
            if (!this.yearRange.contains(it2.getYear())) {
                throw new IllegalArgumentException(("The provided end date year (" + it2.getYear() + ") is out of the years range of " + this.yearRange + '.').toString());
            }
        }
        if (endDate != null) {
            if (startDate == null) {
    ...
    public final void m1725switchDisplayModevCnGnXg(int displayMode) {
        CalendarDate it = this.selectedStartDate.getValue();
        if (it != null) {
            setDisplayedMonth(this.calendarModel.getMonth(it));
        }
        if (this.selectedStartDate.getValue() == null && this.selectedEndDate.getValue() != null) {
            this.selectedEndDate.setValue(null);
        }
        this.displayMode.setValue(DisplayMode.m1498boximpl(displayMode));
    }
        ...
        public final Saver<StateData, Object> Saver() {
            return ListSaverKt.listSaver(new Function2<SaverScope, StateData, List<? extends Object>>() { // from class: androidx.compose.material3.StateData$Companion$Saver$1
                ...
                public final StateData invoke2(List<? extends Object> value) {
                    ...
                    return new StateData(l, l2, l3, intRange, DisplayMode.m1499constructorimpl(((Integer) obj3).intValue()), null);
                }
            });
        }
    }
