...
.method public final chipColors-5tl4gsc(JJJJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ChipColors;
    ...
    .local v6, "leadingIconContentColor":J
    goto :goto_2

    .line 388
    .end local v6    # "leadingIconContentColor":J
    ...
    .line 389
    .end local p5    # "leadingIconContentColor":J
    .local v22, "leadingIconContentColor":J
    :goto_2
    ...
    .end local p7    # "disabledBackgroundColor":J
    .local v6, "disabledBackgroundColor":J
    goto :goto_3

    .line 389
    .end local v6    # "disabledBackgroundColor":J
    .restart local p7    # "disabledBackgroundColor":J
    :cond_3
    move-wide/from16 v24, p7

    .line 393
    .end local p7    # "disabledBackgroundColor":J
    .local v24, "disabledBackgroundColor":J
    :goto_3
    ...
    .end local p9    # "disabledContentColor":J
    .local v6, "disabledContentColor":J
    goto :goto_4

    .line 393
    .end local v6    # "disabledContentColor":J
    .restart local p9    # "disabledContentColor":J
    :cond_4
    move-wide/from16 v26, p9

    .line 394
    .end local p9    # "disabledContentColor":J
    .local v26, "disabledContentColor":J
    :goto_4
    ...
    .end local p11    # "disabledLeadingIconContentColor":J
    .local v2, "disabledLeadingIconContentColor":J
    goto :goto_5

    .line 394
    .end local v2    # "disabledLeadingIconContentColor":J
    .restart local p11    # "disabledLeadingIconContentColor":J
    :cond_5
    move-wide/from16 v2, p11

    .line 398
    .end local p11    # "disabledLeadingIconContentColor":J
    .restart local v2    # "disabledLeadingIconContentColor":J
    :goto_5
    ...
    const-string v7, "androidx.compose.material.ChipDefaults.chipColors (Chip.kt:384)"
    ...
    check-cast v1, Landroidx/compose/material/ChipColors;
...
.method public final filterChipColors-J08w3-E(JJJJJJJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/SelectableChipColors;
    ...
    .param p13, "selectedBackgroundColor"    # J
    .param p15, "selectedContentColor"    # J
    .param p17, "selectedLeadingIconColor"    # J
    ...
    .local v9, "leadingIconColor":J
    goto :goto_2

    .line 458
    .end local v9    # "leadingIconColor":J
    ...
    .end local p7    # "disabledBackgroundColor":J
    .local v9, "disabledBackgroundColor":J
    goto :goto_3

    .line 459
    .end local v9    # "disabledBackgroundColor":J
    .restart local p7    # "disabledBackgroundColor":J
    :cond_3
    ...
    .line 463
    .end local p7    # "disabledBackgroundColor":J
    .local v27, "disabledBackgroundColor":J
    :goto_3
    ...
    .end local p9    # "disabledContentColor":J
    .local v9, "disabledContentColor":J
    goto :goto_4

    .line 463
    .end local v9    # "disabledContentColor":J
    .restart local p9    # "disabledContentColor":J
    :cond_4
    ...
    .line 464
    .end local p9    # "disabledContentColor":J
    .local v29, "disabledContentColor":J
    :goto_4
    ...
    .local v9, "disabledLeadingIconColor":J
    goto :goto_5

    .line 464
    .end local v9    # "disabledLeadingIconColor":J
    ...
    .line 467
    .end local p11    # "disabledLeadingIconColor":J
    .local v31, "disabledLeadingIconColor":J
    :goto_5
    ...
    .line 472
    invoke-static {v9, v10, v5, v6}, Landroidx/compose/ui/graphics/ColorKt;->compositeOver--OWjLjI(JJ)J

    move-result-wide v9

    move-wide/from16 v33, v9

    .end local p13    # "selectedBackgroundColor":J
    .local v9, "selectedBackgroundColor":J
    goto :goto_6

    .line 467
    .end local v9    # "selectedBackgroundColor":J
    .restart local p13    # "selectedBackgroundColor":J
    :cond_6
    move-wide/from16 v33, p13

    .line 472
    .end local p13    # "selectedBackgroundColor":J
    .local v33, "selectedBackgroundColor":J
    :goto_6
    ...
    .end local p15    # "selectedContentColor":J
    .local v9, "selectedContentColor":J
    goto :goto_7

    .line 472
    .end local v9    # "selectedContentColor":J
    .restart local p15    # "selectedContentColor":J
    :cond_7
    move-wide/from16 v35, p15

    .line 475
    .end local p15    # "selectedContentColor":J
    .local v35, "selectedContentColor":J
    :goto_7
    ...
    .line 478
    invoke-static {v3, v4, v14, v15}, Landroidx/compose/ui/graphics/ColorKt;->compositeOver--OWjLjI(JJ)J

    move-result-wide v3

    .end local p17    # "selectedLeadingIconColor":J
    .local v3, "selectedLeadingIconColor":J
    goto :goto_8

    .line 475
    .end local v3    # "selectedLeadingIconColor":J
    .restart local p17    # "selectedLeadingIconColor":J
    :cond_8
    move-wide/from16 v3, p17

    .line 478
    .end local p17    # "selectedLeadingIconColor":J
    .restart local v3    # "selectedLeadingIconColor":J
    :goto_8
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v9, "androidx.compose.material.ChipDefaults.filterChipColors (Chip.kt:454)"
    ...
    .end local v14    # "leadingIconColor":J
    .local v39, "leadingIconColor":J
    ...
    check-cast v1, Landroidx/compose/material/SelectableChipColors;
...
.method public final getOutlinedBorder(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/BorderStroke;
    ...
    const-string v1, "C543@25203L6:Chip.kt#jmzs0o"
...
.method public final outlinedChipColors-5tl4gsc(JJJJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ChipColors;
    ...
    const-string v1, "C(outlinedChipColors)P(0:c#ui.graphics.Color,1:c#ui.graphics.Color,5:c#ui.graphics.Color,2:c#ui.graphics.Color,3:c#ui.graphics.Color,4:c#ui.graphics.Color)421@18817L6,422@18877L6,426@19160L8,429@19308L8,430@19360L342:Chip.kt#jmzs0o"
    ...
    .end local p5    # "leadingIconContentColor":J
    .local v3, "leadingIconContentColor":J
    goto :goto_2

    .line 423
    .end local v3    # "leadingIconContentColor":J
    .restart local p5    # "leadingIconContentColor":J
    :cond_2
    ...
    .line 424
    .end local p5    # "leadingIconContentColor":J
    .local v20, "leadingIconContentColor":J
    :goto_2
    ...
    .end local p7    # "disabledBackgroundColor":J
    .local v3, "disabledBackgroundColor":J
    goto :goto_3

    .line 424
    .end local v3    # "disabledBackgroundColor":J
    .restart local p7    # "disabledBackgroundColor":J
    :cond_3
    ...
    .line 425
    .end local p7    # "disabledBackgroundColor":J
    .local v22, "disabledBackgroundColor":J
    :goto_3
    ...
    .end local p9    # "disabledContentColor":J
    .local v3, "disabledContentColor":J
    goto :goto_4

    .line 425
    .end local v3    # "disabledContentColor":J
    .restart local p9    # "disabledContentColor":J
    :cond_4
    ...
    .line 426
    .end local p9    # "disabledContentColor":J
    .local v24, "disabledContentColor":J
    :goto_4
    ...
    .end local p11    # "disabledLeadingIconContentColor":J
    .local v1, "disabledLeadingIconContentColor":J
    goto :goto_5

    .line 426
    .end local v1    # "disabledLeadingIconContentColor":J
    .restart local p11    # "disabledLeadingIconContentColor":J
    :cond_5
    ...
    .line 430
    .end local p11    # "disabledLeadingIconContentColor":J
    .local v26, "disabledLeadingIconContentColor":J
    :goto_5
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v2, "androidx.compose.material.ChipDefaults.outlinedChipColors (Chip.kt:420)"
...
.method public final outlinedFilterChipColors-J08w3-E(JJJJJJJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/SelectableChipColors;
    ...
    const-string v9, "androidx.compose.material.ChipDefaults.outlinedFilterChipColors (Chip.kt:505)"
