...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroidx/compose/ui/text/android/animation/Segment;

    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->startOffset:I

    iget v4, v1, Landroidx/compose/ui/text/android/animation/Segment;->startOffset:I
    ...
    :cond_2
    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->endOffset:I

    iget v4, v1, Landroidx/compose/ui/text/android/animation/Segment;->endOffset:I
    ...
    :cond_3
    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->left:I

    iget v4, v1, Landroidx/compose/ui/text/android/animation/Segment;->left:I
    ...
    :cond_4
    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->top:I

    iget v4, v1, Landroidx/compose/ui/text/android/animation/Segment;->top:I
    ...
    :cond_5
    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->right:I

    iget v4, v1, Landroidx/compose/ui/text/android/animation/Segment;->right:I
    ...
    :cond_6
    iget v3, p0, Landroidx/compose/ui/text/android/animation/Segment;->bottom:I

    iget v1, v1, Landroidx/compose/ui/text/android/animation/Segment;->bottom:I
...
.method public hashCode()I
    ...
    iget v2, p0, Landroidx/compose/ui/text/android/animation/Segment;->endOffset:I

    add-int/2addr v1, v2

    mul-int/lit8 v0, v1, 0x1f

    iget v2, p0, Landroidx/compose/ui/text/android/animation/Segment;->left:I

    add-int/2addr v0, v2

    mul-int/lit8 v1, v0, 0x1f

    iget v2, p0, Landroidx/compose/ui/text/android/animation/Segment;->top:I

    add-int/2addr v1, v2

    mul-int/lit8 v0, v1, 0x1f

    iget v2, p0, Landroidx/compose/ui/text/android/animation/Segment;->right:I

    add-int/2addr v0, v2

    mul-int/lit8 v1, v0, 0x1f

    iget v2, p0, Landroidx/compose/ui/text/android/animation/Segment;->bottom:I
