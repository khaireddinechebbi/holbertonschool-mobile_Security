...
public final class ComposerImpl implements Composer {
    ...
    public ComposerImpl(Applier<?> applier, CompositionContext parentContext, SlotTable slotTable, Set<RememberObserver> abandonSet, List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> changes, List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> lateChanges, ControlledComposition composition) {
        ...
        SlotReader it = slotTable.openReader();
        it.close();
        this.reader = it;
        SlotTable slotTable2 = new SlotTable();
        this.insertTable = slotTable2;
        SlotWriter it2 = slotTable2.openWriter();
        it2.close();
        this.writer = it2;
    ...
    public void startReplaceableGroup(int key) {
        m2573startBaiHCIY(key, null, GroupKind.INSTANCE.m2585getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2573startBaiHCIY(-127, null, GroupKind.INSTANCE.m2585getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2573startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m2585getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m2573startBaiHCIY(125, null, GroupKind.INSTANCE.m2586getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2573startBaiHCIY(125, null, GroupKind.INSTANCE.m2587getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public <T> void createNode(final Function0<? extends T> factory) {
        ...
        if (value$iv) {
            ...
            final Anchor groupAnchor = slotWriter.anchor(slotWriter.getParent());
            this.groupNodeCount++;
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2573startBaiHCIY(key, null, GroupKind.INSTANCE.m2585getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProviders(final ProvidedValue<?>[] values) {
        ...
        this.providerCache = providers;
        m2573startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2585getGroupULZAiWs(), providers);
    }
    ...
    private final void createFreshInsertTable() {
        ...
        this.insertTable = slotTable;
        SlotWriter it = slotTable.openWriter();
        it.close();
        this.writer = it;
    }
    ...
    private final void m2573startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        Pending newPending;
        validateNodeNotExpected();
        updateCompoundKeyWhenWeEnterGroup(key, objectKey, data);
        boolean isNode = kind != GroupKind.INSTANCE.m2585getGroupULZAiWs();
        if (getInserting()) {
        ...
        boolean forceReplace = (kind != GroupKind.INSTANCE.m2586getNodeULZAiWs() ? 1 : 0) == 0 && this.reusing;
    ...
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m2573startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2585getGroupULZAiWs(), locals);
    ...
    public void sourceInformationMarkerStart(int key, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2573startBaiHCIY(key, null, GroupKind.INSTANCE.m2585getGroupULZAiWs(), sourceInformation);
        }
    }
        ...
        if (this.insertFixups.isEmpty()) {
            ...
            recordSlotEditingOperation(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$recordInsert$1
                ...
                public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                    ...
                    slots.moveFrom(slotTable, anchor.toIndexFor(slotTable), false);
                    slots.endInsert();
                }
            });
            return;
    ...
    private final void updateCompoundKeyWhenWeExitGroupKeyHash(int groupKey) {
        int $this$ror$iv = getCompoundKeyHash() ^ groupKey;
