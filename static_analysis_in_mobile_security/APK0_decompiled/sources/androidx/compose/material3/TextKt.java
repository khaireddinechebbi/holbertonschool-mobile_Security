    ...
    public static final void m1884Text4IGK_g(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 1533916891) == 306783378 && (2995931 & $dirty12) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                lineHeight2 = i13 != 0 ? TextUnit.INSTANCE.m5466getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i14 != 0 ? TextOverflow.INSTANCE.m5181getClipgIe3tQ8() : overflow;
            ...
            if ($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv2 = style2.m4789getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) consume2).m2981unboximpl();
                }
            ...
            BasicTextKt.m753BasicText4YKlhWE(text, modifier2, mergedStyle, onTextLayout, overflow2, softWrap2, maxLines2, minLines3, $composer2, ($dirty & 14) | ($dirty & 112) | (($dirty1 >> 6) & 7168) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (($dirty1 << 9) & 3670016) | (29360128 & ($dirty1 << 9)), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$2
            ...
            public final void invoke(Composer composer, int i23) {
                TextKt.m1884Text4IGK_g(text, modifier7, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration7, textAlign4, j4, i20, z, i21, i22, function12, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1886TextfLXpl1I(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$4
            ...
            public final void invoke(Composer composer, int i20) {
                TextKt.m1886TextfLXpl1I(text, modifier4, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration5, textAlign4, j4, i18, z, i19, function1, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* renamed from: Text-IbK3jfQ, reason: not valid java name */
    public static final void m1885TextIbK3jfQ(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Map<String, InlineTextContent> map, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        int i2;
        int i3;
        long color2;
        long fontSize2;
        ...
        if (i19 == 32768 && (1533916891 & $dirty) == 306783378 && (23967451 & $dirty12) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                lineHeight2 = i14 != 0 ? TextUnit.INSTANCE.m5466getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i15 != 0 ? TextOverflow.INSTANCE.m5181getClipgIe3tQ8() : overflow;
            ...
            $composer2.endReplaceableGroup();
            TextStyle mergedStyle = style2.merge(new TextStyle(textColor, fontSize2, fontWeight2, fontStyle2, (FontSynthesis) null, fontFamily2, (String) null, letterSpacing2, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, textDecoration2, (Shadow) null, textAlign2, (TextDirection) null, lineHeight2, (TextIndent) null, (PlatformTextStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, 4108112, (DefaultConstructorMarker) null));
            BasicTextKt.m756BasicTextVhcvRP8(text, modifier2, mergedStyle, onTextLayout, overflow2, softWrap2, maxLines2, minLines3, inlineContent2, $composer2, 134217728 | ($dirty & 14) | ($dirty & 112) | (($dirty1 >> 9) & 7168) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (($dirty1 << 9) & 3670016) | (($dirty1 << 9) & 29360128), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$6
            ...
            public final void invoke(Composer composer, int i25) {
                TextKt.m1885TextIbK3jfQ(AnnotatedString.this, modifier7, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration7, textAlign4, j4, i22, z, i23, i24, map2, function12, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1883Text4IGK_g(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Map inlineContent, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$8
            ...
            public final void invoke(Composer composer, int i21) {
                TextKt.m1883Text4IGK_g(AnnotatedString.this, modifier5, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration5, textAlign4, j4, i19, z, i20, map, function1, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
