...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo3448getSizeNHjbRc() {
            return CanvasDrawScope.this.getDrawParams().m3446getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public void mo3449setSizeuvyYCjk(long value) {
            CanvasDrawScope.this.getDrawParams().m3447setSizeuvyYCjk(value);
        }
    ...
    public /* synthetic */ long mo3441getCenterF1C5BW0() {
        return DrawScope.CC.m3488$default$getCenterF1C5BW0(this);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getSize-NH-jbRc, reason: not valid java name */
    public /* synthetic */ long mo3442getSizeNHjbRc() {
    ...
    public void mo3429drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        ...
        this.drawParams.getCanvas().mo2832drawLineWko1d7g(start, end, m3419configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3430drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo2832drawLineWko1d7g(start, end, m3417configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3437drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        ...
        this.drawParams.getCanvas().drawRect(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3438drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRect(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3428drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        ...
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2830drawImaged4ec7I(image, topLeft, m3415configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public /* synthetic */ void mo3426drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2831drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3415configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3427drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2831drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3414configurePaintswdJneE(null, style, alpha, colorFilter, blendMode, filterQuality));
    }
    ...
    public void mo3439drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRoundRect(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), CornerRadius.m2706getXimpl(cornerRadius), CornerRadius.m2707getYimpl(cornerRadius), m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3440drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawRoundRect(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), CornerRadius.m2706getXimpl(cornerRadius), CornerRadius.m2707getYimpl(cornerRadius), m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3424drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2829drawCircle9KIMszo(center, radius, m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3425drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().mo2829drawCircle9KIMszo(center, radius, m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3431drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawOval(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3432drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawOval(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3422drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawArc(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), startAngle, sweepAngle, useCenter, m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3423drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawArc(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(topLeft) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(topLeft) + Size.m2797getHeightimpl(size), startAngle, sweepAngle, useCenter, m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3434drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        ...
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawPath(path, m3413configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3433drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        ...
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.drawParams.getCanvas().drawPath(path, m3415configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3435drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        ...
        this.drawParams.getCanvas().mo2833drawPointsO7TthRY(pointMode, points, m3417configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3436drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.drawParams.getCanvas().mo2833drawPointsO7TthRY(pointMode, points, m3419configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    /* renamed from: draw-yzxVdVo, reason: not valid java name */
    public final void m3421drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> block) {
        ...
        $this$draw_yzxVdVo_u24lambda_u240.m3447setSizeuvyYCjk(size);
        canvas.save();
        block.invoke(this);
        canvas.restore();
        ...
        $this$draw_yzxVdVo_u24lambda_u241.m3447setSizeuvyYCjk(prevSize);
    }
    ...
    private final Paint obtainFillPaint() {
        ...
        if (paint == null) {
            ...
            $this$obtainFillPaint_u24lambda_u242.mo2856setStylek9PVt8s(PaintingStyle.INSTANCE.m3238getFillTiuSbCo());
    ...
    private final Paint obtainStrokePaint() {
        ...
        if (paint == null) {
            ...
            $this$obtainStrokePaint_u24lambda_u244.mo2856setStylek9PVt8s(PaintingStyle.INSTANCE.m3239getStrokeTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            if (!StrokeCap.m3320equalsimpl0($this$selectPaint_u24lambda_u246.mo2848getStrokeCapKaPHkGw(), ((Stroke) drawStyle).getCap())) {
                $this$selectPaint_u24lambda_u246.mo2854setStrokeCapBeK7IIE(((Stroke) drawStyle).getCap());
            }
            ...
            if (!StrokeJoin.m3330equalsimpl0($this$selectPaint_u24lambda_u246.mo2849getStrokeJoinLxFBmk8(), ((Stroke) drawStyle).getJoin())) {
                $this$selectPaint_u24lambda_u246.mo2855setStrokeJoinWw9F2mQ(((Stroke) drawStyle).getJoin());
            }
    ...
    static /* synthetic */ Paint m3415configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        int i4;
        if ((i3 & 32) == 0) {
            i4 = i2;
        } else {
            i4 = DrawScope.INSTANCE.m3526getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3414configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i4);
    }

    /* renamed from: configurePaint-swdJneE, reason: not valid java name */
    private final Paint m3414configurePaintswdJneE(Brush brush, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configurePaint_swdJneE_u24lambda_u247 = selectPaint(style);
        if (brush != null) {
            brush.mo2918applyToPq9zytI(mo3442getSizeNHjbRc(), $this$configurePaint_swdJneE_u24lambda_u247, alpha);
        } else {
        ...
        if (!BlendMode.m2884equalsimpl0($this$configurePaint_swdJneE_u24lambda_u247.get_blendMode(), blendMode)) {
            $this$configurePaint_swdJneE_u24lambda_u247.mo2851setBlendModes9anfk8(blendMode);
        }
        if (!FilterQuality.m3061equalsimpl0($this$configurePaint_swdJneE_u24lambda_u247.mo2847getFilterQualityfv9h1I(), filterQuality)) {
            $this$configurePaint_swdJneE_u24lambda_u247.mo2853setFilterQualityvDHp3xo(filterQuality);
        }
        return $this$configurePaint_swdJneE_u24lambda_u247;
    }

    /* renamed from: configurePaint-2qPWKa0$default, reason: not valid java name */
    static /* synthetic */ Paint m3413configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        int i4;
        if ((i3 & 32) == 0) {
            i4 = i2;
        } else {
        ...
        return canvasDrawScope.m3412configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, i4);
    }

    /* renamed from: configurePaint-2qPWKa0, reason: not valid java name */
    private final Paint m3412configurePaint2qPWKa0(long color, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configurePaint_2qPWKa0_u24lambda_u248 = selectPaint(style);
        long targetColor = m3420modulate5vOe2sY(color, alpha);
        if (!Color.m2972equalsimpl0($this$configurePaint_2qPWKa0_u24lambda_u248.mo2846getColor0d7_KjU(), targetColor)) {
            $this$configurePaint_2qPWKa0_u24lambda_u248.mo2852setColor8_81llA(targetColor);
        }
        ...
        if (!BlendMode.m2884equalsimpl0($this$configurePaint_2qPWKa0_u24lambda_u248.get_blendMode(), blendMode)) {
            $this$configurePaint_2qPWKa0_u24lambda_u248.mo2851setBlendModes9anfk8(blendMode);
        }
        if (!FilterQuality.m3061equalsimpl0($this$configurePaint_2qPWKa0_u24lambda_u248.mo2847getFilterQualityfv9h1I(), filterQuality)) {
            $this$configurePaint_2qPWKa0_u24lambda_u248.mo2853setFilterQualityvDHp3xo(filterQuality);
        }
        return $this$configurePaint_2qPWKa0_u24lambda_u248;
    }

    /* renamed from: configureStrokePaint-Q_0CZUI$default, reason: not valid java name */
    static /* synthetic */ Paint m3417configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        int i6;
        if ((i5 & 512) == 0) {
            i6 = i4;
        } else {
            i6 = DrawScope.INSTANCE.m3526getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3416configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, i6);
    }

    /* renamed from: configureStrokePaint-Q_0CZUI, reason: not valid java name */
    private final Paint m3416configureStrokePaintQ_0CZUI(long color, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configureStrokePaint_Q_0CZUI_u24lambda_u249 = obtainStrokePaint();
        long targetColor = m3420modulate5vOe2sY(color, alpha);
        if (!Color.m2972equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2846getColor0d7_KjU(), targetColor)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2852setColor8_81llA(targetColor);
        }
        ...
        if (!BlendMode.m2884equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.get_blendMode(), blendMode)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2851setBlendModes9anfk8(blendMode);
        }
        ...
        if (!StrokeCap.m3320equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2848getStrokeCapKaPHkGw(), cap)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2854setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m3330equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2849getStrokeJoinLxFBmk8(), join)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2855setStrokeJoinWw9F2mQ(join);
        }
        ...
        if (!FilterQuality.m3061equalsimpl0($this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2847getFilterQualityfv9h1I(), filterQuality)) {
            $this$configureStrokePaint_Q_0CZUI_u24lambda_u249.mo2853setFilterQualityvDHp3xo(filterQuality);
        }
        return $this$configureStrokePaint_Q_0CZUI_u24lambda_u249;
    }

    /* renamed from: configureStrokePaint-ho4zsrM$default, reason: not valid java name */
    static /* synthetic */ Paint m3419configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        int i6;
        if ((i5 & 512) == 0) {
            i6 = i4;
        } else {
        ...
        return canvasDrawScope.m3418configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, i6);
    }

    /* renamed from: configureStrokePaint-ho4zsrM, reason: not valid java name */
    private final Paint m3418configureStrokePaintho4zsrM(Brush brush, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint $this$configureStrokePaint_ho4zsrM_u24lambda_u2410 = obtainStrokePaint();
        if (brush != null) {
            brush.mo2918applyToPq9zytI(mo3442getSizeNHjbRc(), $this$configureStrokePaint_ho4zsrM_u24lambda_u2410, alpha);
        } else {
        ...
        if (!BlendMode.m2884equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.get_blendMode(), blendMode)) {
            $this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2851setBlendModes9anfk8(blendMode);
        }
        ...
        if (!StrokeCap.m3320equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2848getStrokeCapKaPHkGw(), cap)) {
            $this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2854setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m3330equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2849getStrokeJoinLxFBmk8(), join)) {
            $this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2855setStrokeJoinWw9F2mQ(join);
        }
        ...
        if (!FilterQuality.m3061equalsimpl0($this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2847getFilterQualityfv9h1I(), filterQuality)) {
            $this$configureStrokePaint_ho4zsrM_u24lambda_u2410.mo2853setFilterQualityvDHp3xo(filterQuality);
        }
        return $this$configureStrokePaint_ho4zsrM_u24lambda_u2410;
    }

    /* renamed from: modulate-5vOe2sY, reason: not valid java name */
    private final long m3420modulate5vOe2sY(long $this$modulate_u2d5vOe2sY, float alpha) {
        long m2969copywmQWz5c;
        if (!(alpha == 1.0f)) {
            m2969copywmQWz5c = Color.m2969copywmQWz5c($this$modulate_u2d5vOe2sY, (r12 & 1) != 0 ? Color.m2973getAlphaimpl($this$modulate_u2d5vOe2sY) : Color.m2973getAlphaimpl($this$modulate_u2d5vOe2sY) * alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl($this$modulate_u2d5vOe2sY) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl($this$modulate_u2d5vOe2sY) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl($this$modulate_u2d5vOe2sY) : 0.0f);
            return m2969copywmQWz5c;
        }
    ...
    public static final /* data */ class DrawParams {
        ...
        public static /* synthetic */ DrawParams m3443copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m3445copyUg5Nnss(density, layoutDirection2, canvas2, j);
        }
        ...
        public final DrawParams m3445copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long size) {
            Intrinsics.checkNotNullParameter(density, "density");
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            Intrinsics.checkNotNullParameter(canvas, "canvas");
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.density, drawParams.density) && this.layoutDirection == drawParams.layoutDirection && Intrinsics.areEqual(this.canvas, drawParams.canvas) && Size.m2796equalsimpl0(this.size, drawParams.size);
        }

        public int hashCode() {
            return (((((this.density.hashCode() * 31) + this.layoutDirection.hashCode()) * 31) + this.canvas.hashCode()) * 31) + Size.m2801hashCodeimpl(this.size);
        }

        public String toString() {
            return "DrawParams(density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", canvas=" + this.canvas + ", size=" + ((Object) Size.m2804toStringimpl(this.size)) + ')';
        }
        ...
        */
        public /* synthetic */ DrawParams(androidx.compose.ui.unit.Density r8, androidx.compose.ui.unit.LayoutDirection r9, androidx.compose.ui.graphics.Canvas r10, long r11, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
            ...
            L23:
                ...
                long r11 = r8.m2809getZeroNHjbRc()
                r4 = r11
                goto L30
            L2f:
                r4 = r11
        ...
        /* renamed from: getSize-NH-jbRc, reason: not valid java name */
        public final long m3446getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m3447setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
