...
public final class LazyStaggeredGridMeasureContext {
    ...
    private LazyStaggeredGridMeasureContext(LazyStaggeredGridState state, List<Integer> pinnedItems, final LazyStaggeredGridItemProvider itemProvider, final LazyStaggeredGridSlots resolvedSlots, long constraints, final boolean isVertical, final LazyLayoutMeasureScope measureScope, int mainAxisAvailableSize, long contentOffset, int beforeContentPadding, int afterContentPadding, boolean reverseLayout, int mainAxisSpacing) {
        ...
        this.measuredItemProvider = new LazyStaggeredGridMeasureProvider(isVertical, itemProvider, measureScope, resolvedSlots) { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext$measuredItemProvider$1
    ...
    public final long m675getSpanRangelOCCd4c(LazyStaggeredGridItemProvider getSpanRange, int itemIndex, int lane) {
        ...
        return SpanRange.m688constructorimpl(targetLane, span);
    }

    /* renamed from: isFullSpan-SZVOQXA, reason: not valid java name */
    public final boolean m676isFullSpanSZVOQXA(long $this$isFullSpan) {
    ...
    public final int m674getLaneInfoSZVOQXA(long $this$laneInfo) {
