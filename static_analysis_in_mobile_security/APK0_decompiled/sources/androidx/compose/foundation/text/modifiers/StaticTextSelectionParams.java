...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m5171boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m5171boximpl(layoutInput.getOverflow());
        int m5183getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m5183getVisiblegIe3tQ8();
        if (m5171boximpl == null) {
            return false;
        }
        return TextOverflow.m5174equalsimpl0(m5171boximpl.getValue(), m5183getVisiblegIe3tQ8);
    }
