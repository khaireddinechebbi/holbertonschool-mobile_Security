...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker $this$addPointerInputChange, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            $this$addPointerInputChange.m4201setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.getPosition());
        ...
        while (index$iv < size) {
            ...
            long historicalDelta = Offset.m2735minusMKHz9U(it.getPosition(), previousPointerPosition);
            previousPointerPosition = it.getPosition();
            $this$addPointerInputChange.m4201setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2736plusMKHz9U($this$addPointerInputChange.getCurrentPointerPositionAccumulator(), historicalDelta));
            $this$addPointerInputChange.m4198addPositionUv8p0NA(it.getUptimeMillis(), $this$addPointerInputChange.getCurrentPointerPositionAccumulator());
            index$iv++;
            $this$fastForEach$iv = $this$fastForEach$iv;
        }
        long delta = Offset.m2735minusMKHz9U(event.getPosition(), previousPointerPosition);
        $this$addPointerInputChange.m4201setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2736plusMKHz9U($this$addPointerInputChange.getCurrentPointerPositionAccumulator(), delta));
        $this$addPointerInputChange.m4198addPositionUv8p0NA(event.getUptimeMillis(), $this$addPointerInputChange.getCurrentPointerPositionAccumulator());
    }
