...
public final class MenuItemColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof MenuItemColors) && Color.m2972equalsimpl0(this.textColor, ((MenuItemColors) other).textColor) && Color.m2972equalsimpl0(this.leadingIconColor, ((MenuItemColors) other).leadingIconColor) && Color.m2972equalsimpl0(this.trailingIconColor, ((MenuItemColors) other).trailingIconColor) && Color.m2972equalsimpl0(this.disabledTextColor, ((MenuItemColors) other).disabledTextColor) && Color.m2972equalsimpl0(this.disabledLeadingIconColor, ((MenuItemColors) other).disabledLeadingIconColor) && Color.m2972equalsimpl0(this.disabledTrailingIconColor, ((MenuItemColors) other).disabledTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2978hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2978hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2978hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2978hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2978hashCodeimpl(this.disabledTrailingIconColor);
    }
}
