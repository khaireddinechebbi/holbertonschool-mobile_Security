...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        long textFieldConstraints2 = ConstraintsKt.m5234offsetNN6EwU(m5208copyZbe2FdA, -occupiedSpaceHorizontally2, verticalConstraintOffset);
        ...
        for (Object element$iv : $this$first$iv) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), "TextField")) {
                ...
                placeholderConstraints = Constraints.m5208copyZbe2FdA(textFieldConstraints2, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(textFieldConstraints2) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(textFieldConstraints2) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(textFieldConstraints2) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(textFieldConstraints2) : 0);
                ...
                width = TextFieldKt.m1267calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), constraints);
                height = TextFieldKt.m1266calculateHeightO3s9Psw(textFieldPlaceable.getHeight(), labelPlaceable != null, effectiveLabelBaseline, TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), constraints, measure.getDensity(), this.paddingValues);
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        Object obj3;
        Object obj4;
        int m1267calculateWidthVsPV1Ek;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1267calculateWidthVsPV1Ek = TextFieldKt.m1267calculateWidthVsPV1Ek(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
                return m1267calculateWidthVsPV1Ek;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1266calculateHeightO3s9Psw;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1266calculateHeightO3s9Psw = TextFieldKt.m1266calculateHeightO3s9Psw(textFieldHeight, labelHeight > 0, labelHeight, leadingHeight, trailingHeight, placeholderHeight, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1266calculateHeightO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
