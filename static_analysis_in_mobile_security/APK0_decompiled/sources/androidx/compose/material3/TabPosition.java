...
public final class TabPosition {
    ...
    public final float m1837getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m5279equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m5279equalsimpl0(this.width, ((TabPosition) other).width);
    }

    public int hashCode() {
        int result = Dp.m5280hashCodeimpl(this.left);
        return (result * 31) + Dp.m5280hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5285toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5285toStringimpl(m1837getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5285toStringimpl(this.width)) + ')';
    }
}
