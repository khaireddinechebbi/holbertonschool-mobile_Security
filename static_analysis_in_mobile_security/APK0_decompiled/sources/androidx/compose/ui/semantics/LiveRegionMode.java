...
public final class LiveRegionMode {
    ...
    private static final int Polite = m4595constructorimpl(0);
    private static final int Assertive = m4595constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4594boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4595constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4596equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4597equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4598hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m4596equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4598hashCodeimpl(this.value);
    }
    ...
    public static String m4599toStringimpl(int arg0) {
        return m4597equalsimpl0(arg0, Polite) ? "Polite" : m4597equalsimpl0(arg0, Assertive) ? "Assertive" : "Unknown";
    }

    public String toString() {
        return m4599toStringimpl(this.value);
    }
}
