...
public interface TimeMark {
    ...
    TimeMark mo6879minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6881plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7026plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7025minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo6881plusLRDsOJo(Duration.m6941unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m6921isNegativeimpl($this.mo6878elapsedNowUwyO8pc());
        }
