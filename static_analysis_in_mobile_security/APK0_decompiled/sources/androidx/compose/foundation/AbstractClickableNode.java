...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    private AbstractClickableNode(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2747getZeroF1C5BW0();
        ...
        public final void m147setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m141updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        Role role2;
        if (obj != null) {
        ...
        abstractClickableNode.m145updateCommonXHw0xAI(mutableInteractionSource, z, str, role2, function0);
    }

    /* renamed from: updateCommon-XHw0xAI, reason: not valid java name */
    protected final void m145updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    protected final void disposeInteractionSource() {
        ...
        Iterable $this$forEach$iv = this.interactionData.getCurrentKeyPressInteractions().values();
    ...
    public void mo143onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo143onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo142onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m208isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3657boximpl(KeyEvent_androidKt.m3968getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3657boximpl(KeyEvent_androidKt.m3968getKeyZmokQxo(event)), press);
        ...
        if (this.enabled && Clickable_androidKt.m206isClickZmokQxo(event)) {
            PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3657boximpl(KeyEvent_androidKt.m3968getKeyZmokQxo(event)));
            if (it != null) {
                BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new AbstractClickableNode$onKeyEvent$2$1(this, it, null), 3, null);
            }
            this.onClick.invoke();
            return true;
        }
    ...
    public boolean mo144onPreKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return false;
    }
}
