...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo209createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path boundingRectangle = AndroidPath_androidKt.Path();
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m2800getWidthimpl(size), Size.m2797getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo2865opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m3263getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        ...
        float cutoutOffset = density.mo327toPx0680j_4(f);
        float f3 = 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m2800getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m2797getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo209createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo2868translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            f2 = AppBarKt.BottomAppBarRoundedEdgeRadius;
            float edgeRadius = density.mo327toPx0680j_4(f2);
