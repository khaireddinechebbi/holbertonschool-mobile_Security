...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int type$iv4 = NodeKind.m4443constructorimpl(2048);
    ...
    public final void m2677fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (!this.isProcessingCustomEnter) {
            this.isProcessingCustomEnter = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2647boximpl(focusDirection));
    ...
    public final void m2678fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (!this.isProcessingCustomExit) {
            this.isProcessingCustomExit = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2647boximpl(focusDirection));
                if (it != FocusRequester.INSTANCE.getDefault()) {
                    block.invoke(it);
                }
            } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int m4443constructorimpl = NodeKind.m4443constructorimpl(4096);
        MutableVector mutableVector2 = null;
        ...
        while (true) {
            ...
            if (node instanceof FocusEventModifierNode) {
                ...
                if (((this_$iv$iv.getKindSet() & m4443constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                    int count$iv = 0;
        ...
        FocusTargetNode $this$visitAncestors_u24default$iv4 = this;
        int i2 = 1024;
        int mask$iv4 = NodeKind.m4443constructorimpl(4096) | NodeKind.m4443constructorimpl(1024);
        boolean includeSelf$iv4 = false;
        if (!$this$visitAncestors_u24default$iv4.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        Modifier.Node node$iv = $this$visitAncestors_u24default$iv4.getNode().getParent();
        LayoutNode layout$iv = DelegatableNodeKt.requireLayoutNode($this$visitAncestors_u24default$iv4);
        while (layout$iv != null) {
            ...
            if ((head$iv.getAggregateChildKindSet() & mask$iv4) != 0) {
                while (node$iv != null) {
                    if ((node$iv.getKindSet() & mask$iv4) != 0) {
                        ...
                        int kind$iv = (it.getKindSet() & NodeKind.m4443constructorimpl(i2)) != 0 ? 1 : 0;
                        if (kind$iv == 0 && it.getIsAttached()) {
                            int m4443constructorimpl2 = NodeKind.m4443constructorimpl(4096);
                            ...
                            while (node2 != null) {
                                if (node2 instanceof FocusEventModifierNode) {
                                    ...
                                    if (((this_$iv$iv3.getKindSet() & m4443constructorimpl2) != 0) && (node2 instanceof DelegatingNode)) {
                                        int count$iv2 = 0;
                                        ...
                                        while (node$iv$iv2 != null) {
                                            ...
                                            if ((next$iv2.getKindSet() & m4443constructorimpl2) != 0) {
                                                count$iv2++;
                                                if (count$iv2 == 1) {
                                                    node2 = next$iv2;
                                                    $this$visitAncestors_u24default$iv3 = $this$visitAncestors_u24default$iv4;
                                                    mask$iv3 = mask$iv4;
                                            ...
                                            $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv3;
                                            mask$iv4 = mask$iv3;
                    ...
                    $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv4;
                    mask$iv4 = mask$iv4;
                    includeSelf$iv4 = includeSelf$iv4;
                    i2 = 1024;
                }
                $this$visitAncestors_u24default$iv = $this$visitAncestors_u24default$iv4;
                mask$iv = mask$iv4;
            ...
            $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv;
            mask$iv4 = mask$iv;
