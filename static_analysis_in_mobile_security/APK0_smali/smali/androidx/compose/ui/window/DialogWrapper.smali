...
.method public constructor <init>(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/window/DialogProperties;Landroid/view/View;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;Ljava/util/UUID;)V
    ...
    const-string/jumbo v6, "onDismissRequest"
    ...
    .line 292
    :cond_0
    sget v9, Landroidx/compose/ui/R$style;->FloatingDialogWindowTheme:I
    ...
    :cond_1
    :goto_0
    sget v9, Landroidx/compose/ui/R$style;->DialogWindowTheme:I
    ...
    invoke-direct {v0, v6, v9, v8, v10}, Landroidx/activity/ComponentDialog;-><init>(Landroid/content/Context;IILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 276
    iput-object v1, v0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:Lkotlin/jvm/functions/Function0;

    .line 277
    iput-object v2, v0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    .line 278
    iput-object v3, v0, Landroidx/compose/ui/window/DialogWrapper;->composeView:Landroid/view/View;
    ...
    iput v6, v0, Landroidx/compose/ui/window/DialogWrapper;->maxSupportedElevation:F

    .line 308
    nop

    .line 309
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/window/DialogWrapper;->getWindow()Landroid/view/Window;
    ...
    .line 310
    iput v11, v0, Landroidx/compose/ui/window/DialogWrapper;->defaultSoftInputMode:I
    ...
    invoke-virtual {v8, v11}, Landroid/view/Window;->setBackgroundDrawableResource(I)V

    .line 315
    iget-object v11, v0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    invoke-virtual {v11}, Landroidx/compose/ui/window/DialogProperties;->getDecorFitsSystemWindows()Z

    move-result v11

    invoke-static {v8, v11}, Landroidx/core/view/WindowCompat;->setDecorFitsSystemWindows(Landroid/view/Window;Z)V

    .line 316
    new-instance v11, Landroidx/compose/ui/window/DialogLayout;

    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/window/DialogWrapper;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v11, v12, v8}, Landroidx/compose/ui/window/DialogLayout;-><init>(Landroid/content/Context;Landroid/view/Window;)V

    move-object v12, v11

    .local v12, "$this$_init__u24lambda_u241":Landroidx/compose/ui/window/DialogLayout;
    const/4 v13, 0x0

    .line 319
    .local v13, "$i$a$-apply-DialogWrapper$1":I
    ...
    invoke-virtual {v12, v14, v10}, Landroidx/compose/ui/window/DialogLayout;->setTag(ILjava/lang/Object;)V

    .line 321
    invoke-virtual {v12, v9}, Landroidx/compose/ui/window/DialogLayout;->setClipChildren(Z)V

    .line 323
    move-object/from16 v9, p5

    .line 468
    .local v9, "$this$lambda_u241_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    const/4 v10, 0x0

    .line 323
    .local v10, "$i$a$-with-DialogWrapper$1$1":I
    invoke-interface {v9, v6}, Landroidx/compose/ui/unit/Density;->toPx-0680j_4(F)F

    move-result v6

    invoke-virtual {v12, v6}, Landroidx/compose/ui/window/DialogLayout;->setElevation(F)V

    .line 328
    .end local v9    # "$this$lambda_u241_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v10    # "$i$a$-with-DialogWrapper$1$1":I
    new-instance v6, Landroidx/compose/ui/window/DialogWrapper$1$2;

    invoke-direct {v6}, Landroidx/compose/ui/window/DialogWrapper$1$2;-><init>()V

    check-cast v6, Landroid/view/ViewOutlineProvider;

    invoke-virtual {v12, v6}, Landroidx/compose/ui/window/DialogLayout;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    .line 337
    nop

    .line 316
    .end local v12    # "$this$_init__u24lambda_u241":Landroidx/compose/ui/window/DialogLayout;
    .end local v13    # "$i$a$-apply-DialogWrapper$1":I
    iput-object v11, v0, Landroidx/compose/ui/window/DialogWrapper;->dialogLayout:Landroidx/compose/ui/window/DialogLayout;
    ...
    invoke-static {v10}, Landroidx/compose/ui/window/DialogWrapper;->_init_$disableClipping(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v6}, Landroidx/compose/ui/window/DialogWrapper;->setContentView(Landroid/view/View;)V
    ...
    invoke-static {v6, v9}, Landroidx/lifecycle/ViewTreeLifecycleOwner;->set(Landroid/view/View;Landroidx/lifecycle/LifecycleOwner;)V
    ...
    invoke-static {v6, v9}, Landroidx/lifecycle/ViewTreeViewModelStoreOwner;->set(Landroid/view/View;Landroidx/lifecycle/ViewModelStoreOwner;)V
    ...
    .line 356
    invoke-static {v11, v6}, Landroidx/savedstate/ViewTreeSavedStateRegistryOwner;->set(Landroid/view/View;Landroidx/savedstate/SavedStateRegistryOwner;)V

    .line 361
    iget-object v6, v0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:Lkotlin/jvm/functions/Function0;

    iget-object v9, v0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    invoke-virtual {v0, v6, v9, v4}, Landroidx/compose/ui/window/DialogWrapper;->updateParameters(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 368
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/window/DialogWrapper;->getOnBackPressedDispatcher()Landroidx/activity/OnBackPressedDispatcher;
    ...
    invoke-direct {v6, v0}, Landroidx/compose/ui/window/DialogWrapper$2;-><init>(Landroidx/compose/ui/window/DialogWrapper;)V
    ...
    invoke-static/range {v10 .. v15}, Landroidx/activity/OnBackPressedDispatcherKt;->addCallback$default(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;ZLkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroidx/activity/OnBackPressedCallback;
    ...
    const-string v8, "Dialog has no window"
