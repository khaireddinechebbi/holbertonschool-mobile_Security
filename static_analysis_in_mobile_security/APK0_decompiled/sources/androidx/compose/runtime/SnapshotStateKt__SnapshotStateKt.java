...
final /* synthetic */ class SnapshotStateKt__SnapshotStateKt {
    ...
    public static final <T> T getValue(State<? extends T> state, Object thisObj, KProperty<?> property) {
        Intrinsics.checkNotNullParameter(state, "<this>");
        Intrinsics.checkNotNullParameter(property, "property");
        return state.getValue();
    }

    public static final <T> void setValue(MutableState<T> mutableState, Object thisObj, KProperty<?> property, T t) {
    ...
    public static final <K, V> SnapshotStateMap<K, V> toMutableStateMap(Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        it.putAll(MapsKt.toMap(iterable));
        return it;
    }
    ...
    public static final <T> State<T> rememberUpdatedState(T t, Composer $composer, int $changed) {
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = mutableStateOf$default(t, null, 2, null);
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        $composer.endReplaceableGroup();
        MutableState $this$rememberUpdatedState_u24lambda_u245 = (MutableState) value$iv$iv;
        $this$rememberUpdatedState_u24lambda_u245.setValue(t);
