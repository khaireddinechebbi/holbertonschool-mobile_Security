...
public final class CoreTextFieldKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:115:0x07a1  */
    /* JADX WARN: Removed duplicated region for block: B:118:0x07e9 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:122:0x07fe  */
    /* JADX WARN: Removed duplicated region for block: B:125:0x08e3 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:129:0x092d  */
    /* JADX WARN: Removed duplicated region for block: B:132:0x0989  */
    /* JADX WARN: Removed duplicated region for block: B:139:0x099b  */
    /* JADX WARN: Removed duplicated region for block: B:142:0x0a04  */
    /* JADX WARN: Removed duplicated region for block: B:144:0x09a6  */
    ...
    */
    public static final void CoreTextField(final androidx.compose.ui.text.input.TextFieldValue r67, final kotlin.jvm.functions.Function1<? super androidx.compose.ui.text.input.TextFieldValue, kotlin.Unit> r68, androidx.compose.ui.Modifier r69, androidx.compose.ui.text.TextStyle r70, androidx.compose.ui.text.input.VisualTransformation r71, kotlin.jvm.functions.Function1<? super androidx.compose.ui.text.TextLayoutResult, kotlin.Unit> r72, androidx.compose.foundation.interaction.MutableInteractionSource r73, androidx.compose.ui.graphics.Brush r74, boolean r75, int r76, int r77, androidx.compose.ui.text.input.ImeOptions r78, androidx.compose.foundation.text.KeyboardActions r79, boolean r80, boolean r81, kotlin.jvm.functions.Function3<? super kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r82, androidx.compose.runtime.Composer r83, final int r84, final int r85, final int r86) {
        /*
    ...
    */
    ...
    private static final Modifier previewKeyEventToDeselectOnBack(Modifier $this$previewKeyEventToDeselectOnBack, final TextFieldState state, final TextFieldSelectionManager manager) {
        return KeyInputModifierKt.onPreviewKeyEvent($this$previewKeyEventToDeselectOnBack, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.text.CoreTextFieldKt$previewKeyEventToDeselectOnBack$1
            ...
            public final Boolean m771invokeZmokQxo(android.view.KeyEvent keyEvent) {
                ...
                if (TextFieldState.this.getHandleState() == HandleState.Selection && KeyEventHelpers_androidKt.m773cancelsTextSelectionZmokQxo(keyEvent)) {
                    z = true;
    ...
    public static final void TextFieldCursorHandle(final TextFieldSelectionManager manager, Composer $composer, final int $changed) {
        ...
        if (state != null && state.getShowCursorHandle()) {
            ...
            final long position = manager.m961getCursorPositiontuRUvjQ$foundation_release((Density) consume);
            ...
            $composer2.endReplaceableGroup();
            AndroidCursorHandle_androidKt.m751CursorHandleULxng0E(position, SemanticsModifierKt.semantics$default(pointerInput, false, (Function1) value$iv$iv2, 1, null), null, $composer2, 384);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
