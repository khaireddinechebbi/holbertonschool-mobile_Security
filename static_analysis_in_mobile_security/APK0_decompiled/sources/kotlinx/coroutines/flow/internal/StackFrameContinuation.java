...
final class StackFrameContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public StackFrameContinuation(Continuation<? super T> continuation, CoroutineContext context) {
