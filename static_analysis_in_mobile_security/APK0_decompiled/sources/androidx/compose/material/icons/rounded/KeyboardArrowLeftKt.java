...
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(Icons.Rounded $this$KeyboardArrowLeft) {
        ...
        ImageVector.Builder $this$_get_KeyboardArrowLeft__u24lambda_u241 = new ImageVector.Builder("Rounded.KeyboardArrowLeft", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(14.71f, 15.88f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(8.71f, 11.3f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
