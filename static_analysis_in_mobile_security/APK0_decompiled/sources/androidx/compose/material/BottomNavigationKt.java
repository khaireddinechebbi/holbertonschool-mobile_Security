...
public final class BottomNavigationKt {
    ...
    private static final float BottomNavigationHeight = Dp.m5274constructorimpl(56);
    private static final float BottomNavigationItemHorizontalPadding = Dp.m5274constructorimpl(12);
    private static final float CombinedItemTextBaseline = Dp.m5274constructorimpl(12);

    /* renamed from: BottomNavigation-PEIptTM, reason: not valid java name */
    public static final void m995BottomNavigationPEIptTM(Modifier modifier, long backgroundColor, long contentColor, float elevation, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long contentColor2;
        float f;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                elevation2 = i5 != 0 ? BottomNavigationDefaults.INSTANCE.m994getElevationD9Ej5fM() : f;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            SurfaceKt.m1210SurfaceFjzlyU(modifier3, null, backgroundColor2, contentColor2, null, elevation2, ComposableLambdaKt.composableLambda($composer2, 678339930, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomNavigationKt$BottomNavigation$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomNavigationKt$BottomNavigation$2
            ...
            public final void invoke(Composer composer, int i6) {
                BottomNavigationKt.m995BottomNavigationPEIptTM(Modifier.this, j2, j3, f2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m996BottomNavigationItemjY6E1Zs(final androidx.compose.foundation.layout.RowScope r38, final boolean r39, final kotlin.jvm.functions.Function0<kotlin.Unit> r40, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r41, androidx.compose.ui.Modifier r42, boolean r43, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r44, boolean r45, androidx.compose.foundation.interaction.MutableInteractionSource r46, long r47, long r49, androidx.compose.runtime.Composer r51, final int r52, final int r53, final int r54) {
        /*
            Method dump skipped, instructions count: 1235
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomNavigationKt.m996BottomNavigationItemjY6E1Zs(androidx.compose.foundation.layout.RowScope, boolean, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: BottomNavigationTransition-Klgx-Pg, reason: not valid java name */
    public static final void m997BottomNavigationTransitionKlgxPg(final long activeColor, final long inactiveColor, final boolean selected, final Function3<? super Float, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            long color = ColorKt.m3022lerpjxsXWHM(inactiveColor, activeColor, BottomNavigationTransition_Klgx_Pg$lambda$3(animationProgress$delegate));
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            m2969copywmQWz5c = Color.m2969copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(color) : 1.0f, (r12 & 2) != 0 ? Color.m2977getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color) : 0.0f);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localContentColor.provides(Color.m2961boximpl(m2969copywmQWz5c)), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2973getAlphaimpl(color)))}, ComposableLambdaKt.composableLambda($composer2, -138092754, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomNavigationKt$BottomNavigationTransition$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.BottomNavigationKt$BottomNavigationTransition$2
            ...
            public final void invoke(Composer composer, int i) {
                BottomNavigationKt.m997BottomNavigationTransitionKlgxPg(activeColor, inactiveColor, selected, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    */
    ...
    public static final MeasureResult m1001placeIcon3p2s80s(MeasureScope $this$placeIcon_u2d3p2s80s, final Placeable iconPlaceable, long constraints) {
    ...
    public static final MeasureResult m1002placeLabelAndIconDIyivk0(MeasureScope $this$placeLabelAndIcon_u2dDIyivk0, final Placeable labelPlaceable, final Placeable iconPlaceable, long constraints, final float iconPositionAnimationProgress) {
        int height = Constraints.m5217getMaxHeightimpl(constraints);
        int firstBaseline = labelPlaceable.get(AlignmentLineKt.getFirstBaseline());
        int baselineOffset = $this$placeLabelAndIcon_u2dDIyivk0.mo321roundToPx0680j_4(CombinedItemTextBaseline);
