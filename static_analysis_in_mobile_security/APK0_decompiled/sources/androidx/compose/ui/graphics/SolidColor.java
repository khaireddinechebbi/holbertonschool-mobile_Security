...
public final class SolidColor extends Brush {
    ...
    public void mo2918applyToPq9zytI(long size, Paint p, float alpha) {
        ...
        if (!(alpha == 1.0f)) {
            long j2 = this.value;
            j = Color.m2969copywmQWz5c(j2, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(j2) : Color.m2973getAlphaimpl(j2) * alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl(j2) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(j2) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(j2) : 0.0f);
        } else {
            j = this.value;
        }
        p.mo2852setColor8_81llA(j);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
