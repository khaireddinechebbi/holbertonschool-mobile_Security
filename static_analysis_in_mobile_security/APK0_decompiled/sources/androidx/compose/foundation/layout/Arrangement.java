...
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public /* synthetic */ float getSpacing() {
            return Arrangement.Horizontal.CC.m401$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final Vertical Top = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public /* synthetic */ float getSpacing() {
            return Arrangement.Vertical.CC.m411$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5274constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public final /* synthetic */ class CC {
            ...
            public static float m401$default$getSpacingD9Ej5fM(Horizontal _this) {
        ...
        public static final class DefaultImpls {
            ...
            public static float m403getSpacingD9Ej5fM(Horizontal $this) {
                return CC.m401$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m411$default$getSpacingD9Ej5fM(Vertical _this) {
                return Dp.m5274constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m413getSpacingD9Ej5fM(Vertical $this) {
                return CC.m411$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m404$default$getSpacingD9Ej5fM(HorizontalOrVertical _this) {
                return Dp.m5274constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m406getSpacingD9Ej5fM(HorizontalOrVertical $this) {
                return CC.m404$default$getSpacingD9Ej5fM($this);
            }
        }
    }
    ...
    public final HorizontalOrVertical m394spacedBy0680j_4(float space) {
    ...
    public final Horizontal m395spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m396spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5274constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5274constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m397spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m398spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m399spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m5274constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m407copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m409copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m409copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m5279equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m5280hashCodeimpl = Dp.m5280hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m5280hashCodeimpl + i) * 31;
        ...
        public final float m410getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int spacePx = $this$arrange.mo321roundToPx0680j_4(this.space);
            int occupied2 = 0;
            int lastSpace2 = 0;
            ...
            Function2<Integer, LayoutDirection, Integer> function2 = this.alignment;
            if (function2 != null && occupied4 < totalSize) {
                int groupPosition = function2.invoke(Integer.valueOf(totalSize - occupied4), layoutDirection).intValue();
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m5285toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
