...
final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        long textFieldConstraints = ConstraintsKt.m5234offsetNN6EwU(m5208copyZbe2FdA, -occupiedSpaceHorizontally4, verticalConstraintOffset);
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it14), "TextField")) {
                ...
                placeholderConstraints = Constraints.m5208copyZbe2FdA(textFieldConstraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(textFieldConstraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(textFieldConstraints) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(textFieldConstraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(textFieldConstraints) : 0);
                ...
                supportingConstraints = Constraints.m5208copyZbe2FdA(r38, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(r38) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(r38) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(r38) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(ConstraintsKt.m5235offsetNN6EwU$default(looseConstraints, 0, -Math.max(occupiedSpaceVertically4, Math.max(TextFieldImplKt.heightOrZero(textFieldPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable)) + effectiveTopOffset + bottomPaddingValue), 1, null)) : 0);
                ...
                if (measurable7 != null) {
                    ...
                    placeable = measurable7.mo4225measureBRTryo0(supportingConstraints2);
                } else {
                    supportingConstraints2 = supportingConstraints;
                    placeable = null;
                }
                        ...
                        return MeasureScope.CC.layout$default(measure, width, totalHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$measure$1
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                if (placeable2 != null) {
                                    ...
                                    int height2 = i3 + Placeable.this.getHeight();
                                    f = this.animationProgress;
                                    TextFieldKt.placeWithLabel(layout, i, i2, placeable3, placeable2, placeable4, placeable5, placeable6, placeable7, placeable8, placeable9, placeable10, z2, i3, height2, f, measure.getDensity());
                                    return;
                                }
                                int i4 = width;
                                int i5 = totalHeight;
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        Object obj5;
        Object obj6;
        int m1881calculateWidthyeHjK3Y;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1881calculateWidthyeHjK3Y = TextFieldKt.m1881calculateWidthyeHjK3Y(leadingWidth, trailingWidth, prefixWidth, suffixWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
                return m1881calculateWidthyeHjK3Y;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj6;
        Object obj7;
        int m1880calculateHeightmKXJcVc;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1880calculateHeightmKXJcVc = TextFieldKt.m1880calculateHeightmKXJcVc(textFieldHeight, labelHeight, leadingHeight, trailingHeight, prefixHeight, suffixHeight, placeholderHeight, supportingHeight, this.animationProgress == 1.0f, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1880calculateHeightmKXJcVc;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
