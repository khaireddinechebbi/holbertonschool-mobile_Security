...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    public FontWeight(int weight) {
        this.weight = weight;
        boolean z = false;
        if (1 <= weight && weight < 1001) {
            z = true;
        }
        if (z) {
        } else {
            throw new IllegalArgumentException(("Font weight can be in range [1, 1000]. Current value: " + weight).toString());
        }
    }
    ...
    static {
        ...
        W100 = fontWeight;
        FontWeight fontWeight2 = new FontWeight(ComposerKt.invocationKey);
        W200 = fontWeight2;
