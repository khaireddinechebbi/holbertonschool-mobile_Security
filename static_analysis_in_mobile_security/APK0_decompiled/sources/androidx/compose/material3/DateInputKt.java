    ...
    public static final void m1464DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate initialDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int inputIdentifier, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer $composer, final int $changed) {
        ...
        final MutableState text$delegate = RememberSaveableKt.rememberSaveable(new Object[0], (Saver) TextFieldValue.INSTANCE.getSaver(), (String) null, (Function0) new Function0<MutableState<TextFieldValue>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$text$2
            ...
            public final MutableState<TextFieldValue> invoke() {
                ...
                return SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TextFieldValue((it == null || (formatWithPattern = $this$invoke_u24lambda_u241.getCalendarModel().formatWithPattern(it.getUtcTimeMillis(), dateInputFormat.getPatternWithoutDelimiters(), locale)) == null) ? "" : formatWithPattern, TextRangeKt.TextRange(0, 0), (TextRange) null, 4, (DefaultConstructorMarker) null), null, 2, null);
            }
        }, $composer2, 72, 4);
        ...
        Modifier m491paddingqDBjuR0$default = PaddingKt.m491paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, f, 7, null);
        ...
        OutlinedTextFieldKt.OutlinedTextField(DateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(m491paddingqDBjuR0$default, false, (Function1) value$iv$iv, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda($composer2, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer, int i) {
                DateInputKt.m1464DateInputTextFieldzm97o8M(Modifier.this, function2, function22, stateData, initialDate, onDateChanged, inputIdentifier, dateInputValidator, dateInputFormat, locale, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
