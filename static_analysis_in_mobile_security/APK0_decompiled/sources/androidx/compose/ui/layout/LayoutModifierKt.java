...
public final class LayoutModifierKt {
    public static final Modifier layout(Modifier $this$layout, Function3<? super MeasureScope, ? super Measurable, ? super Constraints, ? extends MeasureResult> measure) {
        Intrinsics.checkNotNullParameter($this$layout, "<this>");
        Intrinsics.checkNotNullParameter(measure, "measure");
        return $this$layout.then(new LayoutElement(measure));
    }
}
