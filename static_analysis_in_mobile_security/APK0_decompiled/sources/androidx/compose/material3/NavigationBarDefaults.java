...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = NavigationBarTokens.INSTANCE.m2297getContainerElevationD9Ej5fM();

    private NavigationBarDefaults() {
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m1619getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets m560onlybOOhFvg = WindowInsetsKt.m560onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.m570plusgK_yJZ4(WindowInsetsSides.INSTANCE.m580getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m578getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
