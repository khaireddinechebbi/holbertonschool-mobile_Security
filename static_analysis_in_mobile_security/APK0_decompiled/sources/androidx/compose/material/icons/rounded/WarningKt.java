...
public final class WarningKt {
    ...
    public static final ImageVector getWarning(Icons.Rounded $this$Warning) {
        ...
        ImageVector.Builder $this$_get_Warning__u24lambda_u241 = new ImageVector.Builder("Rounded.Warning", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(4.47f, 21.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(15.06f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(1.54f, 0.0f, 2.5f, -1.67f, 1.73f, -3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(13.73f, 4.99f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.77f, -1.33f, -2.69f, -1.33f, -3.46f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(2.74f, 18.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.77f, 1.33f, 0.19f, 3.0f, 1.73f, 3.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_Warning__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        _warning = build;
