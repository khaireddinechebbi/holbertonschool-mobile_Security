...
final class MinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo440calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long constraints) {
        ...
        int width = measurable.minIntrinsicWidth(Constraints.m5217getMaxHeightimpl(constraints));
        return Constraints.INSTANCE.m5228fixedWidthOenEA2s(width);
    }
