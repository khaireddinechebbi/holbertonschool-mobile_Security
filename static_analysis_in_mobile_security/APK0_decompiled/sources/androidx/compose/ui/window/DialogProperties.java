...
public final class DialogProperties {
    ...
    public DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, SecureFlagPolicy securePolicy, boolean usePlatformDefaultWidth, boolean decorFitsSystemWindows) {
    ...
    public DialogProperties(boolean dismissOnBackPress, boolean dismissOnClickOutside, SecureFlagPolicy securePolicy) {
        this(dismissOnBackPress, dismissOnClickOutside, securePolicy, true, true);
        Intrinsics.checkNotNullParameter(securePolicy, "securePolicy");
    }
    ...
    public int hashCode() {
        int result = ClickableElement$$ExternalSyntheticBackport0.m(this.dismissOnBackPress);
        return (((((((result * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.usePlatformDefaultWidth)) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.decorFitsSystemWindows);
    }
}
