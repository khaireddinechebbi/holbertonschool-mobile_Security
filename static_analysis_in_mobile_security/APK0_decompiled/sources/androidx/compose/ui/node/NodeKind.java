...
public final class NodeKind<T> {
    ...
    public static final /* synthetic */ NodeKind m4442boximpl(int i) {
        return new NodeKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> int m4443constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4444equalsimpl(int i, Object obj) {
        return (obj instanceof NodeKind) && i == ((NodeKind) obj).m4450unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4445equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4446hashCodeimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m4444equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m4446hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4449toStringimpl(this.mask);
    }
    ...
    public static final int m4447orH91voCI(int arg0, int other) {
        return arg0 | other;
    }

    /* renamed from: or-impl, reason: not valid java name */
    public static final int m4448orimpl(int arg0, int other) {
        return arg0 | other;
    }
}
