...
public final class DatePickerDefaults {
    ...
    public final DatePickerColors m1473colors1m2CgY(long containerColor, long titleContentColor, long headlineContentColor, long weekdayContentColor, long subheadContentColor, long yearContentColor, long currentYearContentColor, long selectedYearContentColor, long selectedYearContainerColor, long dayContentColor, long disabledDayContentColor, long selectedDayContentColor, long disabledSelectedDayContentColor, long selectedDayContainerColor, long disabledSelectedDayContainerColor, long todayContentColor, long todayDateBorderColor, long dayInSelectionRangeContentColor, long dayInSelectionRangeContainerColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long titleContentColor2 = (i & 2) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getHeaderSupportingTextColor(), $composer, 6) : titleContentColor;
        long headlineContentColor2 = (i & 4) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getHeaderHeadlineColor(), $composer, 6) : headlineContentColor;
        long weekdayContentColor2 = (i & 8) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getWeekdaysLabelTextColor(), $composer, 6) : weekdayContentColor;
        long subheadContentColor2 = (i & 16) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadColor(), $composer, 6) : subheadContentColor;
        long yearContentColor2 = (i & 32) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getSelectionYearUnselectedLabelTextColor(), $composer, 6) : yearContentColor;
        long currentYearContentColor2 = (i & 64) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateTodayLabelTextColor(), $composer, 6) : currentYearContentColor;
        long selectedYearContentColor2 = (i & 128) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getSelectionYearSelectedLabelTextColor(), $composer, 6) : selectedYearContentColor;
        long selectedYearContainerColor2 = (i & 256) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getSelectionYearSelectedContainerColor(), $composer, 6) : selectedYearContainerColor;
        long dayContentColor2 = (i & 512) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateUnselectedLabelTextColor(), $composer, 6) : dayContentColor;
        if ((i & 1024) != 0) {
            m2969copywmQWz5c3 = Color.m2969copywmQWz5c(r82, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r82) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r82) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r82) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(dayContentColor2) : 0.0f);
            disabledDayContentColor2 = m2969copywmQWz5c3;
        } else {
            disabledDayContentColor2 = disabledDayContentColor;
        }
        long selectedDayContentColor2 = (i & 2048) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateSelectedLabelTextColor(), $composer, 6) : selectedDayContentColor;
        if ((i & 4096) != 0) {
            m2969copywmQWz5c2 = Color.m2969copywmQWz5c(r82, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r82) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r82) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r82) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(selectedDayContentColor2) : 0.0f);
            disabledSelectedDayContentColor2 = m2969copywmQWz5c2;
        } else {
            disabledSelectedDayContentColor2 = disabledSelectedDayContentColor;
        }
        long selectedDayContainerColor2 = (i & 8192) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateSelectedContainerColor(), $composer, 6) : selectedDayContainerColor;
        if ((i & 16384) != 0) {
            m2969copywmQWz5c = Color.m2969copywmQWz5c(r82, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r82) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r82) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r82) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(selectedDayContainerColor2) : 0.0f);
            disabledSelectedDayContainerColor2 = m2969copywmQWz5c;
        } else {
            disabledSelectedDayContainerColor2 = disabledSelectedDayContainerColor;
        }
        long todayContentColor2 = (32768 & i) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateTodayLabelTextColor(), $composer, 6) : todayContentColor;
        long todayDateBorderColor2 = (65536 & i) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getDateTodayContainerOutlineColor(), $composer, 6) : todayDateBorderColor;
        long dayInSelectionRangeContentColor2 = (131072 & i) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getSelectionDateInRangeLabelTextColor(), $composer, 6) : dayInSelectionRangeContentColor;
        long dayInSelectionRangeContainerColor2 = (i & 262144) != 0 ? ColorSchemeKt.toColor(DatePickerModalTokens.INSTANCE.getRangeSelectionActiveIndicatorContainerColor(), $composer, 6) : dayInSelectionRangeContainerColor;
    ...
    public final void DatePickerTitle(final DatePickerState state, Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 91) != 18 || !$composer2.getSkipping()) {
            ...
            if (DisplayMode.m1501equalsimpl0(m1482getDisplayModejFl4v0, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                $composer2.startReplaceableGroup(-2065111000);
                ComposerKt.sourceInformation($composer2, "422@19876L43,421@19847L123");
                TextKt.m1884Text4IGK_g(Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1761getDatePickerTitleadMyvUU(), $composer2, 6), modifier4, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, $dirty2 & 112, 0, 131068);
                $composer2.endReplaceableGroup();
            } else if (DisplayMode.m1501equalsimpl0(m1482getDisplayModejFl4v0, DisplayMode.INSTANCE.m1505getInputjFl4v0())) {
                $composer2.startReplaceableGroup(-2065110842);
                ComposerKt.sourceInformation($composer2, "427@20034L42,426@20005L122");
                TextKt.m1884Text4IGK_g(Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1748getDateInputTitleadMyvUU(), $composer2, 6), modifier4, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, $dirty2 & 112, 0, 131068);
                $composer2.endReplaceableGroup();
            } else {
        ...
        if (($dirty & 731) == 146 && $composer3.getSkipping()) {
            ...
            if (verboseDateDescription == null) {
                ...
                if (DisplayMode.m1501equalsimpl0(value, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                    ...
                    verboseDateDescription = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1752getDatePickerNoSelectionDescriptionadMyvUU(), $composer3, 6);
                    ...
                    verboseDateDescription = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1747getDateInputNoInputDescriptionadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                } else {
            ...
            if (formattedDate == null) {
                ...
                if (DisplayMode.m1501equalsimpl0(value2, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                    ...
                    String m1797getStringNWtq28 = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1749getDatePickerHeadlineadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                    headlineText = m1797getStringNWtq28;
                    ...
                    String m1797getStringNWtq282 = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1741getDateInputHeadlineadMyvUU(), $composer3, 6);
                    $composer3.endReplaceableGroup();
                    headlineText = m1797getStringNWtq282;
                } else {
            ...
            if (DisplayMode.m1501equalsimpl0(value3, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                $composer3.startReplaceableGroup(933109538);
                ComposerKt.sourceInformation($composer3, "472@21870L48");
                str = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1750getDatePickerHeadlineDescriptionadMyvUU(), $composer3, 6);
                $composer3.endReplaceableGroup();
            } else if (DisplayMode.m1501equalsimpl0(value3, DisplayMode.INSTANCE.m1505getInputjFl4v0())) {
                $composer3.startReplaceableGroup(933109624);
                ComposerKt.sourceInformation($composer3, "473@21956L47");
                str = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1742getDateInputHeadlineDescriptionadMyvUU(), $composer3, 6);
                $composer3.endReplaceableGroup();
            } else {
            ...
            $composer2 = $composer3;
            TextKt.m1884Text4IGK_g(headlineText, SemanticsModifierKt.semantics$default(modifier4, false, (Function1) value$iv$iv, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 1, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, $composer2, 0, 3072, 122876);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier5;
    ...
    public final float m1474getTonalElevationD9Ej5fM() {
