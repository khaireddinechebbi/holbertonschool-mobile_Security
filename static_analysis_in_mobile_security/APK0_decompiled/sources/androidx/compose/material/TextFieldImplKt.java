        ...
        if (($dirty & 1533916891) == 306783378 && (46811 & $dirty1) == 9362 && $composer3.getSkipping()) {
            ...
            Function3 labelColor = new Function3<InputPhase, Composer, Integer, Color>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$labelColor$1
                ...
                public final long m1263invokeXeAY9LY(InputPhase it, Composer $composer4, int $changed2) {
                    ...
                    int i11 = $dirty12;
                    long m2981unboximpl = textFieldColors.labelColor(z3, z4, interactionSource2, $composer4, i10 | ((i11 << 3) & 896) | (i11 & 7168)).getValue().m2981unboximpl();
                    if (ComposerKt.isTraceInProgress()) {
            ...
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m3007getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv = labelColor.invoke(inputState, $composer3, 0).m2981unboximpl();
                }
            ...
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv2 != Color.INSTANCE.m3007getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv2 = labelColor.invoke(inputState, $composer3, 0).m2981unboximpl();
                }
            ...
            $composer2 = $composer3;
            textFieldTransitionScope.m1268TransitionDTcfvLk(inputState, j, j2, labelColor, function2 != null, ComposableLambdaKt.composableLambda($composer2, 341865432, true, new Function6<Float, Color, Color, Float, Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3
                ...
                */
                public final void m1261invokeRIQooxk(final float r34, final long r35, final long r37, final float r39, androidx.compose.runtime.Composer r40, int r41) {
                    /*
                        Method dump skipped, instructions count: 1026
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3.m1261invokeRIQooxk(float, long, long, float, androidx.compose.runtime.Composer, int):void");
                }
            }), $composer2, 1769472);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
