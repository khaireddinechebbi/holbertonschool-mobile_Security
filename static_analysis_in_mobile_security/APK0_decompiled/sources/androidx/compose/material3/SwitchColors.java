...
public final class SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SwitchColors) && Color.m2972equalsimpl0(this.checkedThumbColor, ((SwitchColors) other).checkedThumbColor) && Color.m2972equalsimpl0(this.checkedTrackColor, ((SwitchColors) other).checkedTrackColor) && Color.m2972equalsimpl0(this.checkedBorderColor, ((SwitchColors) other).checkedBorderColor) && Color.m2972equalsimpl0(this.checkedIconColor, ((SwitchColors) other).checkedIconColor) && Color.m2972equalsimpl0(this.uncheckedThumbColor, ((SwitchColors) other).uncheckedThumbColor) && Color.m2972equalsimpl0(this.uncheckedTrackColor, ((SwitchColors) other).uncheckedTrackColor) && Color.m2972equalsimpl0(this.uncheckedBorderColor, ((SwitchColors) other).uncheckedBorderColor) && Color.m2972equalsimpl0(this.uncheckedIconColor, ((SwitchColors) other).uncheckedIconColor) && Color.m2972equalsimpl0(this.disabledCheckedThumbColor, ((SwitchColors) other).disabledCheckedThumbColor) && Color.m2972equalsimpl0(this.disabledCheckedTrackColor, ((SwitchColors) other).disabledCheckedTrackColor) && Color.m2972equalsimpl0(this.disabledCheckedBorderColor, ((SwitchColors) other).disabledCheckedBorderColor) && Color.m2972equalsimpl0(this.disabledCheckedIconColor, ((SwitchColors) other).disabledCheckedIconColor) && Color.m2972equalsimpl0(this.disabledUncheckedThumbColor, ((SwitchColors) other).disabledUncheckedThumbColor) && Color.m2972equalsimpl0(this.disabledUncheckedTrackColor, ((SwitchColors) other).disabledUncheckedTrackColor) && Color.m2972equalsimpl0(this.disabledUncheckedBorderColor, ((SwitchColors) other).disabledUncheckedBorderColor) && Color.m2972equalsimpl0(this.disabledUncheckedIconColor, ((SwitchColors) other).disabledUncheckedIconColor)) {
            return true;
        }
        return false;
    }
