...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m4999resolveTextDirectionHeuristics9GRLPo0(style.m4798getTextDirectionmmuk1to(), style.getLocaleList());
        Function4 resolveTypeface = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m4998invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m4870unboximpl(), fontSynthesis.getValue());
            }

            /* renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m4998invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
                TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList;
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                State result = AndroidParagraphIntrinsics.this.getFontFamilyResolver().mo4841resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
        ...
        SpanStyle notAppliedStyle = TextPaintExtensions_androidKt.applySpanStyle(androidTextPaint, style.toSpanStyle(), resolveTypeface, density, !spanStyles.isEmpty());
