...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m451setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m452setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo239measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (OffsetNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable, measure.mo321roundToPx0680j_4(OffsetNode.this.getX()), measure.mo321roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeable, measure.mo321roundToPx0680j_4(OffsetNode.this.getX()), measure.mo321roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
