...
public interface GridCells {
    ...
    public static final class Fixed implements GridCells {
        ...
        public Fixed(int count) {
            ...
            if (count > 0) {
                ...
                throw new IllegalArgumentException(("Provided count " + count + " should be larger than zero").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            ...
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize) {
            ...
            int $this$dp$iv = Dp.m5273compareTo0680j_4(minSize, Dp.m5274constructorimpl(0));
            if ($this$dp$iv > 0) {
            } else {
                throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m5285toStringimpl(minSize)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            List<Integer> calculateCellsCrossAxisSizeImpl;
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int count = Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.mo321roundToPx0680j_4(this.minSize) + spacing), 1);
            calculateCellsCrossAxisSizeImpl = LazyGridDslKt.calculateCellsCrossAxisSizeImpl(availableSize, count, spacing);
            return calculateCellsCrossAxisSizeImpl;
        }

        public int hashCode() {
            return Dp.m5280hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m5279equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size) {
            this.size = size;
            int $this$dp$iv = Dp.m5273compareTo0680j_4(size, Dp.m5274constructorimpl(0));
            if ($this$dp$iv > 0) {
            } else {
                throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m5285toStringimpl(size)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int cellSize = $this$calculateCrossAxisCellSizes.mo321roundToPx0680j_4(this.size);
            int i = 0;
        ...
        public int hashCode() {
            return Dp.m5280hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m5279equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
