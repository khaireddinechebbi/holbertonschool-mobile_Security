...
public final class MailOutlineKt {
    ...
    public static final ImageVector getMailOutline(Icons.Rounded $this$MailOutline) {
        ...
        ImageVector.Builder $this$_get_MailOutline__u24lambda_u241 = new ImageVector.Builder("Rounded.MailOutline", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(5.0f, 18.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(4.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(6.94f, 4.34f);
