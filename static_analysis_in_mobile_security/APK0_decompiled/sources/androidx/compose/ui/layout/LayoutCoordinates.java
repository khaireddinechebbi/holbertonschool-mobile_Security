...
public interface LayoutCoordinates {
    ...
    long mo4233localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo4234localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo4235localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    void mo4236transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo4237windowToLocalMKHz9U(long relativeToWindow);
    ...
    public final /* synthetic */ class CC {
        ...
        public static void m4238$default$transformFromEL8BTi8(LayoutCoordinates _this, LayoutCoordinates sourceCoordinates, float[] matrix) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m4240transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            CC.m4238$default$transformFromEL8BTi8($this, sourceCoordinates, matrix);
        }
    }
}
