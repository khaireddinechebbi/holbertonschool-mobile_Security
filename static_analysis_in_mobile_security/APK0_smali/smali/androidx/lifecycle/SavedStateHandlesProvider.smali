...
.method public final performRestore()V
    ...
    .local v2, "$this$performRestore_u24lambda_u245":Landroid/os/Bundle;
    const/4 v3, 0x0

    .line 166
    .local v3, "$i$a$-apply-SavedStateHandlesProvider$performRestore$1":I
    iget-object v4, p0, Landroidx/lifecycle/SavedStateHandlesProvider;->restoredState:Landroid/os/Bundle;
    ...
    .line 166
    .local v5, "$i$a$-let-SavedStateHandlesProvider$performRestore$1$1":I
    invoke-virtual {v2, v4}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    .line 167
    .end local v4    # "it":Landroid/os/Bundle;
    .end local v5    # "$i$a$-let-SavedStateHandlesProvider$performRestore$1$1":I
    :cond_0
    if-eqz v0, :cond_1
    ...
    .line 229
    .restart local v4    # "it":Landroid/os/Bundle;
    const/4 v5, 0x0

    .line 167
    .local v5, "$i$a$-let-SavedStateHandlesProvider$performRestore$1$2":I
    invoke-virtual {v2, v4}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    .line 168
    .end local v4    # "it":Landroid/os/Bundle;
    .end local v5    # "$i$a$-let-SavedStateHandlesProvider$performRestore$1$2":I
    :cond_1
    nop

    .line 165
    .end local v2    # "$this$performRestore_u24lambda_u245":Landroid/os/Bundle;
    .end local v3    # "$i$a$-apply-SavedStateHandlesProvider$performRestore$1":I
    iput-object v1, p0, Landroidx/lifecycle/SavedStateHandlesProvider;->restoredState:Landroid/os/Bundle;
...
.method public saveState()Landroid/os/Bundle;
    ...
    .local v1, "$this$saveState_u24lambda_u241":Landroid/os/Bundle;
    const/4 v2, 0x0
    ...
    .line 139
    .end local v1    # "$this$saveState_u24lambda_u241":Landroid/os/Bundle;
