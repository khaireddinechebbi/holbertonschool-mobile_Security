...
public interface BeyondBoundsLayout {
    ...
    <T> T mo641layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m4203constructorimpl(1);
        private static final int After = m4203constructorimpl(2);
        private static final int Left = m4203constructorimpl(3);
        private static final int Right = m4203constructorimpl(4);
        private static final int Above = m4203constructorimpl(5);
        private static final int Below = m4203constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m4202boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m4203constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4204equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4205equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4206hashCodeimpl(int i) {
            return i;
        }
        ...
        public static final class Companion {
            ...
            public final int m4211getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m4210getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m4213getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m4214getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m4209getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m4212getBelowhoxUOeE() {
                return LayoutDirection.Below;
            }
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m4207toStringimpl(int arg0) {
            return m4205equalsimpl0(arg0, Before) ? "Before" : m4205equalsimpl0(arg0, After) ? "After" : m4205equalsimpl0(arg0, Left) ? "Left" : m4205equalsimpl0(arg0, Right) ? "Right" : m4205equalsimpl0(arg0, Above) ? "Above" : m4205equalsimpl0(arg0, Below) ? "Below" : "invalid LayoutDirection";
        }
