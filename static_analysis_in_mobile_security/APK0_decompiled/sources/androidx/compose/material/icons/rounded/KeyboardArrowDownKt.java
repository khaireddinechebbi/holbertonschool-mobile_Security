...
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(Icons.Rounded $this$KeyboardArrowDown) {
        ...
        ImageVector.Builder $this$_get_KeyboardArrowDown__u24lambda_u241 = new ImageVector.Builder("Rounded.KeyboardArrowDown", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(8.12f, 9.29f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(6.7f, 10.7f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
