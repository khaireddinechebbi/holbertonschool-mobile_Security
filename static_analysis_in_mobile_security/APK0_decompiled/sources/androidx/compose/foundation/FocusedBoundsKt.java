...
public final class FocusedBoundsKt {
    ...
    public static final Modifier onFocusedBoundsChanged(Modifier $this$onFocusedBoundsChanged, Function1<? super LayoutCoordinates, Unit> onPositioned) {
        Intrinsics.checkNotNullParameter($this$onFocusedBoundsChanged, "<this>");
        Intrinsics.checkNotNullParameter(onPositioned, "onPositioned");
        return $this$onFocusedBoundsChanged.then(new FocusedBoundsObserverElement(onPositioned));
    }
}
