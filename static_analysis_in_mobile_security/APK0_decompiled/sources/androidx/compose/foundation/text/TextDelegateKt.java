...
public final class TextDelegateKt {
    public static final int ceilToIntPx(float $this$ceilToIntPx) {
        return MathKt.roundToInt((float) Math.ceil($this$ceilToIntPx));
    }

    /* renamed from: updateTextDelegate-rm0N8CA, reason: not valid java name */
    public static final TextDelegate m814updateTextDelegaterm0N8CA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean softWrap, int overflow, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> placeholders) {
