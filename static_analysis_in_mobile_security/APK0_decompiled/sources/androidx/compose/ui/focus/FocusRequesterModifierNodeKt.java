...
public final class FocusRequesterModifierNodeKt {
    public static final boolean requestFocus(FocusRequesterModifierNode $this$requestFocus) {
        ...
        while (true) {
                            ...
                            if ((node$iv$iv.getKindSet() & count$iv$iv2) != 0) {
                                ...
                                while (this_$iv$iv$iv2 != null) {
                                    if (this_$iv$iv$iv2 instanceof FocusTargetNode) {
                                        ...
                                        return focusProperties.getCanFocus() ? FocusTransactionsKt.requestFocus(focusTarget) : TwoDimensionalFocusSearchKt.m2692findChildCorrespondingToFocusEnterOMvw8(focusTarget, FocusDirection.INSTANCE.m2659getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
            ...
            if (((this_$iv$iv$iv4.getKindSet() & type$iv3) != 0) && (node instanceof DelegatingNode)) {
                int count$iv$iv4 = 0;
    ...
    public static final boolean captureFocus(FocusRequesterModifierNode $this$captureFocus) {
        ...
        while (true) {
            ...
            if (node instanceof FocusTargetNode) {
                ...
                if (((this_$iv$iv$iv3.getKindSet() & type$iv3) != 0) && (node instanceof DelegatingNode)) {
                    int count$iv$iv2 = 0;
