...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo4993getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Typeface m4994buildStyledTypefaceFO1MlWM = m4994buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
        Intrinsics.checkNotNullExpressionValue(m4994buildStyledTypefaceFO1MlWM, "buildStyledTypeface(fontWeight, fontStyle)");
        return m4994buildStyledTypefaceFO1MlWM;
    }

    /* renamed from: buildStyledTypeface-FO1MlWM, reason: not valid java name */
    private final Typeface m4994buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m4820getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m4867equalsimpl0(fontStyle, FontStyle.INSTANCE.m4871getItalic_LCdwA()));
    }
}
