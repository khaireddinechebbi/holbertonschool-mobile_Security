...
public final /* data */ class DeviceRenderNodeData {
    ...
    public int hashCode() {
        ...
        return ((floatToIntBits + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m3052hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m3053toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m4549getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE, reason: not valid java name */
    public final void m4550setCompositingStrategyaDBOjCE(int i) {
