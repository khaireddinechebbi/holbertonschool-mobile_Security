...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5274constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5274constructorimpl((float) 4.0d);
    ...
    public final float m2276getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2277getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
