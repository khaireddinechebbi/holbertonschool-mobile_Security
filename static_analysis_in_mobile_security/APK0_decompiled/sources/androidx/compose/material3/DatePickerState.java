...
public final class DatePickerState {
    ...
    private DatePickerState(Long initialSelectedDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        this(new StateData(initialSelectedDateMillis, null, initialDisplayedMonthMillis, yearRange, initialDisplayMode, null));
    ...
    public final int m1482getDisplayModejFl4v0() {
    ...
    public final void m1483setDisplayModevCnGnXg(int i) {
