...
public interface StateObject {
    ...
    public final /* synthetic */ class CC {
        public static StateRecord $default$mergeRecords(StateObject _this, StateRecord previous, StateRecord current, StateRecord applied) {
    ...
    public static final class DefaultImpls {
        ...
        public static StateRecord mergeRecords(StateObject $this, StateRecord previous, StateRecord current, StateRecord applied) {
            ...
            Intrinsics.checkNotNullParameter(current, "current");
            Intrinsics.checkNotNullParameter(applied, "applied");
            return CC.$default$mergeRecords($this, previous, current, applied);
        }
    }
}
