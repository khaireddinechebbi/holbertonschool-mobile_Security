...
public final class CalendarModel_androidKt {
    ...
    public static final String formatWithSkeleton(long utcTimeMillis, String skeleton, Locale locale) {
        ...
        Intrinsics.checkNotNullExpressionValue(pattern, "pattern");
        return companion2.formatWithPattern(utcTimeMillis, pattern, locale);
    }
    ...
    public static final Locale defaultLocale(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(895332416, $changed, -1, "androidx.compose.material3.defaultLocale (CalendarModel.android.kt:72)");
        }
