...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo731createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2800getWidthimpl(size) - topEnd, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2800getWidthimpl(size), topEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2800getWidthimpl(size), Size.m2797getHeightimpl(size) - bottomEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2800getWidthimpl(size) - bottomEnd, Size.m2797getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(bottomStart, Size.m2797getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m2797getHeightimpl(size) - bottomStart);
