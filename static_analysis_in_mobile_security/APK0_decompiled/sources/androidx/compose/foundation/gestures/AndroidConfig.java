...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo245calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long bounds) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List $this$fastFold$iv = event.getChanges();
        Offset m2720boximpl = Offset.m2720boximpl(Offset.INSTANCE.m2747getZeroF1C5BW0());
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            long acc = m2720boximpl.getPackedValue();
            m2720boximpl = Offset.m2720boximpl(Offset.m2736plusMKHz9U(acc, c.getScrollDelta()));
            index$iv$iv++;
            $this$fastFold$iv = $this$fastFold$iv;
        }
        return Offset.m2738timestuRUvjQ(m2720boximpl.getPackedValue(), -calculateMouseWheelScroll.mo327toPx0680j_4(Dp.m5274constructorimpl(64)));
    }
}
