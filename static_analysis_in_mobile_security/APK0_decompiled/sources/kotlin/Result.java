...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m5562boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m5563constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5564equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5565equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m5568hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m5570isSuccessimpl(Object arg0) {
        return !(arg0 instanceof Failure);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m5569isFailureimpl(Object arg0) {
        return arg0 instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m5567getOrNullimpl(Object obj) {
        if (m5569isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m5566exceptionOrNullimpl(Object arg0) {
    ...
    public static String m5571toStringimpl(Object arg0) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m5563constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m5563constructorimpl(ResultKt.createFailure(exception));
        }
    }
