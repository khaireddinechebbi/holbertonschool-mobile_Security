...
final class DistanceAndInLayer {
    ...
    public static final /* synthetic */ DistanceAndInLayer m4350boximpl(long j) {
        return new DistanceAndInLayer(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4352constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4353equalsimpl(long j, Object obj) {
        return (obj instanceof DistanceAndInLayer) && j == ((DistanceAndInLayer) obj).m4359unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4354equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static String m4358toStringimpl(long j) {
        return "DistanceAndInLayer(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4353equalsimpl(this.packedValue, obj);
    }
    ...
    public String toString() {
        return m4358toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m4359unboximpl() {
    ...
    public static final float m4355getDistanceimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: isInLayer-impl, reason: not valid java name */
    public static final boolean m4357isInLayerimpl(long arg0) {
        return ((int) (4294967295L & arg0)) != 0;
    }

    /* renamed from: compareTo-S_HNhKs, reason: not valid java name */
    public static final int m4351compareToS_HNhKs(long arg0, long other) {
        boolean thisIsInLayer = m4357isInLayerimpl(arg0);
        boolean otherIsInLayer = m4357isInLayerimpl(other);
        if (thisIsInLayer != otherIsInLayer) {
            return thisIsInLayer ? -1 : 1;
        }
        float distanceDiff = m4355getDistanceimpl(arg0) - m4355getDistanceimpl(other);
