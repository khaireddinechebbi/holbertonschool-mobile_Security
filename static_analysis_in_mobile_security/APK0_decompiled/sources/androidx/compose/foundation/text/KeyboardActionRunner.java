...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m776runActionKlQnJC8(int imeAction) {
        Function1 keyboardAction;
        Unit unit = null;
        if (ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4931getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4930getDefaulteUduSuo()) ? true : ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4934getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo775defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo775defaultKeyboardActionKlQnJC8(int imeAction) {
        if (!ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4933getNexteUduSuo())) {
            if (!ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4935getPreviouseUduSuo())) {
                if (!ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4931getDoneeUduSuo())) {
                    if (ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4932getGoeUduSuo()) ? true : ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4936getSearcheUduSuo()) ? true : ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4937getSendeUduSuo()) ? true : ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4930getDefaulteUduSuo())) {
                        return;
                    }
                    ImeAction.m4918equalsimpl0(imeAction, ImeAction.INSTANCE.m4934getNoneeUduSuo());
                    return;
                } else {
            ...
            getFocusManager().mo2668moveFocus3ESFkO8(FocusDirection.INSTANCE.m2665getPreviousdhqQ8s());
            return;
        }
        getFocusManager().mo2668moveFocus3ESFkO8(FocusDirection.INSTANCE.m2663getNextdhqQ8s());
    }
}
