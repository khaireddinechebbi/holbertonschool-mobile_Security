...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m5274constructorimpl((float) 4.0d);
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final float HandleHeight = Dp.m5274constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m5274constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m5274constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5274constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5274constructorimpl((float) 2.0d);
    ...
    public final float m2443getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2444getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2445getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2446getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2447getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2448getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2449getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2450getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2452getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2454getTrackElevationD9Ej5fM() {
    ...
    public final float m2451getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2453getTickMarksContainerSizeD9Ej5fM() {
