...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new ChipElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-1373769818);
            ComposerKt.sourceInformation($composer, "1550@74861L52");
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new ChipElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
