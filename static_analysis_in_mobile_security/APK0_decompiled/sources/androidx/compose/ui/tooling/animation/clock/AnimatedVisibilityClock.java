...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String m5204getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (getAnimation().m5190getAnimationObject().getCurrentState().booleanValue()) {
            m5204getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5205getExitjXw82LU();
        } else {
            m5204getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5204getEnterjXw82LU();
        }
        this.state = m5204getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ AnimatedVisibilityState getState() {
        return AnimatedVisibilityState.m5197boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(AnimatedVisibilityState animatedVisibilityState) {
        m5196setState7IW2chM(animatedVisibilityState.m5203unboximpl());
    }
    ...
    public void m5196setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m5196setState7IW2chM(((AnimatedVisibilityState) par1).m5203unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m5190getAnimationObject();
        Pair<Boolean, Boolean> m5194toCurrentTargetPair7IW2chM = m5194toCurrentTargetPair7IW2chM(getState());
        boolean current = m5194toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = m5194toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m5194toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m5200equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m5204getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
