...
public final class SemanticsNode {
    ...
    public final long m4620getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return findCoordinatorToGetBounds$ui_release != null ? findCoordinatorToGetBounds$ui_release.mo4232getSizeYbymL2g() : IntSize.INSTANCE.m5439getZeroYbymL2g();
    }
    ...
    public final long m4618getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final long m4619getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list) {
        ...
        do {
            ...
            if (child.getNodes().m4406hasH91voCI$ui_release(NodeKind.m4443constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m4340requireCoordinator64DMado(semanticsModifierNode, NodeKind.m4443constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && (!unmergedChildren.isEmpty())) {
            SemanticsNode fakeNode = m4617fakeSemanticsNodeypyhhiA(nodeRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m4624setRolekuIjeqM(fakeSemanticsNode, Role.this.getValue());
                }
            });
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!unmergedChildren.isEmpty()) && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                SemanticsNode fakeNode2 = m4617fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m4617fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
