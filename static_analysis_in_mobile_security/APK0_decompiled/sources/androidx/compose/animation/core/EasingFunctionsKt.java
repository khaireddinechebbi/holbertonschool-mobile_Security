...
public final class EasingFunctionsKt {
    ...
    private static final Easing EaseInElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInElastic$1
        ...
        public final float transform(float fraction) {
            ...
            return (float) ((-((float) Math.pow(2.0f, (fraction * 10.0f) - 10.0f))) * Math.sin(((10.0f * fraction) - 10.75f) * 2.0943951023931953d));
        }
    };
    private static final Easing EaseOutElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseOutElastic$1
        ...
        public final float transform(float fraction) {
            ...
            return (float) ((((float) Math.pow(2.0f, (-10.0f) * fraction)) * Math.sin(((10.0f * fraction) - 0.75f) * 2.0943951023931953d)) + 1.0f);
        }
    };
    private static final Easing EaseInOutElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutElastic$1
        ...
        public final float transform(float fraction) {
            ...
            if (0.0f <= fraction && fraction <= 0.5f) {
                return (float) ((-(((float) Math.pow(r5, (fraction * 20.0f) - 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d))) / 2.0f);
            }
            return ((float) ((((float) Math.pow(r8, ((-20.0f) * fraction) + 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d)) / 2.0f)) + 1.0f;
        }
    };
    private static final Easing EaseOutBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseOutBounce$1
        ...
        public final float transform(float fraction) {
            ...
            if (fraction < 2.0f / 2.75f) {
                float newFraction = fraction - (1.5f / 2.75f);
                return (7.5625f * newFraction * newFraction) + 0.75f;
            }
            if (fraction < 2.5f / 2.75f) {
                float newFraction2 = fraction - (2.25f / 2.75f);
                return (7.5625f * newFraction2 * newFraction2) + 0.9375f;
            }
            float newFraction3 = fraction - (2.625f / 2.75f);
            return (7.5625f * newFraction3 * newFraction3) + 0.984375f;
        }
    };
    private static final Easing EaseInBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInBounce$1
        @Override // androidx.compose.animation.core.Easing
        public final float transform(float fraction) {
            return 1 - EasingFunctionsKt.getEaseOutBounce().transform(1.0f - fraction);
        }
    };
    private static final Easing EaseInOutBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutBounce$1
        ...
        public final float transform(float fraction) {
            if (fraction < 0.5d) {
                return (1 - EasingFunctionsKt.getEaseOutBounce().transform(1.0f - (fraction * 2.0f))) / 2.0f;
            }
            return (1 + EasingFunctionsKt.getEaseOutBounce().transform((fraction * 2.0f) - 1.0f)) / 2.0f;
        }
    };
