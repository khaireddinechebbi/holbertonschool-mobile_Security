...
public final class LazyLayoutNearestRangeState implements State<IntRange> {
    ...
    public LazyLayoutNearestRangeState(int firstVisibleItem, int slidingWindowSize, int extraItemCount) {
        ...
        this.value = SnapshotStateKt.mutableStateOf(Companion.calculateNearestItemsRange(firstVisibleItem, slidingWindowSize, extraItemCount), SnapshotStateKt.structuralEqualityPolicy());
