...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m4766getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m4765getMaximpl(textFieldValue.getSelection());
