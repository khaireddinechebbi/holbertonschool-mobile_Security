...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.Outlined $this$Place) {
        ...
        ImageVector.Builder $this$_get_Place__u24lambda_u241 = new ImageVector.Builder("Outlined.Place", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(18.0f, 10.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(18.0f, 6.57f, 15.35f, 4.0f, 12.0f, 4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-6.0f, 2.57f, -6.0f, 6.2f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 2.34f, 1.95f, 5.44f, 6.0f, 9.14f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(4.05f, -3.7f, 6.0f, -6.8f, 6.0f, -9.14f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveTo(4.0f, 5.22f, 7.8f, 2.0f, 12.0f, 2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_Place__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        _place = build;
