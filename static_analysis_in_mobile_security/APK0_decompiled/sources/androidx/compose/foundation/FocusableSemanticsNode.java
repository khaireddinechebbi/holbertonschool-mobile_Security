...
final class FocusableSemanticsNode extends Modifier.Node implements SemanticsModifierNode, FocusRequesterModifierNode {
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        SemanticsPropertiesKt.requestFocus$default($this$applySemantics, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.FocusableSemanticsNode$applySemantics$1
            {
                super(0);
            }
