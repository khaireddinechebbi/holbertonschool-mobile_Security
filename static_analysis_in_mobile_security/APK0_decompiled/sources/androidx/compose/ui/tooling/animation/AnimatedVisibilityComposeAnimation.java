...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String label) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m5197boximpl(AnimatedVisibilityState.INSTANCE.m5204getEnterjXw82LU()), AnimatedVisibilityState.m5197boximpl(AnimatedVisibilityState.INSTANCE.m5205getExitjXw82LU())});
    }

    /* renamed from: getAnimationObject, reason: merged with bridge method [inline-methods] */
    public Transition<Boolean> m5190getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m5190getAnimationObject().getTransitions(), 0);
