...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    private final Object decide(Object decision) {
        ...
        Object current = atomicReferenceFieldUpdater.get(this);
        return current != AtomicKt.NO_DECISION ? current : AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, AtomicKt.NO_DECISION, decision) ? decision : atomicReferenceFieldUpdater.get(this);
    }
