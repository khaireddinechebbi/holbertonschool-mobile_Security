...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        Object obj4;
        final int width;
        int m1157calculateHeightO3s9Psw;
        ...
        final Placeable trailingPlaceable = measurable2 != null ? measurable2.mo4225measureBRTryo0(ConstraintsKt.m5235offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally2, 0, 2, null)) : null;
        ...
        long labelConstraints = ConstraintsKt.m5234offsetNN6EwU(relaxedConstraints, MathHelpersKt.lerp((-occupiedSpaceHorizontally) - labelHorizontalPaddingOffset, -labelHorizontalPaddingOffset, this.animationProgress), -bottomPadding);
        ...
        m5208copyZbe2FdA = Constraints.m5208copyZbe2FdA(r23, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(r23) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(r23) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(r23) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(ConstraintsKt.m5234offsetNN6EwU(constraints, -occupiedSpaceHorizontally, (-bottomPadding) - topPadding)) : 0);
        long textConstraints2 = m5208copyZbe2FdA;
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), "TextField")) {
                ...
                placeholderConstraints = Constraints.m5208copyZbe2FdA(r23, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(r23) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(r23) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(r23) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(textConstraints2) : 0);
                ...
                width = OutlinedTextFieldKt.m1158calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), this.animationProgress, constraints, measure.getDensity(), this.paddingValues);
                m1157calculateHeightO3s9Psw = OutlinedTextFieldKt.m1157calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), this.animationProgress, constraints, measure.getDensity(), this.paddingValues);
                int bottomPadding2 = m1157calculateHeightO3s9Psw;
                ...
                for (Object element$iv2 : $this$first$iv3) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it12), OutlinedTextFieldKt.BorderId)) {
                        final Placeable borderPlaceable = ((Measurable) element$iv2).mo4225measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, bottomPadding2 != Integer.MAX_VALUE ? bottomPadding2 : 0, bottomPadding2));
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope $this$intrinsicWidth, List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1158calculateWidthO3s9Psw;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1158calculateWidthO3s9Psw = OutlinedTextFieldKt.m1158calculateWidthO3s9Psw(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
                return m1158calculateWidthO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1157calculateHeightO3s9Psw = OutlinedTextFieldKt.m1157calculateHeightO3s9Psw(leadingHeight, trailingHeight, textFieldHeight, labelHeight, placeholderHeight, this.animationProgress, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1157calculateHeightO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
