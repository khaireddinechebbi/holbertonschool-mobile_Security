...
public final class DynamicProvidableCompositionLocal<T> extends ProvidableCompositionLocal<T> {
    ...
    public State<T> provided$runtime_release(T t, Composer $composer, int $changed) {
        Object value$iv$iv;
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = SnapshotStateKt.mutableStateOf(t, this.policy);
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        $composer.endReplaceableGroup();
        MutableState $this$provided_u24lambda_u241 = (MutableState) value$iv$iv;
        $this$provided_u24lambda_u241.setValue(t);
