...
public final class TextFieldKt {
            ...
            Function2<Composer, Integer, Unit> function215 = new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$2
                ...
                public final void invoke(Composer $composer4, int $changed3) {
                    ...
                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier m518defaultMinSizeVpY3zN4 = SizeKt.m518defaultMinSizeVpY3zN4(Modifier.this, TextFieldDefaults.INSTANCE.m1860getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m1859getMinHeightD9Ej5fM());
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer4, -288211827, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$2.1
                            ...
                            public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer5, int $changed4) {
                                ...
                                if (($dirty7 & 91) != 18 || !$composer5.getSkipping()) {
                                    ...
                                    int i33 = i30;
                                    int i34 = i31;
                                    textFieldDefaults.DecorationBox(str2, innerTextField, z8, z9, visualTransformation5, mutableInteractionSource3, z10, function223, function224, function225, function226, function227, function228, function229, shape7, textFieldColors3, null, null, $composer5, (i32 & 14) | (($dirty7 << 3) & 112) | ((i32 >> 3) & 896) | ((i33 >> 12) & 7168) | (i33 & 57344) | ((i34 << 15) & 458752) | ((i33 << 9) & 3670016) | ((i32 << 3) & 29360128) | ((i32 << 3) & 234881024) | ((i32 << 3) & 1879048192), ((i32 >> 27) & 14) | 100663296 | ((i33 << 3) & 112) | ((i33 << 3) & 896) | ((i33 << 3) & 7168) | ((i34 << 9) & 57344) | ((i34 << 9) & 458752), ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                                    if (ComposerKt.isTraceInProgress()) {
                    ...
                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer4, 1751957978, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$5.1
                            ...
                            public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer5, int $changed4) {
                                ...
                                int i33 = i30;
                                int i34 = i31;
                                textFieldDefaults.DecorationBox(text, innerTextField, z8, z9, visualTransformation5, mutableInteractionSource3, z10, function223, function224, function225, function226, function227, function228, function229, shape7, textFieldColors3, null, null, $composer5, ((i32 >> 3) & 896) | (($dirty7 << 3) & 112) | ((i33 >> 12) & 7168) | (i33 & 57344) | ((i34 << 15) & 458752) | ((i33 << 9) & 3670016) | ((i32 << 3) & 29360128) | ((i32 << 3) & 234881024) | ((i32 << 3) & 1879048192), ((i32 >> 27) & 14) | 100663296 | ((i33 << 3) & 112) | ((i33 << 3) & 896) | ((i33 << 3) & 7168) | ((i34 << 9) & 57344) | ((i34 << 9) & 458752), ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:177:0x0b74  */
    /* JADX WARN: Removed duplicated region for block: B:180:0x0c47  */
    /* JADX WARN: Removed duplicated region for block: B:183:0x0c53  */
    /* JADX WARN: Removed duplicated region for block: B:186:0x0d0a  */
    /* JADX WARN: Removed duplicated region for block: B:195:0x0ea4  */
    /* JADX WARN: Removed duplicated region for block: B:197:0x0e89  */
    /* JADX WARN: Removed duplicated region for block: B:198:0x0c57  */
    /* JADX WARN: Removed duplicated region for block: B:199:0x0b51  */
    /* JADX WARN: Removed duplicated region for block: B:200:0x0b41  */
    /* JADX WARN: Removed duplicated region for block: B:202:0x0b22  */
    /* JADX WARN: Removed duplicated region for block: B:204:0x07e9  */
    ...
    */
    ...
    public static final int m1880calculateHeightmKXJcVc(int textFieldHeight, int labelHeight, int leadingHeight, int trailingHeight, int prefixHeight, int suffixHeight, int placeholderHeight, int supportingHeight, boolean isLabelFocused, long constraints, float density, PaddingValues paddingValues) {
        ...
        if (!hasLabel || isLabelFocused) {
            ...
            m5274constructorimpl = Dp.m5274constructorimpl(arg0$iv + other$iv);
        } else {
            float arg0$iv2 = TextFieldImplKt.getTextFieldPadding();
            m5274constructorimpl = Dp.m5274constructorimpl(2 * arg0$iv2);
        }
        float arg0$iv3 = density * m5274constructorimpl;
