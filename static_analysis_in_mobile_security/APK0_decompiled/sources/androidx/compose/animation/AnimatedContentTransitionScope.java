...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo12slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> initialOffset);

    /* renamed from: slideOutOfContainer-mOhB8PU, reason: not valid java name */
    ExitTransition mo13slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> targetOffset);
    ...
    public static final class SlideDirection {
        ...
        private static final int Left = m17constructorimpl(0);
        private static final int Right = m17constructorimpl(1);
        private static final int Up = m17constructorimpl(2);
        private static final int Down = m17constructorimpl(3);
        private static final int Start = m17constructorimpl(4);
        private static final int End = m17constructorimpl(5);
        ...
        public static String m21toStringimpl(int arg0) {
            return m19equalsimpl0(arg0, Left) ? "Left" : m19equalsimpl0(arg0, Right) ? "Right" : m19equalsimpl0(arg0, Up) ? "Up" : m19equalsimpl0(arg0, Down) ? "Down" : m19equalsimpl0(arg0, Start) ? "Start" : m19equalsimpl0(arg0, End) ? "End" : "Invalid";
        }
    }
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ EnterTransition m14slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: slideIntoContainer-mOhB8PU");
            }
            if ((i2 & 2) != 0) {
                finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5383boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
            }
            if ((i2 & 4) != 0) {
            ...
            return animatedContentTransitionScope.mo12slideIntoContainermOhB8PU(i, finiteAnimationSpec, function1);
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: slideOutOfContainer-mOhB8PU$default, reason: not valid java name */
        public static /* synthetic */ ExitTransition m15slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
            if (obj != null) {
            ...
            return animatedContentTransitionScope.mo13slideOutOfContainermOhB8PU(i, finiteAnimationSpec, function1);
        }
    }
}
