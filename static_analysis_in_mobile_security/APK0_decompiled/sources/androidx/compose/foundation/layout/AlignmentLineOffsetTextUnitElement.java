...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    private AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine, long before, long after, Function1<? super InspectorInfo, Unit> inspectorInfo) {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + TextUnit.m5456hashCodeimpl(this.before)) * 31) + TextUnit.m5456hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return otherModifier != null && Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && TextUnit.m5452equalsimpl0(this.before, otherModifier.before) && TextUnit.m5452equalsimpl0(this.after, otherModifier.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m383setBeforeR2X_6o(this.before);
        node.m382setAfterR2X_6o(this.after);
    }
}
