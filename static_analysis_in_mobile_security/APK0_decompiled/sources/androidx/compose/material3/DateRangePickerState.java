...
public final class DateRangePickerState {
    ...
    private DateRangePickerState(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        this(new StateData(initialSelectedStartDateMillis, initialSelectedEndDateMillis, initialDisplayedMonthMillis, yearRange, initialDisplayMode, null));
    ...
    public final int m1488getDisplayModejFl4v0() {
        State $this$getValue$iv = this.displayMode;
        return ((DisplayMode) $this$getValue$iv.getValue()).getValue();
    }

    /* renamed from: setDisplayMode-vCnGnXg, reason: not valid java name */
    public final void m1489setDisplayModevCnGnXg(int i) {
        MutableState $this$setValue$iv = this.displayMode;
        $this$setValue$iv.setValue(DisplayMode.m1498boximpl(i));
    }
        ...
        public final Saver<DateRangePickerState, ?> Saver() {
            return SaverKt.Saver(new Function2<SaverScope, DateRangePickerState, Object>() { // from class: androidx.compose.material3.DateRangePickerState$Companion$Saver$1
                ...
                public final Object invoke(SaverScope Saver, DateRangePickerState it) {
                    ...
                    Saver $this$invoke_u24lambda_u240 = StateData.INSTANCE.Saver();
                    return $this$invoke_u24lambda_u240.save(Saver, it.getStateData());
                }
                ...
                public final DateRangePickerState invoke(Object value) {
                    ...
                    Saver $this$invoke_u24lambda_u240 = StateData.INSTANCE.Saver();
                    StateData restore = $this$invoke_u24lambda_u240.restore(value);
