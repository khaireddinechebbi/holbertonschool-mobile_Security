...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5426boximpl(IntSize.INSTANCE.m5439getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo12slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                long m32getCurrentSizeYbymL2g;
                long m32getCurrentSizeYbymL2g2;
                long m31calculateOffsetemnUabE;
                Function1<Integer, Integer> function1 = initialOffset;
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                int m5434getWidthimpl = IntSize.m5434getWidthimpl(m32getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m32getCurrentSizeYbymL2g2 = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5434getWidthimpl - IntOffset.m5392getXimpl(m31calculateOffsetemnUabE)));
            }
        }) : m34isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                long IntSize = IntSizeKt.IntSize(it, it);
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(m31calculateOffsetemnUabE)) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                int m5433getHeightimpl = IntSize.m5433getHeightimpl(m32getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m32getCurrentSizeYbymL2g2 = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5433getHeightimpl - IntOffset.m5393getYimpl(m31calculateOffsetemnUabE)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m23getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                ...
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5393getYimpl(m31calculateOffsetemnUabE)) - it));
            }
    ...
    private final boolean m33isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m25getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m34isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m31calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2621alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo13slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(m31calculateOffsetemnUabE)) - it));
            }
        }) : m34isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(m31calculateOffsetemnUabE)) + IntSize.m5434getWidthimpl(targetSize)));
            }
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5393getYimpl(m31calculateOffsetemnUabE)) + IntSize.m5433getHeightimpl(targetSize)));
            }
    ...
    public final void m36setMeasuredSizeozmzZPI$animation_release(long j) {
        ...
        $this$setValue$iv.setValue(IntSize.m5426boximpl(j));
    }
    ...
    public final long m32getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().getPackedValue() : m35getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            Intrinsics.checkNotNullParameter(measure, "$this$measure");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            final Placeable mo4225measureBRTryo0 = measurable.mo4225measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo75createAnimationSpecTemP2vQ = value.mo75createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo75createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5426boximpl(m38invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m38invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo2621alignKFBX0sM = this.this$0.getContentAlignment().mo2621alignKFBX0sM(IntSizeKt.IntSize(mo4225measureBRTryo0.getWidth(), mo4225measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.CC.layout$default(measure, IntSize.m5434getWidthimpl(animate.getValue().getPackedValue()), IntSize.m5433getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4284place70tqf50$default(layout, Placeable.this, mo2621alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
