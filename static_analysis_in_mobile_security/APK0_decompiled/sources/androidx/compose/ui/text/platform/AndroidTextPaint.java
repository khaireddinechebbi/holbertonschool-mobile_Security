...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        if (shadow != null && !Intrinsics.areEqual(this.shadow, shadow)) {
            ...
            if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
                ...
                setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2731getXimpl(this.shadow.getOffset()), Offset.m2732getYimpl(this.shadow.getOffset()), ColorKt.m3025toArgb8_81llA(this.shadow.getColor()));
            }
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5008setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
            this.composePaint.mo2852setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m5004setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m5007setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:10:0x0049, code lost:
    
        r9.mo2918applyToPq9zytI(r10, r0, r1);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0042, code lost:
        ...
        r1 = kotlin.ranges.RangesKt.coerceIn(r12, 0.0f, 1.0f);
     */
    /* JADX WARN: Code restructure failed: missing block: B:20:0x002f, code lost:
    
        if ((r10 != androidx.compose.ui.geometry.Size.INSTANCE.m2808getUnspecifiedNHjbRc()) != false) goto L17;
     */
    /* JADX WARN: Code restructure failed: missing block: B:6:0x001b, code lost:
    
        if ((r3 != androidx.compose.ui.graphics.Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 1 : 0) == 0) goto L9;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0039, code lost:
        ...
        if (java.lang.Float.isNaN(r12) == false) goto L20;
     */
    /* JADX WARN: Code restructure failed: missing block: B:9:0x003b, code lost:
    
        r1 = r8.composePaint.getAlpha();
     */
    ...
    */
    public final void m5007setBrush12SF9DM(androidx.compose.ui.graphics.Brush r9, long r10, float r12) {
        /*
            r8 = this;
        ...
        L1d:
            ...
            long r5 = r5.m2808getUnspecifiedNHjbRc()
            int r7 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r7 == 0) goto L2e
            goto L2f
        L2e:
        ...
        L31:
        L33:
            androidx.compose.ui.graphics.Paint r0 = r8.composePaint
            boolean r1 = java.lang.Float.isNaN(r12)
            if (r1 == 0) goto L42
            androidx.compose.ui.graphics.Paint r1 = r8.composePaint
            float r1 = r1.getAlpha()
            goto L49
        L42:
            r1 = 0
            r2 = 1065353216(0x3f800000, float:1.0)
            float r1 = kotlin.ranges.RangesKt.coerceIn(r12, r1, r2)
        L49:
            r9.mo2918applyToPq9zytI(r10, r0, r1)
            goto L55
        L4d:
        ...
        L55:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m5007setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        if (drawStyle != null && !Intrinsics.areEqual(this.drawStyle, drawStyle)) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                this.composePaint.mo2856setStylek9PVt8s(PaintingStyle.INSTANCE.m3238getFillTiuSbCo());
                return;
            }
            if (drawStyle instanceof Stroke) {
                this.composePaint.mo2856setStylek9PVt8s(PaintingStyle.INSTANCE.m3239getStrokeTiuSbCo());
                ...
                this.composePaint.mo2855setStrokeJoinWw9F2mQ(((Stroke) drawStyle).getJoin());
                this.composePaint.mo2854setStrokeCapBeK7IIE(((Stroke) drawStyle).getCap());
    ...
    public final int m5005getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m5006setBlendModes9anfk8(int i) {
        this.composePaint.mo2851setBlendModes9anfk8(i);
    }
}
