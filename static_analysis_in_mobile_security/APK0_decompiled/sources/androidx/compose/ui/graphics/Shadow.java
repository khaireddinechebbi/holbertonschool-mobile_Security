...
public final class Shadow {
    ...
    public static /* synthetic */ void m3293getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m3294getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m2747getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m2972equalsimpl0(this.color, ((Shadow) other).color) && Offset.m2728equalsimpl0(this.offset, ((Shadow) other).offset)) {
            return (this.blurRadius > ((Shadow) other).blurRadius ? 1 : (this.blurRadius == ((Shadow) other).blurRadius ? 0 : -1)) == 0;
        }
        return false;
    }

    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.color);
        return (((result * 31) + Offset.m2733hashCodeimpl(this.offset)) * 31) + Float.floatToIntBits(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2979toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m2739toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m3295copyqcb84PM(long color, long offset, float blurRadius) {
