...
public final class RippleAlpha {
    ...
    public int hashCode() {
        int result = Float.floatToIntBits(this.draggedAlpha);
        return (((((result * 31) + Float.floatToIntBits(this.focusedAlpha)) * 31) + Float.floatToIntBits(this.hoveredAlpha)) * 31) + Float.floatToIntBits(this.pressedAlpha);
    }
