...
public final class Strings {
    ...
    private static final int NavigationMenu = m1195constructorimpl(0);
    private static final int CloseDrawer = m1195constructorimpl(1);
    private static final int CloseSheet = m1195constructorimpl(2);
    private static final int DefaultErrorMessage = m1195constructorimpl(3);
    private static final int ExposedDropdownMenu = m1195constructorimpl(4);
    private static final int SliderRangeStart = m1195constructorimpl(5);
    private static final int SliderRangeEnd = m1195constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Strings m1194boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1195constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1196equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1197equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1198hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1199toStringimpl(int i) {
        return "Strings(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1196equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1198hashCodeimpl(this.value);
    }

    public String toString() {
        return m1199toStringimpl(this.value);
    }
