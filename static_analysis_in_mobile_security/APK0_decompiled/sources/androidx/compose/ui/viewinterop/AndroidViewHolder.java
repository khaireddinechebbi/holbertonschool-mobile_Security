...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (Constraints.m5220getMinWidthimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m5220getMinWidthimpl(constraints));
                }
                if (Constraints.m5219getMinHeightimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m5219getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                int m5220getMinWidthimpl = Constraints.m5220getMinWidthimpl(constraints);
                int m5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl(constraints);
                ViewGroup.LayoutParams layoutParams = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams);
                obtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(m5220getMinWidthimpl, m5218getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = AndroidViewHolder.this;
                int m5219getMinHeightimpl = Constraints.m5219getMinHeightimpl(constraints);
                int m5217getMaxHeightimpl = Constraints.m5217getMaxHeightimpl(constraints);
                ViewGroup.LayoutParams layoutParams2 = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams2);
                obtainMeasureSpec2 = androidViewHolder3.obtainMeasureSpec(m5219getMinHeightimpl, m5217getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long consumedByParent = nestedScrollDispatcher.m3991dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset2 = OffsetKt.Offset(composeOffset3, composeOffset4);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m3991dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset = OffsetKt.Offset(composeOffset, composeOffset2);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long consumedByParent = nestedScrollDispatcher.m3993dispatchPreScrollOzD1aCk(Offset, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2731getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2732getYimpl(consumedByParent));
        }
    }
