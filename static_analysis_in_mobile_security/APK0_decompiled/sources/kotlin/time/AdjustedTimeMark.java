...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6879minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m7025minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6878elapsedNowUwyO8pc() {
        return Duration.m6923minusLRDsOJo(this.mark.mo6878elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6881plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6924plusLRDsOJo(this.adjustment, duration), null);
    }
}
