...
public final class BottomSheetDefaults {
    ...
    private static final float Elevation = SheetBottomTokens.INSTANCE.m2441getDockedModalContainerElevationD9Ej5fM();
    private static final float SheetPeekHeight = Dp.m5274constructorimpl(56);
    ...
    public final float m1325getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        m2969copywmQWz5c = Color.m2969copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r2) : 0.32f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(ColorSchemeKt.toColor(ScrimTokens.INSTANCE.getContainerColor(), $composer, 6)) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final float m1326getSheetPeekHeightD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets m560onlybOOhFvg = WindowInsetsKt.m560onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.INSTANCE.m585getVerticalJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final void m1324DragHandlelgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final float height2;
        Shape shape2;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                width2 = i5 != 0 ? SheetBottomTokens.INSTANCE.m2440getDockedDragHandleWidthD9Ej5fM() : f;
                if (i6 != 0) {
                    height2 = SheetBottomTokens.INSTANCE.m2439getDockedDragHandleHeightD9Ej5fM();
                }
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                ...
                if ((i & 16) != 0) {
                    color2 = Color.m2969copywmQWz5c(r16, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r16) : 0.4f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r16) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r16) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(ColorSchemeKt.toColor(SheetBottomTokens.INSTANCE.getDockedDragHandleColor(), $composer2, 6)) : 0.0f);
                    $dirty &= -57345;
                } else {
                    color2 = j;
                }
            ...
            final String dragHandleDescription = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1735getBottomSheetDragHandleDescriptionadMyvUU(), $composer2, 6);
            f2 = SheetDefaultsKt.DragHandleVerticalPadding;
            Modifier m489paddingVpY3zN4$default = PaddingKt.m489paddingVpY3zN4$default(modifier3, 0.0f, f2, 1, null);
            ...
            SurfaceKt.m1806SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(m489paddingVpY3zN4$default, false, (Function1) value$iv$iv, 1, null), shape2, color2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer2, -1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        BoxKt.Box(SizeKt.m536sizeVpY3zN4(Modifier.INSTANCE, width2, height2), $composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$3
            ...
            public final void invoke(Composer composer, int i7) {
                BottomSheetDefaults.this.m1324DragHandlelgZ2HuY(modifier6, f3, f4, shape4, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
