...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4665toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.m2731getXimpl($this$toLocal_u2dMK_u2dHz9U), Offset.m2732getYimpl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        return $this$toGlobal.m2768translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        $this$toGlobal.mo2868translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4664toGlobalGEjPoXI(long $this$toGlobal_u2dGEjPoXI) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4768getStartimpl($this$toGlobal_u2dGEjPoXI)), toGlobalIndex(TextRange.m4763getEndimpl($this$toGlobal_u2dGEjPoXI)));
    }
}
