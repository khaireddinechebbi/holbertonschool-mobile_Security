...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object item$iv$iv : $this$map$iv) {
            ...
            destination$iv$iv.add(it.mo4225measureBRTryo0(constraints));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5426boximpl(IntSizeKt.IntSize(maxWidth, maxHeight)));
        return MeasureScope.CC.layout$default(measure, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedEnterExitMeasurePolicy$measure$1
