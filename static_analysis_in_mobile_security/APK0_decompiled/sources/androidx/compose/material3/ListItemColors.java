...
public final class ListItemColors {
    ...
    private ListItemColors(long containerColor, long headlineColor, long leadingIconColor, long overlineColor, long supportingTextColor, long trailingIconColor, long disabledHeadlineColor, long disabledLeadingIconColor, long disabledTrailingIconColor) {
        ...
        this.disabledHeadlineColor = disabledHeadlineColor;
    ...
    public final State<Color> containerColor$material3_release(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-380363090, $changed, -1, "androidx.compose.material3.ListItemColors.containerColor (ListItem.kt:347)");
        }
    ...
    public final State<Color> headlineColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1254314043, $changed, -1, "androidx.compose.material3.ListItemColors.headlineColor (ListItem.kt:353)");
        }
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.headlineColor : this.disabledHeadlineColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(694213044, $changed, -1, "androidx.compose.material3.ListItemColors.leadingIconColor (ListItem.kt:361)");
        }
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.leadingIconColor : this.disabledLeadingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> overlineColor$material3_release(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1467587733, $changed, -1, "androidx.compose.material3.ListItemColors.overlineColor (ListItem.kt:369)");
        }
    ...
    public final State<Color> supportingColor$material3_release(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1251828896, $changed, -1, "androidx.compose.material3.ListItemColors.supportingColor (ListItem.kt:375)");
        }
    ...
    public final State<Color> trailingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-778325338, $changed, -1, "androidx.compose.material3.ListItemColors.trailingIconColor (ListItem.kt:381)");
        }
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.trailingIconColor : this.disabledTrailingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
