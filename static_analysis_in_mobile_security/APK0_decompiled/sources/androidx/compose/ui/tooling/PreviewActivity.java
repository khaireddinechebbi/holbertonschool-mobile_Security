                    ...
                    ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer, 2137630662, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity$setParameterizedContent$1.1
                        ...
                        public final void invoke(Composer $composer2, int $changed2) {
                            ...
                            if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                                ...
                                Function2<Composer, Integer, Unit> m5187getLambda1$ui_tooling_release = ComposableSingletons$PreviewActivityKt.INSTANCE.m5187getLambda1$ui_tooling_release();
                                final MutableIntState mutableIntState = MutableIntState.this;
                                final Object[] objArr2 = objArr;
                                FloatingActionButtonKt.m1125ExtendedFloatingActionButtonwqdebIU(m5187getLambda1$ui_tooling_release, new Function0<Unit>() { // from class: androidx.compose.ui.tooling.PreviewActivity.setParameterizedContent.1.1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(0);
                                    }
