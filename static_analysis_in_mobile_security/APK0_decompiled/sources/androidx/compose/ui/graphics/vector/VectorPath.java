...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.fillAlpha == ((VectorPath) other).fillAlpha) || !Intrinsics.areEqual(this.stroke, ((VectorPath) other).stroke)) {
            return false;
        }
        if (!(this.strokeAlpha == ((VectorPath) other).strokeAlpha)) {
            return false;
        }
        if (!(this.strokeLineWidth == ((VectorPath) other).strokeLineWidth) || !StrokeCap.m3320equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m3330equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if ((this.trimPathOffset == ((VectorPath) other).trimPathOffset) && PathFillType.m3250equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual(this.pathData, ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result3 = (((result2 + (brush != null ? brush.hashCode() : 0)) * 31) + Float.floatToIntBits(this.fillAlpha)) * 31;
        Brush brush2 = this.stroke;
        return ((((((((((((((((((result3 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.floatToIntBits(this.strokeAlpha)) * 31) + Float.floatToIntBits(this.strokeLineWidth)) * 31) + StrokeCap.m3321hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3331hashCodeimpl(this.strokeLineJoin)) * 31) + Float.floatToIntBits(this.strokeLineMiter)) * 31) + Float.floatToIntBits(this.trimPathStart)) * 31) + Float.floatToIntBits(this.trimPathEnd)) * 31) + Float.floatToIntBits(this.trimPathOffset)) * 31) + PathFillType.m3251hashCodeimpl(this.pathFillType);
    }
}
