...
public final class FilledAutocompleteTokens {
    ...
    private static final float MenuContainerElevation = ElevationTokens.INSTANCE.m2149getLevel2D9Ej5fM();
    private static final ShapeKeyTokens MenuContainerShape = ShapeKeyTokens.CornerExtraSmall;
    private static final ColorSchemeKeyTokens MenuContainerSurfaceTintLayerColor = ColorSchemeKeyTokens.SurfaceTint;
    private static final ColorSchemeKeyTokens MenuDividerColor = ColorSchemeKeyTokens.SurfaceVariant;
    private static final float MenuDividerHeight = Dp.m5274constructorimpl((float) 1.0d);
    private static final float MenuListItemContainerHeight = Dp.m5274constructorimpl((float) 48.0d);
    private static final ColorSchemeKeyTokens MenuListItemLabelTextColor = ColorSchemeKeyTokens.OnSurface;
    private static final TypographyKeyTokens MenuListItemLabelTextFont = TypographyKeyTokens.LabelLarge;
    private static final ColorSchemeKeyTokens MenuListItemSelectedContainerColor = ColorSchemeKeyTokens.SurfaceVariant;
    private static final ColorSchemeKeyTokens TextFieldActiveIndicatorColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float TextFieldActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    private static final ColorSchemeKeyTokens TextFieldCaretColor = ColorSchemeKeyTokens.Primary;
    private static final ColorSchemeKeyTokens TextFieldContainerColor = ColorSchemeKeyTokens.SurfaceVariant;
    private static final float TextFieldContainerHeight = Dp.m5274constructorimpl((float) 56.0d);
    ...
    private static final float TextFieldDisabledActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float TextFieldFocusActiveIndicatorHeight = Dp.m5274constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldHoverActiveIndicatorHeight = Dp.m5274constructorimpl((float) 1.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m5274constructorimpl((float) 20.0d);
    ...
    private static final float TextFieldTrailingIconSize = Dp.m5274constructorimpl((float) 24.0d);
    ...
    public final float m2207getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m2208getMenuDividerHeightD9Ej5fM() {
        return MenuDividerHeight;
    }

    /* renamed from: getMenuListItemContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2209getMenuListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2210getTextFieldActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2211getTextFieldContainerHeightD9Ej5fM() {
    ...
    public final float m2212getTextFieldDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2213getTextFieldFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2214getTextFieldHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2215getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2216getTextFieldTrailingIconSizeD9Ej5fM() {
