...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m534size3ABfNKs(Modifier.INSTANCE, IconButtonTokens.INSTANCE.m2266getIconSizeD9Ej5fM());

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1568Iconww6aTOc(final ImageVector imageVector, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long tint2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    ...
                    $dirty &= -7169;
                    tint2 = ((Color) consume).m2981unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 8) != 0) {
            ...
            m1567Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer2, $dirty & 14), contentDescription, modifier3, tint2, $composer2, VectorPainter.$stable | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$1
            ...
            public final void invoke(Composer composer, int i4) {
                IconKt.m1568Iconww6aTOc(ImageVector.this, contentDescription, modifier5, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1566Iconww6aTOc(final ImageBitmap bitmap, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long tint2;
        int $dirty;
        ...
        if ((i & 8) == 0) {
            ...
            Object consume = $composer2.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            long tint3 = ((Color) consume).m2981unboximpl();
        ...
        m1567Iconww6aTOc(painter, contentDescription, modifier2, tint2, $composer2, ($dirty & 112) | 8 | ($dirty & 896) | ($dirty & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = $composer2.endRestartGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$2
            ...
            public final void invoke(Composer composer, int i2) {
                IconKt.m1566Iconww6aTOc(ImageBitmap.this, contentDescription, modifier3, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1567Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        final long tint2;
        int $dirty;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$3
            ...
            public final void invoke(Composer composer, int i3) {
                IconKt.m1567Iconww6aTOc(Painter.this, contentDescription, modifier3, tint2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        Modifier.Companion companion;
        if (Size.m2796equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m2808getUnspecifiedNHjbRc()) || m1569isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
    ...
    private static final boolean m1569isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
