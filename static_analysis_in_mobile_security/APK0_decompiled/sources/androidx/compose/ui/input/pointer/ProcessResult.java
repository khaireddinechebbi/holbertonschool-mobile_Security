...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m4189boximpl(int i) {
        return new ProcessResult(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4190constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4191equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4192equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4195hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4196toStringimpl(int i) {
    ...
    public int hashCode() {
        return m4195hashCodeimpl(this.value);
    }

    public String toString() {
        return m4196toStringimpl(this.value);
    }
    ...
    public static final boolean m4194getDispatchedToAPointerInputModifierimpl(int arg0) {
        return (arg0 & 1) != 0;
    }

    /* renamed from: getAnyMovementConsumed-impl, reason: not valid java name */
    public static final boolean m4193getAnyMovementConsumedimpl(int arg0) {
        return (arg0 & 2) != 0;
    }
}
