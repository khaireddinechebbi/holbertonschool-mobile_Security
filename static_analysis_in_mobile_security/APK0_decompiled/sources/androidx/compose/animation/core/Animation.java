...
public interface Animation<T, V extends AnimationVector> {
    ...
    boolean isFinishedFromNanos(long playTimeNanos);
    ...
    public final /* synthetic */ class CC {
        public static boolean $default$isFinishedFromNanos(Animation _this, long playTimeNanos) {
            return playTimeNanos >= _this.getDurationNanos();
        }
    }
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <T, V extends AnimationVector> boolean isFinishedFromNanos(Animation<T, V> animation, long playTimeNanos) {
            return CC.$default$isFinishedFromNanos(animation, playTimeNanos);
        }
    }
}
