                            ...
                            if (focusEventNode.getNode().getIsAttached()) {
                                ...
                                while (node != null) {
                                    ...
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (((this_$iv$iv$iv4.getKindSet() & m4443constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                            int count$iv$iv5 = 0;
                                ...
                                it = it8;
                                int mask$iv$iv = m4443constructorimpl;
                                            ...
                                            if ((node$iv$iv.getKindSet() & mask$iv$iv) != 0) {
                                                ...
                                                while (node2 != null) {
                                                    ...
                                                    if (node2 instanceof FocusTargetNode) {
                                                        ...
                                                        if (((this_$iv$iv$iv7.getKindSet() & m4443constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                                                            int count$iv$iv6 = 0;
                                                            ...
                                                            while (node$iv$iv$iv2 != null) {
                                                                ...
                                                                if ((next$iv$iv2.getKindSet() & m4443constructorimpl) != 0) {
                                                                    count$iv$iv6++;
