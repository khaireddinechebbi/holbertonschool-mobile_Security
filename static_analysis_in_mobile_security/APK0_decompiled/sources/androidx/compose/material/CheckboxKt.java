...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m5274constructorimpl(24);
    private static final float CheckboxDefaultPadding = Dp.m5274constructorimpl(2);
    private static final float CheckboxSize = Dp.m5274constructorimpl(20);
    private static final float StrokeWidth = Dp.m5274constructorimpl(2);
    private static final float RadiusSize = Dp.m5274constructorimpl(2);
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors3 = CheckboxDefaults.INSTANCE.m1026colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty &= -458753;
                } else {
                    colors3 = colors;
                }
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors2 = CheckboxDefaults.INSTANCE.m1026colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty = $dirty3 & (-458753);
                    modifier3 = modifier4;
                    enabled2 = enabled3;
                    interactionSource3 = interactionSource2;
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                companion = ToggleableKt.m727triStateToggleableO2vRcR0(Modifier.INSTANCE, state, interactionSource3, RippleKt.m1298rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m4603boximpl(Role.INSTANCE.m4611getCheckboxo7Vup1c()), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m487padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void CheckboxImpl(final boolean enabled, final ToggleableState value, final Modifier modifier, final CheckboxColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2118895727, $dirty3, -1, "androidx.compose.material.CheckboxImpl (Checkbox.kt:258)");
            }
            Transition transition = TransitionKt.updateTransition(value, (String) null, $composer2, ($dirty3 >> 3) & 14, 2);
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State checkColor$delegate = colors.checkmarkColor(value, $composer2, (($dirty3 >> 3) & 14) | (($dirty3 >> 6) & 112));
                    final State boxColor$delegate = colors.boxColor(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    final State borderColor$delegate = colors.borderColor(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    Modifier m526requiredSize3ABfNKs = SizeKt.m526requiredSize3ABfNKs(SizeKt.wrapContentSize$default(modifier, Alignment.INSTANCE.getCenter(), false, 2, null), CheckboxSize);
                    ...
                    if (invalid$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                float strokeWidthPx = (float) Math.floor(Canvas.mo327toPx0680j_4(f5));
                                ...
                                CheckboxKt.m1029drawBox1wkBAMs(Canvas, CheckboxImpl$lambda$9, CheckboxImpl$lambda$10, Canvas.mo327toPx0680j_4(f6), strokeWidthPx);
                                ...
                                CheckboxKt.m1030drawCheck3IgeMak(Canvas, CheckboxImpl$lambda$8, CheckboxImpl$lambda$4, CheckboxImpl$lambda$6, strokeWidthPx, CheckDrawingCache.this);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    } else {
                    ...
                    $composer2.endReplaceableGroup();
                    CanvasKt.Canvas(m526requiredSize3ABfNKs, (Function1) value$iv$iv2, $composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        break;
                    }
    ...
    public static final void m1029drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        float halfStrokeWidth = strokeWidth / 2.0f;
        Stroke stroke = new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null);
        float checkboxSize = Size.m2800getWidthimpl($this$drawBox_u2d1wkBAMs.mo3442getSizeNHjbRc());
        if (Color.m2972equalsimpl0(boxColor, borderColor)) {
            DrawScope.CC.m3524drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, 0L, androidx.compose.ui.geometry.SizeKt.Size(checkboxSize, checkboxSize), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f = 2;
        DrawScope.CC.m3524drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, OffsetKt.Offset(strokeWidth, strokeWidth), androidx.compose.ui.geometry.SizeKt.Size(checkboxSize - (strokeWidth * f), checkboxSize - (f * strokeWidth)), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, radius - strokeWidth), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
    ...
    public static final void m1030drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
        Stroke stroke = new Stroke(strokeWidthPx, 0.0f, StrokeCap.INSTANCE.m3326getSquareKaPHkGw(), 0, null, 26, null);
        float width = Size.m2800getWidthimpl($this$drawCheck_u2d3IgeMak.mo3442getSizeNHjbRc());
        ...
        DrawScope.CC.m3518drawPathLG529CI$default($this$drawCheck_u2d3IgeMak, drawingCache.getPathToDraw(), checkColor, 0.0f, stroke, null, 0, 52, null);
    }
}
