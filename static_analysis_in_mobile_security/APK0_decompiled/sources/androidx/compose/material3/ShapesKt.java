...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape $this$top) {
        ...
        return CornerBasedShape.copy$default($this$top, null, null, CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), 3, null);
    }
    ...
    public static final CornerBasedShape bottom(CornerBasedShape $this$bottom) {
        ...
        return CornerBasedShape.copy$default($this$bottom, CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape $this$start) {
        Intrinsics.checkNotNullParameter($this$start, "<this>");
        return CornerBasedShape.copy$default($this$start, null, CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape $this$end) {
        Intrinsics.checkNotNullParameter($this$end, "<this>");
        return CornerBasedShape.copy$default($this$end, CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), null, null, CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl((float) 0.0d)), 6, null);
    }
