...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m952getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if (textLayoutResult != null) {
            long textRange = TextRangeKt.TextRange(rawStartOffset, rawEndOffset);
            if (previousSelection == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.INSTANCE.getCharacter())) {
                return textRange;
            }
            return adjustment.mo900adjustZXO7KMw(textLayoutResult, textRange, -1, isStartHandle, previousSelection);
        }
