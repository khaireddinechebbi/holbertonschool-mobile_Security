...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m5112getProportionalPIaL0Z0(), Trim.INSTANCE.m5123getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LineHeightStyle) && Alignment.m5106equalsimpl0(this.alignment, ((LineHeightStyle) other).alignment) && Trim.m5117equalsimpl0(this.trim, ((LineHeightStyle) other).trim);
    }

    public int hashCode() {
        int result = Alignment.m5107hashCodeimpl(this.alignment);
        return (result * 31) + Trim.m5118hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m5108toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m5121toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m5115constructorimpl(1);
        private static final int LastLineBottom = m5115constructorimpl(16);
        private static final int Both = m5115constructorimpl(17);
        private static final int None = m5115constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m5114boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m5115constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5116equalsimpl(int i, Object obj) {
            return (obj instanceof Trim) && i == ((Trim) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5117equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5118hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object obj) {
            return m5116equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m5118hashCodeimpl(this.value);
        }
        ...
        public static String m5121toStringimpl(int arg0) {
        ...
        public static final class Companion {
            ...
            public final int m5124getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m5125getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m5123getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m5126getNoneEVpEnUU() {
                return Trim.None;
            }
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5119isTrimFirstLineTopimpl$ui_text_release(int arg0) {
            return (arg0 & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5120isTrimLastLineBottomimpl$ui_text_release(int arg0) {
            return (arg0 & 16) > 0;
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m5104constructorimpl(0.0f);
        private static final float Center = m5104constructorimpl(0.5f);
        private static final float Proportional = m5104constructorimpl(-1.0f);
        private static final float Bottom = m5104constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m5103boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5105equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5106equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5107hashCodeimpl(float f) {
            return Float.floatToIntBits(f);
        }

        public boolean equals(Object obj) {
            return m5105equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m5107hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m5104constructorimpl(float topRatio) {
            boolean z = true;
        ...
        public String toString() {
            return m5108toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5108toStringimpl(float arg0) {
            if (arg0 == Top) {
        ...
        public static final class Companion {
            ...
            public final float m5113getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m5111getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m5112getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m5110getBottomPIaL0Z0() {
