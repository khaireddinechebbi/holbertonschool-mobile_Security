...
public interface SubcomposeIntermediateMeasureScope extends SubcomposeMeasureScope {
    ...
    public final /* synthetic */ class CC {
        public static List $default$subcompose(SubcomposeIntermediateMeasureScope _this, Object slotId, Function2 content) {
            Intrinsics.checkNotNullParameter(content, "content");
            return _this.measurablesForSlot(slotId);
        }
    }
}
