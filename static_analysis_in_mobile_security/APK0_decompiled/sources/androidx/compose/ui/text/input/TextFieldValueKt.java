...
public final class TextFieldValueKt {
    public static final AnnotatedString getTextBeforeSelection(TextFieldValue $this$getTextBeforeSelection, int maxChars) {
        ...
        return $this$getTextBeforeSelection.getText().subSequence(Math.max(0, TextRange.m4766getMinimpl($this$getTextBeforeSelection.getSelection()) - maxChars), TextRange.m4766getMinimpl($this$getTextBeforeSelection.getSelection()));
    }
    ...
    public static final AnnotatedString getTextAfterSelection(TextFieldValue $this$getTextAfterSelection, int maxChars) {
        ...
        return $this$getTextAfterSelection.getText().subSequence(TextRange.m4765getMaximpl($this$getTextAfterSelection.getSelection()), Math.min(TextRange.m4765getMaximpl($this$getTextAfterSelection.getSelection()) + maxChars, $this$getTextAfterSelection.getText().length()));
    }
    ...
    public static final AnnotatedString getSelectedText(TextFieldValue $this$getSelectedText) {
        ...
        return $this$getSelectedText.getText().m4643subSequence5zctL8($this$getSelectedText.getSelection());
    }
}
