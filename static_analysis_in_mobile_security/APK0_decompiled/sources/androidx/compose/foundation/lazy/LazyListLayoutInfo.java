...
public interface LazyListLayoutInfo {
    ...
    long mo589getViewportSizeYbymL2g();
    ...
    public final /* synthetic */ class CC {
        ...
        public static long m591$default$getViewportSizeYbymL2g(LazyListLayoutInfo _this) {
    ...
    public static final class DefaultImpls {
        ...
        public static long m593getViewportSizeYbymL2g(LazyListLayoutInfo $this) {
            return CC.m591$default$getViewportSizeYbymL2g($this);
        }

        @Deprecated
        public static Orientation getOrientation(LazyListLayoutInfo $this) {
            return CC.$default$getOrientation($this);
        }

        @Deprecated
        public static boolean getReverseLayout(LazyListLayoutInfo $this) {
            return CC.$default$getReverseLayout($this);
        }

        @Deprecated
        public static int getBeforeContentPadding(LazyListLayoutInfo $this) {
            return CC.$default$getBeforeContentPadding($this);
        }

        @Deprecated
        public static int getAfterContentPadding(LazyListLayoutInfo $this) {
            return CC.$default$getAfterContentPadding($this);
        }

        @Deprecated
        public static int getMainAxisItemSpacing(LazyListLayoutInfo $this) {
            return CC.$default$getMainAxisItemSpacing($this);
        }
    }
}
