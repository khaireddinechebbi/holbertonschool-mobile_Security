...
public class MutableIntState implements StateObject, androidx.compose.runtime.MutableIntState, SnapshotMutableState<Integer> {
    ...
    public /* synthetic */ Integer getValue() {
        return MutableIntState.CC.$default$getValue((androidx.compose.runtime.MutableIntState) this);
    }
    ...
    public void setIntValue(int value) {
        ...
        if (it.getValue() != value) {
            ...
            synchronized (lock$iv$iv$iv) {
                ...
                IntStateStateRecord $this$_set_intValue__u24lambda_u241_u24lambda_u240 = (IntStateStateRecord) SnapshotKt.overwritableRecord($this$overwritable$iv, this, current, it);
                $this$_set_intValue__u24lambda_u241_u24lambda_u240.setValue(value);
