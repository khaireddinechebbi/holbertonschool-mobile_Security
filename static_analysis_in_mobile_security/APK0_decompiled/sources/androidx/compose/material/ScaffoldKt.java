...
public final class ScaffoldKt {
    ...
    */
    public static final void m1181Scaffold27mzLpw(androidx.compose.ui.Modifier r54, androidx.compose.material.ScaffoldState r55, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r56, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r57, kotlin.jvm.functions.Function3<? super androidx.compose.material.SnackbarHostState, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r58, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r59, int r60, boolean r61, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r62, boolean r63, androidx.compose.ui.graphics.Shape r64, float r65, long r66, long r68, long r70, long r72, long r74, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.PaddingValues, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r76, androidx.compose.runtime.Composer r77, final int r78, final int r79, final int r80) {
        /*
            Method dump skipped, instructions count: 1377
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ScaffoldKt.m1181Scaffold27mzLpw(androidx.compose.ui.Modifier, androidx.compose.material.ScaffoldState, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, int, boolean, kotlin.jvm.functions.Function3, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: ScaffoldLayout-MDYNRJg, reason: not valid java name */
    public static final void m1182ScaffoldLayoutMDYNRJg(final boolean isFabDocked, final int fabPosition, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, Composer $composer, final int $changed) {
        int i;
        ...
        if ((2995931 & $dirty2) != 599186 || !$composer2.getSkipping()) {
            ...
            Object[] keys$iv = {function2, function22, function23, FabPosition.m1111boximpl(fabPosition), Boolean.valueOf(isFabDocked), function24, function3};
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public final MeasureResult m1184invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        looseConstraints = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : 0);
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                if (!fabPlaceables.isEmpty()) {
                                    ...
                                    if (fabWidth == 0 || fabHeight == 0) {
                                        ...
                                        if (!FabPosition.m1114equalsimpl0(i2, FabPosition.INSTANCE.m1119getEnd5ygKITE())) {
                                            ...
                                            fabLeftOffset = (i5 - subcomposeMeasureScope.mo321roundToPx0680j_4(f4)) - fabWidth;
                                        } else {
                                            SubcomposeMeasureScope subcomposeMeasureScope2 = SubcomposeMeasureScope.this;
                                            f3 = ScaffoldKt.FabSpacing;
                                            fabLeftOffset = subcomposeMeasureScope2.mo321roundToPx0680j_4(f3);
                                        }
                                ...
                                List $this$fastMap$iv4 = subcomposeMeasureScope3.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(1529070963, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(FabPlacement.this)}, function29, $composer3, ((i6 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                if (fabPlacement2 != null) {
                                    ...
                                    if (bottomBarHeight == 0) {
                                        ...
                                        i4 = height3 + subcomposeMeasureScope4.mo321roundToPx0680j_4(f2);
                                    } else if (z2) {
                                        i4 = bottomBarHeight + (fabPlacement2.getHeight() / 2);
                                    } else {
                                        int height4 = fabPlacement2.getHeight() + bottomBarHeight;
                                        f = ScaffoldKt.FabSpacing;
                                        i4 = height4 + subcomposeMeasureScope4.mo321roundToPx0680j_4(f);
                                    }
                                ...
                                List $this$fastMap$iv5 = subcomposeMeasureScope5.subcompose(scaffoldLayoutContent2, ComposableLambdaKt.composableLambdaInstance(-1132241596, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1$1$bodyContentPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            PaddingValues innerPadding = PaddingKt.m484PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, SubcomposeMeasureScope.this.mo324toDpu2uoSUM(bottomBarHeight), 7, null);
                                            function33.invoke(innerPadding, $composer3, Integer.valueOf((i7 >> 6) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                while ($i$f$fastMap5 < size5) {
                                    ...
                                    long j6 = j5;
                                    m5208copyZbe2FdA = Constraints.m5208copyZbe2FdA(r20, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(r20) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(r20) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(r20) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(j5) : bodyContentHeight);
                                    target$iv5.add(it14.mo4225measureBRTryo0(m5208copyZbe2FdA));
                                    $i$f$fastMap5++;
                                    size5 = size5;
                                ...
                                while (index$iv3 < size8) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it17, 0, i8 - snackbarOffsetFromBottom, 0.0f, 4, null);
                                    index$iv3++;
                                    size8 = size8;
                                ...
                                while (index$iv4 < size9) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it18, 0, i9 - bottomBarHeight2, 0.0f, 4, null);
                                    index$iv4++;
                                    size9 = size9;
                                ...
                                while (index$iv5 < size10) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it19, fabPlacement2 != null ? fabPlacement2.getLeft() : 0, i10 - (fabOffsetFromBottom != null ? fabOffsetFromBottom.intValue() : 0), 0.0f, 4, null);
                                    index$iv5++;
                                    size10 = size10;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer, int i2) {
                ScaffoldKt.m1182ScaffoldLayoutMDYNRJg(isFabDocked, fabPosition, function2, function3, function22, function23, function24, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
