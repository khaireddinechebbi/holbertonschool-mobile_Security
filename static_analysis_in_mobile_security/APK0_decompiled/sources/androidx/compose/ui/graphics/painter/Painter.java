...
public abstract class Painter {
    ...
    public abstract long mo3594getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3599drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        ...
        painter.m3600drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3600drawx_KDEd0(DrawScope draw, long size, float alpha, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float right$iv = Size.m2800getWidthimpl(draw.mo3442getSizeNHjbRc()) - Size.m2800getWidthimpl(size);
        float bottom$iv = Size.m2797getHeightimpl(draw.mo3442getSizeNHjbRc()) - Size.m2797getHeightimpl(size);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, right$iv, bottom$iv);
        if (alpha > 0.0f && Size.m2800getWidthimpl(size) > 0.0f && Size.m2797getHeightimpl(size) > 0.0f) {
            if (this.useLayer) {
                Rect layerRect = RectKt.m2771Recttz77jQw(Offset.INSTANCE.m2747getZeroF1C5BW0(), SizeKt.Size(Size.m2800getWidthimpl(size), Size.m2797getHeightimpl(size)));
