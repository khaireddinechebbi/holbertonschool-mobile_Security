...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2788boximpl(Size.INSTANCE.m2809getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3620getSizeNHjbRc$ui_release() {
        State $this$getValue$iv = this.size;
        return ((Size) $this$getValue$iv.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m3621setSizeuvyYCjk$ui_release(long j) {
        MutableState $this$setValue$iv = this.size;
        $this$setValue$iv.setValue(Size.m2788boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m3620getSizeNHjbRc$ui_release();
    }
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        ...
        if (!getAutoMirror$ui_release() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long pivot$iv$iv = $this$onDraw.mo3441getCenterF1C5BW0();
            DrawContext $this$withTransform_u24lambda_u246$iv$iv$iv = $this$onDraw.getDrawContext();
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u246$iv$iv$iv.mo3448getSizeNHjbRc();
            ...
            $this$scale_Fgt4K4Q_u24lambda_u242$iv$iv.mo3455scale0AR0LA0(-1.0f, 1.0f, pivot$iv$iv);
            ...
            $this$withTransform_u24lambda_u246$iv$iv$iv.mo3449setSizeuvyYCjk(previousSize$iv$iv$iv);
        }
        if (isDirty()) {
            setDirty(false);
        }
