...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;
    ...
    .local v1, "this":Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->L$0:Ljava/lang/Object;
    ...
    new-instance v9, Landroidx/compose/material/RangeSliderLogic;

    .line 977
    iget-object v4, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$startInteractionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    .line 978
    iget-object v5, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$endInteractionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    .line 979
    iget-object v6, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$rawOffsetStart:Landroidx/compose/runtime/State;

    .line 980
    iget-object v7, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$rawOffsetEnd:Landroidx/compose/runtime/State;

    .line 981
    iget-object v8, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$onDrag:Landroidx/compose/runtime/State;

    .line 976
    move-object v3, v9

    invoke-direct/range {v3 .. v8}, Landroidx/compose/material/RangeSliderLogic;-><init>(Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;)V

    move-object v7, v9

    .line 983
    .local v7, "rangeSliderLogic":Landroidx/compose/material/RangeSliderLogic;
    new-instance v13, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1$1;

    iget-boolean v5, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$isRtl:Z

    iget v6, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$maxPx:F

    iget-object v8, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$rawOffsetStart:Landroidx/compose/runtime/State;

    iget-object v9, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$gestureEndAction:Landroidx/compose/runtime/State;

    iget-object v10, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$rawOffsetEnd:Landroidx/compose/runtime/State;

    iget-object v11, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->$onDrag:Landroidx/compose/runtime/State;
    ...
    iput v4, v1, Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;->label:I
    ...
    .end local v7    # "rangeSliderLogic":Landroidx/compose/material/RangeSliderLogic;
    if-ne v2, v0, :cond_0
    ...
    .line 1035
    .end local v1    # "this":Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;
    .restart local v0    # "this":Landroidx/compose/material/SliderKt$rangeSliderPressDragModifier$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
