        ...
        */
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Offset m2720boximpl = Offset.m2720boximpl(this.$down.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m2720boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                        PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                        Offset m2720boximpl = Offset.m2720boximpl(this.$secondDown.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m2720boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
        ...
        static final class AnonymousClass9 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                secondUp.consume();
                BuildersKt__Builders_commonKt.launch$default(anonymousClass9.$$this$coroutineScope, null, null, new C00091(anonymousClass9.$pressScope, null), 3, null);
