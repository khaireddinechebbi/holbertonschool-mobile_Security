    ...
    */
    ...
    public Shader mo2940createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2752isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2810getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset((Offset.m2731getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2731getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2800getWidthimpl(size) : Offset.m2731getXimpl(this.center), Offset.m2732getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2797getHeightimpl(size) : Offset.m2732getYimpl(this.center));
        }
        return ShaderKt.m3290SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
