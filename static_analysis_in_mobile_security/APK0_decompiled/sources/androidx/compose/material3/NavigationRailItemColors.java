...
public final class NavigationRailItemColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m2972equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m2972equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m2972equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m2972equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m2972equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m2972equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m2972equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((result * 31) + Color.m2978hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2978hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2978hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2978hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m2978hashCodeimpl(this.disabledIconColor)) * 31) + Color.m2978hashCodeimpl(this.disabledTextColor);
    }
}
