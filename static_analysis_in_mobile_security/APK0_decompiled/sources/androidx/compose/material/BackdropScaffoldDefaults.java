...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m5274constructorimpl(56);
    private static final float HeaderHeight = Dp.m5274constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m5274constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m984getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM, reason: not valid java name */
    public final float m983getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl(16)), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m982getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        m2969copywmQWz5c = Color.m2969copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r1) : 0.6f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1052getSurface0d7_KjU()) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
