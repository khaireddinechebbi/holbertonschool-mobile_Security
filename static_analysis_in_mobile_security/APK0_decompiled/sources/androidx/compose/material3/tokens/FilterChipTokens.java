...
public final class FilterChipTokens {
    ...
    private static final float ContainerHeight = Dp.m5274constructorimpl((float) 32.0d);
    ...
    private static final float DraggedContainerElevation = ElevationTokens.INSTANCE.m2151getLevel4D9Ej5fM();
    private static final float ElevatedContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final ColorSchemeKeyTokens ElevatedDisabledContainerColor = ColorSchemeKeyTokens.OnSurface;
    private static final float ElevatedDisabledContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final float ElevatedFocusContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final float ElevatedHoverContainerElevation = ElevationTokens.INSTANCE.m2149getLevel2D9Ej5fM();
    private static final float ElevatedPressedContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    ...
    private static final float FlatContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    ...
    private static final float FlatSelectedFocusContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final float FlatSelectedHoverContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final float FlatSelectedOutlineWidth = Dp.m5274constructorimpl((float) 0.0d);
    private static final float FlatSelectedPressedContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final float FlatUnselectedFocusContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens FlatUnselectedFocusOutlineColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float FlatUnselectedHoverContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens FlatUnselectedOutlineColor = ColorSchemeKeyTokens.Outline;
    private static final float FlatUnselectedOutlineWidth = Dp.m5274constructorimpl((float) 1.0d);
    private static final float FlatUnselectedPressedContainerElevation = ElevationTokens.INSTANCE.m2147getLevel0D9Ej5fM();
    ...
    public final float m2249getContainerHeightD9Ej5fM() {
    ...
    public final float m2250getDraggedContainerElevationD9Ej5fM() {
        return DraggedContainerElevation;
    }

    /* renamed from: getElevatedContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2251getElevatedContainerElevationD9Ej5fM() {
    ...
    public final float m2252getElevatedDisabledContainerElevationD9Ej5fM() {
    ...
    public final float m2253getElevatedFocusContainerElevationD9Ej5fM() {
        return ElevatedFocusContainerElevation;
    }

    /* renamed from: getElevatedHoverContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2254getElevatedHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2255getElevatedPressedContainerElevationD9Ej5fM() {
    ...
    public final float m2256getFlatContainerElevationD9Ej5fM() {
    ...
    public final float m2257getFlatSelectedFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2261getFlatUnselectedFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2262getFlatUnselectedHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2263getFlatUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2264getFlatUnselectedPressedContainerElevationD9Ej5fM() {
