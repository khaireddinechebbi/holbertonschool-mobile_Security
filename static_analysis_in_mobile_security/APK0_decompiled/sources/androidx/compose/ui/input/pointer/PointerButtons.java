...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m4039boximpl(int i) {
    ...
    public static boolean m4041equalsimpl(int i, Object obj) {
        return (obj instanceof PointerButtons) && i == ((PointerButtons) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4042equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4043hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4044toStringimpl(int i) {
    ...
    public int hashCode() {
        return m4043hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4044toStringimpl(this.packedValue);
    }
