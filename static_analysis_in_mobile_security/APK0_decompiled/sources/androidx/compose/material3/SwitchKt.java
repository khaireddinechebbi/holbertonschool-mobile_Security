...
public final class SwitchKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1828SwitchImpl0DmnUew(final androidx.compose.foundation.layout.BoxScope r64, final boolean r65, final boolean r66, final androidx.compose.material3.SwitchColors r67, final androidx.compose.runtime.State<java.lang.Float> r68, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r69, final androidx.compose.foundation.interaction.InteractionSource r70, final androidx.compose.ui.graphics.Shape r71, final float r72, final float r73, final float r74, androidx.compose.runtime.Composer r75, final int r76, final int r77) {
        /*
            Method dump skipped, instructions count: 1630
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwitchKt.m1828SwitchImpl0DmnUew(androidx.compose.foundation.layout.BoxScope, boolean, boolean, androidx.compose.material3.SwitchColors, androidx.compose.runtime.State, kotlin.jvm.functions.Function2, androidx.compose.foundation.interaction.InteractionSource, androidx.compose.ui.graphics.Shape, float, float, float, androidx.compose.runtime.Composer, int, int):void");
    }
