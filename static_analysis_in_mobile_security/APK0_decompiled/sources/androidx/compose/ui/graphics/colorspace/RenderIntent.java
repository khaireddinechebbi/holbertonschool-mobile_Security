...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3397constructorimpl(0);
    private static final int Relative = m3397constructorimpl(1);
    private static final int Saturation = m3397constructorimpl(2);
    private static final int Absolute = m3397constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3396boximpl(int i) {
    ...
    public static String m3401toStringimpl(int arg0) {
        return m3399equalsimpl0(arg0, Perceptual) ? "Perceptual" : m3399equalsimpl0(arg0, Relative) ? "Relative" : m3399equalsimpl0(arg0, Saturation) ? "Saturation" : m3399equalsimpl0(arg0, Absolute) ? "Absolute" : "Unknown";
    }
