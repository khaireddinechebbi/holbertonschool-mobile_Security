...
.method public getCoroutineContext()Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-virtual {v0}, Landroidx/compose/ui/layout/IntermediateLayoutModifierNode;->getCoroutineScope()Lkotlinx/coroutines/CoroutineScope;
...
.method public getLookaheadScopeCoordinates(Landroidx/compose/ui/layout/Placeable$PlacementScope;)Landroidx/compose/ui/layout/LayoutCoordinates;
    ...
    .local v0, "$this$_get_lookaheadScopeCoordinates__u24lambda_u241":Landroidx/compose/ui/layout/LookaheadScope;
    const/4 v1, 0x0

    .line 283
    .local v1, "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$lookaheadScopeCoordinates$1":I
    ...
    .line 282
    .end local v0    # "$this$_get_lookaheadScopeCoordinates__u24lambda_u241":Landroidx/compose/ui/layout/LookaheadScope;
    .end local v1    # "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$lookaheadScopeCoordinates$1":I
    nop
...
.method public synthetic intermediateLayout(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function4;)Landroidx/compose/ui/Modifier;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/layout/LookaheadScope$-CC;->$default$intermediateLayout(Landroidx/compose/ui/layout/LookaheadScope;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function4;)Landroidx/compose/ui/Modifier;
...
.method public synthetic localLookaheadPositionOf-dBAh8RU(Landroidx/compose/ui/layout/LayoutCoordinates;Landroidx/compose/ui/layout/LayoutCoordinates;)J
    ...
    invoke-static {p0, p1, p2}, Landroidx/compose/ui/layout/LookaheadScope$-CC;->$default$localLookaheadPositionOf-dBAh8RU(Landroidx/compose/ui/layout/LookaheadScope;Landroidx/compose/ui/layout/LayoutCoordinates;Landroidx/compose/ui/layout/LayoutCoordinates;)J
...
.method public onPlaced(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;)Landroidx/compose/ui/Modifier;
    ...
    .local v0, "$this$onPlaced_u24lambda_u242":Landroidx/compose/ui/layout/LookaheadScope;
    const/4 v1, 0x0

    .line 298
    .local v1, "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$onPlaced$1":I
    invoke-interface {v0, p1, p2}, Landroidx/compose/ui/layout/LookaheadScope;->onPlaced(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;)Landroidx/compose/ui/Modifier;

    move-result-object v0

    .line 297
    .end local v0    # "$this$onPlaced_u24lambda_u242":Landroidx/compose/ui/layout/LookaheadScope;
    .end local v1    # "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$onPlaced$1":I
    nop
...
.method public toLookaheadCoordinates(Landroidx/compose/ui/layout/LayoutCoordinates;)Landroidx/compose/ui/layout/LayoutCoordinates;
    ...
    .line 334
    .local v0, "$this$toLookaheadCoordinates_u24lambda_u240":Landroidx/compose/ui/layout/LookaheadScope;
    const/4 v1, 0x0

    .line 279
    .local v1, "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$toLookaheadCoordinates$1":I
    ...
    .end local v0    # "$this$toLookaheadCoordinates_u24lambda_u240":Landroidx/compose/ui/layout/LookaheadScope;
    .end local v1    # "$i$a$-with-IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$toLookaheadCoordinates$1":I
    return-object v0
.end method
