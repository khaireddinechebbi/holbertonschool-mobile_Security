...
public final class FocusChangedModifierKt {
    public static final Modifier onFocusChanged(Modifier $this$onFocusChanged, Function1<? super FocusState, Unit> onFocusChanged) {
        Intrinsics.checkNotNullParameter($this$onFocusChanged, "<this>");
        Intrinsics.checkNotNullParameter(onFocusChanged, "onFocusChanged");
        return $this$onFocusChanged.then(new FocusChangedElement(onFocusChanged));
    }
}
