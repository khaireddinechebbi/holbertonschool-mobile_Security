...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String label, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer $composer, int $changed, int i) {
        ...
        String label2 = (i & 2) != 0 ? "ColorAnimation" : label;
        ColorSpace colorSpace = Color.m2975getColorSpaceimpl(targetValueByState.invoke(transition.getTargetState(), $composer, Integer.valueOf(($changed >> 6) & 112)).m2981unboximpl());
    ...
    public static final State<Color> m78animateColorDTcfvLk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> animationSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m2975getColorSpaceimpl(targetValue));
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        ...
        State<Color> animateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2961boximpl(initialValue), Color.m2961boximpl(targetValue), converter, animationSpec, label2, $composer, InfiniteTransition.$stable | 4096 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m79animateColorRIQooxk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(animateColor, "$this$animateColor");
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        State<Color> m78animateColorDTcfvLk = m78animateColorDTcfvLk(animateColor, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m78animateColorDTcfvLk;
    }
}
