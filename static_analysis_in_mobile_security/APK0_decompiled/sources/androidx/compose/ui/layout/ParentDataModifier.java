...
public interface ParentDataModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static boolean all(ParentDataModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$all($this, predicate);
        }

        @Deprecated
        public static boolean any(ParentDataModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
        ...
        public static <R> R foldIn(ParentDataModifier parentDataModifier, R r, Function2<? super R, ? super Modifier.Element, ? extends R> operation) {
            ...
            return (R) Modifier.Element.CC.$default$foldIn(parentDataModifier, r, operation);
        }
        ...
        public static <R> R foldOut(ParentDataModifier parentDataModifier, R r, Function2<? super Modifier.Element, ? super R, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) Modifier.Element.CC.$default$foldOut(parentDataModifier, r, operation);
        }

        @Deprecated
        public static Modifier then(ParentDataModifier $this, Modifier other) {
