...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2602boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2603constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2604equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2605equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2606hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2611toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2604equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2606hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2611toStringimpl(this.composer);
    }
    ...
    public static final void m2609setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2610setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2612updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2613updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = arg0.getInserting();
    ...
    public static final void m2607initimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2608reconcileimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
