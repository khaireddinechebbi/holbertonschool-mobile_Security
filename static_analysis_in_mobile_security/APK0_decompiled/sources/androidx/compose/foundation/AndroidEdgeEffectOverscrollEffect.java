...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfig) {
        ...
        this.allEffects = CollectionsKt.listOf((Object[]) new EdgeEffect[]{create3, create, create4, create2});
        ...
        Function1<IntSize, Unit> function1 = new Function1<IntSize, Unit>() { // from class: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect$onNewSize$1
            ...
            public final void m156invokeozmzZPI(long size2) {
                ...
                long m5444toSizeozmzZPI = IntSizeKt.m5444toSizeozmzZPI(size2);
                j = AndroidEdgeEffectOverscrollEffect.this.containerSize;
                boolean differentSize = !Size.m2796equalsimpl0(m5444toSizeozmzZPI, j);
                AndroidEdgeEffectOverscrollEffect.this.containerSize = IntSizeKt.m5444toSizeozmzZPI(size2);
                if (differentSize) {
                    edgeEffect = AndroidEdgeEffectOverscrollEffect.this.topEffect;
                    edgeEffect.setSize(IntSize.m5434getWidthimpl(size2), IntSize.m5433getHeightimpl(size2));
                    edgeEffect2 = AndroidEdgeEffectOverscrollEffect.this.bottomEffect;
                    edgeEffect2.setSize(IntSize.m5434getWidthimpl(size2), IntSize.m5433getHeightimpl(size2));
                    edgeEffect3 = AndroidEdgeEffectOverscrollEffect.this.leftEffect;
                    edgeEffect3.setSize(IntSize.m5433getHeightimpl(size2), IntSize.m5434getWidthimpl(size2));
                    edgeEffect4 = AndroidEdgeEffectOverscrollEffect.this.rightEffect;
                    edgeEffect4.setSize(IntSize.m5433getHeightimpl(size2), IntSize.m5434getWidthimpl(size2));
                    edgeEffect5 = AndroidEdgeEffectOverscrollEffect.this.topEffectNegation;
                    edgeEffect5.setSize(IntSize.m5434getWidthimpl(size2), IntSize.m5433getHeightimpl(size2));
                    edgeEffect6 = AndroidEdgeEffectOverscrollEffect.this.bottomEffectNegation;
                    edgeEffect6.setSize(IntSize.m5434getWidthimpl(size2), IntSize.m5433getHeightimpl(size2));
                    edgeEffect7 = AndroidEdgeEffectOverscrollEffect.this.leftEffectNegation;
                    edgeEffect7.setSize(IntSize.m5433getHeightimpl(size2), IntSize.m5434getWidthimpl(size2));
                    edgeEffect8 = AndroidEdgeEffectOverscrollEffect.this.rightEffectNegation;
                    edgeEffect8.setSize(IntSize.m5433getHeightimpl(size2), IntSize.m5434getWidthimpl(size2));
                }
                if (differentSize) {
        ...
        if (!(Offset.m2731getXimpl(delta) == 0.0f)) {
            if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f) {
                if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
                    float m151pullRight0a9Yr6o = m151pullRight0a9Yr6o(delta, pointer);
                    if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f) {
                        this.rightEffect.onRelease();
                    }
                    consumedPixelsX = m151pullRight0a9Yr6o;
                }
            } else {
                float m150pullLeft0a9Yr6o = m150pullLeft0a9Yr6o(delta, pointer);
                if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f) {
                    this.leftEffect.onRelease();
                }
                consumedPixelsX = m150pullLeft0a9Yr6o;
            }
        }
    ...
    */
    public java.lang.Object mo154applyToFlingBMRW4eQ(long r10, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Velocity, ? super kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity>, ? extends java.lang.Object> r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        /*
            Method dump skipped, instructions count: 458
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo154applyToFlingBMRW4eQ(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
