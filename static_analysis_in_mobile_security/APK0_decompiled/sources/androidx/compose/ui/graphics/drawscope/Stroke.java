...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m3324getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3335getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m3590getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m3591getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == ((Stroke) other).width) {
            return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m3320equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m3330equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m3321hashCodeimpl(this.cap)) * 31) + StrokeJoin.m3331hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m3322toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m3332toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
