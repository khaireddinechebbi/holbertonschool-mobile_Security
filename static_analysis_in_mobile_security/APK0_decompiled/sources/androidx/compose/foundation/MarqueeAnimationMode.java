...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m224constructorimpl(0);
    private static final int WhileFocused = m224constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m223boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m224constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m225equalsimpl(int i, Object obj) {
    ...
    public static int m227hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m228toStringimpl(int arg0) {
        if (m226equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m226equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m230getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations, reason: not valid java name */
        public static /* synthetic */ void m231getWhileFocusedZbEOnfQ$annotations() {
        }
