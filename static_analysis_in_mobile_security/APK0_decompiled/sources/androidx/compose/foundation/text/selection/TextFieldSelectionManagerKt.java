...
public final class TextFieldSelectionManagerKt {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager $this$isSelectionHandleInVisibleBound, boolean isStartHandle) {
        ...
        if (state != null && (layoutCoordinates = state.getLayoutCoordinates()) != null && (visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates)) != null) {
            return SelectionManagerKt.m942containsInclusiveUv8p0NA(visibleBounds, $this$isSelectionHandleInVisibleBound.m962getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
        }
        return false;
    }
            ...
            if (layoutResult3 != null) {
                ...
                if (state2 != null && (textDelegate = state2.getTextDelegate()) != null) {
                    ...
                    if (transformedText != null) {
                        ...
                        long offsetCenter = layoutResult3.getBoundingBox(textOffset2).m2761getCenterF1C5BW0();
                        ...
                        if (state3 != null && (containerCoordinates = state3.getLayoutCoordinates()) != null) {
                            ...
                            if (state4 != null && (layoutResult2 = state4.getLayoutResult()) != null) {
                                ...
                                if (fieldCoordinates != null) {
                                    Offset m960getCurrentDragPosition_m7T9E = manager.m960getCurrentDragPosition_m7T9E();
                                    if (m960getCurrentDragPosition_m7T9E == null) {
                                        return Offset.INSTANCE.m2746getUnspecifiedF1C5BW0();
                                    }
                                    long it = m960getCurrentDragPosition_m7T9E.getPackedValue();
                                    ...
                                    int m4768getStartimpl = TextRange.m4768getStartimpl(manager.getValue$foundation_release().getSelection());
                                    int rawTextOffset2 = TextRange.m4763getEndimpl(manager.getValue$foundation_release().getSelection());
                                    boolean areHandlesCrossed = m4768getStartimpl > rawTextOffset2;
