...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m4957getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m4983getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m4930getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m4938copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        return imeOptions.m4939copyuxg59PA(z, (i4 & 2) != 0 ? imeOptions.capitalization : i, (i4 & 4) != 0 ? imeOptions.autoCorrect : z2, (i4 & 8) != 0 ? imeOptions.keyboardType : i2, (i4 & 16) != 0 ? imeOptions.imeAction : i3);
    }

    /* renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m4939copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ImeOptions) && this.singleLine == ((ImeOptions) other).singleLine && KeyboardCapitalization.m4948equalsimpl0(this.capitalization, ((ImeOptions) other).capitalization) && this.autoCorrect == ((ImeOptions) other).autoCorrect && KeyboardType.m4963equalsimpl0(this.keyboardType, ((ImeOptions) other).keyboardType) && ImeAction.m4918equalsimpl0(this.imeAction, ((ImeOptions) other).imeAction);
    }

    public int hashCode() {
        int result = ClickableElement$$ExternalSyntheticBackport0.m(this.singleLine);
        return (((((((result * 31) + KeyboardCapitalization.m4949hashCodeimpl(this.capitalization)) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m4964hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4919hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m4950toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4965toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4920toStringimpl(this.imeAction)) + ')';
    }
}
