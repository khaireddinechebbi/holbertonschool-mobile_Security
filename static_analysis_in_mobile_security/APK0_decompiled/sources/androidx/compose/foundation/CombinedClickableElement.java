...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    */
    ...
    private CombinedClickableElement(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> function0, Function0<Unit> function02) {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m210updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.interactionSource, ((CombinedClickableElement) other).interactionSource) && this.enabled == ((CombinedClickableElement) other).enabled && Intrinsics.areEqual(this.onClickLabel, ((CombinedClickableElement) other).onClickLabel) && Intrinsics.areEqual(this.role, ((CombinedClickableElement) other).role) && Intrinsics.areEqual(this.onClick, ((CombinedClickableElement) other).onClick) && Intrinsics.areEqual(this.onLongClickLabel, ((CombinedClickableElement) other).onLongClickLabel) && Intrinsics.areEqual(this.onLongClick, ((CombinedClickableElement) other).onLongClick) && Intrinsics.areEqual(this.onDoubleClick, ((CombinedClickableElement) other).onDoubleClick);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.interactionSource.hashCode();
        int result2 = ((result * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        String str = this.onClickLabel;
        int result3 = (result2 + (str != null ? str.hashCode() : 0)) * 31;
        Role role = this.role;
        int result4 = (((result3 + (role != null ? Role.m4607hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int result5 = (result4 + (str2 != null ? str2.hashCode() : 0)) * 31;
        Function0<Unit> function0 = this.onLongClick;
        int result6 = (result5 + (function0 != null ? function0.hashCode() : 0)) * 31;
        Function0<Unit> function02 = this.onDoubleClick;
        return result6 + (function02 != null ? function02.hashCode() : 0);
    }
}
