...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    public ConflatedBufferedChannel(int capacity, BufferOverflow onBufferOverflow, Function1<? super E, Unit> function1) {
        ...
        if (capacity >= 1) {
            ...
            throw new IllegalArgumentException(("Buffered channel capacity must be at least 1, but " + capacity + " was specified").toString());
        }
    }
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m7094trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m7080exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m7094trySendImplMj0NB7M(e, true);
    ...
    public Object mo7066trySendJP2dKIU(E element) {
        return m7094trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m7094trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m7092trySendDropLatestMj0NB7M(element, isSendOp) : m7093trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m7092trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo7066trySendJP2dKIU(element);
        if (ChannelResult.m7086isSuccessimpl(result) || ChannelResult.m7084isClosedimpl(result)) {
            return result;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0099, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m7089closedJP2dKIU(getSendException());
     */
    ...
    */
    private final java.lang.Object m7093trySendDropOldestJP2dKIU(E r21) {
        /*
            Method dump skipped, instructions count: 260
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.ConflatedBufferedChannel.m7093trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.BufferedChannel
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo7066trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m7080exceptionOrNullimpl(it);
