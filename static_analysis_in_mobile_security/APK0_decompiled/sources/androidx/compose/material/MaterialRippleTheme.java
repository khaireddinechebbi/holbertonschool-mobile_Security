...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1133defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1300defaultRippleColor5vOe2sY = companion.m1300defaultRippleColor5vOe2sY(((Color) consume).m2981unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object consume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha m1299defaultRippleAlphaDxMtmZc = companion.m1299defaultRippleAlphaDxMtmZc(((Color) consume).m2981unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
