...
public final class SlotWriter {
    ...
    private final void startGroup(int key, Object objectKey, boolean isNode, Object aux) {
        ...
        if (z) {
            ...
            SlotTableKt.initGroup(this.groups, groupIndexToAddress, key, isNode, z2, z3, this.parent, this.currentSlot);
            this.currentSlotEnd = this.currentSlot;
            int i3 = (isNode ? 1 : 0) + (z2 ? 1 : 0) + (z3 ? 1 : 0);
            if (i3 > 0) {
                insertSlots(i3, i2);
                Object[] objArr = this.slots;
                    ...
                    if (groupSizeDelta != 0 || nodesDelta != 0) {
                        ...
                        while (current != 0 && current != newParent && (nodesDelta != 0 || groupSizeDelta != 0)) {
                            ...
                            if (nodesDelta != 0) {
                                ...
                                nodeCount = SlotTableKt.nodeCount(iArr, currentAddress);
    ...
    public static final class Companion {
        ...
        public final List<Anchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            int dataIndexDelta3 = currentSlot - toWriter.dataIndex(groups, currentGroup);
            ...
            while (true) {
                ...
                int newDataIndex = toWriter.dataIndex(groups, currentSlot2) + dataIndexDelta3;
                if (slotsGapOwner2 < currentSlot2) {
                    dataIndexDelta = dataIndexDelta3;
                    dataIndexDelta2 = 0;
                } else {
                    dataIndexDelta = dataIndexDelta3;
                    dataIndexDelta2 = toWriter.slotsGapStart;
                }
                ...
                currentSlot2++;
                moveEnd2 = moveEnd;
                dataIndexDelta3 = dataIndexDelta;
    ...
    public final List<Anchor> moveTo(Anchor anchor, int offset, SlotWriter writer) {
        ...
        while (current >= currentGroup) {
            int currentAddress = groupIndexToAddress(current);
            int[] iArr = this.groups;
            groupSize = SlotTableKt.groupSize(iArr, currentAddress);
            ...
            if (updatingNodes) {
                ...
                if (isNode) {
                    ...
                    nodeCount = SlotTableKt.nodeCount(iArr2, currentAddress);
    ...
    public final void addToGroupSizeAlongSpine(int address, int amount) {
        ...
        while (current > 0) {
            int[] iArr = this.groups;
            groupSize = SlotTableKt.groupSize(iArr, current);
