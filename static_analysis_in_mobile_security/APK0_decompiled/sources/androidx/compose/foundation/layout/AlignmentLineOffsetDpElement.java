...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((before >= 0.0f || Dp.m5279equalsimpl0(before, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM())) && (after >= 0.0f || Dp.m5279equalsimpl0(after, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m377setBefore0680j_4(this.before);
        node.m376setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return otherModifier != null && Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m5279equalsimpl0(this.before, otherModifier.before) && Dp.m5279equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m5280hashCodeimpl(this.before)) * 31) + Dp.m5280hashCodeimpl(this.after);
    }
}
