...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m4766getMinimpl(selection);
        this.selectionEnd = TextRange.m4765getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m4766getMinimpl(selection);
        int end = TextRange.m4765getMaximpl(selection);
    ...
    public final TextRange m4912getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4756boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release, reason: not valid java name */
    public final long m4913getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m4914updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m4766getMinimpl(newSelection));
        setSelectionEnd(TextRange.m4765getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m4914updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m4762getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m4766getMinimpl(newComposition);
                this.compositionEnd = TextRange.m4765getMaximpl(newComposition);
            }
        }
    }
