...
public final class OffsetKt {
    ...
    public static final boolean m2748isFinitek4lQ0M(long $this$isFinite) {
        float m2731getXimpl = Offset.m2731getXimpl($this$isFinite);
        if ((Float.isInfinite(m2731getXimpl) || Float.isNaN(m2731getXimpl)) ? false : true) {
            float m2732getYimpl = Offset.m2732getYimpl($this$isFinite);
            if ((Float.isInfinite(m2732getYimpl) || Float.isNaN(m2732getYimpl)) ? false : true) {
                return true;
            }
        }
        return false;
