...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo337onPreScrollOzD1aCk(long available, int source) {
        return !this.enabled ? Offset.INSTANCE.m2747getZeroF1C5BW0() : (!NestedScrollSource.m3997equalsimpl0(source, NestedScrollSource.INSTANCE.m4002getDragWNlRxjI()) || Offset.m2732getYimpl(available) >= 0.0f) ? Offset.INSTANCE.m2747getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m2732getYimpl(available))).floatValue());
    }
    ...
    */
    public java.lang.Object mo336onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L35:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m5500getYimpl(r8)
        ...
        L50:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m5490boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo336onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
