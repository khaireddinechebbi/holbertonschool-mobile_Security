...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m484PaddingValuesa9UjIt4$default(Dp.m5274constructorimpl(24), Dp.m5274constructorimpl(20), 0.0f, Dp.m5274constructorimpl(8), 4, null);
    private static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m484PaddingValuesa9UjIt4$default(Dp.m5274constructorimpl(64), 0.0f, Dp.m5274constructorimpl(12), 0.0f, 10, null);
    private static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m484PaddingValuesa9UjIt4$default(Dp.m5274constructorimpl(64), 0.0f, Dp.m5274constructorimpl(12), Dp.m5274constructorimpl(12), 2, null);
    private static final float HeaderHeightOffset = Dp.m5274constructorimpl(60);
    ...
    public static final void DateRangePicker(final DateRangePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
                ...
                headline = i7 != 0 ? ComposableLambdaKt.composableLambda($composer2, -204181785, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$4
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            int i9 = $dirty;
                            dateRangePickerDefaults.DateRangePickerHeadline(dateRangePickerState, datePickerFormatter, padding, $composer3, (i9 & 14) | 3456 | ((i9 >> 3) & 112), 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            ComposableLambda composableLambda = showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1062265737, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int m1488getDisplayModejFl4v0 = DateRangePickerState.this.m1488getDisplayModejFl4v0();
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5$1$1
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode) {
                                    m1486invokevCnGnXg(displayMode.getValue());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-vCnGnXg, reason: not valid java name */
                                public final void m1486invokevCnGnXg(int displayMode) {
                                    DateRangePickerState.this.getStateData().m1725switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1478DisplayModeToggleButtontER2X8s(padding, m1488getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            float arg0$iv = DatePickerModalTokens.INSTANCE.m2125getRangeSelectionHeaderContainerHeightD9Ej5fM();
            ...
            final int i9 = $dirty;
            DatePickerKt.m1476DateEntryContainerau3_HiA(modifier2, title, headline, composableLambda, colors2, fromToken, Dp.m5274constructorimpl(arg0$iv - other$iv), ComposableLambdaKt.composableLambda($composer2, -186850856, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$6
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int i10 = i9;
                        DateRangePickerKt.SwitchableDateEntryContent(dateRangePickerState, datePickerFormatter2, function13, datePickerColors2, $composer3, (i10 & 14) | ((i10 >> 3) & 112) | ((i10 >> 3) & 896) | ((i10 >> 12) & 7168));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final DateRangePickerState m1485rememberDateRangePickerStatepMw4iz8(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, Composer $composer, int $changed, int i) {
        ...
        int initialDisplayMode2 = (i & 16) != 0 ? DisplayMode.INSTANCE.m1506getPickerjFl4v0() : initialDisplayMode;
        if (ComposerKt.isTraceInProgress()) {
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2617rememberSaveable(new Object[0], (Saver) DateRangePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int m1488getDisplayModejFl4v0 = state.m1488getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1498boximpl(m1488getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                @Override // kotlin.jvm.functions.Function1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer, Integer num) {
                    m1487invokeQujVXRc(displayMode.getValue(), composer, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1487invokeQujVXRc(int mode, Composer $composer3, int $changed2) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                        ...
                        if (DisplayMode.m1501equalsimpl0(mode, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                            ...
                            int i2 = i;
                            DateRangePickerKt.DateRangePickerContent(stateData, datePickerFormatter, function12, datePickerColors, $composer3, (i2 & 112) | (i2 & 896) | (i2 & 7168));
                            $composer3.endReplaceableGroup();
                            ...
                            int i3 = i;
                            DateRangeInputKt.DateRangeInputContent(stateData2, datePickerFormatter2, function13, $composer3, (i3 & 896) | (i3 & 112));
                            $composer3.endReplaceableGroup();
                        } else {
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            Modifier modifier$iv = PaddingKt.m489paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda($composer2, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        $composer3.endReplaceableGroup();
                        final String scrollToPreviousMonthLabel = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1769getDateRangePickerScrollToShowPreviousMonthadMyvUU(), $composer3, 6);
                        final String scrollToNextMonthLabel = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1768getDateRangePickerScrollToShowNextMonthadMyvUU(), $composer3, 6);
                                ...
                                LazyListScope.CC.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int it, Composer $composer4, int $changed3) {
                                        ...
                                        if (($dirty3 & 731) != 146 || !$composer4.getSkipping()) {
                                            ...
                                            TextKt.m1884Text4IGK_g(str3, SemanticsModifierKt.semantics$default(ClickableKt.m193clickableXHw0xAI$default(PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                @Override // kotlin.jvm.functions.Function0
    ...
    public static final void m1484drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long color) {
        float m2800getWidthimpl;
        ...
        float itemContainerWidth = drawRangeBackground.mo327toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemContainerHeight = drawRangeBackground.mo327toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemStateLayerHeight = drawRangeBackground.mo327toPx0680j_4(DatePickerModalTokens.INSTANCE.m2118getDateStateLayerHeightD9Ej5fM());
        float f = 2;
        float stateLayerVerticalPadding = (itemContainerHeight - itemStateLayerHeight) / f;
        float f2 = 7;
        float horizontalSpaceBetweenItems = (Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) - (f2 * itemContainerWidth)) / f2;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int x1 = IntOffset.m5384component1impl(packedValue);
        int y1 = IntOffset.m5385component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int x2 = IntOffset.m5384component1impl(packedValue2);
        int y2 = IntOffset.m5385component2impl(packedValue2);
        ...
        if (isRtl) {
            startX = Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) - startX;
            endX = Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) - endX;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(startX, startY);
        if (y1 == y2) {
            m2800getWidthimpl = endX - startX;
        } else {
            m2800getWidthimpl = isRtl ? -startX : Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) - startX;
        }
        DrawScope.CC.m3522drawRectnJ9OG0$default(contentDrawScope, color, Offset, SizeKt.Size(m2800getWidthimpl, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
                DrawScope.CC.m3522drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(0.0f, (y * itemContainerHeight) + startY), SizeKt.Size(Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()), itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
                y--;
                itemContainerHeight = itemContainerHeight;
            }
            float topLeftX = drawRangeBackground.getLayoutDirection() == LayoutDirection.Ltr ? 0.0f : Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc());
            DrawScope.CC.m3522drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(topLeftX, endY), SizeKt.Size(isRtl ? endX - Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) : endX, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        }
    }
