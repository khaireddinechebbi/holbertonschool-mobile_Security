...
public final class LayoutCoordinatesKt {
    public static final long positionInRoot(LayoutCoordinates $this$positionInRoot) {
        ...
        return $this$positionInRoot.mo4234localToRootMKHz9U(Offset.INSTANCE.m2747getZeroF1C5BW0());
    }
    ...
    public static final long positionInWindow(LayoutCoordinates $this$positionInWindow) {
        ...
        return $this$positionInWindow.mo4235localToWindowMKHz9U(Offset.INSTANCE.m2747getZeroF1C5BW0());
    }
    ...
    public static final Rect boundsInRoot(LayoutCoordinates $this$boundsInRoot) {
        ...
        return LayoutCoordinates.CC.localBoundingBoxOf$default(findRootCoordinates($this$boundsInRoot), $this$boundsInRoot, false, 2, null);
    }
    ...
    public static final Rect boundsInWindow(LayoutCoordinates $this$boundsInWindow) {
        ...
        float rootWidth = IntSize.m5434getWidthimpl(root.mo4232getSizeYbymL2g());
        float rootHeight = IntSize.m5433getHeightimpl(root.mo4232getSizeYbymL2g());
        ...
        if (!(boundsLeft == boundsRight)) {
            if (!(boundsTop == boundsBottom)) {
                long topLeft = root.mo4235localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsTop));
                long topRight = root.mo4235localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsTop));
                long bottomRight = root.mo4235localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsBottom));
                long bottomLeft = root.mo4235localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsBottom));
    ...
    public static final long positionInParent(LayoutCoordinates $this$positionInParent) {
        ...
        return parentLayoutCoordinates != null ? parentLayoutCoordinates.mo4233localPositionOfR5De75A($this$positionInParent, Offset.INSTANCE.m2747getZeroF1C5BW0()) : Offset.INSTANCE.m2747getZeroF1C5BW0();
    }
    ...
    public static final Rect boundsInParent(LayoutCoordinates $this$boundsInParent) {
        ...
        return (parentLayoutCoordinates == null || (localBoundingBoxOf$default = LayoutCoordinates.CC.localBoundingBoxOf$default(parentLayoutCoordinates, $this$boundsInParent, false, 2, null)) == null) ? new Rect(0.0f, 0.0f, IntSize.m5434getWidthimpl($this$boundsInParent.mo4232getSizeYbymL2g()), IntSize.m5433getHeightimpl($this$boundsInParent.mo4232getSizeYbymL2g())) : localBoundingBoxOf$default;
    }
