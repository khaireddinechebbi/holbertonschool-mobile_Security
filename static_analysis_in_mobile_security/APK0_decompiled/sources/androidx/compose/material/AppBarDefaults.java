...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m5274constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m5274constructorimpl(8);
    ...
    static {
        ...
        ContentPadding = PaddingKt.m484PaddingValuesa9UjIt4$default(f, 0.0f, f2, 0.0f, 10, null);
    }

    /* renamed from: getTopAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m976getTopAppBarElevationD9Ej5fM() {
        return TopAppBarElevation;
    }

    /* renamed from: getBottomAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m975getBottomAppBarElevationD9Ej5fM() {
