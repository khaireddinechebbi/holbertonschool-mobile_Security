...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m2808getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope $this$draw, float alpha, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2796equalsimpl0(this.previousDrawSize, $this$draw.mo3442getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2800getWidthimpl($this$draw.mo3442getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2797getHeightimpl($this$draw.mo3442getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3601drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2800getWidthimpl($this$draw.mo3442getSizeNHjbRc())), (int) Math.ceil(Size.m2797getHeightimpl($this$draw.mo3442getSizeNHjbRc()))), $this$draw, $this$draw.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = $this$draw.mo3442getSizeNHjbRc();
        }
