...
public final class AndroidWindowInsets implements WindowInsets {
    ...
    public AndroidWindowInsets(int type, String name) {
        ...
        this.isVisible = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(true, null, 2, null);
    }
