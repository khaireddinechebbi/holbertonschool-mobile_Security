...
public final class DebuggerInfo implements Serializable {
    ...
    public DebuggerInfo(DebugCoroutineInfo source, CoroutineContext context) {
        Thread.State state;
