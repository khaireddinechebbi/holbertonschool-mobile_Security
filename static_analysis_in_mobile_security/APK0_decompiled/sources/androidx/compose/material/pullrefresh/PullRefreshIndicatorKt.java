...
public final class PullRefreshIndicatorKt {
    ...
    */
    public static final void m1284PullRefreshIndicatorjB83MbM(final boolean r42, final androidx.compose.material.pullrefresh.PullRefreshState r43, androidx.compose.ui.Modifier r44, long r45, long r47, boolean r49, androidx.compose.runtime.Composer r50, final int r51, final int r52) {
        /*
            Method dump skipped, instructions count: 765
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt.m1284PullRefreshIndicatorjB83MbM(boolean, androidx.compose.material.pullrefresh.PullRefreshState, androidx.compose.ui.Modifier, long, long, boolean, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1283CircularArrowIndicatoriJQMabo(final PullRefreshState state, final long color, final Modifier modifier, Composer $composer, final int $changed) {
        ...
        CanvasKt.Canvas(SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$1
            ...
            public final void invoke2(DrawScope Canvas) {
                ...
                float f4 = Canvas.mo327toPx0680j_4(f);
                f2 = PullRefreshIndicatorKt.StrokeWidth;
                float arcRadius = f4 + (Canvas.mo327toPx0680j_4(f2) / 2.0f);
                Rect arcBounds = new Rect(Offset.m2731getXimpl(SizeKt.m2810getCenteruvyYCjk(Canvas.mo3442getSizeNHjbRc())) - arcRadius, Offset.m2732getYimpl(SizeKt.m2810getCenteruvyYCjk(Canvas.mo3442getSizeNHjbRc())) - arcRadius, Offset.m2731getXimpl(SizeKt.m2810getCenteruvyYCjk(Canvas.mo3442getSizeNHjbRc())) + arcRadius, Offset.m2732getYimpl(SizeKt.m2810getCenteruvyYCjk(Canvas.mo3442getSizeNHjbRc())) + arcRadius);
                float startAngle = values.getStartAngle();
                float endAngle = values.getEndAngle() - values.getStartAngle();
                long m2766getTopLeftF1C5BW0 = arcBounds.m2766getTopLeftF1C5BW0();
                long m2764getSizeNHjbRc = arcBounds.m2764getSizeNHjbRc();
                f3 = PullRefreshIndicatorKt.StrokeWidth;
                DrawScope.CC.m3507drawArcyD3GUKo$default(Canvas, j, startAngle, endAngle, false, m2766getTopLeftF1C5BW0, m2764getSizeNHjbRc, alpha, new Stroke(Canvas.mo327toPx0680j_4(f3), 0.0f, StrokeCap.INSTANCE.m3326getSquareKaPHkGw(), 0, null, 26, null), null, 0, 768, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$3
            ...
            public final void invoke(Composer composer, int i) {
                PullRefreshIndicatorKt.m1283CircularArrowIndicatoriJQMabo(PullRefreshState.this, color, modifier, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
