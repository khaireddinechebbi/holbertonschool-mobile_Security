...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m888setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m4763getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m4762getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m4766getMinimpl($this$collapseLeftOr_u24lambda_u244.selection));
            } else {
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m4765getMaximpl($this$collapseLeftOr_u24lambda_u244.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T collapseRightOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m4762getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m4765getMaximpl($this$collapseRightOr_u24lambda_u245.selection));
            } else {
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m4766getMinimpl($this$collapseRightOr_u24lambda_u245.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m4763getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m4763getEndimpl(this.selection));
    }
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m4768getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m4763getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m4742getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m4763getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m4763getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m4742getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m4768getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m4768getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m4740getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y)));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4763getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4766getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4765getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m4766getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m4765getMaximpl(this.selection));
    }
}
