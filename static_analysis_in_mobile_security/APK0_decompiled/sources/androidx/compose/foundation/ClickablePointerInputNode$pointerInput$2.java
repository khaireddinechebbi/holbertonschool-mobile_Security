...
final class ClickablePointerInputNode$pointerInput$2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ClickablePointerInputNode$pointerInput$2 clickablePointerInputNode$pointerInput$2;
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.this$0.getEnabled()) {
                    this.label = 1;
                    if (this.this$0.m148handlePressInteractiond4ec7I($this$detectTapAndPress, offset, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    clickablePointerInputNode$pointerInput$2 = this;
                }
