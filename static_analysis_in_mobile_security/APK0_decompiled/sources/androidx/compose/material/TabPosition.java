...
public final class TabPosition {
    ...
    public final float m1232getRightD9Ej5fM() {
    ...
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5285toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5285toStringimpl(m1232getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5285toStringimpl(this.width)) + ')';
    }
}
