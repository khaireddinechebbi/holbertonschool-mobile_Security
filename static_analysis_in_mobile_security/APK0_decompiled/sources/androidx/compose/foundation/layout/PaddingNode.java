...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5274constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5274constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5274constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5274constructorimpl(0) : f4, z, null);
    }
    ...
    public final void m498setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m499setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m497setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m496setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo239measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int horizontal = measure.mo321roundToPx0680j_4(this.start) + measure.mo321roundToPx0680j_4(this.end);
        int vertical = measure.mo321roundToPx0680j_4(this.top) + measure.mo321roundToPx0680j_4(this.bottom);
        final Placeable placeable = measurable.mo4225measureBRTryo0(ConstraintsKt.m5234offsetNN6EwU(constraints, -horizontal, -vertical));
        int width = ConstraintsKt.m5232constrainWidthK40F9xA(constraints, placeable.getWidth() + horizontal);
        int height = ConstraintsKt.m5231constrainHeightK40F9xA(constraints, placeable.getHeight() + vertical);
        return MeasureScope.CC.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (PaddingNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable, measure.mo321roundToPx0680j_4(PaddingNode.this.getStart()), measure.mo321roundToPx0680j_4(PaddingNode.this.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeable, measure.mo321roundToPx0680j_4(PaddingNode.this.getStart()), measure.mo321roundToPx0680j_4(PaddingNode.this.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
