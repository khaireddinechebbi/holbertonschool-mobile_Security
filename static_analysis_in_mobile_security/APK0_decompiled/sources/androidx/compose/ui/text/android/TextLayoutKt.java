...
public final class TextLayoutKt {
    ...
    public static final long VerticalPaddings(int topPadding, int bottomPadding) {
        return VerticalPaddings.m4803constructorimpl((topPadding << 32) | (bottomPadding & 4294967295L));
    }
    ...
    public static final Paint.FontMetricsInt getLastLineMetrics(TextLayout $this$getLastLineMetrics, TextPaint textPaint, TextDirectionHeuristic frameworkTextDir, LineHeightStyleSpan[] lineHeightSpans) {
        ...
        LineHeightStyleSpan newLineHeightSpan = lineHeightSpan.copy$ui_text_release(0, emptyText.length(), (lastLine == 0 || !lineHeightSpan.getTrimLastLineBottom()) ? lineHeightSpan.getTrimLastLineBottom() : false);
