...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static /* synthetic */ Font m4839Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m4838Fontvxs03AY(str, fontWeight, i, settings);
    }

    /* renamed from: Font-vxs03AY, reason: not valid java name */
    public static final Font m4838Fontvxs03AY(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {
