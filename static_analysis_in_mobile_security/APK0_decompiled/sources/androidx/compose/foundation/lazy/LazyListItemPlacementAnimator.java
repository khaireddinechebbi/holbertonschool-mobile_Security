    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        ...
        while (i < placeablesCount) {
            ...
            if (it$iv != null) {
                ...
                long targetFirstPlaceableOffset3 = IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(targetFirstPlaceableOffset) + IntOffset.m5392getXimpl(arg0$iv2), IntOffset.m5393getYimpl(targetFirstPlaceableOffset) + IntOffset.m5393getYimpl(arg0$iv2));
                it$iv.m634setRawOffsetgyyYBs(targetFirstPlaceableOffset3);
            } else {
                targetFirstPlaceableOffset2 = targetFirstPlaceableOffset;
                $this$forEachNode$iv = $this$forEachNode$iv2;
            }
