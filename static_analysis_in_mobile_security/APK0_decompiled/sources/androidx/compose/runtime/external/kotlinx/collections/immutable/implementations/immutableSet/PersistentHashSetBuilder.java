...
public final class PersistentHashSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public boolean addAll(Collection<? extends E> elements) {
        ...
        PersistentHashSet set = elements instanceof PersistentHashSet ? (PersistentHashSet) elements : null;
        if (set == null) {
            ...
            set = persistentHashSetBuilder != null ? persistentHashSetBuilder.build() : null;
        }
        if (set != null) {
            DeltaCounter deltaCounter = new DeltaCounter(0, 1, null);
            int size = size();
            TrieNode result = this.node.mutableAddAll(set.getNode$runtime_release(), 0, deltaCounter, this);
            int newSize = (elements.size() + size) - deltaCounter.getCount();
            if (size != newSize) {
                this.node = result;
                setSize(newSize);
            }
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        if (set != null) {
            DeltaCounter deltaCounter = new DeltaCounter(0, 1, null);
            int size = size();
            Object result = this.node.mutableRetainAll(set.getNode$runtime_release(), 0, deltaCounter, this);
    ...
    public boolean removeAll(Collection<? extends Object> elements) {
        ...
        if (set != null) {
            ...
            int size = size();
            Object result = this.node.mutableRemoveAll(set.getNode$runtime_release(), 0, counter, this);
