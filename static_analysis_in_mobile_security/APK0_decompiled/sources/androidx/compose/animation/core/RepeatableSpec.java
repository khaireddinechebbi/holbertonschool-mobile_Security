    ...
    */
    public /* synthetic */ RepeatableSpec(int r8, androidx.compose.animation.core.DurationBasedAnimationSpec r9, androidx.compose.animation.core.RepeatMode r10, long r11, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L9:
            ...
            r11 = 0
            r12 = 0
            long r11 = androidx.compose.animation.core.StartOffset.m112constructorimpl$default(r12, r12, r10, r11)
            r4 = r11
            goto L17
        L16:
            r4 = r11
    ...
    public /* synthetic */ RepeatableSpec(int iterations, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(iterations, animation, repeatMode, StartOffset.m112constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof RepeatableSpec) && ((RepeatableSpec) other).iterations == this.iterations && Intrinsics.areEqual(((RepeatableSpec) other).animation, this.animation) && ((RepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m114equalsimpl0(((RepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }

    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m117hashCodeimpl(this.initialStartOffset);
    }
}
