...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m3281createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        if (inputRenderEffect == null) {
            android.graphics.RenderEffect createBlurEffect = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m2878toAndroidTileMode0vamqd0(edgeTreatment));
            Intrinsics.checkNotNullExpressionValue(createBlurEffect, "{\n            android.gr…)\n            )\n        }");
            return createBlurEffect;
        }
        android.graphics.RenderEffect createBlurEffect2 = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m2878toAndroidTileMode0vamqd0(edgeTreatment));
    ...
    public final android.graphics.RenderEffect m3282createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        if (inputRenderEffect == null) {
            android.graphics.RenderEffect createOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(Offset.m2731getXimpl(offset), Offset.m2732getYimpl(offset));
            Intrinsics.checkNotNullExpressionValue(createOffsetEffect, "{\n            android.gr…et.x, offset.y)\n        }");
            return createOffsetEffect;
        }
        android.graphics.RenderEffect createOffsetEffect2 = android.graphics.RenderEffect.createOffsetEffect(Offset.m2731getXimpl(offset), Offset.m2732getYimpl(offset), inputRenderEffect.asAndroidRenderEffect());
