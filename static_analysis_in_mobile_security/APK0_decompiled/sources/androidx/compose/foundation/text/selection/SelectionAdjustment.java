...
public interface SelectionAdjustment {
    ...
    long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange);
    ...
    public static final class Companion {
        ...
        private static final SelectionAdjustment None = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$None$1
            ...
            public long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
        ...
        private static final SelectionAdjustment Character = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Character$1
            ...
            public long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                if (TextRange.m4762getCollapsedimpl(newRawSelectionRange)) {
                    boolean previousHandlesCrossed = previousSelectionRange != null ? TextRange.m4767getReversedimpl(previousSelectionRange.getPackedValue()) : false;
                    return SelectionAdjustmentKt.ensureAtLeastOneChar(textLayoutResult.getLayoutInput().getText().getText(), TextRange.m4768getStartimpl(newRawSelectionRange), StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText()), isStartHandle, previousHandlesCrossed);
                }
                return newRawSelectionRange;
            }
        };
        private static final SelectionAdjustment Word = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Word$1
            ...
            /* renamed from: adjust-ZXO7KMw */
            public long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                long m902adjustByBoundaryDvylE;
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                m902adjustByBoundaryDvylE = SelectionAdjustment.Companion.$$INSTANCE.m902adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, new SelectionAdjustment$Companion$Word$1$adjust$1(textLayoutResult));
                return m902adjustByBoundaryDvylE;
            }
        };
        private static final SelectionAdjustment Paragraph = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Paragraph$1
            ...
            public long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                ...
                m902adjustByBoundaryDvylE = SelectionAdjustment.Companion.$$INSTANCE.m902adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, (Function1) boundaryFun);
                return m902adjustByBoundaryDvylE;
            }
        };
        private static final SelectionAdjustment CharacterWithWordAccelerate = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$CharacterWithWordAccelerate$1
            ...
            public long mo900adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                ...
                if (previousSelectionRange == null) {
                    return SelectionAdjustment.Companion.$$INSTANCE.getWord().mo900adjustZXO7KMw(textLayoutResult, newRawSelectionRange, previousHandleOffset, isStartHandle, previousSelectionRange);
                }
                if (TextRange.m4762getCollapsedimpl(newRawSelectionRange)) {
                    return SelectionAdjustmentKt.ensureAtLeastOneChar(textLayoutResult.getLayoutInput().getText().getText(), TextRange.m4768getStartimpl(newRawSelectionRange), StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText()), isStartHandle, TextRange.m4767getReversedimpl(previousSelectionRange.getPackedValue()));
                }
                if (isStartHandle) {
                    start = updateSelectionBoundary(textLayoutResult, TextRange.m4768getStartimpl(newRawSelectionRange), previousHandleOffset, TextRange.m4768getStartimpl(previousSelectionRange.getPackedValue()), TextRange.m4763getEndimpl(newRawSelectionRange), true, TextRange.m4767getReversedimpl(newRawSelectionRange));
                    end = TextRange.m4763getEndimpl(newRawSelectionRange);
                } else {
                    start = TextRange.m4768getStartimpl(newRawSelectionRange);
                    end = updateSelectionBoundary(textLayoutResult, TextRange.m4763getEndimpl(newRawSelectionRange), previousHandleOffset, TextRange.m4763getEndimpl(previousSelectionRange.getPackedValue()), TextRange.m4768getStartimpl(newRawSelectionRange), false, TextRange.m4767getReversedimpl(newRawSelectionRange));
                }
            ...
            private final int snapToWordBoundary(TextLayoutResult textLayoutResult, int newRawOffset, int currentLine, int otherBoundaryOffset, boolean isStart, boolean isReversed) {
                int start;
                int end;
                long wordBoundary = textLayoutResult.m4742getWordBoundaryjx7JFs(newRawOffset);
                int wordStartLine = textLayoutResult.getLineForOffset(TextRange.m4768getStartimpl(wordBoundary));
                if (wordStartLine == currentLine) {
                    start = TextRange.m4768getStartimpl(wordBoundary);
                } else {
                    start = textLayoutResult.getLineStart(currentLine);
                }
                int wordEndLine = textLayoutResult.getLineForOffset(TextRange.m4763getEndimpl(wordBoundary));
                if (wordEndLine != currentLine) {
                    end = TextLayoutResult.getLineEnd$default(textLayoutResult, currentLine, false, 2, null);
                } else {
                    end = TextRange.m4763getEndimpl(wordBoundary);
                }
            ...
            private final boolean isAtWordBoundary(TextLayoutResult $this$isAtWordBoundary, int offset) {
                long wordBoundary = $this$isAtWordBoundary.m4742getWordBoundaryjx7JFs(offset);
                return offset == TextRange.m4768getStartimpl(wordBoundary) || offset == TextRange.m4763getEndimpl(wordBoundary);
            }
        ...
        public final long m902adjustByBoundaryDvylE(TextLayoutResult textLayoutResult, long newRawSelection, Function1<? super Integer, TextRange> boundaryFun) {
            if (textLayoutResult.getLayoutInput().getText().length() == 0) {
                return TextRange.INSTANCE.m4773getZerod9O1mEE();
            }
            int maxOffset = StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText());
            long startBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m4768getStartimpl(newRawSelection), 0, maxOffset))).getPackedValue();
            long endBoundary = boundaryFun.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m4763getEndimpl(newRawSelection), 0, maxOffset))).getPackedValue();
            int start = TextRange.m4767getReversedimpl(newRawSelection) ? TextRange.m4763getEndimpl(startBoundary) : TextRange.m4768getStartimpl(startBoundary);
            int end = TextRange.m4767getReversedimpl(newRawSelection) ? TextRange.m4768getStartimpl(endBoundary) : TextRange.m4763getEndimpl(endBoundary);
            return TextRangeKt.TextRange(start, end);
        }
