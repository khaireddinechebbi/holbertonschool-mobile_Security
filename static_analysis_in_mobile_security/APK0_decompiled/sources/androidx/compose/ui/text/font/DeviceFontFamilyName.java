...
public final class DeviceFontFamilyName {
    ...
    public static final /* synthetic */ DeviceFontFamilyName m4831boximpl(String str) {
        return new DeviceFontFamilyName(str);
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4833equalsimpl(String str, Object obj) {
        return (obj instanceof DeviceFontFamilyName) && Intrinsics.areEqual(str, ((DeviceFontFamilyName) obj).m4837unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m4833equalsimpl(this.name, obj);
    }

    public int hashCode() {
        return m4835hashCodeimpl(this.name);
    }

    public String toString() {
        return m4836toStringimpl(this.name);
    }
    ...
    private /* synthetic */ DeviceFontFamilyName(String name) {
        this.name = name;
    }
    ...
    public static String m4832constructorimpl(String name) {
