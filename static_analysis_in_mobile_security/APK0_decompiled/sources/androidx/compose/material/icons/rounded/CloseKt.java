...
public final class CloseKt {
    ...
    public static final ImageVector getClose(Icons.Rounded $this$Close) {
        ...
        ImageVector.Builder $this$_get_Close__u24lambda_u241 = new ImageVector.Builder("Rounded.Close", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_Close__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        _close = build;
