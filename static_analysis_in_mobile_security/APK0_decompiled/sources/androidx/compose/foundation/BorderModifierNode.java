...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float widthParameter, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope CacheDrawModifierNode) {
                DrawResult m174drawRectBorderNsqcLGU;
                DrawResult m177drawRoundRectBorderJqoCqck;
                DrawResult drawGenericBorder;
                DrawResult drawContentWithoutBorder;
                Intrinsics.checkNotNullParameter(CacheDrawModifierNode, "$this$CacheDrawModifierNode");
                boolean hasValidBorderParams = CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth()) >= 0.0f && Size.m2799getMinDimensionimpl(CacheDrawModifierNode.m2637getSizeNHjbRc()) > 0.0f;
                if (!hasValidBorderParams) {
                    drawContentWithoutBorder = BorderKt.drawContentWithoutBorder(CacheDrawModifierNode);
                    return drawContentWithoutBorder;
                }
                float f = 2;
                float strokeWidthPx = Math.min(Dp.m5279equalsimpl0(BorderModifierNode.this.getWidth(), Dp.INSTANCE.m5292getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil(CacheDrawModifierNode.mo327toPx0680j_4(BorderModifierNode.this.getWidth())), (float) Math.ceil(Size.m2799getMinDimensionimpl(CacheDrawModifierNode.m2637getSizeNHjbRc()) / f));
                ...
                Outline outline = BorderModifierNode.this.getShape().mo209createOutlinePq9zytI(CacheDrawModifierNode.m2637getSizeNHjbRc(), CacheDrawModifierNode.getLayoutDirection(), CacheDrawModifierNode);
                if (outline instanceof Outline.Generic) {
                    BorderModifierNode borderModifierNode = BorderModifierNode.this;
                    drawGenericBorder = borderModifierNode.drawGenericBorder(CacheDrawModifierNode, borderModifierNode.getBrush(), (Outline.Generic) outline, fillArea, strokeWidthPx);
                    return drawGenericBorder;
                }
                if (outline instanceof Outline.Rounded) {
                    BorderModifierNode borderModifierNode2 = BorderModifierNode.this;
                    m177drawRoundRectBorderJqoCqck = borderModifierNode2.m177drawRoundRectBorderJqoCqck(CacheDrawModifierNode, borderModifierNode2.getBrush(), (Outline.Rounded) outline, topLeft, borderSize, fillArea, strokeWidthPx);
                    return m177drawRoundRectBorderJqoCqck;
                }
                if (outline instanceof Outline.Rectangle) {
                    m174drawRectBorderNsqcLGU = BorderKt.m174drawRectBorderNsqcLGU(CacheDrawModifierNode, BorderModifierNode.this.getBrush(), topLeft, borderSize, fillArea, strokeWidthPx);
                    return m174drawRectBorderNsqcLGU;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00ed, code lost:
        ...
        if (androidx.compose.ui.graphics.ImageBitmapConfig.m3188equalsimpl(r13, r2 != null ? androidx.compose.ui.graphics.ImageBitmapConfig.m3186boximpl(r2.mo2840getConfig_sVssgQ()) : null) != false) goto L26;
     */
    ...
    public final DrawResult m177drawRoundRectBorderJqoCqck(CacheDrawScope $this$drawRoundRectBorder_u2dJqoCqck, final Brush brush, Outline.Rounded outline, final long topLeft, final long borderSize, final boolean fillArea, final float strokeWidth) {
        ...
        if (RoundRectKt.isSimple(outline.getRoundRect())) {
            ...
            return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope onDrawWithContent) {
                    ...
                    float m2706getXimpl = CornerRadius.m2706getXimpl(cornerRadius);
                    float f = halfStroke;
                    if (m2706getXimpl < f) {
                    ...
                    long j2 = topLeft;
                    long j3 = borderSize;
                    m175shrinkKibmq7A = BorderKt.m175shrinkKibmq7A(cornerRadius, f);
                    DrawScope.CC.m3523drawRoundRectZuiqVtQ$default(onDrawWithContent, brush3, j2, j3, m175shrinkKibmq7A, 0.0f, borderStroke, null, 0, 208, null);
                }
            });
        }
        ...
        return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.CC.m3517drawPathGBMwjPU$default(onDrawWithContent, Path.this, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
