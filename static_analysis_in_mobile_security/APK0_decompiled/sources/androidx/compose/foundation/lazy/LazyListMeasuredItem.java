...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m597getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < placeablesCount) {
            ...
            long offset = m597getOffsetBjo55l4(index);
            ...
            if (animateNode == null) {
                ...
                if ((m596getMainAxisgyyYBs(offset) <= minOffset && m596getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m596getMainAxisgyyYBs(offset) >= maxOffset && m596getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
    ...
    private final int m596getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m595copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
