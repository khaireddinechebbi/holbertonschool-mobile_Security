...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public State<Dp> elevation(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new DefaultFloatingActionButtonElevation$elevation$2(animatable, this, target, interaction, null), $composer, 64);
