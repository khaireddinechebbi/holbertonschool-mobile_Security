...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m62copybnNdC4k$default(Scale scale, float f, long j, FiniteAnimationSpec finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale.m64copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final Scale m64copybnNdC4k(float scale, long transformOrigin, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m3356equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }

    public int hashCode() {
        return (((Float.floatToIntBits(this.scale) * 31) + TransformOrigin.m3359hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m3360toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
