...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5274constructorimpl(10);
    ...
    public static final float m1293getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m2800getWidthimpl(size), Size.m2797getHeightimpl(size)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1292getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean bounded, long size) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float radiusCoveringBounds = Offset.m2729getDistanceimpl(OffsetKt.Offset(Size.m2800getWidthimpl(size), Size.m2797getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return getRippleEndRadius.mo327toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }
