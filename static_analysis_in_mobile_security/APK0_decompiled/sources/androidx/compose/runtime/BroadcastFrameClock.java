    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                m5563constructorimpl = Result.m5563constructorimpl($this$resume_u24lambda_u240.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(m5563constructorimpl);
        }
    }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (cause != null) {
                    Result.Companion companion = Result.INSTANCE;
                    co.resumeWith(Result.m5563constructorimpl(ResultKt.createFailure(cause)));
                } else {
                    try {
    ...
    public final void fail(Throwable cause) {
        ...
        synchronized (lock$iv) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m5563constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
            Unit unit = Unit.INSTANCE;
        }
