...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RichTooltipColors) && Color.m2972equalsimpl0(this.containerColor, ((RichTooltipColors) other).containerColor) && Color.m2972equalsimpl0(this.contentColor, ((RichTooltipColors) other).contentColor) && Color.m2972equalsimpl0(this.titleContentColor, ((RichTooltipColors) other).titleContentColor) && Color.m2972equalsimpl0(this.actionContentColor, ((RichTooltipColors) other).actionContentColor);
    }

    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.containerColor);
        return (((((result * 31) + Color.m2978hashCodeimpl(this.contentColor)) * 31) + Color.m2978hashCodeimpl(this.titleContentColor)) * 31) + Color.m2978hashCodeimpl(this.actionContentColor);
    }
}
