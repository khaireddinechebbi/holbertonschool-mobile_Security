...
public final class AnchoredDraggableKt {
    ...
    public static final <T> AnchoredDraggableState<T> rememberAnchoredDraggableState(final T initialValue, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        AnimationSpec animationSpec2 = (i & 2) != 0 ? AnchoredDraggableDefaults.INSTANCE.getAnimationSpec() : animationSpec;
        Function1 confirmValueChange = (i & 4) != 0 ? new Function1<T, Boolean>() { // from class: androidx.compose.material.AnchoredDraggableKt$rememberAnchoredDraggableState$1
        ...
        AnchoredDraggableState<T> anchoredDraggableState = (AnchoredDraggableState) RememberSaveableKt.m2617rememberSaveable(new Object[]{initialValue, animationSpec2, confirmValueChange, positionalThreshold, velocityThreshold}, (Saver) AnchoredDraggableState.INSTANCE.Saver(animationSpec2, confirmValueChange, positionalThreshold, velocityThreshold), (String) null, (Function0) new Function0<AnchoredDraggableState<T>>() { // from class: androidx.compose.material.AnchoredDraggableKt$rememberAnchoredDraggableState$2
