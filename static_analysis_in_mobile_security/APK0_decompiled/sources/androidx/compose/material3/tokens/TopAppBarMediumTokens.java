...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m5274constructorimpl((float) 112.0d);
    ...
    public final float m2509getContainerElevationD9Ej5fM() {
    ...
    public final float m2511getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2512getTrailingIconSizeD9Ej5fM() {
