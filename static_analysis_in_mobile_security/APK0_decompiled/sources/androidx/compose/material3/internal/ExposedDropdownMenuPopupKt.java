        ...
        if ((i6 & 731) == 146 && startRestartGroup.getSkipping()) {
                        ...
                        if (($changed & 11) != 2 || !$composer.getSkipping()) {
                            ...
                            Modifier modifier$iv = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public final void m2010invokeozmzZPI(long it) {
                                    PopupLayout.this.m2012setPopupContentSizefhxjrPA(IntSize.m5426boximpl(it));
                            ...
                            skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer)), $composer, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    PopupLayout.this.setParentBounds(IntRectKt.m5424IntRectVbeCjmY(layoutPosition, layoutSize));
                    PopupLayout.this.updatePosition();
                }
            });
            ...
            Composer m2603constructorimpl = Updater.m2603constructorimpl(composer4);
            Updater.m2610setimpl(m2603constructorimpl, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2610setimpl(m2603constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2610setimpl(m2603constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2610setimpl(m2603constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            materializerOf.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl(composer4)), composer4, Integer.valueOf((i7 >> 3) & 112));
