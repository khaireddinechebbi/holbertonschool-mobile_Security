...
public final class AndroidAlertDialog_androidKt {
    private static final float ButtonsMainAxisSpacing = Dp.m5274constructorimpl(8);
    private static final float ButtonsCrossAxisSpacing = Dp.m5274constructorimpl(12);

    /* renamed from: AlertDialog-Oix01E0, reason: not valid java name */
    public static final void m1307AlertDialogOix01E0(final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Shape shape, long containerColor, long iconContentColor, long titleContentColor, long textContentColor, float tonalElevation, DialogProperties properties, Composer $composer, final int $changed, final int $changed1, final int i) {
        Function2 title;
        Function2 text;
        Shape shape2;
        ...
        if (($dirty2 & 1533916891) == 306783378 && ($dirty12 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                float tonalElevation3 = i12 != 0 ? AlertDialogDefaults.INSTANCE.m1304getTonalElevationD9Ej5fM() : tonalElevation;
                if (i13 != 0) {
            ...
            AlertDialog(onDismissRequest, modifier2, properties2, ComposableLambdaKt.composableLambda($composer2, 741647174, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer3, -1873210524, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    AlertDialogKt.m1306AlertDialogFlowRowixp7dh8(f2, f3, ComposableLambdaKt.composableLambda($composer4, 628285581, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1.1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
                        ...
                        long j5 = j;
                        float f2 = f;
                        long color = ColorSchemeKt.toColor(DialogTokens.INSTANCE.getActionLabelTextColor(), $composer3, 6);
                        long j6 = j2;
                        long j7 = j3;
                        long j8 = j4;
                        int i18 = i15;
                        int i19 = i16;
                        AlertDialogKt.m1305AlertDialogContent4hvqGtA(composableLambda, null, function211, function212, function213, shape5, j5, f2, color, j6, j7, j8, $composer3, ((i18 >> 6) & 7168) | ((i18 >> 6) & 896) | 6 | ((i18 >> 6) & 57344) | ((i18 >> 6) & 458752) | ((i18 >> 6) & 3670016) | ((i19 << 15) & 29360128) | (i18 & 1879048192), (i19 & 14) | (i19 & 112), 2);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$2
            ...
            public final void invoke(Composer composer, int i17) {
                AndroidAlertDialog_androidKt.m1307AlertDialogOix01E0(onDismissRequest, confirmButton, modifier6, function29, function210, function211, function212, shape5, j5, j6, j7, j8, f2, dialogProperties, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
            ...
            AndroidDialog_androidKt.Dialog(onDismissRequest, properties3, ComposableLambdaKt.composableLambda($composer2, 823217604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt$AlertDialog$3
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        final String dialogPaneDescription = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1773getDialogadMyvUU(), $composer3, 6);
                        Modifier m538sizeInqDBjuR0$default = SizeKt.m538sizeInqDBjuR0$default(Modifier.this, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
                        ...
                        Modifier modifier$iv = m538sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion, false, (Function1) value$iv$iv, 1, null));
