        ...
        if (isInTouchMode) {
            ?? r7 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
                ...
                public void mo818onStartk4lQ0M(long startPoint) {
                    boolean m876outOfBoundary2x9bVx0;
                    ...
                    if (it != null) {
                        ...
                        m876outOfBoundary2x9bVx0 = SelectionControllerKt.m876outOfBoundary2x9bVx0(function03.invoke(), startPoint, startPoint);
                        if (m876outOfBoundary2x9bVx0) {
                ...
                public void mo817onDragk4lQ0M(long delta) {
                    ...
                    if (it != null) {
                        ...
                        if (it.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                            long m2736plusMKHz9U = Offset.m2736plusMKHz9U(this.dragTotalDistance, delta);
                            this.dragTotalDistance = m2736plusMKHz9U;
                            long newPosition = Offset.m2736plusMKHz9U(this.lastPosition, m2736plusMKHz9U);
                            m876outOfBoundary2x9bVx0 = SelectionControllerKt.m876outOfBoundary2x9bVx0(function03.invoke(), this.lastPosition, newPosition);
                            if (!m876outOfBoundary2x9bVx0) {
