...
public final class Xyz extends ColorSpace {
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        float val1$iv = clamp(v0);
        float val2$iv = clamp(v1);
