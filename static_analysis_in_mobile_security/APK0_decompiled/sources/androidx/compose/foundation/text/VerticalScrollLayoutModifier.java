...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(TextFieldScrollerPosition scrollerPosition, int cursorOffset, TransformedText transformedText, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        Intrinsics.checkNotNullParameter(scrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText, "transformedText");
        Intrinsics.checkNotNullParameter(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        long childConstraints;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        childConstraints = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : Integer.MAX_VALUE);
        final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
        final int height = Math.min(placeable.getHeight(), Constraints.m5217getMaxHeightimpl(constraints));
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, placeable.getWidth());
                this.getScrollerPosition().update(Orientation.Vertical, cursorRect, height, placeable.getHeight());
                float offset = -this.getScrollerPosition().getOffset();
                Placeable.PlacementScope.placeRelative$default(layout, placeable, 0, MathKt.roundToInt(offset), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
