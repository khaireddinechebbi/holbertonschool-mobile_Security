...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m377setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m376setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        m363alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m363alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, constraints);
