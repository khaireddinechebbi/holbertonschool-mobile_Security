        ...
        switch (this.label) {
            case 0:
                ...
                if (!this.$consumed) {
                    ...
                    this.label = 1;
                    if (nestedScrollDispatcher2.m3990dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m5510getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 2;
                    if (nestedScrollDispatcher.m3990dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m5510getZero9UxMQ8M(), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
