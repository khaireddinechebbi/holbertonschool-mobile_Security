...
public interface PointerInputModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static boolean all(PointerInputModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$all($this, predicate);
        }

        @Deprecated
        public static boolean any(PointerInputModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
        ...
        @Deprecated
        public static Modifier then(PointerInputModifier $this, Modifier other) {
