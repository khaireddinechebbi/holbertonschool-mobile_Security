...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int m5220getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m5220getMinWidthimpl(constraints);
        int m5219getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m5219getMinHeightimpl(constraints) : 0;
        if (this.direction != Direction.Vertical && this.unbounded) {
            m5218getMaxWidthimpl = Integer.MAX_VALUE;
        } else {
            m5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl(constraints);
        }
        long wrappedConstraints = ConstraintsKt.Constraints(m5220getMinWidthimpl, m5218getMaxWidthimpl, m5219getMinHeightimpl, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m5217getMaxHeightimpl(constraints) : Integer.MAX_VALUE);
        ...
        return MeasureScope.CC.layout$default(measure, wrapperWidth, wrapperHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                long position = WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m5426boximpl(IntSizeKt.IntSize(wrapperWidth - placeable.getWidth(), wrapperHeight - placeable.getHeight())), measure.getLayoutDirection()).getPackedValue();
