...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.Outlined $this$CheckCircle) {
        ...
        ImageVector.Builder $this$_get_CheckCircle__u24lambda_u241 = new ImageVector.Builder("Outlined.CheckCircle", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.reflectiveCurveToRelative(-3.59f, 8.0f, -8.0f, 8.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(16.59f, 7.58f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(10.0f, 14.17f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineToRelative(-2.59f, -2.58f);
