...
public final class TextStyleKt {
    ...
    public static final int m4800resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m5143equalsimpl0(textDirection.getValue(), TextDirection.INSTANCE.m5147getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5148getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5149getContentOrRtls_7Xco();
                default:
        ...
        if (textDirection == null) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5150getLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5151getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
