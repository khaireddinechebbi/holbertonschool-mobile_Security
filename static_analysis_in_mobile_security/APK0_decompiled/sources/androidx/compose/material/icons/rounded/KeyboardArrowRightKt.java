...
public final class KeyboardArrowRightKt {
    ...
    public static final ImageVector getKeyboardArrowRight(Icons.Rounded $this$KeyboardArrowRight) {
        ...
        ImageVector.Builder $this$_get_KeyboardArrowRight__u24lambda_u241 = new ImageVector.Builder("Rounded.KeyboardArrowRight", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(9.29f, 15.88f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(13.17f, 12.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(9.29f, 8.12f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(10.7f, 17.3f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.38f, -0.39f, -0.39f, -1.03f, 0.0f, -1.42f);
