...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m2168getIconSizeD9Ej5fM();

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1551getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1550elevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m2185getContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m2195getPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m2188getFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m2189getHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1552loweredElevationxZ9QkE(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = FabPrimaryTokens.INSTANCE.m2191getLoweredContainerElevationD9Ej5fM();
        }
        if ((i & 2) != 0) {
            pressedElevation = FabPrimaryTokens.INSTANCE.m2194getLoweredPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) != 0) {
            focusedElevation = FabPrimaryTokens.INSTANCE.m2192getLoweredFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) != 0) {
            hoveredElevation = FabPrimaryTokens.INSTANCE.m2193getLoweredHoverContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1548bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m1549bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: bottomAppBarFabElevation-a9UjIt4, reason: not valid java name */
    public final FloatingActionButtonElevation m1549bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
