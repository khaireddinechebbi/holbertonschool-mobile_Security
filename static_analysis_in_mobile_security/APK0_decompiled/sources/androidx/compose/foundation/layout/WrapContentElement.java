...
final class WrapContentElement extends ModifierNodeElement<WrapContentNode> {
    ...
    public WrapContentElement(Direction direction, boolean unbounded, Function2<? super IntSize, ? super LayoutDirection, IntOffset> alignmentCallback, Object align, String inspectorName) {
    ...
    public boolean equals(Object other) {
        ...
        return this.direction == ((WrapContentElement) other).direction && this.unbounded == ((WrapContentElement) other).unbounded && Intrinsics.areEqual(this.align, ((WrapContentElement) other).align);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.direction.hashCode();
        return (((result * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.unbounded)) * 31) + this.align.hashCode();
    }
    ...
    public static final class Companion {
        ...
        public final WrapContentElement width(final Alignment.Horizontal align, boolean unbounded) {
            ...
            return new WrapContentElement(Direction.Horizontal, unbounded, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.WrapContentElement$Companion$width$1
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                    return IntOffset.m5383boximpl(m588invoke5SAbXVA(intSize.getPackedValue(), layoutDirection));
                }

                /* renamed from: invoke-5SAbXVA, reason: not valid java name */
                public final long m588invoke5SAbXVA(long size, LayoutDirection layoutDirection) {
                    Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                    return IntOffsetKt.IntOffset(Alignment.Horizontal.this.align(0, IntSize.m5434getWidthimpl(size), layoutDirection), 0);
                }
        ...
        public final WrapContentElement height(final Alignment.Vertical align, boolean unbounded) {
            ...
            return new WrapContentElement(Direction.Vertical, unbounded, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.WrapContentElement$Companion$height$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                    return IntOffset.m5383boximpl(m586invoke5SAbXVA(intSize.getPackedValue(), layoutDirection));
                }

                /* renamed from: invoke-5SAbXVA, reason: not valid java name */
                public final long m586invoke5SAbXVA(long size, LayoutDirection layoutDirection) {
                    Intrinsics.checkNotNullParameter(layoutDirection, "<anonymous parameter 1>");
                    return IntOffsetKt.IntOffset(0, Alignment.Vertical.this.align(0, IntSize.m5433getHeightimpl(size)));
                }
        ...
        public final WrapContentElement size(final Alignment align, boolean unbounded) {
            ...
            return new WrapContentElement(Direction.Both, unbounded, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.WrapContentElement$Companion$size$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                    return IntOffset.m5383boximpl(m587invoke5SAbXVA(intSize.getPackedValue(), layoutDirection));
                }

                /* renamed from: invoke-5SAbXVA, reason: not valid java name */
                public final long m587invoke5SAbXVA(long size, LayoutDirection layoutDirection) {
                    Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                    return Alignment.this.mo2621alignKFBX0sM(IntSize.INSTANCE.m5439getZeroYbymL2g(), size, layoutDirection);
                }
