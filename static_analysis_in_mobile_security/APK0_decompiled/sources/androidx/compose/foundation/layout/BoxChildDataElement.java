...
final class BoxChildDataElement extends ModifierNodeElement<BoxChildDataNode> {
    ...
    public int hashCode() {
        ...
        return (result * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.matchParentSize);
    }
    ...
    public boolean equals(Object other) {
        ...
        BoxChildDataElement otherModifier = other instanceof BoxChildDataElement ? (BoxChildDataElement) other : null;
        return otherModifier != null && Intrinsics.areEqual(this.alignment, otherModifier.alignment) && this.matchParentSize == otherModifier.matchParentSize;
    }
}
