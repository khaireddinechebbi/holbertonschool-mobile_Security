...
public final class Node extends NodeParent {
    ...
    public boolean dispatchMainEventPass(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        int m4443constructorimpl = NodeKind.m4443constructorimpl(16);
        ...
        if (this.pointerInputFilter.getIsAttached()) {
            ...
            int m4443constructorimpl2 = NodeKind.m4443constructorimpl(16);
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (this_$iv4.relevantChanges.isEmpty()) {
            z = false;
        } else if (this_$iv4.pointerInputFilter.getIsAttached()) {
            int i3 = 0;
            PointerEvent event = this.pointerEvent;
            Intrinsics.checkNotNull(event);
            LayoutCoordinates layoutCoordinates = this.coordinates;
    ...
    public boolean buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean isInBounds) {
        ...
        while (node != null) {
            if (node instanceof PointerInputModifierNode) {
                ...
                Modifier.Node this_$iv$iv = node;
                if (((this_$iv$iv.getKindSet() & kind$iv3) != 0) && (node instanceof DelegatingNode)) {
                    int count$iv = 0;
                    DelegatingNode this_$iv$iv2 = (DelegatingNode) node;
                    Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                    while (node$iv$iv != null) {
        ...
        while (it.hasNext()) {
            ...
            if (0 <= size) {
                while (true) {
                    ...
                    if (this_$iv2.getContent()[i2].m4092unboximpl() == keyValue) {
            ...
            if (keyInPointerIds) {
                ...
                Map<PointerId, PointerInputChange> map = this.relevantChanges;
                PointerId m4086boximpl = PointerId.m4086boximpl(key);
                LayoutCoordinates layoutCoordinates2 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates2);
                long mo4233localPositionOfR5De75A = layoutCoordinates2.mo4233localPositionOfR5De75A(parentCoordinates, change.getPreviousPosition());
                LayoutCoordinates layoutCoordinates3 = this.coordinates;
                Intrinsics.checkNotNull(layoutCoordinates3);
                map.put(m4086boximpl, PointerInputChange.m4096copyOHpmEuE$default(change, 0L, 0L, layoutCoordinates3.mo4233localPositionOfR5De75A(parentCoordinates, change.getPosition()), false, 0L, mo4233localPositionOfR5De75A, false, 0, historical, 0L, 731, null));
                it = it2;
            }
        }
        ...
        for (int i3 = this_$iv3.getSize() - 1; -1 < i3; i3--) {
            ...
            long pointerId = this_$iv4.getContent()[i3].m4092unboximpl();
