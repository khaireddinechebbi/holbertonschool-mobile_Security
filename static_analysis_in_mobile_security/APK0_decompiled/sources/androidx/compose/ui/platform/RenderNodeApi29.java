...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    public RenderNodeApi29(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3055getAutoNrFUSI();
    }
    ...
    public void mo4545setCompositingStrategyaDBOjCE(int value) {
        RenderNode $this$setCompositingStrategy_aDBOjCE_u24lambda_u240 = this.renderNode;
        if (CompositingStrategy.m3051equalsimpl0(value, CompositingStrategy.INSTANCE.m3057getOffscreenNrFUSI())) {
            $this$setCompositingStrategy_aDBOjCE_u24lambda_u240.setUseCompositingLayer(true, null);
            $this$setCompositingStrategy_aDBOjCE_u24lambda_u240.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3051equalsimpl0(value, CompositingStrategy.INSTANCE.m3056getModulateAlphaNrFUSI())) {
            $this$setCompositingStrategy_aDBOjCE_u24lambda_u240.setUseCompositingLayer(false, null);
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        android.graphics.Canvas beginRecording = this.renderNode.beginRecording();
        Intrinsics.checkNotNullExpressionValue(beginRecording, "renderNode.beginRecording()");
        android.graphics.Canvas targetCanvas$iv = beginRecording;
        ...
        Canvas $this$record_u24lambda_u241 = canvasHolder.getAndroidCanvas();
        if (clipPath != null) {
            $this$record_u24lambda_u241.save();
            Canvas.CC.m2943clipPathmtrdDE$default($this$record_u24lambda_u241, clipPath, 0, 2, null);
        }
