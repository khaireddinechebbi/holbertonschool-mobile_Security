...
public final class SnapshotStateObserver {
    ...
    static final class ObservedScopeMap {
            ...
            if ($this$fastForEach$iv2 instanceof IdentityArraySet) {
                ...
                while (i$iv$iv < size) {
                    ...
                    if (dependencyToDerivedStates2.contains(value)) {
                        ...
                        int index$iv = dependencyToDerivedStates2.find(value);
                        if (index$iv >= 0) {
                            IdentityArraySet this_$iv$iv3 = dependencyToDerivedStates2.scopeSetAt(index$iv);
                            ...
                            while (index$iv2 < size2) {
                                ...
                                if (policy2.equivalent(derivedState.getCurrentRecord().getCurrentValue(), previousValue)) {
                                    ...
                                    int index$iv3 = valueToScopes.find(derivedState);
                                    if (index$iv3 >= 0) {
                                        IdentityArraySet this_$iv$iv5 = valueToScopes.scopeSetAt(index$iv3);
                    ...
                    int index$iv5 = valueToScopes.find(value);
                    if (index$iv5 >= 0) {
                        IdentityArraySet this_$iv$iv6 = valueToScopes.scopeSetAt(index$iv5);
                ...
                for (Object element$iv$iv : $this$forEach$iv$iv2) {
                    if (dependencyToDerivedStates2.contains(element$iv$iv)) {
                        ...
                        int index$iv6 = this_$iv.find(element$iv$iv);
                        if (index$iv6 >= 0) {
                            IdentityArraySet this_$iv$iv7 = this_$iv.scopeSetAt(index$iv6);
                            ...
                            while (i$iv$iv4 < index$iv7) {
                                ...
                                if (policy4.equivalent(derivedState2.getCurrentRecord().getCurrentValue(), previousValue2)) {
                                    ...
                                    int index$iv8 = valueToScopes.find(derivedState2);
                                    if (index$iv8 >= 0) {
                                        IdentityArraySet this_$iv$iv8 = valueToScopes.scopeSetAt(index$iv8);
                    ...
                    int index$iv10 = valueToScopes.find(element$iv$iv);
                    if (index$iv10 >= 0) {
                        IdentityArraySet this_$iv$iv9 = valueToScopes.scopeSetAt(index$iv10);
        ...
        public final void rereadDerivedState(DerivedState<?> derivedState) {
            ...
            int index$iv = this_$iv.find(derivedState);
            if (index$iv >= 0) {
