...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    private static final float[] tmpMatrix = Matrix.m3202constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public int mo4439entityTypeOLwlOKw() {
        ...
        public boolean interceptOutOfBoundsChildEvents(Modifier.Node node) {
            ...
            int kind$iv3 = NodeKind.m4443constructorimpl(16);
            ...
            while (node2 != null) {
                ...
                if (node2 instanceof PointerInputModifierNode) {
                    ...
                    if (!((this_$iv$iv.getKindSet() & kind$iv3) != 0) || !(node2 instanceof DelegatingNode)) {
                        kind$iv = kind$iv3;
                    } else {
                        int count$iv = 0;
        ...
        public void mo4438childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m4368hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public void mo4438childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m4369hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    ...
    public interface HitTestSource {
        /* renamed from: childHitTest-YqVAtuI */
        void mo4438childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* renamed from: entityType-OLwlOKw */
        int mo4439entityTypeOLwlOKw();
    ...
    public NodeCoordinator(LayoutNode layoutNode) {
        ...
        this.position = IntOffset.INSTANCE.m5402getZeronOccac();
    ...
    public final /* synthetic */ <T> void m4436visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        int i;
        ...
        int i4 = 0;
        boolean includeTail$iv4 = NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m4416hasNodeH91voCI(int type) {
        Modifier.Node headNode = headNode(NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type));
        return headNode != null && DelegatableNodeKt.m4338has64DMado(headNode, type);
    }

    /* renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m4429headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type);
    ...
    public final long mo4232getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        mo4226placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (layer4 != null) {
            layer4.mo4492resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            if (nodeCoordinator != null) {
        ...
        m4282setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        updateLayerParameters(false);
        int type$iv4 = NodeKind.m4443constructorimpl(4);
        NodeCoordinator this_$iv4 = this;
        boolean includeTail$iv$iv = NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type$iv4);
    ...
    protected void m4434setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i = 64;
        if (!getLayoutNode().getNodes().m4406hasH91voCI$ui_release(NodeKind.m4443constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv != null) {
            ...
            int kind$iv = (node.getKindSet() & NodeKind.m4443constructorimpl(i)) != 0 ? 1 : 0;
            if (kind$iv != 0) {
                int m4443constructorimpl = NodeKind.m4443constructorimpl(i);
                MutableVector mutableVector2 = null;
                Modifier.Node node2 = node;
                while (node2 != null) {
                    if (node2 instanceof ParentDataModifierNode) {
                        ...
                        Modifier.Node this_$iv$iv = node2;
                        if (((this_$iv$iv.getKindSet() & m4443constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                            int count$iv2 = 0;
                            DelegatingNode this_$iv$iv2 = (DelegatingNode) node2;
                            Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                            while (node$iv$iv != null) {
                                Modifier.Node next$iv = node$iv$iv;
                                if ((next$iv.getKindSet() & m4443constructorimpl) != 0) {
                                    count$iv2++;
                                    thisNode2 = thisNode3;
                                    if (count$iv2 == 1) {
                                        node2 = next$iv;
    ...
    public final long m4427getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m4432performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m4283setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    public final void onMeasured() {
        ...
        MutableVector mutableVector;
        if (!m4416hasNodeH91voCI(NodeKind.m4443constructorimpl(128))) {
            return;
        }
        ...
        try {
            try {
                int type$iv4 = NodeKind.m4443constructorimpl(128);
                                    ...
                                    try {
                                        if (node instanceof LayoutAwareModifierNode) {
                                            try {
                                                ...
                                                this_$iv3 = this_$iv5;
                                                i2 = i3;
                                                it.mo215onRemeasuredozmzZPI(getMeasuredSize());
                                                type$iv2 = type$iv4;
    ...
    protected void mo4226placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m4420placeSelff8xVGno(position, zIndex, layerBlock);
    }

    /* renamed from: placeSelf-f8xVGno, reason: not valid java name */
    private final void m4420placeSelff8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        updateLayerBlock$default(this, layerBlock, false, 2, null);
        if (!IntOffset.m5391equalsimpl0(getPosition(), position)) {
            m4434setPositiongyyYBs(position);
            ...
            if (layer != null) {
                layer.mo4491movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m4433placeSelfApparentToRealOffsetf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        long other$iv = getApparentToRealOffset();
        m4420placeSelff8xVGno(IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(position) + IntOffset.m5392getXimpl(other$iv), IntOffset.m5393getYimpl(position) + IntOffset.m5393getYimpl(other$iv)), zIndex, layerBlock);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float x = IntOffset.m5392getXimpl(getPosition());
        float y = IntOffset.m5393getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas) {
        Modifier.Node head = m4429headH91voCI(NodeKind.m4443constructorimpl(4));
        if (head == null) {
            performDraw(canvas);
        } else {
            LayoutNodeDrawScope drawScope = getLayoutNode().getMDrawScope$ui_release();
            drawScope.m4378drawx_KDEd0$ui_release(canvas, IntSizeKt.m5444toSizeozmzZPI(mo4232getSizeYbymL2g()), this, head);
        }
    }
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (isAttached() && layerBlock != null) {
            if (this.layer == null) {
                ...
                $this$updateLayerBlock_u24lambda_u2413.mo4492resizeozmzZPI(getMeasuredSize());
                $this$updateLayerBlock_u24lambda_u2413.mo4491movegyyYBs(getPosition());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        reusableGraphicsLayerScope.m3283setSizeuvyYCjk(IntSizeKt.m5444toSizeozmzZPI(mo4232getSizeYbymL2g()));
    ...
    public final long m4428getMinimumTouchTargetSizeNHjbRc() {
        Density $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2416 = this.layerDensity;
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2416.mo328toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo4372getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m4430hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        Modifier.Node head = m4429headH91voCI(hitTestSource.mo4439entityTypeOLwlOKw());
        if (!m4437withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float distanceFromEdge = m4425distanceInMinimumTouchTargettz77jQw(pointerPosition, m4428getMinimumTouchTargetSizeNHjbRc());
                if (((Float.isInfinite(distanceFromEdge) || Float.isNaN(distanceFromEdge)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m4418hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                    return;
                }
                return;
            }
        ...
        if (head == null) {
            mo4361hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m4431isPointerInBoundsk4lQ0M(pointerPosition)) {
            m4417hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float distanceFromEdge2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m4425distanceInMinimumTouchTargettz77jQw(pointerPosition, m4428getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(distanceFromEdge2) || Float.isNaN(distanceFromEdge2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
            m4418hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        } else {
            m4421speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m4417hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Modifier.Node m4441nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m4441nextUntilhw7D004 = NodeCoordinatorKt.m4441nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2));
                    nodeCoordinator.m4417hit1hIXUjU(m4441nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m4418hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                public final void invoke2() {
                    Modifier.Node m4441nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m4441nextUntilhw7D004 = NodeCoordinatorKt.m4441nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2));
                    nodeCoordinator.m4418hitNearJHbHoSQ(m4441nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m4421speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        Modifier.Node m4441nextUntilhw7D004;
        if ($this$speculativeHit_u2dJHbHoSQ != null) {
            if (!hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
                m4441nextUntilhw7D004 = NodeCoordinatorKt.m4441nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2));
                m4421speculativeHitJHbHoSQ(m4441nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                return;
            } else {
                hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        Modifier.Node m4441nextUntilhw7D0042;
                        NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                        m4441nextUntilhw7D0042 = NodeCoordinatorKt.m4441nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2));
                        nodeCoordinator.m4421speculativeHitJHbHoSQ(m4441nextUntilhw7D0042, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                    }
                });
                return;
            }
    ...
    public void mo4361hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        NodeCoordinator wrapped = this.wrapped;
        if (wrapped != null) {
            long positionInWrapped = wrapped.m4426fromParentPositionMKHz9U(pointerPosition);
            wrapped.m4430hitTestYqVAtuI(hitTestSource, positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m4424calculateMinimumTouchTargetPaddingE7KxVPU(m4428getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m2800getWidthimpl(padding));
        bounds.setTop(-Size.m2797getHeightimpl(padding));
        bounds.setRight(getMeasuredWidth() + Size.m2800getWidthimpl(padding));
        bounds.setBottom(getMeasuredHeight() + Size.m2797getHeightimpl(padding));
    ...
    public long mo4237windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        long positionInRoot = Offset.m2735minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo4495calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root));
        return mo4233localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo4235localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo4234localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo4496calculatePositionInWindowMKHz9U(positionInRoot);
    }
    ...
    public long mo4233localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            return Offset.m2740unaryMinusF1C5BW0(sourceCoordinates.mo4233localPositionOfR5De75A(this, Offset.m2740unaryMinusF1C5BW0(relativeToSource)));
        }
        ...
        while (coordinator != commonAncestor) {
            position = coordinator.m4435toParentPositionMKHz9U(position);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m4415ancestorToLocalR5De75A(commonAncestor, position);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformFrom-EL8BTi8 */
    public void mo4236transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        ...
        Matrix.m3211resetimpl(matrix);
        coordinator.m4423transformToAncestorEL8BTi8(commonAncestor, matrix);
        m4422transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m4423transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.mo4493transform58bKbWc(matrix);
            }
            long position = wrapper.getPosition();
            if (!IntOffset.m5391equalsimpl0(position, IntOffset.INSTANCE.m5402getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m3211resetimpl(fArr);
                Matrix.m3222translateimpl$default(fArr, IntOffset.m5392getXimpl(position), IntOffset.m5393getYimpl(position), 0.0f, 4, null);
                Matrix.m3219timesAssign58bKbWc(matrix, fArr);
            }
    ...
    private final void m4422transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m4422transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m5391equalsimpl0(getPosition(), IntOffset.INSTANCE.m5402getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m3211resetimpl(fArr);
                Matrix.m3222translateimpl$default(fArr, -IntOffset.m5392getXimpl(getPosition()), -IntOffset.m5393getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m3219timesAssign58bKbWc(matrix, fArr);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo4488inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m5434getWidthimpl(sourceCoordinates.mo4232getSizeYbymL2g()));
        bounds.setBottom(IntSize.m5433getHeightimpl(sourceCoordinates.mo4232getSizeYbymL2g()));
    ...
    private final long m4415ancestorToLocalR5De75A(NodeCoordinator ancestor, long offset) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy = this.wrappedBy;
        if (wrappedBy == null || Intrinsics.areEqual(ancestor, wrappedBy)) {
            return m4426fromParentPositionMKHz9U(offset);
        }
        return m4426fromParentPositionMKHz9U(wrappedBy.m4415ancestorToLocalR5De75A(ancestor, offset));
    }
    ...
    public long mo4234localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        onCoordinatesUsed$ui_release();
    ...
    public long m4435toParentPositionMKHz9U(long position) {
        OwnedLayer layer = this.layer;
        long targetPosition = layer != null ? layer.mo4490mapOffset8S9VItk(position, false) : position;
        return IntOffsetKt.m5406plusNvtHpc(targetPosition, getPosition());
    }

    /* renamed from: fromParentPosition-MK-Hz9U, reason: not valid java name */
    public long m4426fromParentPositionMKHz9U(long position) {
        long relativeToPosition = IntOffsetKt.m5404minusNvtHpc(position, getPosition());
        OwnedLayer layer = this.layer;
        return layer != null ? layer.mo4490mapOffset8S9VItk(relativeToPosition, true) : relativeToPosition;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(paint, "paint");
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m5434getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m5433getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m4428getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m2800getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m2797getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, IntSize.m5434getWidthimpl(mo4232getSizeYbymL2g()) + horz, IntSize.m5433getHeightimpl(mo4232getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m5434getWidthimpl(mo4232getSizeYbymL2g()), IntSize.m5433getHeightimpl(mo4232getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m5392getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m5393getYimpl(getPosition());
    ...
    protected final boolean m4437withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m2748isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer = this.layer;
        return layer == null || !this.isClipping || layer.mo4489isInLayerk4lQ0M(pointerPosition);
    }

    /* renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m4431isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m2731getXimpl(pointerPosition);
        float y = Offset.m2732getYimpl(pointerPosition);
    ...
    static /* synthetic */ Object propagateRelocationRequest$suspendImpl(NodeCoordinator $this, Rect rect, Continuation<? super Unit> continuation) {
        ...
        Rect rectInParentBounds = rect.m2768translatek4lQ0M(boundingBoxInParentCoordinates.m2766getTopLeftF1C5BW0());
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int m4443constructorimpl = NodeKind.m4443constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start = headNode(NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(NodeKind.m4443constructorimpl(16)));
        if (start == null) {
            return false;
        }
        Modifier.Node $this$visitLocalDescendants_u2d6rFNWt0$iv = start;
        int type$iv3 = NodeKind.m4443constructorimpl(16);
    ...
    private final long m4419offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m2731getXimpl(pointerPosition);
    ...
    protected final long m4424calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        float widthDiff = Size.m2800getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth();
        float heightDiff = Size.m2797getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight();
        return SizeKt.Size(Math.max(0.0f, widthDiff / 2.0f), Math.max(0.0f, heightDiff / 2.0f));
    }

    /* renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m4425distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m2800getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m2797getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long m4424calculateMinimumTouchTargetPaddingE7KxVPU = m4424calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m2800getWidthimpl(m4424calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m2797getHeightimpl(m4424calculateMinimumTouchTargetPaddingE7KxVPU);
        long offsetFromEdge = m4419offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m2731getXimpl(offsetFromEdge) <= width && Offset.m2732getYimpl(offsetFromEdge) <= height) {
            return Offset.m2730getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }
