...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1599constructorimpl(1);
    private static final int TwoLine = m1599constructorimpl(2);
    private static final int ThreeLine = m1599constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m1597boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1599constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1600equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1602hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1603toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1604compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m1598compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m1604compareToyh95HIg(int other) {
        return m1598compareToyh95HIg(this.lines, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m1607getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* renamed from: getTwoLine-AlXitO8, reason: not valid java name */
        public final int m1609getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* renamed from: getThreeLine-AlXitO8, reason: not valid java name */
        public final int m1608getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* renamed from: getListItemType-7AlIA9s$material3_release, reason: not valid java name */
        public final int m1606getListItemType7AlIA9s$material3_release(boolean hasOverline, boolean hasSupporting) {
            if (hasOverline && hasSupporting) {
                return m1608getThreeLineAlXitO8();
            }
            if (hasOverline || hasSupporting) {
                return m1609getTwoLineAlXitO8();
            }
            return m1607getOneLineAlXitO8();
        }
    }
}
