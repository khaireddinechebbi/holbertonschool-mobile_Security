...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5274constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m166basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        int i6;
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        int m232getImmediatelyZbEOnfQ = (i5 & 2) != 0 ? MarqueeAnimationMode.INSTANCE.m232getImmediatelyZbEOnfQ() : i2;
        int i7 = (i5 & 4) != 0 ? DefaultMarqueeDelayMillis : i3;
        if ((i5 & 8) != 0) {
            i6 = MarqueeAnimationMode.m226equalsimpl0(m232getImmediatelyZbEOnfQ, MarqueeAnimationMode.INSTANCE.m232getImmediatelyZbEOnfQ()) ? i7 : 0;
        } else {
            i6 = i4;
        }
        return m165basicMarquee1Mj1MLw(modifier, i, m232getImmediatelyZbEOnfQ, i7, i6, (i5 & 16) != 0 ? DefaultMarqueeSpacing : marqueeSpacing, (i5 & 32) != 0 ? DefaultMarqueeVelocity : f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m165basicMarquee1Mj1MLw(Modifier basicMarquee, int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
    ...
    public static final AnimationSpec<Float> m167createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        float pxPerSec = density.mo327toPx0680j_4(velocity);
        TweenSpec singleSpec = velocityBasedTween(Math.abs(pxPerSec), targetValue, delayMillis);
        long startOffset = StartOffset.m112constructorimpl$default((-delayMillis) + initialDelayMillis, 0, 2, null);
    ...
    public static final MarqueeSpacing m163MarqueeSpacing0680j_4(final float spacing) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
                ...
                return MarqueeSpacing.mo321roundToPx0680j_4(spacing);
            }
        };
    }
}
