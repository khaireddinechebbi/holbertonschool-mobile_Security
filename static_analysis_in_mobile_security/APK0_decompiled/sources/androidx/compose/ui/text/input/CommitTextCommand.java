...
public final class CommitTextCommand implements EditCommand {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof CommitTextCommand) && Intrinsics.areEqual(getText(), ((CommitTextCommand) other).getText()) && this.newCursorPosition == ((CommitTextCommand) other).newCursorPosition;
    }
