...
public final class TextFieldGestureModifiersKt {
    public static final Modifier longPressDragGestureFilter(Modifier $this$longPressDragGestureFilter, TextDragObserver observer, boolean enabled) {
        ...
        if (enabled) {
            return SuspendingPointerInputFilterKt.pointerInput($this$longPressDragGestureFilter, observer, new TextFieldGestureModifiersKt$longPressDragGestureFilter$1(observer, null));
        }
    ...
    public static final Modifier mouseDragGestureDetector(Modifier $this$mouseDragGestureDetector, MouseSelectionObserver observer, boolean enabled) {
        ...
        Intrinsics.checkNotNullParameter(observer, "observer");
        return enabled ? SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, observer, new TextFieldGestureModifiersKt$mouseDragGestureDetector$1(observer, null)) : $this$mouseDragGestureDetector;
    }
}
