...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(Icons.Rounded $this$ExitToApp) {
        ...
        ImageVector.Builder $this$_get_ExitToApp__u24lambda_u241 = new ImageVector.Builder("Rounded.ExitToApp", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(10.79f, 16.29f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(12.2f, 7.7f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-0.39f, 0.39f, -0.38f, 1.03f, 0.0f, 1.41f);
