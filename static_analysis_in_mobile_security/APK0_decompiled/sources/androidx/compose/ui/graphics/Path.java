...
public interface Path {
    ...
    void mo2863addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo2865opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo2866setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    void mo2867transform58bKbWc(float[] matrix);

    /* renamed from: translate-k-4lQ0M */
    void mo2868translatek4lQ0M(long offset);

    /* compiled from: Path.kt */
    /* renamed from: androidx.compose.ui.graphics.Path$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        static {
            Companion companion = Path.INSTANCE;
        }

        public static void $default$arcToRad(Path _this, Rect rect, float startAngleRadians, float sweepAngleRadians, boolean forceMoveTo) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            _this.arcTo(rect, DegreesKt.degrees(startAngleRadians), DegreesKt.degrees(sweepAngleRadians), forceMoveTo);
        }

        /* renamed from: addPath-Uv8p0NA$default, reason: not valid java name */
        public static /* synthetic */ void m3242addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: addPath-Uv8p0NA");
            }
            if ((i & 2) != 0) {
                j = Offset.INSTANCE.m2747getZeroF1C5BW0();
            }
            path.mo2863addPathUv8p0NA(path2, j);
        }
    }
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static void arcToRad(Path $this, Rect rect, float startAngleRadians, float sweepAngleRadians, boolean forceMoveTo) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            CC.$default$arcToRad($this, rect, startAngleRadians, sweepAngleRadians, forceMoveTo);
        }

        @Deprecated
        public static void rewind(Path $this) {
            $this.reset();
        }

        @Deprecated
        /* renamed from: transform-58bKbWc, reason: not valid java name */
        public static void m3245transform58bKbWc(Path $this, float[] matrix) {
    ...
    public static final class Companion {
        ...
        public final Path m3243combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.mo2865opN5in7k0(path1, path2, operation)) {
                return path;
            }
