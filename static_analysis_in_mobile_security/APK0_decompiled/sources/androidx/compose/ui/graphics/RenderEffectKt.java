...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m3280BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m3344getClamp3opZhB0();
        }
        return m3279BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m3279BlurEffect3YTHUZs(float radiusX, float radiusY, int edgeTreatment) {
    ...
    public static final OffsetEffect OffsetEffect(float offsetX, float offsetY) {
        return new OffsetEffect(null, OffsetKt.Offset(offsetX, offsetY), null);
    }
}
