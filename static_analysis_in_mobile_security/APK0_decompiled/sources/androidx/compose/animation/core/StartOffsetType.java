...
public final class StartOffsetType {
    ...
    private static final int Delay = m121constructorimpl(-1);
    private static final int FastForward = m121constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m120boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m121constructorimpl(int i) {
        return i;
    }
    ...
    public static int m124hashCodeimpl(int i) {
        return i;
    }
