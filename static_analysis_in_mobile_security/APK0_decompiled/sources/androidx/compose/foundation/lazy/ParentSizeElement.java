...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ParentSizeNode) {
            return ((this.fraction > ((ParentSizeNode) other).getFraction() ? 1 : (this.fraction == ((ParentSizeNode) other).getFraction() ? 0 : -1)) == 0) && Intrinsics.areEqual(this.widthState, ((ParentSizeNode) other).getWidthState()) && Intrinsics.areEqual(this.heightState, ((ParentSizeNode) other).getHeightState());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result2 * 31) + Float.floatToIntBits(this.fraction);
    }
