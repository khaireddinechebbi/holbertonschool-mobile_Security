...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2621alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m5434getWidthimpl(space) - IntSize.m5434getWidthimpl(size), IntSize.m5433getHeightimpl(space) - IntSize.m5433getHeightimpl(size));
        float centerX = IntSize.m5434getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m5433getHeightimpl(remaining) / 2.0f;
        float f = 1;
