...
.method public static final boundsInWindow(Landroidx/compose/ui/layout/LayoutCoordinates;)Landroidx/compose/ui/geometry/Rect;
    ...
    .local v17, "bounds":Landroidx/compose/ui/geometry/Rect;
    ...
    .local v19, "root":Landroidx/compose/ui/layout/LayoutCoordinates;
    const/4 v0, 0x3

    move/from16 v20, v3

    .end local v3    # "rootWidth":F
    .local v20, "rootWidth":F
    new-array v3, v0, [F
    ...
    invoke-static {v15, v3}, Lkotlin/comparisons/ComparisonsKt;->minOf(F[F)F
    ...
    .end local v4    # "rootHeight":F
    .local v21, "rootHeight":F
    new-array v4, v0, [F
    ...
    invoke-static {v15, v4}, Lkotlin/comparisons/ComparisonsKt;->minOf(F[F)F
    ...
    .end local v5    # "boundsLeft":F
    .local v23, "boundsLeft":F
    new-array v5, v0, [F
    ...
    invoke-static {v15, v5}, Lkotlin/comparisons/ComparisonsKt;->maxOf(F[F)F
    ...
    invoke-static {v15, v0}, Lkotlin/comparisons/ComparisonsKt;->maxOf(F[F)F
    ...
    invoke-direct {v15, v3, v4, v5, v0}, Landroidx/compose/ui/geometry/Rect;-><init>(FFFF)V
    ...
    .end local v17    # "bounds":Landroidx/compose/ui/geometry/Rect;
    .end local v19    # "root":Landroidx/compose/ui/layout/LayoutCoordinates;
    .end local v20    # "rootWidth":F
    .end local v21    # "rootHeight":F
    .end local v23    # "boundsLeft":F
    .local v0, "root":Landroidx/compose/ui/layout/LayoutCoordinates;
    .restart local v2    # "bounds":Landroidx/compose/ui/geometry/Rect;
    .local v3, "rootWidth":F
    .local v4, "rootHeight":F
    .local v5, "boundsLeft":F
    :cond_3
    ...
    .end local v4    # "rootHeight":F
    .end local v5    # "boundsLeft":F
    .restart local v17    # "bounds":Landroidx/compose/ui/geometry/Rect;
    .restart local v19    # "root":Landroidx/compose/ui/layout/LayoutCoordinates;
    .restart local v20    # "rootWidth":F
    .restart local v21    # "rootHeight":F
    .restart local v23    # "boundsLeft":F
    :goto_2
