...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        PersistentHashMap newMap = this.hashMapBuilder.build2();
        if (newMap == this.set.getHashMap$runtime_release()) {
            CommonFunctionsKt.m2616assert(this.firstElement == this.set.getFirstElement());
            CommonFunctionsKt.m2616assert(this.lastElement == this.set.getLastElement());
