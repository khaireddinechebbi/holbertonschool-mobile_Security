...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    private ClickableSemanticsNode(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> function0) {
    ...
    public final void m205updateUMe6uN4(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick) {
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        this.enabled = enabled;
        this.onClickLabel = onClickLabel;
        this.role = role;
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m4624setRolekuIjeqM($this$applySemantics, role.getValue());
        }
        SemanticsPropertiesKt.onClick($this$applySemantics, this.onClickLabel, new Function0<Boolean>() { // from class: androidx.compose.foundation.ClickableSemanticsNode$applySemantics$1
            {
                super(0);
            }
        ...
        if (this.onLongClick != null) {
            SemanticsPropertiesKt.onLongClick($this$applySemantics, this.onLongClickLabel, new Function0<Boolean>() { // from class: androidx.compose.foundation.ClickableSemanticsNode$applySemantics$2
                {
                    super(0);
                }
