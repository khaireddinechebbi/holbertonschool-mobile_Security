...
public final class KeyboardActions {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardActions) && Intrinsics.areEqual(this.onDone, ((KeyboardActions) other).onDone) && Intrinsics.areEqual(this.onGo, ((KeyboardActions) other).onGo) && Intrinsics.areEqual(this.onNext, ((KeyboardActions) other).onNext) && Intrinsics.areEqual(this.onPrevious, ((KeyboardActions) other).onPrevious) && Intrinsics.areEqual(this.onSearch, ((KeyboardActions) other).onSearch) && Intrinsics.areEqual(this.onSend, ((KeyboardActions) other).onSend);
    }
    ...
    public int hashCode() {
        ...
        int result4 = (result3 + (function13 != null ? function13.hashCode() : 0)) * 31;
        Function1<KeyboardActionScope, Unit> function14 = this.onPrevious;
        int result5 = (result4 + (function14 != null ? function14.hashCode() : 0)) * 31;
        Function1<KeyboardActionScope, Unit> function15 = this.onSearch;
        int result6 = (result5 + (function15 != null ? function15.hashCode() : 0)) * 31;
        Function1<KeyboardActionScope, Unit> function16 = this.onSend;
        return result6 + (function16 != null ? function16.hashCode() : 0);
    }
