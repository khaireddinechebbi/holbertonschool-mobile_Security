...
public final class TrieNode<E> {
    ...
    public final TrieNode<E> mutableAddAll(TrieNode<E> otherNode, int shift, DeltaCounter intersectionSizeRef, PersistentHashSetBuilder<?> mutator) {
        ...
        TrieNode mutableNode = (newBitMap == i && Intrinsics.areEqual(this.ownedBy, mutator.getOwnership())) ? this : new TrieNode(newBitMap, new Object[Integer.bitCount(newBitMap)], mutator.getOwnership());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x00f6, code lost:
        ...
        if ((r0 instanceof androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode) == false) goto L53;
     */
    /* JADX WARN: Multi-variable type inference failed */
    /*
