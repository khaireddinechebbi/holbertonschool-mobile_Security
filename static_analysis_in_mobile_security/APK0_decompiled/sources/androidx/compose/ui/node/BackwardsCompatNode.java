...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((this_$iv.getKindSet() & NodeKind.m4443constructorimpl(32)) != 0) {
        ...
        if ((this_$iv2.getKindSet() & NodeKind.m4443constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        BackwardsCompatNode this_$iv2 = this;
        if ((this_$iv2.getKindSet() & NodeKind.m4443constructorimpl(4)) != 0) {
        ...
        if ((this_$iv3.getKindSet() & NodeKind.m4443constructorimpl(2)) != 0) {
        ...
        if ((this_$iv4.getKindSet() & NodeKind.m4443constructorimpl(128)) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$2
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode.onPlaced(DelegatableNodeKt.m4340requireCoordinator64DMado(backwardsCompatNode, NodeKind.m4443constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if (((this_$iv5.getKindSet() & NodeKind.m4443constructorimpl(256)) != 0) && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if (((this_$iv7.getKindSet() & NodeKind.m4443constructorimpl(16)) != 0) && (element instanceof PointerInputModifier)) {
        ...
        if ((this_$iv8.getKindSet() & NodeKind.m4443constructorimpl(8)) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo2636getSizeNHjbRc() {
        return IntSizeKt.m5444toSizeozmzZPI(DelegatableNodeKt.m4340requireCoordinator64DMado(this, NodeKind.m4443constructorimpl(128)).mo4232getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        int m4443constructorimpl = NodeKind.m4443constructorimpl(32);
        if (!backwardsCompatNode3.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        Modifier.Node parent = backwardsCompatNode3.getNode().getParent();
        LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(backwardsCompatNode3);
        while (requireLayoutNode != null) {
            if ((requireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & m4443constructorimpl) != 0) {
                while (parent != null) {
                    if ((parent.getKindSet() & m4443constructorimpl) != 0) {
                        ...
                        while (node != null) {
                            if (node instanceof ModifierLocalModifierNode) {
                                ...
                                i2 = m4443constructorimpl;
                            } else {
                                backwardsCompatNode2 = backwardsCompatNode3;
                                int i5 = 1;
                                if (((node.getKindSet() & m4443constructorimpl) != 0 ? 1 : 0) == 0 || !(node instanceof DelegatingNode)) {
                                    i2 = m4443constructorimpl;
                                } else {
                                    int i6 = 0;
                                    ...
                                    while (delegate != null) {
                                        ...
                                        if ((node2.getKindSet() & m4443constructorimpl) != 0) {
                                            i6++;
                                            if (i6 == i5) {
                                                node = node2;
                                                i3 = m4443constructorimpl;
                                            } else {
                                        ...
                                        m4443constructorimpl = i3;
                                        i5 = 1;
                                    }
                                    i2 = m4443constructorimpl;
                                    if (i6 == 1) {
                                        backwardsCompatNode3 = backwardsCompatNode2;
                                        m4443constructorimpl = i2;
                                    }
                                }
                            }
                    ...
                    backwardsCompatNode3 = backwardsCompatNode3;
                    m4443constructorimpl = m4443constructorimpl;
                }
                backwardsCompatNode = backwardsCompatNode3;
                i = m4443constructorimpl;
            } else {
                backwardsCompatNode = backwardsCompatNode3;
                i = m4443constructorimpl;
            }
            ...
            backwardsCompatNode3 = backwardsCompatNode;
            m4443constructorimpl = i;
        }
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return $this$measure_3p2s80s_u24lambda_u241.mo37measure3p2s80s(measure, measurable, constraints);
    }
    ...
    public void mo143onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        $this$onPointerEvent_H0pRuoY_u24lambda_u247.getPointerInputFilter().mo4127onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo215onRemeasuredozmzZPI(long size) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo252onRemeasuredozmzZPI(size);
        }
    }
