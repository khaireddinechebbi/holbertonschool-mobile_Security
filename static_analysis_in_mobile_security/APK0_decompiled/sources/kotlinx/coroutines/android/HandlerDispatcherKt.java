...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m5563constructorimpl = Result.m5563constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m5569isFailureimpl(m5563constructorimpl) ? null : m5563constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo7121dispatch(cont.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
