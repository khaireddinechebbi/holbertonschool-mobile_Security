...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m5274constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m5274constructorimpl((float) 6.0d);
    ...
    public final float m2024getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m2025getSizeD9Ej5fM() {
        return Size;
    }
}
