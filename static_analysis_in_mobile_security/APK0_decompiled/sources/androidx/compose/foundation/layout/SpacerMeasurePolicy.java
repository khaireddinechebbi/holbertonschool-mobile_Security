...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        int width = Constraints.m5216getHasFixedWidthimpl(constraints) ? Constraints.m5218getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m5215getHasFixedHeightimpl(constraints) ? Constraints.m5217getMaxHeightimpl(constraints) : 0;
        return MeasureScope.CC.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
