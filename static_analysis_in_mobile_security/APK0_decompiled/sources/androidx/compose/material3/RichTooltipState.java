...
public final class RichTooltipState implements TooltipState {
    ...
    private final MutableState isVisible = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(false, null, 2, null);

    /* renamed from: isPersistent$delegate, reason: from kotlin metadata */
    private final MutableState isPersistent = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
    ...
    public final boolean isPersistent$material3_release() {
        State $this$getValue$iv = this.isPersistent;
        return ((Boolean) $this$getValue$iv.getValue()).booleanValue();
    }

    public final void setPersistent$material3_release(boolean z) {
        MutableState $this$setValue$iv = this.isPersistent;
        $this$setValue$iv.setValue(Boolean.valueOf(z));
    }
