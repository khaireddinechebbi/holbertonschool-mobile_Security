...
.method static constructor <clinit>()V
    ...
    sput v1, Landroidx/compose/material/ButtonDefaults;->ButtonVerticalPadding:F
    ...
    .end local v1    # "$this$dp$iv":I
    .end local v2    # "$i$f$getDp":I
    sput v1, Landroidx/compose/material/ButtonDefaults;->MinWidth:F
    ...
    .end local v1    # "$this$dp$iv":I
    .end local v2    # "$i$f$getDp":I
    sput v1, Landroidx/compose/material/ButtonDefaults;->MinHeight:F
    ...
    .end local v1    # "$this$dp$iv":I
    .end local v2    # "$i$f$getDp":I
    sput v1, Landroidx/compose/material/ButtonDefaults;->IconSize:F
    ...
    .end local v1    # "$this$dp$iv":I
    .end local v2    # "$i$f$getDp":I
    sput v1, Landroidx/compose/material/ButtonDefaults;->IconSpacing:F
    ...
    .end local v1    # "$this$dp$iv":I
    .end local v2    # "$i$f$getDp":I
    sput v1, Landroidx/compose/material/ButtonDefaults;->OutlinedBorderSize:F
...
.method public final buttonColors-ro_MJ88(JJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ButtonColors;
    ...
    .end local p5    # "disabledBackgroundColor":J
    .local v7, "disabledBackgroundColor":J
    goto :goto_2

    .line 408
    .end local v7    # "disabledBackgroundColor":J
    .restart local p5    # "disabledBackgroundColor":J
    :cond_2
    move-wide/from16 v19, p5

    .line 410
    .end local p5    # "disabledBackgroundColor":J
    .local v19, "disabledBackgroundColor":J
    :goto_2
    ...
    .line 412
    .end local p7    # "disabledContentColor":J
    .restart local v3    # "disabledContentColor":J
    :goto_3
    ...
    const-string v8, "androidx.compose.material.ButtonDefaults.buttonColors (Button.kt:405)"

    invoke-static {v2, v1, v7, v8}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    :cond_4
    new-instance v2, Landroidx/compose/material/DefaultButtonColors;
    ...
    check-cast v2, Landroidx/compose/material/ButtonColors;
...
.method public final elevation-R_JCAzs(FFFFFLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ButtonElevation;
    ...
    .end local v4    # "$i$f$getDp":I
    .end local p3    # "disabledElevation":F
    .local v3, "disabledElevation":F
    goto :goto_2

    .line 625
    .end local v3    # "disabledElevation":F
    .restart local p3    # "disabledElevation":F
    :cond_2
    move/from16 v11, p3

    .line 626
    .end local p3    # "disabledElevation":F
    .local v11, "disabledElevation":F
    :goto_2
    ...
    .end local v4    # "$i$f$getDp":I
    .end local p5    # "focusedElevation":F
    .local v3, "focusedElevation":F
    goto :goto_4

    .line 627
    .end local v3    # "focusedElevation":F
    .restart local p5    # "focusedElevation":F
    :cond_4
    move/from16 v13, p5

    .line 628
    .end local p5    # "focusedElevation":F
    .local v13, "focusedElevation":F
    :goto_4
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v4, "androidx.compose.material.ButtonDefaults.elevation (Button.kt:371)"
    ...
    .line 386
    .local v20, "$i$a$-remember-ButtonDefaults$elevation$1":I
    new-instance v21, Landroidx/compose/material/DefaultButtonElevation;
    ...
    .line 634
    .end local v20    # "$i$a$-remember-ButtonDefaults$elevation$1":I
    ...
    check-cast v8, Landroidx/compose/material/DefaultButtonElevation;
    ...
    check-cast v8, Landroidx/compose/material/ButtonElevation;
...
.method public final synthetic elevation-yajeYGU(FFFLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ButtonElevation;
    ...
    const-string v1, "C(elevation)P(0:c#ui.unit.Dp,2:c#ui.unit.Dp,1:c#ui.unit.Dp)349@14667L161:Button.kt#jmzs0o"
    ...
    .end local v2    # "$i$f$getDp":I
    .end local p2    # "pressedElevation":F
    .local v1, "pressedElevation":F
    goto :goto_1

    .line 619
    .end local v1    # "pressedElevation":F
    .restart local p2    # "pressedElevation":F
    :cond_1
    move/from16 v12, p2
    ...
    .end local v2    # "$i$f$getDp":I
    .end local p3    # "disabledElevation":F
    .local v1, "disabledElevation":F
    goto :goto_2

    .line 620
    .end local v1    # "disabledElevation":F
    .restart local p3    # "disabledElevation":F
    :cond_2
    move/from16 v13, p3
    ...
    const-string v2, "androidx.compose.material.ButtonDefaults.elevation (Button.kt:345)"
...
.method public final getOutlinedBorder(Landroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/BorderStroke;
    ...
    const-string v1, "C477@19729L6:Button.kt#jmzs0o"
...
.method public final outlinedButtonColors-RGew2ao(JJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ButtonColors;
    ...
    .param p1, "backgroundColor"    # J
    .param p3, "contentColor"    # J
    .param p5, "disabledContentColor"    # J
    ...
    .end local p5    # "disabledContentColor":J
    .local v2, "disabledContentColor":J
    goto :goto_2

    .line 431
    .end local v2    # "disabledContentColor":J
    .restart local p5    # "disabledContentColor":J
    :cond_2
    ...
    const-string v7, "androidx.compose.material.ButtonDefaults.outlinedButtonColors (Button.kt:428)"
    ...
    check-cast v1, Landroidx/compose/material/ButtonColors;
...
.method public final textButtonColors-RGew2ao(JJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material/ButtonColors;
    ...
    .line 454
    .end local p5    # "disabledContentColor":J
    .local v16, "disabledContentColor":J
    :goto_2
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v5, "androidx.compose.material.ButtonDefaults.textButtonColors (Button.kt:449)"
