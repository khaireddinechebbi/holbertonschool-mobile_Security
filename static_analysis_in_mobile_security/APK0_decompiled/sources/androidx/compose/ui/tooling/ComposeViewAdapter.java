...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    public ComposeViewAdapter(Context context, AttributeSet attrs) {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5185getLambda2$ui_tooling_release();
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m3025toArgb8_81llA(Color.INSTANCE.m3005getRed0d7_KjU()));
    ...
    private final void processViewInfos() {
        ...
        if (this.debugViewInfos) {
            String debugString = ViewInfoUtilKt.toDebugString$default(list, 0, null, 3, null);
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5186getLambda3$ui_tooling_release());
