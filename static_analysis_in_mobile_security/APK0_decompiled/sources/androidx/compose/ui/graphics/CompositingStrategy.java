...
public final class CompositingStrategy {
    ...
    private static final int Auto = m3049constructorimpl(0);
    private static final int Offscreen = m3049constructorimpl(1);
    private static final int ModulateAlpha = m3049constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m3048boximpl(int i) {
    ...
    public static int m3052hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3053toStringimpl(int i) {
    ...
    public int hashCode() {
        return m3052hashCodeimpl(this.value);
    }
