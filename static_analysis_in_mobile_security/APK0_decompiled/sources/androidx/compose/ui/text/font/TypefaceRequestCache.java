...
public final class TypefaceRequestCache {
    ...
    public final State<Object> runCached(final TypefaceRequest typefaceRequest, Function1<? super Function1<? super TypefaceResult, Unit>, ? extends TypefaceResult> resolveTypeface) {
        ...
        synchronized (lock$iv) {
            ...
            try {
                TypefaceResult currentTypefaceResult = resolveTypeface.invoke(new Function1<TypefaceResult, Unit>() { // from class: androidx.compose.ui.text.font.TypefaceRequestCache$runCached$currentTypefaceResult$1
                    ...
                    public final void invoke2(TypefaceResult finalResult) {
                        ...
                        SynchronizedObject lock$iv2 = TypefaceRequestCache.this.getLock();
