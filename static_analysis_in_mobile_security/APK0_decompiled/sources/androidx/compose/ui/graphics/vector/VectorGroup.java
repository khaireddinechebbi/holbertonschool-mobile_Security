...
public final class VectorGroup extends VectorNode implements Iterable<VectorNode>, KMappedMarker {
    ...
    public boolean equals(Object other) {
        ...
        if ((this.translationY == ((VectorGroup) other).translationY) && Intrinsics.areEqual(this.clipPathData, ((VectorGroup) other).clipPathData) && Intrinsics.areEqual(this.children, ((VectorGroup) other).children)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((result * 31) + Float.floatToIntBits(this.rotation)) * 31) + Float.floatToIntBits(this.pivotX)) * 31) + Float.floatToIntBits(this.pivotY)) * 31) + Float.floatToIntBits(this.scaleX)) * 31) + Float.floatToIntBits(this.scaleY)) * 31) + Float.floatToIntBits(this.translationX)) * 31) + Float.floatToIntBits(this.translationY)) * 31) + this.clipPathData.hashCode()) * 31) + this.children.hashCode();
    }
}
