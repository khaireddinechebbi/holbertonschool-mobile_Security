...
public final class LazyLayoutItemContentFactory {
    ...
    final class CachedItemContent {
        ...
        public CachedItemContent(LazyLayoutItemContentFactory this$0, int index, Object key, Object contentType) {
            Intrinsics.checkNotNullParameter(key, "key");
            this.this$0 = this$0;
            this.key = key;
                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1403994769, $changed, -1, "androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory.CachedItemContent.createContentLambda.<anonymous> (LazyLayoutItemContentFactory.kt:90)");
                        }
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m642SkippableItemJVlU9Rs(itemProvider, StableValue.m658constructorimpl(saveableStateHolder), index, StableValue.m658constructorimpl(cachedItemContent.getKey()), $composer, 0);
