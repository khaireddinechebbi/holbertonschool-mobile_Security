...
public final class ProgressIndicatorKt {
    ...
    private static final float LinearIndicatorHeight = LinearProgressIndicatorTokens.INSTANCE.m2277getTrackHeightD9Ej5fM();

    /* renamed from: LinearProgressIndicator-_5eSR-E, reason: not valid java name */
    public static final void m1670LinearProgressIndicator_5eSRE(final float progress, Modifier modifier, long color, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long color2;
        long trackColor2;
        int i2;
        ...
        int i4;
        int i5;
        Composer $composer2 = $composer.startRestartGroup(905419617);
        ComposerKt.sourceInformation($composer2, "C(LinearProgressIndicator)P(2,1,0:c#ui.graphics.Color,4:c#ui.graphics.Color,3:c#ui.graphics.StrokeCap)75@3530L11,76@3593L16,84@3883L194,80@3741L336:ProgressIndicator.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        ...
        if (i7 != 0) {
            ...
            i2 = strokeCap;
            $dirty2 |= $composer2.changed(i2) ? 16384 : 8192;
        } else {
            i2 = strokeCap;
        }
        if ((46811 & $dirty2) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeCap2 = i7 != 0 ? ProgressIndicatorDefaults.INSTANCE.m1663getLinearStrokeCapKaPHkGw() : i2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty2 &= -897;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(905419617, $changed, -1, "androidx.compose.material3.LinearProgressIndicator (ProgressIndicator.kt:72)");
            }
            final float coercedProgress = RangesKt.coerceIn(progress, 0.0f, 1.0f);
            Modifier m536sizeVpY3zN4 = SizeKt.m536sizeVpY3zN4(ProgressSemanticsKt.progressSemantics$default(modifier3, coercedProgress, null, 0, 6, null), LinearIndicatorWidth, LinearIndicatorHeight);
            Object[] keys$iv = {Color.m2961boximpl(trackColor2), StrokeCap.m3317boximpl(strokeCap2), Float.valueOf(coercedProgress), Color.m2961boximpl(color2)};
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                modifier4 = modifier3;
                i3 = 0;
                final long j = trackColor2;
                final int i8 = strokeCap2;
                final long j2 = color2;
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$1$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        ProgressIndicatorKt.m1682drawLinearIndicatorTrackAZGd3zU(Canvas, j, strokeWidth, i8);
                        ProgressIndicatorKt.m1681drawLinearIndicatorqYKTg0g(Canvas, 0.0f, coercedProgress, j2, strokeWidth, i8);
                    }
                };
            ...
            CanvasKt.Canvas(m536sizeVpY3zN4, (Function1) value$iv$iv, $composer2, i3);
            if (ComposerKt.isTraceInProgress()) {
        ...
        final int i9 = strokeCap3;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final void invoke(Composer composer, int i10) {
                ProgressIndicatorKt.m1670LinearProgressIndicator_5eSRE(progress, modifier6, j3, j4, i9, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: LinearProgressIndicator-2cYBFYY, reason: not valid java name */
    public static final void m1668LinearProgressIndicator2cYBFYY(Modifier modifier, long color, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        int i2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    ...
                    color3 = color2;
                    trackColor3 = trackColor2;
                    strokeCap2 = ProgressIndicatorDefaults.INSTANCE.m1663getLinearStrokeCapKaPHkGw();
                } else {
                    color3 = color2;
                    trackColor3 = trackColor2;
                    strokeCap2 = i2;
            ...
            Modifier m536sizeVpY3zN4 = SizeKt.m536sizeVpY3zN4(ProgressSemanticsKt.progressSemantics(modifier3), LinearIndicatorWidth, LinearIndicatorHeight);
            Object[] keys$iv = {Color.m2961boximpl(trackColor3), StrokeCap.m3317boximpl(strokeCap2), firstLineHead, firstLineTail, Color.m2961boximpl(color3), secondLineHead, secondLineTail};
            $composer2.startReplaceableGroup(-568225417);
            ComposerKt.sourceInformation($composer2, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean invalid$iv = false;
            for (Object key$iv : keys$iv) {
            ...
            if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$3$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        Intrinsics.checkNotNullParameter(Canvas, "$this$Canvas");
                        float strokeWidth = Size.m2797getHeightimpl(Canvas.mo3442getSizeNHjbRc());
                        ProgressIndicatorKt.m1682drawLinearIndicatorTrackAZGd3zU(Canvas, j3, strokeWidth, i7);
                        if (firstLineHead.getValue().floatValue() - firstLineTail.getValue().floatValue() > 0.0f) {
                            ProgressIndicatorKt.m1681drawLinearIndicatorqYKTg0g(Canvas, firstLineHead.getValue().floatValue(), firstLineTail.getValue().floatValue(), j4, strokeWidth, i7);
                        }
                        if (secondLineHead.getValue().floatValue() - secondLineTail.getValue().floatValue() > 0.0f) {
                            ProgressIndicatorKt.m1681drawLinearIndicatorqYKTg0g(Canvas, secondLineHead.getValue().floatValue(), secondLineTail.getValue().floatValue(), j4, strokeWidth, i7);
                        }
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv);
            ...
            $composer2.endReplaceableGroup();
            CanvasKt.Canvas(m536sizeVpY3zN4, (Function1) value$iv$iv, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i9) {
                ProgressIndicatorKt.m1668LinearProgressIndicator2cYBFYY(Modifier.this, j5, j6, i8, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1671LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long trackColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            m1670LinearProgressIndicator_5eSRE(progress, modifier3, color2, trackColor2, ProgressIndicatorDefaults.INSTANCE.m1663getLinearStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1671LinearProgressIndicatoreaDK9VM(progress, modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1669LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long trackColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1668LinearProgressIndicator2cYBFYY(modifier3, color2, trackColor2, ProgressIndicatorDefaults.INSTANCE.m1663getLinearStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1669LinearProgressIndicatorRIQooxk(Modifier.this, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void m1681drawLinearIndicatorqYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
    ...
    public static final void m1682drawLinearIndicatorTrackAZGd3zU(DrawScope $this$drawLinearIndicatorTrack_u2dAZGd3zU, long color, float strokeWidth, int strokeCap) {
        m1681drawLinearIndicatorqYKTg0g($this$drawLinearIndicatorTrack_u2dAZGd3zU, 0.0f, 1.0f, color, strokeWidth, strokeCap);
    }

    /* renamed from: CircularProgressIndicator-DUhRLBM, reason: not valid java name */
    public static final void m1664CircularProgressIndicatorDUhRLBM(final float progress, Modifier modifier, long color, float strokeWidth, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long color2;
        float strokeWidth2;
        long trackColor2;
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    strokeWidth2 = ProgressIndicatorDefaults.INSTANCE.m1662getCircularStrokeWidthD9Ej5fM();
                }
                if ((i & 16) != 0) {
                    $dirty2 &= -57345;
                ...
                if (i7 != 0) {
                    $dirty = $dirty2;
                    strokeCap2 = ProgressIndicatorDefaults.INSTANCE.m1660getCircularDeterminateStrokeCapKaPHkGw();
            ...
            final Stroke stroke = new Stroke($this$CircularProgressIndicator_DUhRLBM_u24lambda_u242.mo327toPx0680j_4(strokeWidth3), 0.0f, strokeCap2, 0, null, 26, null);
            Modifier modifier5 = modifier3;
            final long j = trackColor3;
            final long j2 = trackColor4;
            CanvasKt.Canvas(SizeKt.m534size3ABfNKs(ProgressSemanticsKt.progressSemantics$default(modifier5, coercedProgress, null, 0, 6, null), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(DrawScope Canvas) {
                    ...
                    ProgressIndicatorKt.m1678drawCircularIndicatorTrackbw27NRU(Canvas, j, stroke);
                    ProgressIndicatorKt.m1679drawDeterminateCircularIndicator42QJj7c(Canvas, 270.0f, sweep, j2, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$2
            ...
            public final void invoke(Composer composer, int i9) {
                ProgressIndicatorKt.m1664CircularProgressIndicatorDUhRLBM(progress, modifier6, j3, f, j4, i8, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: CircularProgressIndicator-LxG7B9w, reason: not valid java name */
    public static final void m1665CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long trackColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float strokeWidth2;
        long trackColor2;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i7 != 0) {
                    modifier3 = modifier4;
                    color3 = color2;
                    strokeCap2 = ProgressIndicatorDefaults.INSTANCE.m1661getCircularIndeterminateStrokeCapKaPHkGw();
                    strokeWidth3 = strokeWidth2;
                    trackColor3 = trackColor2;
                } else {
                    modifier3 = modifier4;
            ...
            final Stroke stroke = new Stroke($this$CircularProgressIndicator_LxG7B9w_u24lambda_u243.mo327toPx0680j_4(strokeWidth3), 0.0f, strokeCap2, 0, null, 26, null);
            ...
            final State baseRotation = InfiniteTransitionKt.animateFloat(transition, 0.0f, BaseRotationAngle, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(RotationDuration, 0, EasingKt.getLinearEasing(), 2, null), null, 0L, 6, null), null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            ...
            final long j3 = color3;
            CanvasKt.Canvas(SizeKt.m534size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(DrawScope Canvas) {
                    Intrinsics.checkNotNullParameter(Canvas, "$this$Canvas");
                    ProgressIndicatorKt.m1678drawCircularIndicatorTrackbw27NRU(Canvas, j2, stroke);
                    ...
                    ProgressIndicatorKt.m1680drawIndeterminateCircularIndicatorhrjfTZI(Canvas, startAngle.getValue().floatValue() + offset, strokeWidth5, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i9) {
                ProgressIndicatorKt.m1665CircularProgressIndicatorLxG7B9w(Modifier.this, j4, f, j5, i8, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1666CircularProgressIndicatorMBs18nI(final float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeWidth2 = i4 != 0 ? ProgressIndicatorDefaults.INSTANCE.m1662getCircularStrokeWidthD9Ej5fM() : f;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            m1664CircularProgressIndicatorDUhRLBM(progress, modifier3, color2, strokeWidth2, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor($composer2, 6), ProgressIndicatorDefaults.INSTANCE.m1660getCircularDeterminateStrokeCapKaPHkGw(), $composer2, 196608 | ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1666CircularProgressIndicatorMBs18nI(progress, modifier5, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1667CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1665CircularProgressIndicatorLxG7B9w(modifier3, color2, strokeWidth2, ProgressIndicatorDefaults.INSTANCE.getCircularTrackColor($composer2, 6), ProgressIndicatorDefaults.INSTANCE.m1661getCircularIndeterminateStrokeCapKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$CircularProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1667CircularProgressIndicatoraMcp0Q(Modifier.this, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* renamed from: drawCircularIndicator-42QJj7c, reason: not valid java name */
    private static final void m1677drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        float f = 2;
    ...
    public static final void m1678drawCircularIndicatorTrackbw27NRU(DrawScope $this$drawCircularIndicatorTrack_u2dbw27NRU, long color, Stroke stroke) {
        m1677drawCircularIndicator42QJj7c($this$drawCircularIndicatorTrack_u2dbw27NRU, 0.0f, 360.0f, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawDeterminateCircularIndicator-42QJj7c, reason: not valid java name */
    public static final void m1679drawDeterminateCircularIndicator42QJj7c(DrawScope $this$drawDeterminateCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        m1677drawCircularIndicator42QJj7c($this$drawDeterminateCircularIndicator_u2d42QJj7c, startAngle, sweep, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawIndeterminateCircularIndicator-hrjfTZI, reason: not valid java name */
    public static final void m1680drawIndeterminateCircularIndicatorhrjfTZI(DrawScope $this$drawIndeterminateCircularIndicator_u2dhrjfTZI, float startAngle, float strokeWidth, float sweep, long color, Stroke stroke) {
        ...
        m1677drawCircularIndicator42QJj7c($this$drawIndeterminateCircularIndicator_u2dhrjfTZI, adjustedStartAngle, adjustedSweep, color, stroke);
    }

    static {
        float arg0$iv = CircularProgressIndicatorTokens.INSTANCE.m2049getSizeD9Ej5fM();
        float arg0$iv2 = CircularProgressIndicatorTokens.INSTANCE.m2048getActiveIndicatorWidthD9Ej5fM();
        CircularIndicatorDiameter = Dp.m5274constructorimpl(arg0$iv - Dp.m5274constructorimpl(2 * arg0$iv2));
