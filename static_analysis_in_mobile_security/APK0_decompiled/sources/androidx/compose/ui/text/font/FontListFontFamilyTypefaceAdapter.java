...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv < size4) {
            ...
            List matched = fontMatcher.m4863matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle);
            ...
            firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(matched, typeRequest, this.asyncTypefaceCache, resourceLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
            ...
            List asyncFontsToLoad = (List) firstImmediatelyAvailable.component1();
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        List matched = fontMatcher.m4863matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4910getFontStyle_LCdwA());
        firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(matched, typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
        List asyncFontsToLoad = (List) firstImmediatelyAvailable.component1();
        Object synthesizedTypeface = firstImmediatelyAvailable.component2();
        if (asyncFontsToLoad == null) {
