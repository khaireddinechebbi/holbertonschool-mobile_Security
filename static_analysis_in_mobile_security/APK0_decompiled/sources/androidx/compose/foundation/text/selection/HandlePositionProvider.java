...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private HandlePositionProvider(HandleReferencePoint handleReferencePoint, long offset) {
    ...
    public long mo889calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m5392getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m5393getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5392getXimpl(this.offset)) - IntSize.m5434getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m5393getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5392getXimpl(this.offset)) - (IntSize.m5434getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m5393getYimpl(this.offset));
            default:
