...
public interface LayoutModifierNode extends DelegatableNode {
    ...
    MeasureResult mo239measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(final LayoutModifierNode _this, IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicWidth$1
                ...
                public final MeasureResult mo4231measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long constraints) {
                    ...
                    return LayoutModifierNode.this.mo239measure3p2s80s(minWidth, intrinsicMeasurable, constraints);
                }
            }, $this$minIntrinsicWidth, measurable, height);
        }

        public static int $default$minIntrinsicHeight(final LayoutModifierNode _this, IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicHeight$1
                ...
                public final MeasureResult mo4231measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long constraints) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo239measure3p2s80s(minHeight, intrinsicMeasurable, constraints);
                }
            }, $this$minIntrinsicHeight, measurable, width);
        }

        public static int $default$maxIntrinsicWidth(final LayoutModifierNode _this, IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicWidth$1
                ...
                public final MeasureResult mo4231measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long constraints) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo239measure3p2s80s(maxWidth, intrinsicMeasurable, constraints);
                }
            }, $this$maxIntrinsicWidth, measurable, height);
        }

        public static int $default$maxIntrinsicHeight(final LayoutModifierNode _this, IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
            ...
            return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicHeight$1
                ...
                public final MeasureResult mo4231measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long constraints) {
                    ...
                    Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                    return LayoutModifierNode.this.mo239measure3p2s80s(maxHeight, intrinsicMeasurable, constraints);
                }
