...
public final class LazyStaggeredGridBeyondBoundsModifierKt {
    public static final Modifier lazyStaggeredGridBeyondBoundsModifier(Modifier $this$lazyStaggeredGridBeyondBoundsModifier, LazyStaggeredGridState state, boolean reverseLayout, Orientation orientation, Composer $composer, int $changed) {
        Object value$iv$iv;
        Intrinsics.checkNotNullParameter($this$lazyStaggeredGridBeyondBoundsModifier, "<this>");
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new LazyStaggeredGridBeyondBoundsState(state);
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        $composer.endReplaceableGroup();
        LazyStaggeredGridBeyondBoundsState beyondBoundsState = (LazyStaggeredGridBeyondBoundsState) value$iv$iv;
        Object[] keys$iv = {beyondBoundsState, state, Boolean.valueOf(reverseLayout), layoutDirection, orientation};
        ...
        $composer.endReplaceableGroup();
        Modifier then = $this$lazyStaggeredGridBeyondBoundsModifier.then((Modifier) value$iv$iv2);
        if (ComposerKt.isTraceInProgress()) {
