...
public final class SwipeableV2State<T> {
    ...
    */
    ...
    public final T computeTarget(float offset, T currentValue, float velocity) {
        ...
        float mo327toPx0680j_4 = requireDensity.mo327toPx0680j_4(this.velocityThreshold);
        if (!Intrinsics.areEqual(f, offset) && f != null) {
            if (f.floatValue() < offset) {
                if (velocity >= mo327toPx0680j_4) {
                    closestAnchor4 = SwipeableV2Kt.closestAnchor(anchors$material3_release, offset, true);
                    return (T) closestAnchor4;
                }
                closestAnchor3 = SwipeableV2Kt.closestAnchor(anchors$material3_release, offset, true);
                ...
                if (velocity <= (-mo327toPx0680j_4)) {
                    closestAnchor2 = SwipeableV2Kt.closestAnchor(anchors$material3_release, offset, false);
                    return (T) closestAnchor2;
                }
                closestAnchor = SwipeableV2Kt.closestAnchor(anchors$material3_release, offset, false);
