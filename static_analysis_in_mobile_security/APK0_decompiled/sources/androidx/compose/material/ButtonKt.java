...
public final class ButtonKt {
    public static final void Button(final Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, ButtonElevation elevation, Shape shape, BorderStroke border, ButtonColors colors, PaddingValues contentPadding, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if ((1533916891 & $dirty3) == 306783378 && $composer3.getSkipping()) {
            ...
            long m2981unboximpl = colors3.backgroundColor(enabled2, $composer3, (($dirty >> 6) & 14) | (($dirty >> 18) & 112)).getValue().m2981unboximpl();
            m2969copywmQWz5c = Color.m2969copywmQWz5c(r20, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r20) : 1.0f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r20) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r20) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(Button$lambda$1(contentColor$delegate)) : 0.0f);
            ...
            modifier3 = modifier2;
            $composer2 = $composer3;
            SurfaceKt.m1211SurfaceLPr_se0(onClick, semantics$default, enabled2, shape3, m2981unboximpl, m2969copywmQWz5c, border2, elevation5 != null ? elevation5.getValue().m5288unboximpl() : Dp.m5274constructorimpl(0), interactionSource2, ComposableLambdaKt.composableLambda($composer3, 7524271, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ButtonKt$Button$3
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ProvidedValue[] providedValueArr = {localContentAlpha.provides(Float.valueOf(Color.m2973getAlphaimpl(Button$lambda$1)))};
                                    ...
                                    TextKt.ProvideTextStyle(button, ComposableLambdaKt.composableLambda($composer5, -630330208, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ButtonKt.Button.3.1.1
                                        ...
                                        */
                                        public final void invoke(androidx.compose.runtime.Composer r25, int r26) {
                                            ...
                                            */
                                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ButtonKt$Button$3.AnonymousClass1.C00251.invoke(androidx.compose.runtime.Composer, int):void");
                                        }
                                    }), $composer5, 48);
                                    if (ComposerKt.isTraceInProgress()) {
