...
public final class DividerKt {
    ...
    public static final void m1083DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        float f2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    color2 = Color.m2969copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r12) : 0.12f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(MaterialTheme.INSTANCE.getColors($composer2, 6).m1047getOnSurface0d7_KjU()) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                thickness2 = i5 != 0 ? Dp.m5274constructorimpl(1) : f;
                startIndent2 = i6 != 0 ? Dp.m5274constructorimpl(0) : f2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            if (startIndent2 == 0.0f) {
                ...
                i2 = 1;
                indentMod = PaddingKt.m491paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null);
            }
            $composer2.startReplaceableGroup(1228914189);
            ComposerKt.sourceInformation($composer2, "*55@2139L7");
            if (Dp.m5279equalsimpl0(thickness2, Dp.INSTANCE.m5292getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = $composer2.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                float $this$dp$iv = 1.0f / ((Density) consume).getDensity();
                targetThickness = Dp.m5274constructorimpl($this$dp$iv);
            } else {
                targetThickness = thickness2;
            }
            $composer2.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m160backgroundbw27NRU$default(SizeKt.m520height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, i2, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer, int i7) {
                DividerKt.m1083DivideroMI9zvI(Modifier.this, j2, f3, f4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
