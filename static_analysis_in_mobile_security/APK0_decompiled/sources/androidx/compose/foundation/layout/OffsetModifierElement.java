...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    private OffsetModifierElement(float x, float y, boolean rtlAware, Function1<? super InspectorInfo, Unit> inspectorInfo) {
    ...
    public void update(OffsetNode node) {
        ...
        node.m451setX0680j_4(this.x);
        node.m452setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return otherModifierElement != null && Dp.m5279equalsimpl0(this.x, otherModifierElement.x) && Dp.m5279equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m5280hashCodeimpl(this.x);
        return (((result * 31) + Dp.m5280hashCodeimpl(this.y)) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5285toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5285toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
