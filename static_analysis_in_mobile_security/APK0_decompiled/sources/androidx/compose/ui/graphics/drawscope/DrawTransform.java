...
public interface DrawTransform {
    ...
    void mo3450clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo3451clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: getCenter-F1C5BW0 */
    long mo3452getCenterF1C5BW0();

    /* renamed from: getSize-NH-jbRc */
    long mo3453getSizeNHjbRc();

    void inset(float left, float top, float right, float bottom);

    /* renamed from: rotate-Uv8p0NA */
    void mo3454rotateUv8p0NA(float degrees, long pivot);

    /* renamed from: scale-0AR0LA0 */
    void mo3455scale0AR0LA0(float scaleX, float scaleY, long pivot);

    /* renamed from: transform-58bKbWc */
    void mo3456transform58bKbWc(float[] matrix);
    ...
    public final /* synthetic */ class CC {
        ...
        public static long m3573$default$getCenterF1C5BW0(DrawTransform _this) {
            float f = 2;
            return OffsetKt.Offset(Size.m2800getWidthimpl(_this.mo3453getSizeNHjbRc()) / f, Size.m2797getHeightimpl(_this.mo3453getSizeNHjbRc()) / f);
        }

        /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
        public static /* synthetic */ void m3576clipRectN_I0leg$default(DrawTransform drawTransform, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            if ((i2 & 4) != 0) {
                f3 = Size.m2800getWidthimpl(drawTransform.mo3453getSizeNHjbRc());
            }
            if ((i2 & 8) != 0) {
                f4 = Size.m2797getHeightimpl(drawTransform.mo3453getSizeNHjbRc());
            }
            if ((i2 & 16) != 0) {
                i = ClipOp.INSTANCE.m2960getIntersectrtfAjoo();
            }
            drawTransform.mo3451clipRectN_I0leg(f, f2, f3, f4, i);
        }

        /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
        public static /* synthetic */ void m3575clipPathmtrdDE$default(DrawTransform drawTransform, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            drawTransform.mo3450clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m3577rotateUv8p0NA$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
            if (obj != null) {
            ...
            if ((i & 2) != 0) {
                j = drawTransform.mo3452getCenterF1C5BW0();
            }
            drawTransform.mo3454rotateUv8p0NA(f, j);
        }

        /* renamed from: scale-0AR0LA0$default, reason: not valid java name */
        public static /* synthetic */ void m3578scale0AR0LA0$default(DrawTransform drawTransform, float f, float f2, long j, int i, Object obj) {
            if (obj != null) {
            ...
            drawTransform.mo3455scale0AR0LA0(f, f2, j);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static long m3581getCenterF1C5BW0(DrawTransform $this) {
            return CC.m3573$default$getCenterF1C5BW0($this);
        }
    }
}
