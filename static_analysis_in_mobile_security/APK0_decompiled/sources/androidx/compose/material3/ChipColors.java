...
public final class ChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.containerColor : this.disabledContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.labelColor : this.disabledLabelColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipColors) && Color.m2972equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) && Color.m2972equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) && Color.m2972equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) && Color.m2972equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) && Color.m2972equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) && Color.m2972equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) && Color.m2972equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) && Color.m2972equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((result * 31) + Color.m2978hashCodeimpl(this.labelColor)) * 31) + Color.m2978hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2978hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m2978hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2978hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2978hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m2978hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
