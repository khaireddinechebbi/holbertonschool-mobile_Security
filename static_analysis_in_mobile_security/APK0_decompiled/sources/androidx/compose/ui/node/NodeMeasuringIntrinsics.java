...
public final class NodeMeasuringIntrinsics {
    ...
    public interface MeasureBlock {
        ...
        MeasureResult mo4231measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo4231measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        ...
        public Placeable mo4225measureBRTryo0(long constraints) {
            ...
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    width = this.measurable.maxIntrinsicWidth(Constraints.m5217getMaxHeightimpl(constraints));
                } else {
                    width = this.measurable.minIntrinsicWidth(Constraints.m5217getMaxHeightimpl(constraints));
                }
                return new EmptyPlaceable(width, Constraints.m5217getMaxHeightimpl(constraints));
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                height = this.measurable.maxIntrinsicHeight(Constraints.m5218getMaxWidthimpl(constraints));
            } else {
                height = this.measurable.minIntrinsicHeight(Constraints.m5218getMaxWidthimpl(constraints));
            }
            return new EmptyPlaceable(Constraints.m5218getMaxWidthimpl(constraints), height);
        }
