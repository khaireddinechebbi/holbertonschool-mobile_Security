...
public final class CubicBezierEasing implements Easing {
    ...
    public CubicBezierEasing(float a, float b, float c, float d) {
        ...
        this.c = c;
        this.d = d;
        if ((Float.isNaN(a) || Float.isNaN(b) || Float.isNaN(c) || Float.isNaN(d)) ? false : true) {
        } else {
            throw new IllegalArgumentException(("Parameters to CubicBezierEasing cannot be NaN. Actual parameters are: " + a + ", " + b + ", " + c + ", " + d + '.').toString());
        }
    }
