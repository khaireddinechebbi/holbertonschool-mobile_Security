...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new SelectableChipElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-699481942);
            ComposerKt.sourceInformation($composer, "1710@81127L52");
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new SelectableChipElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m5279equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m5279equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m5279equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m5279equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m5279equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
