...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SCROLL_TO_POSITION = new AccessibilityActionCompat(accessibilityAction, R.id.accessibilityActionScrollToPosition, null, null, AccessibilityViewCommand.ScrollToPositionArguments.class);
            ...
            if (Build.VERSION.SDK_INT >= 33) {
                accessibilityAction2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TEXT_SUGGESTIONS;
            } else {
                accessibilityAction2 = null;
            }
            ACTION_SHOW_TEXT_SUGGESTIONS = new AccessibilityActionCompat(accessibilityAction2, R.id.accessibilityActionShowTextSuggestions, null, null, null);
            if (Build.VERSION.SDK_INT >= 34) {
                accessibilityAction3 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_IN_DIRECTION;
            } else {
                accessibilityAction3 = null;
            }
            ACTION_SCROLL_IN_DIRECTION = new AccessibilityActionCompat(accessibilityAction3, R.id.accessibilityActionScrollInDirection, null, null, null);
        }
    ...
    public static class RangeInfoCompat {
        ...
        public RangeInfoCompat(int type, float min, float max, float current) {
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                this.mInfo = Api19Impl.createRangeInfo(type, min, max, current);
            }
        }
    ...
    public void getBoundsInWindow(Rect outBounds) {
        ...
        Rect extraBounds = (Rect) Api19Impl.getExtras(this.mInfo).getParcelable(BOUNDS_IN_WINDOW_KEY);
        if (extraBounds != null) {
    ...
    public void setBoundsInWindow(Rect bounds) {
        if (Build.VERSION.SDK_INT >= 34) {
            ...
            Api19Impl.getExtras(this.mInfo).putParcelable(BOUNDS_IN_WINDOW_KEY, bounds);
        }
    }
    ...
    public void setContainerTitle(CharSequence containerTitle) {
        if (Build.VERSION.SDK_INT >= 34) {
            ...
            Api19Impl.getExtras(this.mInfo).putCharSequence(CONTAINER_TITLE_KEY, containerTitle);
        }
    }
    ...
    public void setHintText(CharSequence hintText) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Api19Impl.getExtras(this.mInfo).putCharSequence(HINT_TEXT_KEY, hintText);
        }
    }
    ...
    public void setTooltipText(CharSequence tooltipText) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            Api19Impl.getExtras(this.mInfo).putCharSequence(TOOLTIP_TEXT_KEY, tooltipText);
        }
    }
    ...
    public void setPaneTitle(CharSequence paneTitle) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            Api19Impl.getExtras(this.mInfo).putCharSequence(PANE_TITLE_KEY, paneTitle);
        }
    }
    ...
    private static class Api19Impl {
        ...
        public static CollectionItemInfoCompat createCollectionItemInfo(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(rowIndex, rowSpan, columnIndex, columnSpan, heading));
        }
    }
