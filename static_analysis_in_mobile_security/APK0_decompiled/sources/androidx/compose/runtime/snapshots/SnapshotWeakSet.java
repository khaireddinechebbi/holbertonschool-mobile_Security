...
public final class SnapshotWeakSet<T> {
    ...
    public final boolean add(T value) {
        ...
        if (size == capacity) {
            ...
            ArraysKt.copyInto(weakReferenceArr, newValues, insertIndex + 1, insertIndex, size);
            ...
            ArraysKt.copyInto(weakReferenceArr, weakReferenceArr, insertIndex + 1, insertIndex, size);
            int[] iArr = this.hashes;
            ArraysKt.copyInto(iArr, iArr, insertIndex + 1, insertIndex, size);
        }
