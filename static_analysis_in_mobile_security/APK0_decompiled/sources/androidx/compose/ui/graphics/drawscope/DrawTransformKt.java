...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m3585rotateRad0AR0LA0$default(DrawTransform rotateRad, float radians, long pivot, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotateRad.mo3452getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3454rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    }

    /* renamed from: rotateRad-0AR0LA0, reason: not valid java name */
    public static final void m3584rotateRad0AR0LA0(DrawTransform rotateRad, float radians, long pivot) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3454rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    }

    /* renamed from: scale-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m3587scale0AR0LA0$default(DrawTransform scale, float scale2, long pivot, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = scale.mo3452getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3455scale0AR0LA0(scale2, scale2, pivot);
    }

    /* renamed from: scale-0AR0LA0, reason: not valid java name */
    public static final void m3586scale0AR0LA0(DrawTransform scale, float scale2, long pivot) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3455scale0AR0LA0(scale2, scale2, pivot);
    }
}
