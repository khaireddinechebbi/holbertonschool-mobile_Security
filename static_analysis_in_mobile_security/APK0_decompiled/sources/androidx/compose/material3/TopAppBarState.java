...
public final class TopAppBarState {
    ...
    public TopAppBarState(float initialHeightOffsetLimit, float initialHeightOffset, float initialContentOffset) {
        this.heightOffsetLimit = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(initialHeightOffsetLimit), null, 2, null);
        this.contentOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(initialContentOffset), null, 2, null);
        this._heightOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(initialHeightOffset), null, 2, null);
    }

    public final float getHeightOffsetLimit() {
        State $this$getValue$iv = this.heightOffsetLimit;
        return ((Number) $this$getValue$iv.getValue()).floatValue();
    }

    public final void setHeightOffsetLimit(float f) {
        MutableState $this$setValue$iv = this.heightOffsetLimit;
    ...
    public final float getContentOffset() {
        State $this$getValue$iv = this.contentOffset;
        return ((Number) $this$getValue$iv.getValue()).floatValue();
    }

    public final void setContentOffset(float f) {
        MutableState $this$setValue$iv = this.contentOffset;
        $this$setValue$iv.setValue(Float.valueOf(f));
    }
