...
public final class InsetsValues {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof InsetsValues) && this.left == ((InsetsValues) other).left && this.top == ((InsetsValues) other).top && this.right == ((InsetsValues) other).right && this.bottom == ((InsetsValues) other).bottom;
    }
