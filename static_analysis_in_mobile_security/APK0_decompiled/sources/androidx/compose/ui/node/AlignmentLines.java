...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4325calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo4325calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            positionInContainer = MathKt.roundToInt(Offset.m2732getYimpl(position));
        } else {
            positionInContainer = MathKt.roundToInt(Offset.m2731getXimpl(position));
        }
