...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public LazyGridSlots m610invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m5206boximpl(constraints));
