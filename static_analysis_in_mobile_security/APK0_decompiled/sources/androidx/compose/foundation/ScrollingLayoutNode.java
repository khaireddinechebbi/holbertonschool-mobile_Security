...
final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        CheckScrollableContainerConstraintsKt.m188checkScrollableContainerConstraintsK40F9xA(constraints, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        childConstraints = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : this.isVertical ? Constraints.m5218getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : this.isVertical ? Integer.MAX_VALUE : Constraints.m5217getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
        int width = RangesKt.coerceAtMost(placeable.getWidth(), Constraints.m5218getMaxWidthimpl(constraints));
        int height = RangesKt.coerceAtMost(placeable.getHeight(), Constraints.m5217getMaxHeightimpl(constraints));
        ...
        return MeasureScope.CC.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
