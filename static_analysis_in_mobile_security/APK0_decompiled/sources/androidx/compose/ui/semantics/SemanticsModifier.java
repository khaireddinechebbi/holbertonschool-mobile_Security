...
public interface SemanticsModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static boolean all(SemanticsModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$all($this, predicate);
        }

        @Deprecated
        public static boolean any(SemanticsModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
        ...
        @Deprecated
        public static Modifier then(SemanticsModifier $this, Modifier other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Modifier.CC.$default$then($this, other);
        }

        @Deprecated
        public static int getId(SemanticsModifier $this) {
