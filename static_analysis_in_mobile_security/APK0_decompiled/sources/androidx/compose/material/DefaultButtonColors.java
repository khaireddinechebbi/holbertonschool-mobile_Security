...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2972equalsimpl0(this.backgroundColor, ((DefaultButtonColors) other).backgroundColor) && Color.m2972equalsimpl0(this.contentColor, ((DefaultButtonColors) other).contentColor) && Color.m2972equalsimpl0(this.disabledBackgroundColor, ((DefaultButtonColors) other).disabledBackgroundColor) && Color.m2972equalsimpl0(this.disabledContentColor, ((DefaultButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m2978hashCodeimpl(this.contentColor)) * 31) + Color.m2978hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2978hashCodeimpl(this.disabledContentColor);
    }
}
