...
public final class NotificationsKt {
    ...
    public static final ImageVector getNotifications(Icons.Rounded $this$Notifications) {
        ...
        ImageVector.Builder $this$_get_Notifications__u24lambda_u241 = new ImageVector.Builder("Rounded.Notifications", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.89f, 0.0f, 1.34f, -1.08f, 0.71f, -1.71f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(18.0f, 16.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
