...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m7028boximpl(m7022markNowz9LOYto());
    }
    ...
    public long m7022markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m7031constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m7021elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m7020differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m7019adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m7031constructorimpl(LongSaturatedMathKt.m7017saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
