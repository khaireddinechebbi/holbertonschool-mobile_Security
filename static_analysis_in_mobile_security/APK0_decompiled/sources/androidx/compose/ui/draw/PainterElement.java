...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((hashCode + i) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.floatToIntBits(this.alpha)) * 31;
    ...
    public void update(PainterModifier node) {
        ...
        boolean z = this.sizeToIntrinsics;
        boolean intrinsicsChanged = sizeToIntrinsics != z || (z && !Size.m2796equalsimpl0(node.getPainter().mo3594getIntrinsicSizeNHjbRc(), this.painter.mo3594getIntrinsicSizeNHjbRc()));
