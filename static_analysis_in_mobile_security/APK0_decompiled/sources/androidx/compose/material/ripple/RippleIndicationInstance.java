...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public RippleIndicationInstance(boolean bounded, State<RippleAlpha> rippleAlpha) {
        Intrinsics.checkNotNullParameter(rippleAlpha, "rippleAlpha");
        this.stateLayer = new StateLayer(bounded, rippleAlpha);
    }
    ...
    public final void m1297drawStateLayerH2RKhps(DrawScope drawStateLayer, float radius, long color) {
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        StateLayer $this$drawStateLayer_H2RKhps_u24lambda_u240 = this.stateLayer;
        $this$drawStateLayer_H2RKhps_u24lambda_u240.m1301drawStateLayerH2RKhps(drawStateLayer, radius, color);
    }
}
