...
public final class Rgb extends ColorSpace {
    ...
    public Rgb(String name, float[] primaries, WhitePoint whitePoint, float[] transform, DoubleFunction oetf, DoubleFunction eotf, float min, float max, TransferParameters transferParameters, int id) {
        super(name, ColorModel.INSTANCE.m3385getRgbxdoWZVw(), id, null);
        ...
        this.isWideGamut = companion.isWideGamut(xyPrimaries, min, max);
        this.isSrgb = companion.isSrgb(xyPrimaries, whitePoint, oetf, eotf, min, max, id);
    }
    ...
    */
    public Rgb(java.lang.String r17, float[] r18, final kotlin.jvm.functions.Function1<? super java.lang.Double, java.lang.Double> r19, final kotlin.jvm.functions.Function1<? super java.lang.Double, java.lang.Double> r20) {
        /*
            r16 = this;
            r0 = r18
            r1 = r19
    ...
    */
    ...
    public Rgb(String name, float[] primaries, WhitePoint whitePoint, final double gamma, float min, float max, int id) {
        this(name, primaries, whitePoint, null, (gamma > 1.0d ? 1 : (gamma == 1.0d ? 0 : -1)) == 0 ? DoubleIdentity : new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda2
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
        ...
        }, gamma == 1.0d ? DoubleIdentity : new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda3
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
    ...
    public long mo3388xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
    ...
    public int hashCode() {
        ...
        int result2 = ((((result * 31) + this.whitePoint.hashCode()) * 31) + Arrays.hashCode(this.primaries)) * 31;
        float f = this.min;
        int result3 = (result2 + (!((f > 0.0f ? 1 : (f == 0.0f ? 0 : -1)) == 0) ? Float.floatToIntBits(f) : 0)) * 31;
        float f2 = this.max;
        ...
        return (((result5 * 31) + this.oetfOrig.hashCode()) * 31) + this.eotfOrig.hashCode();
    }
