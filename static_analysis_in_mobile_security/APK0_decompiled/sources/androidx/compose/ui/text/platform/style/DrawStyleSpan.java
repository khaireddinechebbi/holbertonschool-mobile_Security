...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
        ...
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                if (drawStyle instanceof Stroke) {
                    ...
                    textPaint.setStrokeJoin(m5024toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                    textPaint.setStrokeCap(m5023toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m5024toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        return StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3336getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3334getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m5023toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        return StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3324getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3325getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3326getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
