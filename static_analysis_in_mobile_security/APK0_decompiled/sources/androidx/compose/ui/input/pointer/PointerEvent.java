...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m4040constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m4169constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4046calculatePointerEventType7fucELk();
    }
    ...
    public final void m4050setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m4046calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
            }
            return PointerEventType.INSTANCE.m4063getPress7fucELk();
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m4064getRelease7fucELk();
            }
            if (PointerEventKt.changedToDownIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m4063getPress7fucELk();
            }
        }
        return PointerEventType.INSTANCE.m4062getMove7fucELk();
    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            map.put(PointerId.m4086boximpl(change.getId()), change);
            ...
            if (internalPointerEvent != null) {
                ...
                z = true;
                if (internalPointerEvent.m4036issuesEnterExitEvent0FcD4WY(change.getId())) {
                    arrayList.add(new PointerInputEventData(id, uptimeMillis, position, position2, pressed, pressure, type, z, null, 0L, 768, null));
                    index$iv++;
