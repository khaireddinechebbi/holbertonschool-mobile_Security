...
public final class RowColumnMeasurementHelper {
    ...
    public final RowColumnMeasureHelperResult m514measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        int targetSpace;
        int weightedSpace;
        int fixedSpace;
        int crossAxisSpace;
        ...
        long constraints2 = OrientationIndependentConstraints.m456constructorimpl(constraints, this.orientation);
        int i3 = measureScope.mo321roundToPx0680j_4(this.arrangementSpacing);
        int fixedSpace2 = 0;
        ...
        while (true) {
            ...
            if (weight > 0.0f) {
                ...
                int m5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl(constraints2);
                Placeable placeable = this.placeables[i4];
                if (placeable == null) {
                    int weightChildrenCount2 = m5218getMaxWidthimpl != Integer.MAX_VALUE ? m5218getMaxWidthimpl - fixedSpace2 : Integer.MAX_VALUE;
                    mainAxisMax = m5218getMaxWidthimpl;
                    m457copyyUG9Ft0 = OrientationIndependentConstraints.m457copyyUG9Ft0(constraints2, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints2) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints2) : weightChildrenCount2, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints2) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints2) : 0);
                    placeable = child.mo4225measureBRTryo0(OrientationIndependentConstraints.m469toBoxConstraintsOenEA2s(m457copyyUG9Ft0, this.orientation));
                } else {
                    mainAxisMax = m5218getMaxWidthimpl;
                }
                ...
                anyAlignBy2 = anyAlignBy2 || RowColumnImplKt.isRelative(parentData);
        ...
        if (weightChildrenCount == 0) {
            ...
            if (totalWeight > 0.0f && Constraints.m5218getMaxWidthimpl(constraints2) != Integer.MAX_VALUE) {
                targetSpace = Constraints.m5218getMaxWidthimpl(constraints2);
            } else {
                targetSpace = Constraints.m5220getMinWidthimpl(constraints2);
            }
            ...
            while (i6 < i2) {
                if (this.placeables[i6] != null) {
                    ...
                    remainingToTarget = remainingToTarget2;
                    weightUnitSpace = weightUnitSpace2;
                    Placeable placeable3 = child2.mo4225measureBRTryo0(OrientationIndependentConstraints.m469toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m454constructorimpl(i, childMainAxisSize2, 0, Constraints.m5217getMaxHeightimpl(constraints2)), this.orientation));
            ...
            weightedSpace = RangesKt.coerceAtMost(((weightChildrenCount - 1) * i3) + weightedSpace2, Constraints.m5218getMaxWidthimpl(constraints2) - fixedSpace2);
        ...
        int mainAxisLayoutSize = Math.max(beforeCrossAxisAlignmentLine4, Constraints.m5220getMinWidthimpl(constraints2));
        if (Constraints.m5217getMaxHeightimpl(constraints2) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            crossAxisLayoutSize = Math.max(crossAxisSpace, Math.max(Constraints.m5219getMinHeightimpl(constraints2), beforeCrossAxisAlignmentLine + afterCrossAxisAlignmentLine));
        } else {
            crossAxisLayoutSize = Constraints.m5217getMaxHeightimpl(constraints2);
        }
