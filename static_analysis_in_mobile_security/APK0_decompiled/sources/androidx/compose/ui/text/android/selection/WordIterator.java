...
public final class WordIterator {
    ...
    public WordIterator(CharSequence charSequence, int start, int end, Locale locale) {
        ...
        if (!(end >= 0 && end <= charSequence.length())) {
        ...
        this.end = Math.min(charSequence.length(), end + 50);
        wordInstance.setText(new CharSequenceCharacterIterator(charSequence, start, end));
    }
