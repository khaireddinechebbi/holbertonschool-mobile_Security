...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;
    ...
    .line 1277
    .local v1, "this":Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$offsetX$delegate:Landroidx/compose/runtime/MutableState;

    invoke-static {v2}, Landroidx/compose/material3/TimePickerKt$clockDial$2;->access$invoke$lambda$1(Landroidx/compose/runtime/MutableState;)F

    move-result v3

    iget-wide v4, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$dragAmount:J
    ...
    invoke-static {v2, v3}, Landroidx/compose/material3/TimePickerKt$clockDial$2;->access$invoke$lambda$2(Landroidx/compose/runtime/MutableState;F)V

    .line 1278
    iget-object v2, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$offsetY$delegate:Landroidx/compose/runtime/MutableState;

    invoke-static {v2}, Landroidx/compose/material3/TimePickerKt$clockDial$2;->access$invoke$lambda$4(Landroidx/compose/runtime/MutableState;)F
    ...
    invoke-static {v2, v3}, Landroidx/compose/material3/TimePickerKt$clockDial$2;->access$invoke$lambda$5(Landroidx/compose/runtime/MutableState;F)V

    .line 1279
    iget-object v4, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$state:Landroidx/compose/material3/TimePickerState;
    ...
    iget-object v3, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$state:Landroidx/compose/material3/TimePickerState;
    ...
    iget-object v3, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$offsetX$delegate:Landroidx/compose/runtime/MutableState;

    invoke-static {v3}, Landroidx/compose/material3/TimePickerKt$clockDial$2;->access$invoke$lambda$1(Landroidx/compose/runtime/MutableState;)F

    move-result v3

    iget-object v5, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->$state:Landroidx/compose/material3/TimePickerState;

    invoke-virtual {v5}, Landroidx/compose/material3/TimePickerState;->getCenter-nOcc-ac$material3_release()J
    ...
    invoke-static {v2, v3}, Landroidx/compose/material3/TimePickerKt;->access$atan(FF)F
    ...
    iput v2, v1, Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;->label:I
    ...
    .line 1280
    .end local v1    # "this":Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;
    .restart local v0    # "this":Landroidx/compose/material3/TimePickerKt$clockDial$2$3$2$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
