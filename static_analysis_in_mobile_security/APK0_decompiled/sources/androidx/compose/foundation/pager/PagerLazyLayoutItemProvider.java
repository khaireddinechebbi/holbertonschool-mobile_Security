...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(final int index, final Object key, Composer $composer, final int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1201380429, $changed, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:187)");
        }
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedPages(), ComposableLambdaKt.composableLambda($composer2, 1142237095, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$Item$1
            ...
            public final void invoke(Composer $composer3, int $changed2) {
                ...
                ComposerKt.sourceInformation($composer3, "C*190@7719L32:LazyLayoutPager.kt#g6yjnt");
                if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(1142237095, $changed2, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:188)");
                    }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$Item$2
            ...
            public final void invoke(Composer composer, int i) {
                PagerLazyLayoutItemProvider.this.Item(index, key, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
