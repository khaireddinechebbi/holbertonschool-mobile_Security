                        ...
                        while (i8 < length) {
                            ...
                            try {
                                ...
                                if (i8 == 0) {
                                    ...
                                    iArr = iArr3;
                                    i6 = m678maxInRangejy6DScQ(iArr2, SpanRange.m688constructorimpl(0, i8)) + 1;
                                }
                                iArr2[i8] = i6;
                                lazyStaggeredGridMeasureContext.getLaneInfo().setLane(iArr2[i8], i8);
                                i8++;
        ...
        if (itemCount6 <= 0) {
            ...
            if ($this$measure.getLaneCount() != 0) {
                ...
                while (true) {
                    ...
                    long spanRange = lazyStaggeredGridMeasureContext2.m675getSpanRangelOCCd4c($this$measure.getItemProvider(), previousItemIndex, laneIndex);
                    ...
                    LazyStaggeredGridMeasuredItem measuredItem = $this$measure.getMeasuredItemProvider().m683getAndMeasurejy6DScQ(previousItemIndex, spanRange);
                    int offset = m678maxInRangejy6DScQ(firstItemOffsets2, spanRange);
                ...
                while (initialLaneToMeasure3 != i4 && initialItemsMeasured2 < $this$measure.getLaneCount()) {
                    ...
                    if (itemIndex2 >= 0) {
                        ...
                        long spanRange2 = lazyStaggeredGridMeasureContext2.m675getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex2, laneIndex2);
                        LazyStaggeredGridMeasuredItem measuredItem2 = $this$measure.getMeasuredItemProvider().m683getAndMeasurejy6DScQ(itemIndex2, spanRange2);
                        ...
                        int offset2 = m678maxInRangejy6DScQ(currentItemOffsets4, spanRange2) + measuredItem2.getSizeWithSpacings();
                ...
                while (true) {
                    ...
                    long spanRange3 = $this$measure.m675getSpanRangelOCCd4c($this$measure.getItemProvider(), itemIndex3, currentLaneIndex);
                    ...
                    int offset3 = m678maxInRangejy6DScQ(currentItemOffsets5, spanRange3);
                ...
                if (!z4) {
                    ...
                    if (!z5) {
                        ...
                        return new LazyStaggeredGridMeasureResult(currentItemOffsets8, firstItemOffsets4, consumedScroll, MeasureScope.CC.layout$default(scope$iv, layoutWidth, layoutHeight4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt$measure$1$29
