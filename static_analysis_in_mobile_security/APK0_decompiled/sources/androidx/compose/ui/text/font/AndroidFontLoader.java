    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (FontLoadingStrategy.m4854equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4859getBlockingPKNRLFQ())) {
            ...
            try {
                ...
                m5563constructorimpl = Result.m5563constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m5569isFailureimpl(m5563constructorimpl) ? null : m5563constructorimpl);
        } else {
