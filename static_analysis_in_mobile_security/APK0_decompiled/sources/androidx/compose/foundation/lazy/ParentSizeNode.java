...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int height = i2;
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m5220getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m5218getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5219getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5217getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
