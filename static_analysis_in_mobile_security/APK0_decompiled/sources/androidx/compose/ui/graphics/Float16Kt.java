...
public final class Float16Kt {
    ...
    public static final short m3113minAoSsdG0(short x, short y) {
        if (Float16.m3085isNaNimpl(x) || Float16.m3085isNaNimpl(y)) {
            return Float16.INSTANCE.m3107getNaNslo4al4();
        }
        return Float16.m3072compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m3112maxAoSsdG0(short x, short y) {
        if (Float16.m3085isNaNimpl(x) || Float16.m3085isNaNimpl(y)) {
            return Float16.INSTANCE.m3107getNaNslo4al4();
        }
        return Float16.m3072compareTo41bOqos(x, y) >= 0 ? x : y;
