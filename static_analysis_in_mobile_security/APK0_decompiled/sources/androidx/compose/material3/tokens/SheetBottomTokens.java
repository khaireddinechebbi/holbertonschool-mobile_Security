...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5274constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5274constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2148getLevel1D9Ej5fM();
    ...
    public final float m2439getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2440getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2441getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2442getDockedStandardContainerElevationD9Ej5fM() {
