...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2961boximpl(enabled ? this.thumbColor : this.disabledThumbColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2972equalsimpl0(this.thumbColor, ((DefaultSliderColors) other).thumbColor) && Color.m2972equalsimpl0(this.disabledThumbColor, ((DefaultSliderColors) other).disabledThumbColor) && Color.m2972equalsimpl0(this.activeTrackColor, ((DefaultSliderColors) other).activeTrackColor) && Color.m2972equalsimpl0(this.inactiveTrackColor, ((DefaultSliderColors) other).inactiveTrackColor) && Color.m2972equalsimpl0(this.disabledActiveTrackColor, ((DefaultSliderColors) other).disabledActiveTrackColor) && Color.m2972equalsimpl0(this.disabledInactiveTrackColor, ((DefaultSliderColors) other).disabledInactiveTrackColor) && Color.m2972equalsimpl0(this.activeTickColor, ((DefaultSliderColors) other).activeTickColor) && Color.m2972equalsimpl0(this.inactiveTickColor, ((DefaultSliderColors) other).inactiveTickColor) && Color.m2972equalsimpl0(this.disabledActiveTickColor, ((DefaultSliderColors) other).disabledActiveTickColor) && Color.m2972equalsimpl0(this.disabledInactiveTickColor, ((DefaultSliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.thumbColor);
        return (((((((((((((((((result * 31) + Color.m2978hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2978hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2978hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2978hashCodeimpl(this.activeTickColor)) * 31) + Color.m2978hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2978hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2978hashCodeimpl(this.disabledInactiveTickColor);
    }
}
