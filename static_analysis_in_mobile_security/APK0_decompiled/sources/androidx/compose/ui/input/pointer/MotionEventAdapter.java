...
public final class MotionEventAdapter {
    ...
    private final long m4037getComposePointerId_I2yYro(int motionEventPointerId) {
        long newId;
        ...
        return PointerId.m4087constructorimpl(newId);
    }
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        ...
        long pointerId = m4037getComposePointerId_I2yYro(motionEventPointerId);
        ...
        if (index == 0) {
            ...
            position = positionCalculator.mo4188screenToLocalMKHz9U(rawPosition2);
            rawPosition = rawPosition2;
        } else if (Build.VERSION.SDK_INT >= 29) {
            long rawPosition3 = MotionEventHelper.INSTANCE.m4038toRawOffsetdBAh8RU(motionEvent, index);
            position = positionCalculator.mo4188screenToLocalMKHz9U(rawPosition3);
            rawPosition = rawPosition3;
        } else {
            long rawPosition4 = positionCalculator.mo4187localToScreenMKHz9U(position2);
            position = position2;
            rawPosition = rawPosition4;
        }
        switch (motionEvent.getToolType(index)) {
            case 0:
                toolType = PointerType.INSTANCE.m4186getUnknownT8wyACA();
                break;
            case 1:
                toolType = PointerType.INSTANCE.m4185getTouchT8wyACA();
                break;
            case 2:
                toolType = PointerType.INSTANCE.m4184getStylusT8wyACA();
                break;
            case 3:
                toolType = PointerType.INSTANCE.m4183getMouseT8wyACA();
                break;
            case 4:
                toolType = PointerType.INSTANCE.m4182getEraserT8wyACA();
                break;
            default:
                toolType = PointerType.INSTANCE.m4186getUnknownT8wyACA();
                break;
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            scrollDelta = Offset.INSTANCE.m2747getZeroF1C5BW0();
        }
