...
public final class IconButtonColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1876083926, $changed, -1, "androidx.compose.material3.IconButtonColors.containerColor (IconButton.kt:822)");
        }
    ...
    public final State<Color> contentColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(613133646, $changed, -1, "androidx.compose.material3.IconButtonColors.contentColor (IconButton.kt:832)");
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconButtonColors) && Color.m2972equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) && Color.m2972equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) && Color.m2972equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) && Color.m2972equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
