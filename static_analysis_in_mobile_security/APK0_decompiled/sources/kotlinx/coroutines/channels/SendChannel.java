...
public interface SendChannel<E> {
    ...
    Object mo7066trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo7066trySendJP2dKIU(e);
            if (ChannelResult.m7086isSuccessimpl(result)) {
                return true;
            }
            Throwable m7080exceptionOrNullimpl = ChannelResult.m7080exceptionOrNullimpl(result);
