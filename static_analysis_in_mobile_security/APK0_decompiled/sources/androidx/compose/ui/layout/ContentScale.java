...
public interface ContentScale {
    ...
    long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4222computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4223computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4221computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m4224computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                if (Size.m2800getWidthimpl(srcSize) > Size.m2800getWidthimpl(dstSize) || Size.m2797getHeightimpl(srcSize) > Size.m2797getHeightimpl(dstSize)) {
                    it = ContentScaleKt.m4223computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(it, it);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4216computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m4224computeFillWidthiLBOSCw;
                float m4221computeFillHeightiLBOSCw;
                m4224computeFillWidthiLBOSCw = ContentScaleKt.m4224computeFillWidthiLBOSCw(srcSize, dstSize);
                m4221computeFillHeightiLBOSCw = ContentScaleKt.m4221computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m4224computeFillWidthiLBOSCw, m4221computeFillHeightiLBOSCw);
            }
        };
