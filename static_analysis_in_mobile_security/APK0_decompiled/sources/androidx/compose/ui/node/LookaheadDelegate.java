...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4396setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m4282setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m4282setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5439getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4226placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo4226placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m5391equalsimpl0(getPosition(), position)) {
            m4396setPositiongyyYBs(position);
    ...
    public final Placeable m4394performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4395positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long aggregatedOffset = IntOffset.INSTANCE.m5402getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            aggregatedOffset = IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(aggregatedOffset) + IntOffset.m5392getXimpl(other$iv), IntOffset.m5393getYimpl(aggregatedOffset) + IntOffset.m5393getYimpl(other$iv));
