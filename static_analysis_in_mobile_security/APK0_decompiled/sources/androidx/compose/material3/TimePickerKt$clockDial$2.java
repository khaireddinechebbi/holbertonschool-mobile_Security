...
final class TimePickerKt$clockDial$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    final /* synthetic */ boolean $autoSwitchToMinute;
    final /* synthetic */ TimePickerState $state;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TimePickerKt$clockDial$2(TimePickerState timePickerState, boolean z) {
        super(3);
    ...
    public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
        ...
        float maxDist = $this$invoke_u24lambda_u248.mo327toPx0680j_4(f);
        ...
        if (invalid$iv$iv || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv4 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.TimePickerKt$clockDial$2$1$1
                ...
                public final void m1910invokeozmzZPI(long it) {
                    TimePickerState.this.m1926setCentergyyYBs$material3_release(IntSizeKt.m5440getCenterozmzZPI(it));
                }
            };
        ...
        $composer.endReplaceableGroup();
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(OnRemeasuredModifierKt.onSizeChanged(companion, (Function1) value$iv$iv4), new Object[]{this.$state, IntOffset.m5383boximpl(invoke$lambda$7(center$delegate)), Float.valueOf(maxDist)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass2(offsetX$delegate, offsetY$delegate, scope, this.$state, maxDist, this.$autoSwitchToMinute, null)), new Object[]{this.$state, IntOffset.m5383boximpl(invoke$lambda$7(center$delegate)), Float.valueOf(maxDist)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3(scope, this.$state, this.$autoSwitchToMinute, maxDist, offsetX$delegate, offsetY$delegate, null));
        if (ComposerKt.isTraceInProgress()) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        long it = this.J$0;
                        TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, Offset.m2731getXimpl(it));
                        TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, Offset.m2732getYimpl(it));
                        return Unit.INSTANCE;
                    default:
                ...
                case 0:
                    ...
                    Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.3.1
                        ...
                        public final void invoke2() {
                            BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C00601(timePickerState, z, null), 3, null);
                        }
                        ...
                        static final class C00601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            C00601(TimePickerState timePickerState, boolean z, Continuation<? super C00601> continuation) {
                                super(2, continuation);
                                this.$state = timePickerState;
                                this.$autoSwitchToMinute = z;
                            }
                            ...
                            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C00601(this.$state, this.$autoSwitchToMinute, continuation);
                            }
                            ...
                            public final Object invokeSuspend(Object $result) {
                                ...
                                switch (this.label) {
                                    case 0:
                                        ...
                                        if (Selection.m1707equalsimpl0(this.$state.m1924getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1712getMinuteJiIwxys())) {
                                            this.label = 2;
                    ...
                    detectDragGestures = DragGestureDetectorKt.detectDragGestures($this$pointerInput, (r12 & 1) != 0 ? new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.gestures.DragGestureDetectorKt$detectDragGestures$2
                        ...
                        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m281invokek4lQ0M(long it) {
                        }
                            ...
                            public final Object invokeSuspend(Object $result) {
                                ...
                                switch (this.label) {
                                    case 0:
                                        ...
                                        TimePickerKt$clockDial$2.invoke$lambda$2(mutableState, TimePickerKt$clockDial$2.invoke$lambda$1(mutableState) + Offset.m2731getXimpl(this.$dragAmount));
                                        MutableState<Float> mutableState2 = this.$offsetY$delegate;
                                        TimePickerKt$clockDial$2.invoke$lambda$5(mutableState2, TimePickerKt$clockDial$2.invoke$lambda$4(mutableState2) + Offset.m2732getYimpl(this.$dragAmount));
                                        this.label = 1;
                                        if (TimePickerState.update$material3_release$default(this.$state, TimePickerKt.atan(TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m5393getYimpl(this.$state.m1923getCenternOccac$material3_release()), TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m5392getXimpl(this.$state.m1923getCenternOccac$material3_release())), false, this, 2, null) != coroutine_suspended) {
                                            break;
                                        } else {
                                            return coroutine_suspended;
                                        }
