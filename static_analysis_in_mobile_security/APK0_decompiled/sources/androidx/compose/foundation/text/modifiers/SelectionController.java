    ...
    */
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.CC.m3518drawPathLG529CI$default(drawScope, selectionPath, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        float right$iv = Size.m2800getWidthimpl(drawScope.mo3442getSizeNHjbRc());
        float bottom$iv = Size.m2797getHeightimpl(drawScope.mo3442getSizeNHjbRc());
