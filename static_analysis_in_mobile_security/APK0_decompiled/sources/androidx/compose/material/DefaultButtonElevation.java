...
final class DefaultButtonElevation implements ButtonElevation {
    ...
    public State<Dp> elevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new DefaultButtonElevation$elevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-1598807317);
            ComposerKt.sourceInformation($composer, "552@22389L80");
            EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new DefaultButtonElevation$elevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
