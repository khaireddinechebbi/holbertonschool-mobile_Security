...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m5563constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m5563constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    */
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult m7076boximpl = ChannelResult.m7076boximpl(ChannelResult.INSTANCE.m7091successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m7076boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
            return tryResume02;
        }
                    ...
                    try {
                        if (updateCellReceive != symbol2) {
                            ...
                            while (!isClosedForReceive()) {
                                ...
                                int i4 = (int) (andIncrement % BufferedChannelKt.SEGMENT_SIZE);
                                ...
                                Object updateCellReceive2 = updateCellReceive(channelSegment2, i4, andIncrement, orCreateCancellableContinuation);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ <E> java.lang.Object m7068receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r17, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r18) {
        /*
            Method dump skipped, instructions count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7068receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m7069receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r28, int r29, long r30, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r32) {
        /*
            Method dump skipped, instructions count: 452
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7069receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m5563constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    */
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m7127getSegmentimpl(s$iv);
        if (segment.id > id) {
    ...
    public final ChannelSegment<E> findSegmentReceive(long id, ChannelSegment<E> startFrom) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m7127getSegmentimpl(it);
    ...
    public final String toStringDebug$kotlinx_coroutines_core() {
        ...
        while (true) {
            StringBuilder append4 = new StringBuilder().append(DebugStringsKt.getHexAddress(channelSegment2)).append("=[").append(channelSegment2.isRemoved() ? "*" : "").append(channelSegment2.id).append(",prev=");
            ChannelSegment channelSegment3 = (ChannelSegment) channelSegment2.getPrev();
            sb.append(append4.append(channelSegment3 != null ? DebugStringsKt.getHexAddress(channelSegment3) : null).append(',').toString());
            ...
            StringBuilder append5 = new StringBuilder().append("next=");
            ChannelSegment channelSegment4 = (ChannelSegment) channelSegment2.getNext();
            sb.append(append5.append(channelSegment4 != null ? DebugStringsKt.getHexAddress(channelSegment4) : null).append("]  ").toString());
