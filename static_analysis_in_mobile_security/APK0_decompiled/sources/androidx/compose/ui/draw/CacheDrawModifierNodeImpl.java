...
final class CacheDrawModifierNodeImpl extends Modifier.Node implements CacheDrawModifierNode, ObserverModifierNode, BuildDrawCacheParams {
    ...
    private final DrawResult getOrBuildCachedDrawBlock() {
        if (!this.isCacheValid) {
            final CacheDrawScope $this$getOrBuildCachedDrawBlock_u24lambda_u241 = this.cacheDrawScope;
            $this$getOrBuildCachedDrawBlock_u24lambda_u241.setDrawResult$ui_release(null);
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.ui.draw.CacheDrawModifierNodeImpl$getOrBuildCachedDrawBlock$1$1
                ...
                public final void invoke2() {
                    CacheDrawModifierNodeImpl.this.getBlock().invoke($this$getOrBuildCachedDrawBlock_u24lambda_u241);
                }
            });
            if ($this$getOrBuildCachedDrawBlock_u24lambda_u241.getDrawResult() == null) {
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        getOrBuildCachedDrawBlock().getBlock$ui_release().invoke($this$draw);
    }
}
