    ...
    public TimePickerState(int initialHour, int initialMinute, final boolean is24Hour) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public final long m1928invokeRKDOV3M() {
                ...
                float length = Dp.m5274constructorimpl(Dp.m5274constructorimpl(((is24Hour && inInnerCircle && Selection.m1707equalsimpl0(TimePickerState.this.m1924getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1711getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - arg0$iv) + arg0$iv);
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L3e:
            kotlin.ResultKt.throwOnFailure(r8)
            r1 = r12
            int r0 = r1.m1924getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r2 = androidx.compose.material3.Selection.INSTANCE
            int r2 = r2.m1711getHourJiIwxys()
            boolean r0 = androidx.compose.material3.Selection.m1707equalsimpl0(r0, r2)
            if (r0 == 0) goto L5f
