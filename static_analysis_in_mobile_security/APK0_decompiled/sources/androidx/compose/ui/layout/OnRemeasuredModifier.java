...
public interface OnRemeasuredModifier extends Modifier.Element {
    ...
    void mo252onRemeasuredozmzZPI(long size);
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static boolean all(OnRemeasuredModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$all($this, predicate);
        }

        @Deprecated
        public static boolean any(OnRemeasuredModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
        ...
        public static <R> R foldIn(OnRemeasuredModifier onRemeasuredModifier, R r, Function2<? super R, ? super Modifier.Element, ? extends R> operation) {
            ...
            return (R) Modifier.Element.CC.$default$foldIn(onRemeasuredModifier, r, operation);
        }
        ...
        public static <R> R foldOut(OnRemeasuredModifier onRemeasuredModifier, R r, Function2<? super Modifier.Element, ? super R, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) Modifier.Element.CC.$default$foldOut(onRemeasuredModifier, r, operation);
        }
