...
public final class SavedStateHandleSupport {
    ...
    public static final <T extends SavedStateRegistryOwner & ViewModelStoreOwner> void enableSavedStateHandles(T t) {
        ...
        Lifecycle.State currentState = t.getLifecycleRegistry().getState();
        ...
        if (t.getSavedStateRegistry().getSavedStateProvider(SAVED_STATE_KEY) == null) {
            ...
            t.getLifecycleRegistry().addObserver(new SavedStateHandleAttacher(provider));
        }
    }
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(ViewModelStoreOwner $this$savedStateHandlesVM) {
        ...
        return (SavedStateHandlesVM) new ViewModelProvider($this$savedStateHandlesVM, new ViewModelProvider.Factory() { // from class: androidx.lifecycle.SavedStateHandleSupport$savedStateHandlesVM$1
