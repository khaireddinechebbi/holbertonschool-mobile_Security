...
public final class TabKt {
    ...
    public static final void m1833TabwqdebIU(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 191739611) == 38347922 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 64) != 0) {
                    ...
                    selectedContentColor2 = ((Color) consume).m2981unboximpl();
                    $dirty2 &= -3670017;
                } else {
                    modifier2 = modifier4;
            ...
            final Function2 styledText = text != null ? ComposableLambdaKt.composableLambda($composer3, 708874428, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$styledText$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        TextStyle style = TextStyle.m4776copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer4, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5127boximpl(TextAlign.INSTANCE.m5134getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
            ...
            text2 = text;
            $composer2 = $composer3;
            m1832TabbogVsAg(selected, onClick, modifier3, enabled2, selectedContentColor3, unselectedContentColor3, interactionSource2, ComposableLambdaKt.composableLambda($composer3, 1540996038, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabKt.m1833TabwqdebIU(selected, onClick, modifier5, z, function24, function25, j, j2, mutableInteractionSource, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
            ...
            m1834TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor3, selected, ComposableLambdaKt.composableLambda($composer2, -429037564, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$2
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier m719selectableO2vRcR0 = SelectableKt.m719selectableO2vRcR0(SizeKt.m520height3ABfNKs(modifier5, f), selected, mutableInteractionSource, ripple, z, Role.m4603boximpl(Role.INSTANCE.m4616getTabo7Vup1c()), onClick);
                        f2 = TabKt.HorizontalTextPadding;
                        Modifier modifier$iv = SizeKt.fillMaxWidth$default(PaddingKt.m489paddingVpY3zN4$default(m719selectableO2vRcR0, f2, 0.0f, 2, null), 0.0f, 1, null);
                        ...
                        SpacerKt.Spacer(SizeKt.m531requiredWidth3ABfNKs(companion, f3), $composer3, 6);
                        TextStyle style = TextStyle.m4776copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5127boximpl(TextAlign.INSTANCE.m5134getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1834TabTransitionKlgxPg(final long r30, final long r32, final boolean r34, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, androidx.compose.runtime.Composer r36, final int r37) {
        /*
            Method dump skipped, instructions count: 591
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1834TabTransitionKlgxPg(long, long, boolean, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int):void");
    }
        ...
        if (($dirty & 91) != 18 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    if (function2 == null) {
                        ...
                        for (Object element$iv : $this$first$iv) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "text")) {
                                ...
                                placeable = ((Measurable) element$iv).mo4225measureBRTryo0(m5208copyZbe2FdA);
                            }
                        }
                    ...
                    if (function22 != null) {
                        ...
                        for (Object element$iv2 : $this$first$iv2) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "icon")) {
                                placeable2 = ((Measurable) element$iv2).mo4225measureBRTryo0(constraints);
                            }
                        }
                        throw new NoSuchElementException("Collection contains no element matching the predicate.");
                    }
                    ...
                    final int tabHeight = Math.max(specHeight, height + height2 + Layout.mo320roundToPxR2X_6o(j));
