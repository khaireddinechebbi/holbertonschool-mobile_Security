...
public final class TextLayoutInput {
    ...
    private TextLayoutInput(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, FontFamily.Resolver fontFamilyResolver, long constraints) {
        this.text = text;
        this.style = style;
    ...
    public final Font.ResourceLoader getResourceLoader() {
        ...
        return DeprecatedBridgeFontResourceLoader.INSTANCE.from(this.fontFamilyResolver);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    private TextLayoutInput(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
        this(text, style, placeholders, maxLines, softWrap, overflow, density, layoutDirection, resourceLoader, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader), constraints);
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    private TextLayoutInput(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        this(text, style, placeholders, maxLines, softWrap, overflow, density, layoutDirection, (Font.ResourceLoader) null, fontFamilyResolver, constraints);
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        Intrinsics.checkNotNullParameter(density, "density");
    ...
    public final TextLayoutInput m4735copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        Intrinsics.checkNotNullParameter(density, "density");
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextLayoutInput) && Intrinsics.areEqual(this.text, ((TextLayoutInput) other).text) && Intrinsics.areEqual(this.style, ((TextLayoutInput) other).style) && Intrinsics.areEqual(this.placeholders, ((TextLayoutInput) other).placeholders) && this.maxLines == ((TextLayoutInput) other).maxLines && this.softWrap == ((TextLayoutInput) other).softWrap && TextOverflow.m5174equalsimpl0(this.overflow, ((TextLayoutInput) other).overflow) && Intrinsics.areEqual(this.density, ((TextLayoutInput) other).density) && this.layoutDirection == ((TextLayoutInput) other).layoutDirection && Intrinsics.areEqual(this.fontFamilyResolver, ((TextLayoutInput) other).fontFamilyResolver) && Constraints.m5211equalsimpl0(this.constraints, ((TextLayoutInput) other).constraints);
    }

    public int hashCode() {
        int result = this.text.hashCode();
        return (((((((((((((((((result * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.softWrap)) * 31) + TextOverflow.m5175hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m5221hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m5176toStringimpl(this.overflow)) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m5223toStringimpl(this.constraints)) + ')';
    }
}
