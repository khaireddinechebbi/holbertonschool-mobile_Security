...
public interface LazyLayoutItemProvider {
    ...
    public final /* synthetic */ class CC {
        public static Object $default$getContentType(LazyLayoutItemProvider _this, int index) {
            return null;
        }

        public static int $default$getIndex(LazyLayoutItemProvider _this, Object key) {
