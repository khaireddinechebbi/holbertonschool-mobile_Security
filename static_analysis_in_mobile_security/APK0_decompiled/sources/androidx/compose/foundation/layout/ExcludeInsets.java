...
final class ExcludeInsets implements WindowInsets {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ExcludeInsets) && Intrinsics.areEqual(((ExcludeInsets) other).included, this.included) && Intrinsics.areEqual(((ExcludeInsets) other).excluded, this.excluded);
    }
