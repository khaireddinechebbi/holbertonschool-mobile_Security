...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2972equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m2972equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m2972equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Color.m2978hashCodeimpl(this.unselectedColor)) * 31) + Color.m2978hashCodeimpl(this.disabledColor);
    }
}
