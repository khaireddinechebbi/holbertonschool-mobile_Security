...
final class CombinedClickablePointerInputNode extends AbstractClickablePointerInputNode {
    ...
    protected Object pointerInput(PointerInputScope $this$pointerInput, Continuation<? super Unit> continuation) {
        ...
        Object detectTapGestures = TapGestureDetectorKt.detectTapGestures($this$pointerInput, (!getEnabled() || this.onDoubleClick == null) ? null : new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.CombinedClickablePointerInputNode$pointerInput$2
            {
                super(1);
            }
