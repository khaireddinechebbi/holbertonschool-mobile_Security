...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m5274constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m5274constructorimpl((float) 72.0d);
    ...
    public final float m2436getContainerElevationD9Ej5fM() {
    ...
    public final float m2437getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m2438getFullScreenHeaderContainerHeightD9Ej5fM() {
