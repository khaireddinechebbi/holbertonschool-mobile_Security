...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.CC.layout$default(measure, Constraints.m5220getMinWidthimpl(constraints), Constraints.m5219getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (measurables.size() == 1) {
            final Placeable placeable = measurables.get(0).mo4225measureBRTryo0(constraints);
            return MeasureScope.CC.layout$default(measure, ConstraintsKt.m5232constrainWidthK40F9xA(constraints, placeable.getWidth()), ConstraintsKt.m5231constrainHeightK40F9xA(constraints, placeable.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
                {
                    super(1);
                }
        ...
        return MeasureScope.CC.layout$default(measure, ConstraintsKt.m5232constrainWidthK40F9xA(constraints, maxWidth), ConstraintsKt.m5231constrainHeightK40F9xA(constraints, maxHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
