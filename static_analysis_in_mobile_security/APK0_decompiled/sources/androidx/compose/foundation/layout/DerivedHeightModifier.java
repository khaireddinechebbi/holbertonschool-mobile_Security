...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int height = this.heightCalc.invoke(getUnconsumedInsets(), measure).intValue();
        if (height != 0) {
            childConstraints = Constraints.m5208copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : height, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : height);
            final Placeable placeable = measurable.mo4225measureBRTryo0(childConstraints);
            return MeasureScope.CC.layout$default(measure, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
                {
                    super(1);
                }
        ...
        return MeasureScope.CC.layout$default(measure, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Placeable.PlacementScope placementScope) {
                invoke2(placementScope);
                return Unit.INSTANCE;
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DerivedHeightModifier) && Intrinsics.areEqual(this.insets, ((DerivedHeightModifier) other).insets) && Intrinsics.areEqual(this.heightCalc, ((DerivedHeightModifier) other).heightCalc);
    }
