...
final class ClickableSemanticsElement extends ModifierNodeElement<ClickableSemanticsNode> {
    ...
    public void update(ClickableSemanticsNode node) {
        ...
        node.m205updateUMe6uN4(this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = ClickableElement$$ExternalSyntheticBackport0.m(this.enabled);
        int i = result * 31;
        Role role = this.role;
