...
public class MutableLongState implements StateObject, androidx.compose.runtime.MutableLongState, SnapshotMutableState<Long> {
    ...
    public /* synthetic */ Long getValue() {
        return MutableLongState.CC.$default$getValue((androidx.compose.runtime.MutableLongState) this);
    }
    ...
    public void setLongValue(long value) {
        ...
        if (it.getValue() != value) {
            ...
            synchronized (lock$iv$iv$iv) {
                ...
                LongStateStateRecord $this$_set_longValue__u24lambda_u241_u24lambda_u240 = (LongStateStateRecord) SnapshotKt.overwritableRecord($this$overwritable$iv, this, current, it);
                $this$_set_longValue__u24lambda_u241_u24lambda_u240.setValue(value);
    ...
    public Function1<Long, Unit> component2() {
        return new Function1<Long, Unit>() { // from class: androidx.compose.runtime.SnapshotMutableLongStateImpl$component2$1
            ...
            public final void invoke(long it) {
                MutableLongState.this.setLongValue(it);
            }
        };
    }
