...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo4892createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4910getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo4893createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4910getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo4993getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4910getFontStyle_LCdwA(), typefaceRequest.m4911getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(result, false, 2, null);
    }
}
