...
public interface DrawModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static boolean all(DrawModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
            return Modifier.Element.CC.$default$all($this, predicate);
        }

        @Deprecated
        public static boolean any(DrawModifier $this, Function1<? super Modifier.Element, Boolean> predicate) {
            Intrinsics.checkNotNullParameter(predicate, "predicate");
        ...
        public static <R> R foldIn(DrawModifier drawModifier, R r, Function2<? super R, ? super Modifier.Element, ? extends R> operation) {
            ...
            return (R) Modifier.Element.CC.$default$foldIn(drawModifier, r, operation);
        }

        @Deprecated
        public static <R> R foldOut(DrawModifier drawModifier, R r, Function2<? super Modifier.Element, ? super R, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) Modifier.Element.CC.$default$foldOut(drawModifier, r, operation);
        }

        @Deprecated
        public static Modifier then(DrawModifier $this, Modifier other) {
