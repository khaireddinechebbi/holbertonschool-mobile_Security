...
public final class DecayAnimationSpecKt {
    public static final <T, V extends AnimationVector> T calculateTargetValue(DecayAnimationSpec<T> decayAnimationSpec, TwoWayConverter<T, V> typeConverter, T t, T t2) {
        ...
        VectorizedDecayAnimationSpec vectorizedSpec = decayAnimationSpec.vectorize(typeConverter);
        return typeConverter.getConvertFromVector().invoke(vectorizedSpec.getTargetValue(typeConverter.getConvertToVector().invoke(t), typeConverter.getConvertToVector().invoke(t2)));
    }
    ...
    public static final <T> DecayAnimationSpec<T> generateDecayAnimationSpec(FloatDecayAnimationSpec $this$generateDecayAnimationSpec) {
        Intrinsics.checkNotNullParameter($this$generateDecayAnimationSpec, "<this>");
