...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5272boximpl(target), new FloatingActionButtonElevation$animateElevation$2(animatable, this, target, interaction, null), $composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof FloatingActionButtonElevation) && Dp.m5279equalsimpl0(this.defaultElevation, ((FloatingActionButtonElevation) other).defaultElevation) && Dp.m5279equalsimpl0(this.pressedElevation, ((FloatingActionButtonElevation) other).pressedElevation) && Dp.m5279equalsimpl0(this.focusedElevation, ((FloatingActionButtonElevation) other).focusedElevation) && Dp.m5279equalsimpl0(this.hoveredElevation, ((FloatingActionButtonElevation) other).hoveredElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m5280hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5280hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5280hashCodeimpl(this.hoveredElevation);
    }
}
