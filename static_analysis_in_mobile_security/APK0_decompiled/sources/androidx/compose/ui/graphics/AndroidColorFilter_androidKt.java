...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2839actualTintColorFilterxETnrds(long color, int blendMode) {
        PorterDuffColorFilter androidColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m2917BlendModeColorFilterxETnrds(color, blendMode);
        } else {
            androidColorFilter = new PorterDuffColorFilter(ColorKt.m3025toArgb8_81llA(color), AndroidBlendMode_androidKt.m2824toPorterDuffModes9anfk8(blendMode));
        }
        return new ColorFilter(androidColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final ColorFilter m2837actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final ColorFilter m2838actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m3025toArgb8_81llA(multiply), ColorKt.m3025toArgb8_81llA(add)));
    }
}
