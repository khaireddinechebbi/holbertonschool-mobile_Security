...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo6879minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo6880minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo6881plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m6883minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo6881plusLRDsOJo(Duration.m6941unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m6887compareToLRDsOJo($this.mo6880minusUwyO8pc(other), Duration.INSTANCE.m6991getZEROUwyO8pc());
        }
    }
}
