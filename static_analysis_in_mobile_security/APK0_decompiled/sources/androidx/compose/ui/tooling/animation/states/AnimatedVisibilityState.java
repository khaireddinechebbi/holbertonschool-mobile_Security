...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    private static final String Enter = m5198constructorimpl("Enter");
    private static final String Exit = m5198constructorimpl("Exit");
    private final String value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m5197boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static String m5198constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5199equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual(str, ((AnimatedVisibilityState) obj).m5203unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5200equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5201hashCodeimpl(String str) {
        return str.hashCode();
    }

    public boolean equals(Object obj) {
        return m5199equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5201hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ String m5203unboximpl() {
        return this.value;
    }
    ...
    public static String m5202toStringimpl(String arg0) {
        return arg0;
    }

    public String toString() {
        return m5202toStringimpl(this.value);
    }
