...
public final class ViewCompositionStrategy_androidKt {
    ...
    public static final Function0<Unit> installForLifecycle(final AbstractComposeView view, final Lifecycle lifecycle) {
        ...
        final LifecycleEventObserver observer = new LifecycleEventObserver() { // from class: androidx.compose.ui.platform.ViewCompositionStrategy_androidKt$installForLifecycle$observer$1
