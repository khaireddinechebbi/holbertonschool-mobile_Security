...
public class PersistentOrderedMapBuilderLinksIterator<K, V> implements Iterator<LinkedValue<V>>, KMutableIterator {
    ...
    public PersistentOrderedMapBuilderLinksIterator(Object nextKey, PersistentOrderedMapBuilder<K, V> builder) {
    ...
    public LinkedValue<V> next() {
        ...
        this.index++;
        LinkedValue linkedValue = this.builder.getHashMapBuilder$runtime_release().get(this.nextKey);
        if (linkedValue == null) {
        ...
        LinkedValue result = linkedValue;
        this.nextKey = result.getNext();
        return result;
    }
