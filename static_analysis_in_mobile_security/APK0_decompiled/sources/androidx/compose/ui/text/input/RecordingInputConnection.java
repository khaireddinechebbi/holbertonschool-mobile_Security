...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            inputMethodManager.updateSelection(TextRange.m4766getMinimpl(state.getSelection()), TextRange.m4765getMaximpl(state.getSelection()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4762getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    */
    public boolean performContextMenuAction(int r9) {
        ...
        L21:
            ...
            androidx.compose.ui.text.input.TextFieldValue r7 = r8.mTextFieldValue
        ...
        L36:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.input.RecordingInputConnection.performContextMenuAction(int):boolean");
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.INSTANCE.m4930getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.INSTANCE.m4932getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.INSTANCE.m4936getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.INSTANCE.m4937getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.INSTANCE.m4933getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.INSTANCE.m4931getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.INSTANCE.m4935getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo4944onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4766getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
