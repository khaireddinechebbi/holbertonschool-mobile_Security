...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), measure.mo321roundToPx0680j_4(DpSize.m5372getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), measure.mo321roundToPx0680j_4(DpSize.m5370getHeightD9Ej5fM(this.size)));
        return MeasureScope.CC.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5369equalsimpl0(this.size, otherModifier.size);
    }

    public int hashCode() {
        return DpSize.m5374hashCodeimpl(this.size);
    }
}
