...
public final class SelectionManager {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L49:
            r8 = 1
            long r9 = r4.mo890getHandlePositiondBAh8RU(r1, r8)
            long r9 = r2.mo4233localPositionOfR5De75A(r6, r9)
            r11 = 0
            long r12 = r5.mo890getHandlePositiondBAh8RU(r1, r11)
            long r12 = r2.mo4233localPositionOfR5De75A(r7, r12)
            androidx.compose.ui.geometry.Rect r14 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r2)
            androidx.compose.ui.geometry.Offset r15 = androidx.compose.ui.geometry.Offset.m2720boximpl(r9)
            long r16 = r15.getPackedValue()
            r18 = 0
            boolean r19 = androidx.compose.foundation.text.selection.SelectionManagerKt.m942containsInclusiveUv8p0NA(r14, r9)
            if (r19 != 0) goto L84
        ...
        L89:
            r15 = 0
        L8a:
            r0.m927setStartHandlePosition_kEHs6E(r15)
            androidx.compose.ui.geometry.Offset r8 = androidx.compose.ui.geometry.Offset.m2720boximpl(r12)
            long r15 = r8.getPackedValue()
            r11 = 0
            boolean r17 = androidx.compose.foundation.text.selection.SelectionManagerKt.m942containsInclusiveUv8p0NA(r14, r12)
            if (r17 != 0) goto Laa
        ...
        Lb3:
            r3 = 0
        Lb4:
            r0.m926setEndHandlePosition_kEHs6E(r3)
            return
        Lb8:
            r18 = r1
            goto Lc3
        ...
        Lc3:
            r1 = 0
            r0.m927setStartHandlePosition_kEHs6E(r1)
            r0.m926setEndHandlePosition_kEHs6E(r1)
            return
        */
        ...
        if (startSelectable != null && (startLayoutCoordinates = startSelectable.getLayoutCoordinates()) != null) {
            if (endSelectable != null && (endLayoutCoordinates = endSelectable.getLayoutCoordinates()) != null) {
                ...
                if (localLayoutCoordinates != null && localLayoutCoordinates.isAttached()) {
                    ...
                    float bottom = Math.max(Offset.m2732getYimpl(startOffset2), Offset.m2732getYimpl(endOffset2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo818onStartk4lQ0M(long startPoint) {
                ...
                long mo890getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    mo890getHandlePositiondBAh8RU = startSelectable.mo890getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(endSelectable);
                    mo890getHandlePositiondBAh8RU = endSelectable.mo890getHandlePositiondBAh8RU(selection, false);
                }
                long beginCoordinates = SelectionHandlesKt.m909getAdjustedCoordinatesk4lQ0M(mo890getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
    ...
    public final boolean m936updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        Offset m922convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (newPosition != null && (selection = getSelection()) != null) {
            ...
            if (otherSelectable == null) {
                m922convertToContainerCoordinatesQ7Q5hAU = null;
            } else {
                LayoutCoordinates layoutCoordinates = otherSelectable.getLayoutCoordinates();
                Intrinsics.checkNotNull(layoutCoordinates);
                m922convertToContainerCoordinatesQ7Q5hAU = m922convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m909getAdjustedCoordinatesk4lQ0M(otherSelectable.mo890getHandlePositiondBAh8RU(selection, !isStartHandle)));
            }
            if (m922convertToContainerCoordinatesQ7Q5hAU != null) {
                long otherHandlePosition = m922convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
    ...
    public final boolean m935updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        while (index$iv$iv < size) {
            ...
            Pair<Selection, Boolean> mo892updateSelectionqCDeeow = selectable.mo892updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, previousSubselection);
            Selection selection2 = mo892updateSelectionqCDeeow.component1();
            boolean consumed = mo892updateSelectionqCDeeow.component2().booleanValue();
