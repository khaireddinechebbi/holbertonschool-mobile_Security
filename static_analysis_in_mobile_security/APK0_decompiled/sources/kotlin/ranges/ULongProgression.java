...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m6771getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m5737constructorimpl = ((int) ULong.m5737constructorimpl(j ^ ULong.m5737constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m5737constructorimpl2 = (m5737constructorimpl + ((int) ULong.m5737constructorimpl(j2 ^ ULong.m5737constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m5737constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            append = sb.append((Object) ULong.m5783toStringimpl(this.first)).append("..").append((Object) ULong.m5783toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            append = sb.append((Object) ULong.m5783toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m5783toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m6797fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
