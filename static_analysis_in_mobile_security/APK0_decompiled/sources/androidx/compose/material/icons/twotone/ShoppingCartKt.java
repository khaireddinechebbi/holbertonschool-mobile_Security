...
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(Icons.TwoTone $this$ShoppingCart) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_ShoppingCart__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        _shoppingCart = build;
