...
final class PlainTooltipPositionProvider implements PopupPositionProvider {
    ...
    public PlainTooltipPositionProvider(int tooltipAnchorPadding) {
    ...
    public long mo889calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int x = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m5434getWidthimpl(popupContentSize)) / 2);
