        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    this.label = 1;
                    if (ScrollableState.CC.scroll$default(scrollableState, null, new AnonymousClass1(this.this$0, animationJob, null), this, 1, null) == coroutine_suspended) {
                    ...
                    if (updatableAnimationState2.animateToZero(function1, new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewModifier.launchAnimation.1.1.2
                        ...
                        public final void invoke2() {
                            ...
                            if (z) {
                                ...
                                if (focusedChildBounds != null && ContentInViewModifier.m250isMaxVisibleO0kMr_c$default(ContentInViewModifier.this, focusedChildBounds, 0L, 1, null)) {
