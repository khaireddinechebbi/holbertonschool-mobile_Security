...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int initialInputMode, Function1<? super InputMode, Boolean> onRequestInputModeChange) {
        ...
        this.inputMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3643boximpl(initialInputMode), null, 2, null);
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: getInputMode-aOaMEAU */
    public int mo3652getInputModeaOaMEAU() {
        State $this$getValue$iv = this.inputMode;
        return ((InputMode) $this$getValue$iv.getValue()).getValue();
    }

    /* renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m3654setInputModeiuPiT84(int i) {
        MutableState $this$setValue$iv = this.inputMode;
        $this$setValue$iv.setValue(InputMode.m3643boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3653requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m3643boximpl(inputMode)).booleanValue();
    }
}
