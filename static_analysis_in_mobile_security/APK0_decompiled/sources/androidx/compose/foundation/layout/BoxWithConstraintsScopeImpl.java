...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m429copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m431copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m431copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m5211equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m5221hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m5223toStringimpl(this.constraints)) + ')';
    }
    ...
    public long mo424getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo428getMinWidthD9Ej5fM() {
        Density $this$getMinWidth_D9Ej5fM_u24lambda_u240 = this.density;
        return $this$getMinWidth_D9Ej5fM_u24lambda_u240.mo324toDpu2uoSUM(Constraints.m5220getMinWidthimpl(mo424getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo426getMaxWidthD9Ej5fM() {
        Density $this$getMaxWidth_D9Ej5fM_u24lambda_u241 = this.density;
        return Constraints.m5214getHasBoundedWidthimpl(mo424getConstraintsmsEJaDk()) ? $this$getMaxWidth_D9Ej5fM_u24lambda_u241.mo324toDpu2uoSUM(Constraints.m5218getMaxWidthimpl(mo424getConstraintsmsEJaDk())) : Dp.INSTANCE.m5293getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo427getMinHeightD9Ej5fM() {
        Density $this$getMinHeight_D9Ej5fM_u24lambda_u242 = this.density;
        return $this$getMinHeight_D9Ej5fM_u24lambda_u242.mo324toDpu2uoSUM(Constraints.m5219getMinHeightimpl(mo424getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo425getMaxHeightD9Ej5fM() {
        Density $this$getMaxHeight_D9Ej5fM_u24lambda_u243 = this.density;
        return Constraints.m5213getHasBoundedHeightimpl(mo424getConstraintsmsEJaDk()) ? $this$getMaxHeight_D9Ej5fM_u24lambda_u243.mo324toDpu2uoSUM(Constraints.m5217getMaxHeightimpl(mo424getConstraintsmsEJaDk())) : Dp.INSTANCE.m5293getInfinityD9Ej5fM();
    }
}
