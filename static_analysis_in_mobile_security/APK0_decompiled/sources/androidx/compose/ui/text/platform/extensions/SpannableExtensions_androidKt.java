...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            if ((!TextUnit.m5452equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m5452equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m5473isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m5473isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long m5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(textIndent.getFirstLine());
                float f = 0.0f;
                if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
                    firstLine = density.mo326toPxR2X_6o(textIndent.getFirstLine());
                } else {
                    firstLine = TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA()) ? TextUnit.m5455getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long m5454getTypeUIouoOA2 = TextUnit.m5454getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA2, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
                    f = density.mo326toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA2, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
                    f = TextUnit.m5455getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = f;
    ...
    public static final void m5020setLineHeightKmRG4DE(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float resolvedLineHeight = m5015resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan(setLineHeight, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m5119isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5120isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
        }
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m5021setLineHeightr9BaKPg(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float resolvedLineHeight = m5015resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m5015resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long m5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(lineHeight);
        if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
            return density.mo326toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
            return TextUnit.m5455getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m5014createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m5017setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m5018setColorRPmYEkk($this$setSpanStyle, style.m4727getColor0d7_KjU(), start, end);
        ...
        m5019setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m5016setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0L, 0L, contextTextStyle.getFontWeight(), contextTextStyle.m4791getFontStyle4Lr2A7w(), contextTextStyle.m4792getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4864boximpl, FontSynthesis.m4873boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4882getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
    ...
    private static final MetricAffectingSpan m5014createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long m5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo326toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5455getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m5483equalsimpl0(TextUnit.m5454getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5488getSpUIouoOA()) || TextUnitType.m5483equalsimpl0(TextUnit.m5454getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5487getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            setSpan($this$setShadow, new ShadowSpan(ColorKt.m3025toArgb8_81llA(shadow.getColor()), Offset.m2731getXimpl(shadow.getOffset()), Offset.m2732getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m5016setBackgroundRPmYEkk(Spannable setBackground, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (color != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m3025toArgb8_81llA(color)), start, end);
        }
    }
    ...
    public static final void setLocaleList(Spannable $this$setLocaleList, LocaleList localeList, int start, int end) {
        ...
        if (localeList != null) {
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                Locale locale = localeList.isEmpty() ? Locale.INSTANCE.getCurrent() : localeList.get(0);
                localeSpan = new LocaleSpan(LocaleExtensions_androidKt.toJavaLocale(locale));
            }
            setSpan($this$setLocaleList, localeSpan, start, end);
        }
    }
    ...
    public static final void m5019setFontSizeKmRG4DE(Spannable setFontSize, long fontSize, Density density, int start, int end) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(fontSize);
        if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo326toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m5483equalsimpl0(m5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5455getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m5018setColorRPmYEkk(Spannable setColor, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (color != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m3025toArgb8_81llA(color)), start, end);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m5017setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m5033unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m5018setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m4792getFontSynthesisZQGJjVo() != null;
    }
