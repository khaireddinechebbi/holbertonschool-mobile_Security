...
public final class AndroidCanvas implements Canvas {
    ...
    public /* synthetic */ void mo2827clipRectmtrdDE(androidx.compose.ui.geometry.Rect rect, int i) {
        Canvas.CC.m2941$default$clipRectmtrdDE(this, rect, i);
    }
    ...
    public void mo2828concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (!MatrixKt.m3226isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m2843setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo2826clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m2836toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo2825clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m2836toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m2836toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m2955equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.INSTANCE.m2959getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo2832drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2731getXimpl(p1), Offset.m2732getYimpl(p1), Offset.m2731getXimpl(p2), Offset.m2732getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo2829drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2731getXimpl(center), Offset.m2732getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo2830drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2731getXimpl(topLeftOffset), Offset.m2732getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo2831drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m5392getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m5393getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m5392getXimpl(srcOffset) + IntSize.m5434getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m5393getYimpl(srcOffset) + IntSize.m5433getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect $this$drawImageRect_HPBpro0_u24lambda_u241 = this.dstRect;
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m5392getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m5393getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m5392getXimpl(dstOffset) + IntSize.m5434getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m5393getYimpl(dstOffset) + IntSize.m5433getHeightimpl(dstSize);
    ...
    public void mo2833drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (!PointMode.m3272equalsimpl0(pointMode, PointMode.INSTANCE.m3276getLinesr_lszbg())) {
            if (!PointMode.m3272equalsimpl0(pointMode, PointMode.INSTANCE.m3278getPolygonr_lszbg())) {
                if (PointMode.m3272equalsimpl0(pointMode, PointMode.INSTANCE.m3277getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            this.internalCanvas.drawPoint(Offset.m2731getXimpl(point), Offset.m2732getYimpl(point), paint.getInternalPaint());
        }
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m2731getXimpl(p1), Offset.m2732getYimpl(p1), Offset.m2731getXimpl(p2), Offset.m2732getYimpl(p2), frameworkPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo2834drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    public void mo2835drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2879toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}
