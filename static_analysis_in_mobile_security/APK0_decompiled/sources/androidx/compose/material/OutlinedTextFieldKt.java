...
public final class OutlinedTextFieldKt {
    ...
    public static final void OutlinedTextField(final String value, final Function1<? super String, Unit> onValueChange, Modifier modifier, boolean enabled, boolean readOnly, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean isError, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean singleLine, int maxLines, int minLines, MutableInteractionSource interactionSource, Shape shape, TextFieldColors colors, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty3 & 1533916891) == 306783378 && (1533916891 & $dirty13) == 306783378 && $composer3.getSkipping()) {
            ...
            long textColor = ($this$takeOrElse_u2dDxMtmZc$iv > Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 1 : ($this$takeOrElse_u2dDxMtmZc$iv == Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? $this$takeOrElse_u2dDxMtmZc$iv : colors2.textColor(enabled3, $composer3, (($dirty2 >> 9) & 14) | (($dirty13 >> 24) & 112)).getValue().m2981unboximpl();
            $composer3.endReplaceableGroup();
            ...
            enabled4 = enabled3;
            modifier4 = modifier3;
            BasicTextFieldKt.BasicTextField(value, onValueChange, SizeKt.m518defaultMinSizeVpY3zN4(BackgroundKt.m159backgroundbw27NRU(label != null ? PaddingKt.m491paddingqDBjuR0$default(SemanticsModifierKt.semantics(modifier3, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt$OutlinedTextField$2
            ...
            }), 0.0f, OutlinedTextFieldTopPadding, 0.0f, 0.0f, 13, null) : modifier3, colors2.backgroundColor(enabled3, $composer3, (($dirty2 >> 9) & 14) | (($dirty13 >> 24) & 112)).getValue().m2981unboximpl(), shape3), TextFieldDefaults.INSTANCE.m1250getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m1249getMinHeightD9Ej5fM()), enabled3, readOnly2, mergedTextStyle, keyboardOptions2, keyboardActions2, singleLine2, maxLines4, minLines2, visualTransformation2, (Function1<? super TextLayoutResult, Unit>) null, interactionSource3, new SolidColor(colors2.cursorColor(isError2, $composer3, ($dirty13 & 14) | (($dirty13 >> 24) & 112)).getValue().m2981unboximpl(), null), ComposableLambdaKt.composableLambda($composer3, 1710364390, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt$OutlinedTextField$3
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer4, -1823843281, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldKt$OutlinedTextField$3.1
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    Shape shape7 = shape6;
                                    int i25 = ((i23 >> 9) & 14) | 12582912;
                                    int i26 = i24;
                                    textFieldDefaults2.m1247BorderBoxnbWgWpA(z9, z10, mutableInteractionSource4, textFieldColors4, shape7, 0.0f, 0.0f, $composer5, i25 | ((i26 << 3) & 112) | ((i26 >> 15) & 896) | ((i26 >> 18) & 7168) | ((i26 >> 12) & 57344), 96);
                                    if (ComposerKt.isTraceInProgress()) {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:187:0x06cb A[ADDED_TO_REGION] */
