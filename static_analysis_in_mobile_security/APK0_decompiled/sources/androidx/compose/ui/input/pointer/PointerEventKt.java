...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        ...
        return !Offset.m2728equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m2747getZeroF1C5BW0());
    }
    ...
    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        ...
        return true ^ Offset.m2728equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m2747getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m2735minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m2747getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        ...
        if (!Offset.m2728equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m2747getZeroF1C5BW0())) {
    ...
    public static final boolean m4051isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long size) {
    ...
    public static final boolean m4052isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long size, long extendedTouchPadding) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m4178equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m4185getTouchT8wyACA())) {
            return m4051isOutOfBoundsO0kMr_c(isOutOfBounds, size);
        }
        long position = isOutOfBounds.getPosition();
        float x = Offset.m2731getXimpl(position);
        float y = Offset.m2732getYimpl(position);
        float minX = -Size.m2800getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m5434getWidthimpl(size) + Size.m2800getWidthimpl(extendedTouchPadding);
        float minY = -Size.m2797getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m5433getHeightimpl(size) + Size.m2797getHeightimpl(extendedTouchPadding);
