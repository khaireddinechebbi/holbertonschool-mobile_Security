...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            lastScheduled = (Task) atomicReferenceFieldUpdater.get(this);
            ...
            return null;
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, lastScheduled, null));
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        do {
            ...
            long staleness = time - r1.submissionTime;
    ...
    private final Task pollBuffer() {
        ...
        while (true) {
            ...
            int tailLocal = atomicIntegerFieldUpdater.get(this);
            if (tailLocal - producerIndex$FU.get(this) == 0) {
                return null;
            }
            int index = tailLocal & WorkQueueKt.MASK;
            if (atomicIntegerFieldUpdater.compareAndSet(this, tailLocal, tailLocal + 1) && (value = this.buffer.getAndSet(index, null)) != null) {
