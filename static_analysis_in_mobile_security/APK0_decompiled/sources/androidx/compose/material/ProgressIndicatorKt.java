...
public final class ProgressIndicatorKt {
    ...
    */
    public static final void m1167LinearProgressIndicator_5eSRE(final float r24, androidx.compose.ui.Modifier r25, long r26, long r28, int r30, androidx.compose.runtime.Composer r31, final int r32, final int r33) {
        /*
            Method dump skipped, instructions count: 518
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ProgressIndicatorKt.m1167LinearProgressIndicator_5eSRE(float, androidx.compose.ui.Modifier, long, long, int, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1165LinearProgressIndicator2cYBFYY(Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    backgroundColor2 = Color.m2969copywmQWz5c(r15, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r15) : 0.24f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r15) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r15) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color2) : 0.0f);
                    $dirty &= -897;
                } else {
                    backgroundColor2 = j2;
                }
            ...
            final State firstLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$firstLineHead$2
            ...
            final State firstLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            final State secondLineHead$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$secondLineHead$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            final State secondLineTail$delegate = InfiniteTransitionKt.animateFloat(infiniteTransition, 0.0f, 1.0f, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$secondLineTail$2
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
                    invoke2(keyframesSpecConfig);
                    return Unit.INSTANCE;
            ...
            Object[] keys$iv = {Color.m2961boximpl(backgroundColor3), StrokeCap.m3317boximpl(strokeCap2), firstLineHead$delegate, firstLineTail$delegate, Color.m2961boximpl(color3), secondLineHead$delegate, secondLineTail$delegate};
            ...
            if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$3$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        ProgressIndicatorKt.m1179drawLinearIndicatorBackgroundAZGd3zU(Canvas, j3, strokeWidth, i9);
                        ...
                        if (LinearProgressIndicator_2cYBFYY$lambda$1 - LinearProgressIndicator_2cYBFYY$lambda$2 > 0.0f) {
                            ...
                            ProgressIndicatorKt.m1178drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$12, LinearProgressIndicator_2cYBFYY$lambda$22, j4, strokeWidth, i9);
                        }
                        ...
                        if (LinearProgressIndicator_2cYBFYY$lambda$3 - LinearProgressIndicator_2cYBFYY$lambda$4 > 0.0f) {
                            ...
                            ProgressIndicatorKt.m1178drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$32, LinearProgressIndicator_2cYBFYY$lambda$42, j4, strokeWidth, i9);
                        }
                    }
                };
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1165LinearProgressIndicator2cYBFYY(Modifier.this, j5, j6, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1168LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    backgroundColor2 = Color.m2969copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r12) : 0.24f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color2) : 0.0f);
                    $dirty &= -7169;
                } else {
                    backgroundColor2 = j2;
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1168LinearProgressIndicatoreaDK9VM(progress, modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1166LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    backgroundColor2 = Color.m2969copywmQWz5c(r11, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r11) : 0.24f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r11) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r11) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color2) : 0.0f);
                    $dirty &= -897;
                } else {
                    backgroundColor2 = j2;
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1166LinearProgressIndicatorRIQooxk(Modifier.this, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void m1162CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            final State baseRotation$delegate = InfiniteTransitionKt.animateFloat(transition, 0.0f, BaseRotationAngle, AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(RotationDuration, 0, EasingKt.getLinearEasing(), 2, null), null, 0L, 6, null), null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            ...
            CanvasKt.Canvas(SizeKt.m534size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$3
                ...
                public final void invoke2(DrawScope Canvas) {
                    ...
                    ProgressIndicatorKt.m1177drawIndeterminateCircularIndicatorhrjfTZI(Canvas, CircularProgressIndicator_LxG7B9w$lambda$112 + offset, strokeWidth5, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1162CircularProgressIndicatorLxG7B9w(Modifier.this, j4, f, j5, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1164CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1164CircularProgressIndicatoraMcp0Q(Modifier.this, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
