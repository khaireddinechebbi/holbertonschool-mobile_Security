...
.method public final invoke(Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, v1, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->label:I
    ...
    .local v0, "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    ...
    .end local v0    # "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    .end local v2    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object/from16 v2, p0

    .local v2, "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    move-object/from16 v5, p1

    .local v5, "$result":Ljava/lang/Object;
    iget-object v6, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    ...
    .restart local v2    # "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    move-object/from16 v5, p1
    ...
    iget-object v7, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$$this$coroutineScope:Lkotlinx/coroutines/CoroutineScope;
    ...
    iget-object v11, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$pressScope:Landroidx/compose/foundation/gestures/PressGestureScopeImpl;

    invoke-direct {v10, v11, v4}, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1$1;-><init>(Landroidx/compose/foundation/gestures/PressGestureScopeImpl;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object v6, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->L$0:Ljava/lang/Object;

    iput v3, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->label:I
    ...
    .line 377
    .local v8, "it":Landroidx/compose/ui/input/pointer/PointerInputChange;
    const/4 v9, 0x0

    .line 237
    .local v9, "$i$a$-also-TapGestureDetectorKt$detectTapAndPress$2$1$down$1":I
    invoke-virtual {v8}, Landroidx/compose/ui/input/pointer/PointerInputChange;->consume()V

    .end local v8    # "it":Landroidx/compose/ui/input/pointer/PointerInputChange;
    .end local v9    # "$i$a$-also-TapGestureDetectorKt$detectTapAndPress$2$1$down$1":I
    check-cast v7, Landroidx/compose/ui/input/pointer/PointerInputChange;

    .line 239
    .local v7, "down":Landroidx/compose/ui/input/pointer/PointerInputChange;
    iget-object v8, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$onPress:Lkotlin/jvm/functions/Function3;
    ...
    .line 240
    iget-object v10, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$$this$coroutineScope:Lkotlinx/coroutines/CoroutineScope;
    ...
    iget-object v9, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$onPress:Lkotlin/jvm/functions/Function3;

    iget-object v13, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$pressScope:Landroidx/compose/foundation/gestures/PressGestureScopeImpl;

    invoke-direct {v8, v9, v13, v7, v4}, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1$2;-><init>(Lkotlin/jvm/functions/Function3;Landroidx/compose/foundation/gestures/PressGestureScopeImpl;Landroidx/compose/ui/input/pointer/PointerInputChange;Lkotlin/coroutines/Continuation;)V
    ...
    .line 245
    .end local v7    # "down":Landroidx/compose/ui/input/pointer/PointerInputChange;
    :cond_1
    move-object v7, v2

    check-cast v7, Lkotlin/coroutines/Continuation;

    iput-object v4, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->L$0:Ljava/lang/Object;

    const/4 v8, 0x2

    iput v8, v2, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->label:I

    invoke-static {v6, v4, v7, v3, v4}, Landroidx/compose/foundation/gestures/TapGestureDetectorKt;->waitForUpOrCancellation$default(Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;Landroidx/compose/ui/input/pointer/PointerEventPass;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 232
    .end local v2    # "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    .restart local v0    # "this":Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;
    :goto_1
    check-cast v2, Landroidx/compose/ui/input/pointer/PointerInputChange;

    .line 246
    .local v2, "up":Landroidx/compose/ui/input/pointer/PointerInputChange;
    if-nez v2, :cond_3

    .line 247
    .end local v2    # "up":Landroidx/compose/ui/input/pointer/PointerInputChange;
    ...
    .line 251
    .restart local v2    # "up":Landroidx/compose/ui/input/pointer/PointerInputChange;
    :cond_3
    ...
    new-instance v3, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1$4;

    iget-object v6, v0, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$pressScope:Landroidx/compose/foundation/gestures/PressGestureScopeImpl;

    invoke-direct {v3, v6, v4}, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1$4;-><init>(Landroidx/compose/foundation/gestures/PressGestureScopeImpl;Lkotlin/coroutines/Continuation;)V
    ...
    .line 255
    iget-object v3, v0, Landroidx/compose/foundation/gestures/TapGestureDetectorKt$detectTapAndPress$2$1;->$onTap:Lkotlin/jvm/functions/Function1;
