...
public final class SelectKt {
    ...
    public static final <R> Object select(Function1<? super SelectBuilder<? super R>, Unit> function1, Continuation<? super R> continuation) {
        SelectImplementation $this$select_u24lambda_u241 = new SelectImplementation(continuation.getContext());
        function1.invoke($this$select_u24lambda_u241);
        return $this$select_u24lambda_u241.doSelect(continuation);
    }
    ...
    public static final boolean tryResume(CancellableContinuation<? super Unit> cancellableContinuation, Function1<? super Throwable, Unit> function1) {
        Object token = cancellableContinuation.tryResume(Unit.INSTANCE, null, function1);
        if (token == null) {
            return false;
        }
