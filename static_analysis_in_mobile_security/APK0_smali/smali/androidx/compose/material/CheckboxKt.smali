...
.method private static final CheckboxImpl(ZLandroidx/compose/ui/state/ToggleableState;Landroidx/compose/ui/Modifier;Landroidx/compose/material/CheckboxColors;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-static {v0, v2, v15, v1}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V
    ...
    invoke-static {v7, v1, v5, v0, v4}, Landroidx/compose/animation/core/TransitionKt;->updateTransition(Ljava/lang/Object;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)Landroidx/compose/animation/core/Transition;
    ...
    const-string v12, "CC(animateFloat)P(2)939@37552L78:Transition.kt#pdpnli"
    ...
    .local v13, "it":Landroidx/compose/ui/state/ToggleableState;
    ...
    const-string v1, "C:Checkbox.kt#jmzs0o"
    ...
    const v12, -0x6b309374

    invoke-static {v12, v3, v15, v10}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V
    ...
    .end local v13    # "it":Landroidx/compose/ui/state/ToggleableState;
    ...
    const v15, -0x6b309374

    .restart local v18    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkDrawFraction$3":I
    ...
    invoke-static {v15, v10, v6, v8}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V
    ...
    invoke-interface {v14, v10, v5, v15}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    shl-int/lit8 v16, v25, 0x9

    and-int v16, v16, v24

    or-int v15, v15, v16

    shl-int/lit8 v16, v25, 0x6
    ...
    .line 282
    .local v10, "checkDrawFraction$delegate":Landroidx/compose/runtime/State;
    ...
    .restart local v4    # "it":Landroidx/compose/ui/state/ToggleableState;
    move-object v13, v5
    ...
    .local v17, "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    invoke-static {v6, v12, v14, v0}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    goto :goto_9

    .line 521
    .end local v17    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    .end local p4    # "transition":Landroidx/compose/animation/core/Transition;
    .restart local v0    # "transition":Landroidx/compose/animation/core/Transition;
    .restart local v14    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    :cond_f
    move-object/from16 p4, v0
    ...
    .end local v0    # "transition":Landroidx/compose/animation/core/Transition;
    .end local v14    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    .restart local v17    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    .restart local p4    # "transition":Landroidx/compose/animation/core/Transition;
    :goto_9
    ...
    .line 291
    const-string v1, "androidx.compose.material.CheckboxImpl.<anonymous> (Checkbox.kt:289)"
    ...
    .end local v14    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    .restart local v17    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    invoke-static {v6, v4, v14, v1}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V
    ...
    .restart local v17    # "$i$a$-animateFloat-CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$3":I
    :goto_b
    sget-object v1, Landroidx/compose/material/CheckboxKt$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    invoke-interface {v15, v0, v5, v1}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 297
    .local v0, "checkCenterGravitationShiftFraction$delegate":Landroidx/compose/runtime/State;
    const/4 v1, 0x0
    ...
    .line 297
    .local v14, "$i$a$-remember-CheckboxKt$CheckboxImpl$checkCache$1":I
    new-instance v21, Landroidx/compose/material/CheckDrawingCache;
    ...
    invoke-direct/range {v15 .. v20}, Landroidx/compose/material/CheckDrawingCache;-><init>(Landroidx/compose/ui/graphics/Path;Landroidx/compose/ui/graphics/PathMeasure;Landroidx/compose/ui/graphics/Path;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 529
    .end local v14    # "$i$a$-remember-CheckboxKt$CheckboxImpl$checkCache$1":I
    ...
    check-cast v3, Landroidx/compose/material/CheckDrawingCache;

    .line 298
    .local v3, "checkCache":Landroidx/compose/material/CheckDrawingCache;
    ...
    invoke-interface {v9, v7, v5, v4}, Landroidx/compose/material/CheckboxColors;->checkmarkColor(Landroidx/compose/ui/state/ToggleableState;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v4

    .line 299
    .local v4, "checkColor$delegate":Landroidx/compose/runtime/State;
    ...
    invoke-interface {v9, v14, v7, v5, v6}, Landroidx/compose/material/CheckboxColors;->boxColor(ZLandroidx/compose/ui/state/ToggleableState;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v6

    .line 300
    .local v6, "boxColor$delegate":Landroidx/compose/runtime/State;
    ...
    invoke-interface {v9, v14, v7, v5, v8}, Landroidx/compose/material/CheckboxColors;->borderColor(ZLandroidx/compose/ui/state/ToggleableState;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    invoke-static {v15, v11, v1, v13, v12}, Landroidx/compose/foundation/layout/SizeKt;->wrapContentSize$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/Alignment;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    .line 301
    .local v7, "$i$a$-remember-CheckboxKt$CheckboxImpl$1":I
    new-instance v21, Landroidx/compose/material/CheckboxKt$CheckboxImpl$1$1;
    ...
    .line 538
    .end local v7    # "$i$a$-remember-CheckboxKt$CheckboxImpl$1":I
    ...
    invoke-static {v11, v7, v5, v1}, Landroidx/compose/foundation/CanvasKt;->Canvas(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V
    ...
    .line 317
    .end local v0    # "checkCenterGravitationShiftFraction$delegate":Landroidx/compose/runtime/State;
    .end local v3    # "checkCache":Landroidx/compose/material/CheckDrawingCache;
    .end local v4    # "checkColor$delegate":Landroidx/compose/runtime/State;
    .end local v6    # "boxColor$delegate":Landroidx/compose/runtime/State;
    .end local v8    # "borderColor$delegate":Landroidx/compose/runtime/State;
    .end local v10    # "checkDrawFraction$delegate":Landroidx/compose/runtime/State;
    .end local p4    # "transition":Landroidx/compose/animation/core/Transition;
    :cond_17
    :goto_11
...
.method private static final drawBox-1wkBAMs(Landroidx/compose/ui/graphics/drawscope/DrawScope;JJFF)V
    ...
    invoke-static/range {v11 .. v25}, Landroidx/compose/ui/graphics/drawscope/DrawScope$-CC;->drawRoundRect-u-Aw5IA$default(Landroidx/compose/ui/graphics/drawscope/DrawScope;JJJJLandroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;IILjava/lang/Object;)V
    ...
    invoke-static/range {v26 .. v40}, Landroidx/compose/ui/graphics/drawscope/DrawScope$-CC;->drawRoundRect-u-Aw5IA$default(Landroidx/compose/ui/graphics/drawscope/DrawScope;JJJJLandroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;IILjava/lang/Object;)V
