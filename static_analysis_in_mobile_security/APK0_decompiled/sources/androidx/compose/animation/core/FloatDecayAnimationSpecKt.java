...
public final class FloatDecayAnimationSpecKt {
    ...
    public static final Animation<Float, AnimationVector1D> createAnimation(FloatDecayAnimationSpec $this$createAnimation, float startValue, float startVelocity) {
        Intrinsics.checkNotNullParameter($this$createAnimation, "<this>");
        return AnimationKt.DecayAnimation($this$createAnimation, startValue, startVelocity);
    }
}
