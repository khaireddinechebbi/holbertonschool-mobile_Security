...
final class OnBackInstance {
    ...
    public OnBackInstance(CoroutineScope scope, boolean isPredictiveBack, Function2<? super Flow<BackEventCompat>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Job launch$default;
        this.isPredictiveBack = isPredictiveBack;
        launch$default = BuildersKt__Builders_commonKt.launch$default(scope, null, null, new OnBackInstance$job$1(function2, this, null), 3, null);
    ...
    public final Object m6sendJP2dKIU(BackEventCompat backEvent) {
        return this.channel.mo7066trySendJP2dKIU(backEvent);
    }
