...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    private static final Function1<Placeable.PlacementScope, Unit> placementBlock = new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.EmptyMeasurePolicy$placementBlock$1
        ...
        public final void invoke2(Placeable.PlacementScope $this$null) {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        return MeasureScope.CC.layout$default(measure, Constraints.m5218getMaxWidthimpl(constraints), Constraints.m5217getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}
