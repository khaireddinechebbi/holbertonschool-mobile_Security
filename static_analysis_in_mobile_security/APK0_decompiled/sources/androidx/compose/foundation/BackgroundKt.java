...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m160backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m159backgroundbw27NRU(modifier, j, shape);
    }

    /* renamed from: background-bw27NRU, reason: not valid java name */
    public static final Modifier m159backgroundbw27NRU(Modifier background, final long color, final Shape shape) {
        Intrinsics.checkNotNullParameter(background, "$this$background");
        Intrinsics.checkNotNullParameter(shape, "shape");
        float alpha = 1.0f;
        return background.then(new BackgroundElement(color, null, alpha, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Color.m2961boximpl(color));
                $this$null.getProperties().set("color", Color.m2961boximpl(color));
