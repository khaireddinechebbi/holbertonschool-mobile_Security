            ...
            case 0:
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                    ...
                    public float scrollBy(float pixels) {
                        ...
                        return scrollingLogic5.m346toFloatk4lQ0M(outerScopeScroll.invoke(Offset.m2720boximpl(scrollingLogic5.m347toOffsettuRUvjQ(pixels))).getPackedValue());
                    }
                };
                ...
                float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m345toFloatTH1AsA0(j2));
