            ...
            case 0:
                ...
                Function1<AnimationScope<Float, AnimationVector1D>, Unit> function1 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animateZoomBy$3.1
                    ...
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animateTo2) {
                        ...
                        float scaleFactor = (Ref.FloatRef.this.element > 0.0f ? 1 : (Ref.FloatRef.this.element == 0.0f ? 0 : -1)) == 0 ? 1.0f : animateTo2.getValue().floatValue() / Ref.FloatRef.this.element;
                        TransformScope.CC.m355transformByd4ec7I$default($this$transform, scaleFactor, 0L, 0.0f, 6, null);
