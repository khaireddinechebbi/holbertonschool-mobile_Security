...
public final /* data */ class Selection {
    ...
    public Selection(AnchorInfo start, AnchorInfo end, boolean handlesCrossed) {
        Intrinsics.checkNotNullParameter(start, "start");
        Intrinsics.checkNotNullParameter(end, "end");
        this.start = start;
        this.end = end;
    ...
    public static final /* data */ class AnchorInfo {
        ...
        public int hashCode() {
            return (((this.direction.hashCode() * 31) + this.offset) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.selectableId);
        }
    ...
    public final long m899toTextRanged9O1mEE() {
