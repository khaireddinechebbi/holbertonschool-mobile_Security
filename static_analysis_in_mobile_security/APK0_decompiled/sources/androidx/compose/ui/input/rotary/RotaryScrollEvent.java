...
public final class RotaryScrollEvent {
    ...
    public int hashCode() {
        int it = Float.floatToIntBits(this.verticalScrollPixels);
        return (((it * 31) + Float.floatToIntBits(this.horizontalScrollPixels)) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.uptimeMillis);
    }
