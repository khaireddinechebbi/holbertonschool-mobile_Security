...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m3202constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m3211resetimpl(matrix);
        }
        Matrix.m3222translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3214rotateZimpl(matrix, this.rotation);
        Matrix.m3215scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3222translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            float[] it = (fArr != null ? Matrix.m3200boximpl(fArr) : null).m3223unboximpl();
            $this$draw_u24lambda_u245.mo3456transform58bKbWc(it);
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.CC.m3575clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, null);
        }
        List $this$fastForEach$iv = this.children;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
