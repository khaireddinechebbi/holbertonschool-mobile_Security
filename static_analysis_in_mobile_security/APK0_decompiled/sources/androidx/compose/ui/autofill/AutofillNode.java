...
public final class AutofillNode {
    ...
    public AutofillNode(List<? extends AutofillType> autofillTypes, Rect boundingBox, Function1<? super String, Unit> function1) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AutofillNode) && Intrinsics.areEqual(this.autofillTypes, ((AutofillNode) other).autofillTypes) && Intrinsics.areEqual(this.boundingBox, ((AutofillNode) other).boundingBox) && Intrinsics.areEqual(this.onFill, ((AutofillNode) other).onFill);
    }
