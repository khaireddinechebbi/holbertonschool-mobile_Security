...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m96boximpl(long j) {
        return new Motion(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m97constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m100equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m106unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m100equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m104hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m105toStringimpl(this.packedValue);
    }
    ...
    public static final float m102getValueimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m103getVelocityimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: copy-XB9eQnU, reason: not valid java name */
    public static final long m98copyXB9eQnU(long arg0, float value, float velocity) {
        return SpringSimulationKt.Motion(value, velocity);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m99copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m102getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m103getVelocityimpl(j);
        }
        return m98copyXB9eQnU(j, f, f2);
    }
}
