...
public final class SuspendPointerInputElement extends ModifierNodeElement<SuspendingPointerInputModifierNodeImpl> {
    ...
    public SuspendPointerInputElement(Object key1, Object key2, Object[] keys, Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> pointerInputHandler) {
    ...
    public boolean equals(Object other) {
        ...
        if (objArr != null) {
            if (((SuspendPointerInputElement) other).keys == null || !Arrays.equals(objArr, ((SuspendPointerInputElement) other).keys)) {
                return false;
            }
    ...
    public int hashCode() {
        ...
        Object[] objArr = this.keys;
        return result3 + (objArr != null ? Arrays.hashCode(objArr) : 0);
    }
}
