...
.method public final copy(Ljava/util/List;Landroid/view/MotionEvent;)Landroidx/compose/ui/input/pointer/PointerEvent;
    ...
    iget-object v4, v0, Landroidx/compose/ui/input/pointer/PointerEvent;->internalPointerEvent:Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    ...
    .line 95
    .local v3, "map":Ljava/util/LinkedHashMap;
    ...
    .line 96
    .local v4, "pointerEventData":Ljava/util/ArrayList;
    ...
    .line 97
    .local v11, "$i$a$-fastForEach-PointerEvent$copy$1":I
    move-object v12, v3
    ...
    .line 104
    invoke-virtual {v10}, Landroidx/compose/ui/input/pointer/PointerInputChange;->getPressure()F
    ...
    .line 106
    iget-object v13, v0, Landroidx/compose/ui/input/pointer/PointerEvent;->internalPointerEvent:Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    ...
    invoke-virtual {v13, v5, v6}, Landroidx/compose/ui/input/pointer/InternalPointerEvent;->issuesEnterExitEvent-0FcD4WY(J)Z
    ...
    invoke-direct/range {v13 .. v30}, Landroidx/compose/ui/input/pointer/PointerInputEventData;-><init>(JJJJZFIZLjava/util/List;JILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .end local v11    # "$i$a$-fastForEach-PointerEvent$copy$1":I
    nop
    ...
    invoke-direct {v5, v6, v7, v8, v2}, Landroidx/compose/ui/input/pointer/PointerInputEvent;-><init>(JLjava/util/List;Landroid/view/MotionEvent;)V
    ...
    new-instance v6, Landroidx/compose/ui/input/pointer/InternalPointerEvent;

    move-object v7, v3

    check-cast v7, Ljava/util/Map;

    invoke-direct {v6, v7, v5}, Landroidx/compose/ui/input/pointer/InternalPointerEvent;-><init>(Ljava/util/Map;Landroidx/compose/ui/input/pointer/PointerInputEvent;)V

    .line 113
    .local v6, "event":Landroidx/compose/ui/input/pointer/InternalPointerEvent;
    new-instance v7, Landroidx/compose/ui/input/pointer/PointerEvent;

    invoke-direct {v7, v1, v6}, Landroidx/compose/ui/input/pointer/PointerEvent;-><init>(Ljava/util/List;Landroidx/compose/ui/input/pointer/InternalPointerEvent;)V

    move-object v3, v7

    .line 115
    .end local v3    # "map":Ljava/util/LinkedHashMap;
