...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m2917BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m3025toArgb8_81llA(color), AndroidBlendMode_androidKt.m2823toAndroidBlendModes9anfk8(blendMode));
    }
}
