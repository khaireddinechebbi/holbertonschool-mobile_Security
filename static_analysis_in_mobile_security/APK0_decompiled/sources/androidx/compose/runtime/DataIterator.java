...
final class DataIterator implements Iterable<Object>, Iterator<Object>, KMappedMarker {
    ...
    public DataIterator(SlotTable table, int group) {
        ...
        this.table = table;
        this.group = group;
        dataAnchor = SlotTableKt.dataAnchor(table.getGroups(), group);
        this.start = dataAnchor;
        this.end = group + 1 < table.getGroupsSize() ? SlotTableKt.dataAnchor(table.getGroups(), group + 1) : table.getSlotsSize();
