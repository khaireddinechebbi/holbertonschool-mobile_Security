    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                IntSize m5426boximpl = IntSize.m5426boximpl(sizeAnimationModifier$animateTo$data$1$1.$targetSize);
                ...
                animateTo = anim.animateTo(m5426boximpl, (r12 & 2) != 0 ? anim.defaultSpringSpec : animSpec, (r12 & 4) != 0 ? anim.getVelocity() : null, (r12 & 8) != 0 ? null : null, sizeAnimationModifier$animateTo$data$1$1);
        ...
        if (result.getEndReason() == AnimationEndReason.Finished && (listener = sizeAnimationModifier$animateTo$data$1$1.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m5426boximpl(sizeAnimationModifier$animateTo$data$1$1.$this_apply.m73getStartSizeYbymL2g()), result.getEndState().getValue());
        }
