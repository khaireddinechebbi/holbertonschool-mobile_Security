...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5563constructorimpl = Result.m5563constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5569isFailureimpl(m5563constructorimpl)) {
                m5563constructorimpl = null;
            }
            return (E) m5563constructorimpl;
        }
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        while (true) {
            ...
            switch (p.length) {
                ...
                case 2:
                    if (!Intrinsics.areEqual(p[c], String.class) || !Intrinsics.areEqual(p[1], Throwable.class)) {
                        pair = TuplesKt.to(null, -1);
                        break;
                    } else {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    m5563constructorimpl = Result.m5563constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m5569isFailureimpl(m5563constructorimpl) ? null : m5563constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5563constructorimpl = Result.m5563constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5569isFailureimpl(m5563constructorimpl)) {
            m5563constructorimpl = valueOf;
        }
        return ((Number) m5563constructorimpl).intValue();
    }
