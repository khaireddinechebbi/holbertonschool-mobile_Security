...
public final class NotificationsKt {
    ...
    public static final ImageVector getNotifications(Icons.TwoTone $this$Notifications) {
        ...
        ImageVector.Builder $this$_get_Notifications__u24lambda_u242 = new ImageVector.Builder("TwoTone.Notifications", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(-2.49f, 0.0f, -4.0f, 2.02f, -4.0f, 4.5f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -2.48f, -1.51f, -4.5f, -4.0f, -4.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_Notifications__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, -3.07f, -1.63f, -5.64f, -4.5f, -6.32f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(13.5f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(0.68f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveTo(7.64f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(5.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineToRelative(-2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        $this$PathData_u24lambda_u240$iv$iv$iv2.moveTo(16.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.lineTo(8.0f, 17.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(-6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.curveToRelative(0.0f, -2.48f, 1.51f, -4.5f, 4.0f, -4.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveToRelative(4.0f, 2.02f, 4.0f, 4.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.verticalLineToRelative(6.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        ImageVector build = ImageVector.Builder.m3606addPathoIyEayM$default($this$_get_Notifications__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
