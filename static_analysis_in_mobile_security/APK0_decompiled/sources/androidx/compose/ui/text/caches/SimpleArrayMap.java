...
public final class SimpleArrayMap<K, V> {
    ...
    public final V put(K key, V value) {
        ...
        if (i3 < i) {
            ...
            ArraysKt.copyInto(iArr2, iArr2, i3 + 1, i3, i);
            Object[] objArr2 = this.keyValues;
            ArraysKt.copyInto(objArr2, objArr2, (i3 + 1) << 1, i3 << 1, this._size << 1);
        }
        int i5 = this._size;
        if (i == i5) {
    ...
    public final V removeAt(int index) {
        ...
        if (i <= 1) {
            ...
            if (iArr.length > 8 && i < iArr.length / 3) {
                ...
                if (index > 0) {
                    ArraysKt.copyInto(iArr2, iArr3, 0, 0, index);
                    ArraysKt.copyInto(objArr, this.keyValues, 0, 0, index << 1);
                }
                if (index < i2) {
                    ArraysKt.copyInto(iArr2, this.hashes, index, index + 1, i2 + 1);
                    ArraysKt.copyInto(objArr, this.keyValues, index << 1, (index + 1) << 1, (i2 + 1) << 1);
                }
            } else {
                if (index < i2) {
                    ArraysKt.copyInto(iArr, iArr, index, index + 1, i2 + 1);
                    Object[] objArr2 = this.keyValues;
                    ArraysKt.copyInto(objArr2, objArr2, index << 1, (index + 1) << 1, (i2 + 1) << 1);
                }
                Object[] objArr3 = this.keyValues;
                objArr3[i2 << 1] = null;
                objArr3[(i2 << 1) + 1] = null;
