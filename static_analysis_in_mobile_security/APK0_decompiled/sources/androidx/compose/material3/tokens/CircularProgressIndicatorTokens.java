...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5274constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5274constructorimpl((float) 48.0d);
    ...
    public final float m2048getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2049getSizeD9Ej5fM() {
        return Size;
    }
}
