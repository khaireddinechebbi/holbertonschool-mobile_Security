...
public final class LongSaturatedMathKt {
    ...
    public static final long m7017saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long durationInUnit = Duration.m6934toLongimpl(duration, unit);
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m7016checkInfiniteSumDefinedPjuGub4(value, duration, durationInUnit);
        }
        if ((1 | (durationInUnit - 1)) == Long.MAX_VALUE) {
            return m7018saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m7016checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
        if (!Duration.m6920isInfiniteimpl(duration) || (value ^ durationInUnit) >= 0) {
            return value;
        }
    ...
    private static final long m7018saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m6891divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m6934toLongimpl(half, unit);
        if (!((1 | (halfInUnit - 1)) == Long.MAX_VALUE)) {
            return m7017saturatingAddNuflL3o(m7017saturatingAddNuflL3o(value, unit, half), unit, Duration.m6923minusLRDsOJo(duration, half));
        }
        return halfInUnit;
    }
    ...
    private static final long infinityOfSign(long value) {
        ...
        return value < 0 ? companion.m6990getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m6989getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m6941unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ($i$f$isSaturated != 0) {
            return origin1 == origin2 ? Duration.INSTANCE.m6991getZEROUwyO8pc() : Duration.m6941unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (((result ^ value1) & (~(result ^ value2))) < 0) {
            if (unit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m6924plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, unit));
            }
            return Duration.m6941unaryMinusUwyO8pc(infinityOfSign(result));
        }
