    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo818onStartk4lQ0M(long startPoint) {
                ...
                if (!((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m851isPositionOnTextk4lQ0M(startPoint)) ? false : true) && (state = TextFieldSelectionManager.this.getState()) != null && (layoutResult2 = state.getLayoutResult()) != null) {
                    ...
                    newValue = textFieldSelectionManager.m955createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getText(), TextRangeKt.TextRange(offset, offset));
                ...
                textFieldSelectionManager3.m957setCurrentDragPosition_kEHs6E(Offset.m2720boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2747getZeroF1C5BW0();
            }
            ...
            public void mo817onDragk4lQ0M(long delta) {
                ...
                Integer num;
                long j4;
                int m850getOffsetForPosition3MmeM6k;
                if (TextFieldSelectionManager.this.getValue$foundation_release().getText().length() == 0) {
                    return;
                }
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2736plusMKHz9U(j, delta);
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m957setCurrentDragPosition_kEHs6E(Offset.m2720boximpl(Offset.m2736plusMKHz9U(j2, j3)));
                    num = textFieldSelectionManager2.dragBeginOffsetInText;
                    if (num != null) {
                        m850getOffsetForPosition3MmeM6k = num.intValue();
                    } else {
                        j4 = textFieldSelectionManager2.dragBeginPosition;
                        m850getOffsetForPosition3MmeM6k = layoutResult.m850getOffsetForPosition3MmeM6k(j4, false);
                    }
                    int startOffset = m850getOffsetForPosition3MmeM6k;
                    Offset m960getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m960getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m960getCurrentDragPosition_m7T9E);
                    int endOffset = layoutResult.m850getOffsetForPosition3MmeM6k(m960getCurrentDragPosition_m7T9E.getPackedValue(), false);
            ...
            public void onStop() {
                ...
                TextFieldSelectionManager.this.m957setCurrentDragPosition_kEHs6E(null);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null) {
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo880onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    int clickOffset = TextLayoutResultProxy.m848getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo818onStartk4lQ0M(long startPoint) {
                ...
                textFieldSelectionManager2.m957setCurrentDragPosition_kEHs6E(Offset.m2720boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2747getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null) {
            ...
            public void mo817onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset m960getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m960getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m960getCurrentDragPosition_m7T9E);
                        startOffset = layoutResult2.m4740getOffsetForPositionk4lQ0M(m960getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                    ...
                    if (z) {
                        ...
                        Offset m960getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m960getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m960getCurrentDragPosition_m7T9E2);
                        endOffset = layoutResult2.m4740getOffsetForPositionk4lQ0M(m960getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo817onDragk4lQ0M(long delta) {
                ...
                long j2;
                long j3;
                TextFieldValue m955createTextFieldValueFDrldGo;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2736plusMKHz9U(j, delta);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    Offset m960getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m960getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m960getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping.transformedToOriginal(layoutResult2.m4740getOffsetForPositionk4lQ0M(m960getCurrentDragPosition_m7T9E.getPackedValue()));
                    ...
                    m955createTextFieldValueFDrldGo = textFieldSelectionManager2.m955createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getText(), newSelection);
                    onValueChange$foundation_release.invoke(m955createTextFieldValueFDrldGo);
                }
            }
    ...
    */
    public final void showSelectionToolbar$foundation_release() {
        /*
            ...
            boolean r1 = androidx.compose.ui.text.TextRange.m4762getCollapsedimpl(r1)
            r2 = 0
            if (r1 != 0) goto L1e
            if (r0 != 0) goto L1e
        ...
        L1f:
            ...
            boolean r1 = androidx.compose.ui.text.TextRange.m4762getCollapsedimpl(r3)
            if (r1 != 0) goto L3f
        ...
        L60:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.getSelection()
            int r1 = androidx.compose.ui.text.TextRange.m4764getLengthimpl(r3)
