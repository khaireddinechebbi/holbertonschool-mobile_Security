...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2915getSrcOver0nO6VwU();
    }
    ...
    public long mo2846getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2852setColor8_81llA(long color) {
        AndroidPaint_androidKt.m2858setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo2851setBlendModes9anfk8(int value) {
        if (!BlendMode.m2884equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m2857setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2850getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2856setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m2862setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo2848getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2854setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m2860setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2849getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2855setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m2861setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public void mo2853setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m2859setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
