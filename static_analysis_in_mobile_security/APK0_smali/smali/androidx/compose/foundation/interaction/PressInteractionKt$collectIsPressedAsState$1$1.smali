...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;
    ...
    .line 87
    .local v1, "this":Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;
    ...
    .line 88
    .local v2, "pressInteractions":Ljava/util/List;
    iget-object v3, v1, Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;->$this_collectIsPressedAsState:Landroidx/compose/foundation/interaction/InteractionSource;
    ...
    new-instance v4, Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1$1;

    iget-object v5, v1, Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;->$isPressed:Landroidx/compose/runtime/MutableState;

    invoke-direct {v4, v2, v5}, Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1$1;-><init>(Ljava/util/List;Landroidx/compose/runtime/MutableState;)V
    ...
    iput v6, v1, Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;->label:I

    invoke-interface {v3, v4, v5}, Lkotlinx/coroutines/flow/Flow;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2

    .end local v2    # "pressInteractions":Ljava/util/List;
    if-ne v2, v0, :cond_0
    ...
    .line 96
    .end local v1    # "this":Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;
    .restart local v0    # "this":Landroidx/compose/foundation/interaction/PressInteractionKt$collectIsPressedAsState$1$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
