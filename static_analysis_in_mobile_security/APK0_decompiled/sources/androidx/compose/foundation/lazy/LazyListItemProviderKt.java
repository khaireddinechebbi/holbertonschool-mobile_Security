...
public final class LazyListItemProviderKt {
    public static final Function0<LazyListItemProvider> rememberLazyListItemProviderLambda(final LazyListState state, Function1<? super LazyListScope, Unit> content, Composer $composer, int $changed) {
        Object value$iv$iv;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-343736148, $changed, -1, "androidx.compose.foundation.lazy.rememberLazyListItemProviderLambda (LazyListItemProvider.kt:40)");
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new PropertyReference0Impl(itemProviderState) { // from class: androidx.compose.foundation.lazy.LazyListItemProviderKt$rememberLazyListItemProviderLambda$1$1
