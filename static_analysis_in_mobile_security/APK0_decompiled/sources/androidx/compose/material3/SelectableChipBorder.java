...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m187BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipBorder) && Color.m2972equalsimpl0(this.borderColor, ((SelectableChipBorder) other).borderColor) && Color.m2972equalsimpl0(this.selectedBorderColor, ((SelectableChipBorder) other).selectedBorderColor) && Color.m2972equalsimpl0(this.disabledBorderColor, ((SelectableChipBorder) other).disabledBorderColor) && Color.m2972equalsimpl0(this.disabledSelectedBorderColor, ((SelectableChipBorder) other).disabledSelectedBorderColor) && Dp.m5279equalsimpl0(this.borderWidth, ((SelectableChipBorder) other).borderWidth) && Dp.m5279equalsimpl0(this.selectedBorderWidth, ((SelectableChipBorder) other).selectedBorderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.borderColor);
        return (((((((((result * 31) + Color.m2978hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2978hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2978hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5280hashCodeimpl(this.borderWidth)) * 31) + Dp.m5280hashCodeimpl(this.selectedBorderWidth);
    }
}
