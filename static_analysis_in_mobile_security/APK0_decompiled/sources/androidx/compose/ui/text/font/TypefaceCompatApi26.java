...
final class TypefaceCompatApi26 {
    ...
    private final String toAndroidString(FontVariation.Settings $this$toAndroidString, Context context) {
        ...
        return TempListUtilsKt.fastJoinToString$default($this$toAndroidString.getSettings(), null, null, null, 0, null, new Function1<FontVariation.Setting, CharSequence>() { // from class: androidx.compose.ui.text.font.TypefaceCompatApi26$toAndroidString$1
            {
                super(1);
            }
