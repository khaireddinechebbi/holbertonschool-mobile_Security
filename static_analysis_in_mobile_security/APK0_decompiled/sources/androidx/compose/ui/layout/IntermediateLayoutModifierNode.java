...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (closestLookaheadRoot != null && closestLookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int m4443constructorimpl = NodeKind.m4443constructorimpl(512);
            ...
            while (layout$iv$iv != null) {
                ...
                if ((head$iv$iv.getAggregateChildKindSet() & m4443constructorimpl) != 0) {
                    while (node$iv$iv != null) {
                        if ((node$iv$iv.getKindSet() & m4443constructorimpl) != 0) {
                            ...
                            while (node != null) {
                                if (node instanceof IntermediateLayoutModifierNode) {
                                    ...
                                    if (((this_$iv$iv$iv.getKindSet() & m4443constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                        int count$iv$iv = 0;
                                        DelegatingNode this_$iv$iv$iv2 = (DelegatingNode) node;
                                        Modifier.Node node$iv$iv$iv = this_$iv$iv$iv2.getDelegate();
                                        while (node$iv$iv$iv != null) {
                                            Modifier.Node next$iv$iv = node$iv$iv$iv;
                                            if ((next$iv$iv.getKindSet() & m4443constructorimpl) != 0) {
                                                count$iv$iv++;
                                                if (count$iv$iv == i) {
                                                    node = next$iv$iv;
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final Placeable $this$measure_3p2s80s_u24lambda_u241 = measurable.mo4225measureBRTryo0(constraints);
        return MeasureScope.CC.layout$default(measure, $this$measure_3p2s80s_u24lambda_u241.getWidth(), $this$measure_3p2s80s_u24lambda_u241.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final MeasureResult m4227intermediateMeasureTeuZzU(MeasureScope intermediateMeasure, Measurable measurable, long constraints, long lookaheadSize, long lookaheadConstraints) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m4230setLookaheadSizeozmzZPI(lookaheadSize);
        this.lookaheadConstraints = Constraints.m5206boximpl(lookaheadConstraints);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, wrappedMeasurable, Constraints.m5206boximpl(constraints));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4231measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long constraints) {
                Intrinsics.checkNotNullParameter(minWidth, "$this$minWidth");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m5206boximpl(constraints));
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4231measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long constraints) {
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4231measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long constraints) {
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo4231measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long constraints) {
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo4225measureBRTryo0(long constraints) {
            ...
            if (this.this$0.getIsIntermediateChangeActive()) {
                it = this.wrappedMeasurable.mo4225measureBRTryo0(constraints);
                m4283setMeasurementConstraintsBRTryo0(constraints);
                m4282setMeasuredSizeozmzZPI(IntSizeKt.IntSize(it.getWidth(), it.getHeight()));
            } else {
                ...
                it = measurable.mo4225measureBRTryo0(constraints2.getValue());
                ...
                m4283setMeasurementConstraintsBRTryo0(constraints3.getValue());
                ...
                m4282setMeasuredSizeozmzZPI(lookaheadSize);
            }
        ...
        public void mo4226placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            long offset = this.this$0.getIsIntermediateChangeActive() ? position : IntOffset.INSTANCE.m5402getZeronOccac();
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.INSTANCE.m4293placeWithLayeraW9wM(placeable, offset, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.INSTANCE.m4288place70tqf50(placeable2, offset, zIndex);
    ...
    final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        private long lookaheadSize = IntSize.INSTANCE.m5439getZeroYbymL2g();
        ...
        public /* synthetic */ long mo4229localLookaheadPositionOfdBAh8RU(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
            return LookaheadScope.CC.m4250$default$localLookaheadPositionOfdBAh8RU(this, layoutCoordinates, layoutCoordinates2);
        }
        ...
        public void m4230setLookaheadSizeozmzZPI(long j) {
