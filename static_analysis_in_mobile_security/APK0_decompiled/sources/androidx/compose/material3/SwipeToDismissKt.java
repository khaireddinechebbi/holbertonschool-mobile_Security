...
public final class SwipeToDismissKt {
    ...
    public static final DismissState rememberDismissState(DismissValue initialValue, Function1<? super DismissValue, Boolean> function1, Function2<? super Density, ? super Float, Float> function2, Composer $composer, int $changed, int i) {
        ...
        final Function1 confirmValueChange = (i & 2) != 0 ? new Function1<DismissValue, Boolean>() { // from class: androidx.compose.material3.SwipeToDismissKt$rememberDismissState$1
        ...
        final Function2 positionalThreshold = (i & 4) != 0 ? SwipeToDismissDefaults.INSTANCE.getFixedPositionalThreshold() : function2;
        ...
        Saver<DismissState, DismissValue> Saver = DismissState.Companion.Saver(confirmValueChange, positionalThreshold);
        int i2 = ($changed & 14) | ($changed & 112) | ($changed & 896);
        $composer.startReplaceableGroup(1618982084);
        ComposerKt.sourceInformation($composer, "CC(remember)P(1,2,3):Composables.kt#9igjgp");
        boolean invalid$iv$iv = $composer.changed(initialValue2) | $composer.changed(confirmValueChange) | $composer.changed(positionalThreshold);
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = (Function0) new Function0<DismissState>() { // from class: androidx.compose.material3.SwipeToDismissKt$rememberDismissState$2$1
                ...
                public final DismissState invoke() {
                    return new DismissState(DismissValue.this, confirmValueChange, positionalThreshold);
                }
            };
