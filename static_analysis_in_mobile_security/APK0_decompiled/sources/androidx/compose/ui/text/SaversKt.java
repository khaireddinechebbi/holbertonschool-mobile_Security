...
public final class SaversKt {
    ...
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Saver saver$iv6 = SaversKt.getSaver(TextGeometricTransform.INSTANCE);
            ...
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv = SaversKt.getSaver(LocaleList.INSTANCE);
            if (Intrinsics.areEqual(value$iv10, (Object) false)) {
                restore7 = null;
            } else {
                restore7 = value$iv10 != null ? $this$restore_u24lambda_u243_u24lambda_u242$iv.restore(value$iv10) : null;
            }
            Object value$iv11 = list.get(11);
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv2 = SaversKt.getSaver(Color.INSTANCE);
            if (Intrinsics.areEqual(value$iv11, (Object) false)) {
                restore8 = null;
            } else {
                restore8 = value$iv11 != null ? $this$restore_u24lambda_u243_u24lambda_u242$iv2.restore(value$iv11) : null;
            }
            Intrinsics.checkNotNull(restore8);
            long m2981unboximpl2 = restore8.m2981unboximpl();
            Object value$iv12 = list.get(12);
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv3 = SaversKt.getSaver(TextDecoration.INSTANCE);
            if (Intrinsics.areEqual(value$iv12, (Object) false)) {
                restore9 = null;
            } else {
                restore9 = value$iv12 != null ? $this$restore_u24lambda_u243_u24lambda_u242$iv3.restore(value$iv12) : null;
            }
            Object value$iv13 = list.get(13);
            Saver saver$iv7 = SaversKt.getSaver(Shadow.INSTANCE);
            if (Intrinsics.areEqual(value$iv13, (Object) false)) {
                restore10 = null;
            } else {
                restore10 = value$iv13 != null ? saver$iv7.restore(value$iv13) : null;
            }
            return new SpanStyle(m2981unboximpl, packedValue, restore3, fontStyle, fontSynthesis, (FontFamily) null, str, packedValue2, restore5, restore6, restore7, m2981unboximpl2, restore9, restore10, (PlatformSpanStyle) null, (DrawStyle) null, 49184, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(it$iv2);
            return TextRange.m4756boximpl(TextRangeKt.TextRange(intValue, ((Number) it$iv2).intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Shadow invoke(Object it) {
            ...
            return new Shadow(m2981unboximpl, packedValue, f.floatValue(), null);
        }
    });
    ...
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m5445boximpl(TextUnitKt.m5467TextUnitanM5pPY(floatValue, textUnitType.getType()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public final Offset invoke(Object it) {
            ...
            Intrinsics.checkNotNull(it$iv2);
            return Offset.m2720boximpl(OffsetKt.Offset(floatValue, ((Number) it$iv2).floatValue()));
        }
    });
