    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (Animatable$default.animateTo(boxFloat, tweenSpec, Boxing.boxFloat(this.$velocity), new Function1<Animatable<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.material.SliderKt$animateToTarget$2.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Animatable<Float, AnimationVector1D> animateTo) {
                        ...
                        DragScope.this.dragBy(animateTo.getValue().floatValue() - latestValue.element);
