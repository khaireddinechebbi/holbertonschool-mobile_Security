...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m5168getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m5169getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m5158copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m5159copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m5159copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m5164equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m5165hashCodeimpl(this.linearity);
        return (result * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m5162constructorimpl(1);
        private static final int FontHinting = m5162constructorimpl(2);
        private static final int None = m5162constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m5161boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m5162constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5163equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5164equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5165hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object obj) {
            return m5163equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m5165hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m5169getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m5168getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m5170getNone4e0Vf04() {
        ...
        public static String m5166toStringimpl(int arg0) {
            return m5164equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m5164equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m5164equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }
