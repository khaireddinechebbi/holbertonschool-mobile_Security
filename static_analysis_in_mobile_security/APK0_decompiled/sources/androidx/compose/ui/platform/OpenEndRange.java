...
public interface OpenEndRange<T extends Comparable<? super T>> {
    ...
    public final /* synthetic */ class CC {
        public static boolean $default$contains(OpenEndRange _this, Comparable value) {
            Intrinsics.checkNotNullParameter(value, "value");
            return value.compareTo(_this.getStart()) >= 0 && value.compareTo(_this.getEndExclusive()) < 0;
        }
