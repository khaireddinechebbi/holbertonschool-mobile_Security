...
public final class LazyGridDslKt$itemsIndexed$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public final long m613invoke_orMbw(LazyGridItemSpanScope $this$null, int it) {
        Intrinsics.checkNotNullParameter($this$null, "$this$null");
        return this.$span.invoke($this$null, Integer.valueOf(it), this.$items.get(it)).getPackedValue();
    }
}
