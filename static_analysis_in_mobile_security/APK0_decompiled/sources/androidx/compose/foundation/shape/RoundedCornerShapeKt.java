...
public final class RoundedCornerShapeKt {
    ...
    public static final RoundedCornerShape m748RoundedCornerShape0680j_4(float size) {
        return RoundedCornerShape(CornerSizeKt.m740CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ RoundedCornerShape m750RoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m749RoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: RoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final RoundedCornerShape m749RoundedCornerShapea9UjIt4(float topStart, float topEnd, float bottomEnd, float bottomStart) {
        return new RoundedCornerShape(CornerSizeKt.m740CornerSize0680j_4(topStart), CornerSizeKt.m740CornerSize0680j_4(topEnd), CornerSizeKt.m740CornerSize0680j_4(bottomEnd), CornerSizeKt.m740CornerSize0680j_4(bottomStart));
    }
