...
public final class SnackbarTokens {
    ...
    private static final ColorSchemeKeyTokens ActionFocusLabelTextColor = ColorSchemeKeyTokens.InversePrimary;
    private static final ColorSchemeKeyTokens ActionHoverLabelTextColor = ColorSchemeKeyTokens.InversePrimary;
    private static final ColorSchemeKeyTokens ActionLabelTextColor = ColorSchemeKeyTokens.InversePrimary;
    ...
    private static final float SingleLineContainerHeight = Dp.m5274constructorimpl((float) 48.0d);
    private static final float TwoLinesContainerHeight = Dp.m5274constructorimpl((float) 68.0d);
    ...
    public final float m2455getContainerElevationD9Ej5fM() {
    ...
    public final float m2456getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2457getSingleLineContainerHeightD9Ej5fM() {
        return SingleLineContainerHeight;
    }

    /* renamed from: getTwoLinesContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2458getTwoLinesContainerHeightD9Ej5fM() {
