...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> color, State<RippleAlpha> rippleAlpha, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.INSTANCE.m2809getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        this.rippleSize = $this$drawIndication.mo3442getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1292getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo3442getSizeNHjbRc()));
        } else {
            i = $this$drawIndication.mo321roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        long color = this.color.getValue().m2981unboximpl();
        float alpha = this.rippleAlpha.getValue().getPressedAlpha();
        $this$drawIndication.drawContent();
        m1297drawStateLayerH2RKhps($this$drawIndication, this.radius, color);
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1296updateRipplePropertiesbiQXAtU($this$drawIndication.mo3442getSizeNHjbRc(), this.rippleRadius, color, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1295addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m2981unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
