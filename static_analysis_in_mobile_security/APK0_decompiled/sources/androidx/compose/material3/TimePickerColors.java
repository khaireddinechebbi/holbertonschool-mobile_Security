...
public final class TimePickerColors {
    ...
    public final long m1892periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1893periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1894timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1895timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1887clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2972equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m2972equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m2972equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m2972equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m2972equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m2972equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m2972equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m2972equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m2972equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m2972equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m2972equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m2972equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.clockDialColor);
        return (((((((((((((((((((((result * 31) + Color.m2978hashCodeimpl(this.selectorColor)) * 31) + Color.m2978hashCodeimpl(this.containerColor)) * 31) + Color.m2978hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2978hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2978hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2978hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2978hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2978hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2978hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2978hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2978hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
