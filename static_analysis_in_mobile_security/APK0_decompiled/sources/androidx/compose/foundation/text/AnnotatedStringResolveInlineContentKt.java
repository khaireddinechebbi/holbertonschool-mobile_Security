            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> children, long constrains) {
                    ...
                    for (int index$iv$iv = 0; index$iv$iv < size2; index$iv$iv++) {
                        ...
                        target$iv.add(it.mo4225measureBRTryo0(constrains));
                    }
                    final List placeables = target$iv;
                    return MeasureScope.CC.layout$default(Layout, Constraints.m5218getMaxWidthimpl(constrains), Constraints.m5217getMaxHeightimpl(constrains), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2$measure$1
