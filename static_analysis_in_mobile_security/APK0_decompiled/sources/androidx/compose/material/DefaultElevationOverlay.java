...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1082apply7g2Lkgo(long color, float elevation, Composer $composer, int $changed) {
        ...
        int $this$dp$iv = Dp.m5273compareTo0680j_4(elevation, Dp.m5274constructorimpl(0));
        if ($this$dp$iv > 0 && !colors.isLight()) {
            foregroundColor2 = ElevationOverlayKt.m1107calculateForegroundColorCLU3JFs(color, elevation, $composer, ($changed & 14) | ($changed & 112));
            foregroundColor = ColorKt.m3016compositeOverOWjLjI(foregroundColor2, color);
        } else {
