...
public final class Hyphens {
    ...
    private static final int None = m5047constructorimpl(1);
    private static final int Auto = m5047constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Hyphens m5046boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5047constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m5054getNonevmbZdU8() {
            return Hyphens.None;
        }

        /* renamed from: getAuto-vmbZdU8, reason: not valid java name */
        public final int m5053getAutovmbZdU8() {
            return Hyphens.Auto;
        }
    }
    ...
    public static String m5051toStringimpl(int arg0) {
        return m5049equalsimpl0(arg0, None) ? "Hyphens.None" : m5049equalsimpl0(arg0, Auto) ? "Hyphens.Auto" : "Invalid";
    }
