...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m1621colors69fazGs(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor, Composer $composer, int $changed, int i) {
        ...
        long selectedTextColor2 = (i & 2) != 0 ? ColorSchemeKt.toColor(NavigationBarTokens.INSTANCE.getActiveLabelTextColor(), $composer, 6) : selectedTextColor;
        long indicatorColor2 = (i & 4) != 0 ? ColorSchemeKt.toColor(NavigationBarTokens.INSTANCE.getActiveIndicatorColor(), $composer, 6) : indicatorColor;
        long unselectedIconColor2 = (i & 8) != 0 ? ColorSchemeKt.toColor(NavigationBarTokens.INSTANCE.getInactiveIconColor(), $composer, 6) : unselectedIconColor;
        long unselectedTextColor2 = (i & 16) != 0 ? ColorSchemeKt.toColor(NavigationBarTokens.INSTANCE.getInactiveLabelTextColor(), $composer, 6) : unselectedTextColor;
        if ((i & 32) != 0) {
            m2969copywmQWz5c2 = Color.m2969copywmQWz5c(r33, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r33) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r33) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r33) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(unselectedIconColor2) : 0.0f);
            disabledIconColor2 = m2969copywmQWz5c2;
        } else {
            disabledIconColor2 = disabledIconColor;
        }
        if ((i & 64) != 0) {
            m2969copywmQWz5c = Color.m2969copywmQWz5c(r33, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r33) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r33) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r33) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(unselectedTextColor2) : 0.0f);
            disabledTextColor2 = m2969copywmQWz5c;
        } else {
    ...
    public final /* synthetic */ NavigationBarItemColors m1622colorszjMxDiM(long selectedIconColor, long selectedTextColor, long indicatorColor, long unselectedIconColor, long unselectedTextColor, Composer $composer, int $changed, int i) {
        long m2969copywmQWz5c;
        long m2969copywmQWz5c2;
        ...
        m2969copywmQWz5c = Color.m2969copywmQWz5c(r29, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r29) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r29) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r29) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(unselectedIconColor2) : 0.0f);
        m2969copywmQWz5c2 = Color.m2969copywmQWz5c(r29, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r29) : 0.38f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r29) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r29) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(unselectedTextColor2) : 0.0f);
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(selectedIconColor2, selectedTextColor2, indicatorColor2, unselectedIconColor2, unselectedTextColor2, m2969copywmQWz5c, m2969copywmQWz5c2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
