...
public final class DisplayMode {
    ...
    private static final int Picker = m1499constructorimpl(0);
    private static final int Input = m1499constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1498boximpl(int i) {
    ...
    public static boolean m1500equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1501equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1502hashCodeimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m1506getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m1505getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1503toStringimpl(int arg0) {
        return m1501equalsimpl0(arg0, Picker) ? "Picker" : m1501equalsimpl0(arg0, Input) ? "Input" : "Unknown";
    }
