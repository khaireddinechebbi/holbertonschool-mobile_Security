...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior m704flingBehaviorPfoAEA0(PagerState state, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float snapVelocityThreshold, float snapPositionalThreshold, Composer $composer, int $changed, int i) {
        ...
        AnimationSpec lowVelocityAnimationSpec = (i & 4) != 0 ? AnimationSpecKt.tween$default(500, 0, EasingKt.getLinearEasing(), 2, null) : animationSpec;
        DecayAnimationSpec highVelocityAnimationSpec = (i & 8) != 0 ? SplineBasedFloatDecayAnimationSpec_androidKt.rememberSplineBasedDecay($composer, 0) : decayAnimationSpec;
        AnimationSpec snapAnimationSpec = (i & 16) != 0 ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : animationSpec2;
        float snapVelocityThreshold2 = (i & 32) != 0 ? SnapFlingBehaviorKt.getMinFlingVelocityDp() : snapVelocityThreshold;
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new SnapFlingBehavior(snapLayoutInfoProvider, lowVelocityAnimationSpec, highVelocityAnimationSpec, snapAnimationSpec, density, snapVelocityThreshold2, null);
