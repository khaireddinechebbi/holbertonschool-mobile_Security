...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5410getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5418getSizeYbymL2g() {
    ...
    public final IntRect m5422translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5392getXimpl(offset), this.top + IntOffset.m5393getYimpl(offset), this.right + IntOffset.m5392getXimpl(offset), this.bottom + IntOffset.m5393getYimpl(offset));
    }
