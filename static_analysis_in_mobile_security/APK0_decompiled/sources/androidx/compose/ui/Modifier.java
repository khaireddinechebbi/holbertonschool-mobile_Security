...
public interface Modifier {
    ...
    public final /* synthetic */ class CC {
        static {
            Companion companion = Modifier.INSTANCE;
        }

        public static Modifier $default$then(Modifier _this, Modifier other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return other == Modifier.INSTANCE ? _this : new CombinedModifier(_this, other);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static Modifier then(Modifier $this, Modifier other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return CC.$default$then($this, other);
        }
    }
    ...
    public interface Element extends Modifier {
        ...
        public final /* synthetic */ class CC {
            public static Object $default$foldIn(Element _this, Object initial, Function2 operation) {
                Intrinsics.checkNotNullParameter(operation, "operation");
                return operation.invoke(initial, _this);
            }

            public static Object $default$foldOut(Element _this, Object initial, Function2 operation) {
                Intrinsics.checkNotNullParameter(operation, "operation");
                return operation.invoke(_this, initial);
            }
    ...
    public static abstract class Node implements DelegatableNode {
        ...
        public final CoroutineScope getCoroutineScope() {
            ...
            if (coroutineScope == null) {
                CoroutineScope it = CoroutineScopeKt.CoroutineScope(DelegatableNodeKt.requireOwner(this).getCoroutineContext().plus(JobKt.Job((Job) DelegatableNodeKt.requireOwner(this).getCoroutineContext().get(Job.INSTANCE))));
                this.scope = it;
                return it;
            }
        ...
        public final boolean m2622isKindH91voCI$ui_release(int kind) {
