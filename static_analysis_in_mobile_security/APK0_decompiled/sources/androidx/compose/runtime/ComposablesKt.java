...
public final class ComposablesKt {
    ...
    public static final <T> T key(Object[] keys, Function2<? super Composer, ? super Integer, ? extends T> block, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(keys, "keys");
        ...
        T invoke = block.invoke($composer, Integer.valueOf(($changed >> 3) & 14));
        $composer.endReplaceableGroup();
        return invoke;
    }

    public static final void ReusableContent(Object key, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        content.invoke($composer, Integer.valueOf(($changed >> 3) & 14));
        $composer.endReusableGroup();
        $composer.endReplaceableGroup();
    }

    public static final void ReusableContentHost(boolean active, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(content, "content");
    ...
    public static final Composer getCurrentComposer(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-554250212, $changed, -1, "androidx.compose.runtime.<get-currentComposer> (Composables.kt:183)");
        }
    ...
    public static final RecomposeScope getCurrentRecomposeScope(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(394957799, $changed, -1, "androidx.compose.runtime.<get-currentRecomposeScope> (Composables.kt:192)");
        }
    ...
    public static final CompositionLocalContext getCurrentCompositionLocalContext(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-43352356, $changed, -1, "androidx.compose.runtime.<get-currentCompositionLocalContext> (Composables.kt:207)");
        }
    ...
    public static final int getCurrentCompositeKeyHash(Composer $composer, int $changed) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(524444915, $changed, -1, "androidx.compose.runtime.<get-currentCompositeKeyHash> (Composables.kt:224)");
        }
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(final Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Composer composer, int i) {
        ...
        update.invoke(Updater.m2602boximpl(Updater.m2603constructorimpl(composer)));
        composer.endNode();
        composer.endReplaceableGroup();
    }
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.checkNotNullParameter(update, "update");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        update.invoke(Updater.m2602boximpl(Updater.m2603constructorimpl($composer)));
        content.invoke($composer, Integer.valueOf(($changed >> 6) & 14));
        $composer.endNode();
        $composer.endReplaceableGroup();
    }

    public static final /* synthetic */ <T, E extends Applier<?>> void ReusableComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.checkNotNullParameter(update, "update");
        Intrinsics.checkNotNullParameter(content, "content");
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function3<? super SkippableUpdater<T>, ? super Composer, ? super Integer, Unit> skippableUpdate, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.checkNotNullParameter(update, "update");
        ...
        update.invoke(Updater.m2602boximpl(Updater.m2603constructorimpl($composer)));
        skippableUpdate.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer)), $composer, Integer.valueOf(($changed >> 3) & 112));
        $composer.startReplaceableGroup(2058660585);
        content.invoke($composer, Integer.valueOf(($changed >> 9) & 14));
        $composer.endReplaceableGroup();
        $composer.endNode();
    }

    public static final /* synthetic */ <T, E extends Applier<?>> void ReusableComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function3<? super SkippableUpdater<T>, ? super Composer, ? super Integer, Unit> skippableUpdate, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.checkNotNullParameter(update, "update");
        Intrinsics.checkNotNullParameter(skippableUpdate, "skippableUpdate");
        Intrinsics.checkNotNullParameter(content, "content");
    ...
    public static final CompositionContext rememberCompositionContext(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1165786124, $changed, -1, "androidx.compose.runtime.rememberCompositionContext (Composables.kt:480)");
        }
