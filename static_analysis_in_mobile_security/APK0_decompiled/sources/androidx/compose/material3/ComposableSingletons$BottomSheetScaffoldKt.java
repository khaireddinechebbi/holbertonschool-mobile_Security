...
public final class ComposableSingletons$BottomSheetScaffoldKt {
    ...
    public static Function2<Composer, Integer, Unit> f28lambda1 = ComposableLambdaKt.composableLambdaInstance(481988104, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$BottomSheetScaffoldKt$lambda-1$1
        ...
        public final void invoke(Composer $composer, int $changed) {
            ...
            BottomSheetDefaults.INSTANCE.m1324DragHandlelgZ2HuY(null, 0.0f, 0.0f, null, 0L, $composer, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static Function3<SnackbarHostState, Composer, Integer, Unit> f29lambda2 = ComposableLambdaKt.composableLambdaInstance(-928941170, false, new Function3<SnackbarHostState, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$BottomSheetScaffoldKt$lambda-2$1
    ...
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1445getLambda2$material3_release() {
        return f29lambda2;
    }
}
