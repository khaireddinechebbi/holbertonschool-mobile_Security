...
public final class RectKt {
    ...
    public static final Rect m2771Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m2731getXimpl(offset), Offset.m2732getYimpl(offset), Offset.m2731getXimpl(offset) + Size.m2800getWidthimpl(size), Offset.m2732getYimpl(offset) + Size.m2797getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m2769Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m2731getXimpl(topLeft), Offset.m2732getYimpl(topLeft), Offset.m2731getXimpl(bottomRight), Offset.m2732getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m2770Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m2731getXimpl(center) - radius, Offset.m2732getYimpl(center) - radius, Offset.m2731getXimpl(center) + radius, Offset.m2732getYimpl(center) + radius);
    }
