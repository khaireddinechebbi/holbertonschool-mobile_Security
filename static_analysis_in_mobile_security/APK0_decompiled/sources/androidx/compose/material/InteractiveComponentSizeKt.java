...
public final class InteractiveComponentSizeKt {
    ...
    public static final Modifier minimumInteractiveComponentSize(Modifier $this$minimumInteractiveComponentSize) {
        ...
        return ComposedModifierKt.composed($this$minimumInteractiveComponentSize, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.InteractiveComponentSizeKt$minimumInteractiveComponentSize$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setName("minimumInteractiveComponentSize");
                $this$null.getProperties().set("README", "Reserves at least 48.dp in size to disambiguate touch interactions if the element would measure smaller");
            }
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1964721376, $changed, -1, "androidx.compose.material.minimumInteractiveComponentSize.<anonymous> (InteractiveComponentSize.kt:54)");
                }
    ...
    static {
        ...
        minimumInteractiveComponentSize = DpKt.m5296DpSizeYgX7TsA(Dp.m5274constructorimpl(48), Dp.m5274constructorimpl(48));
    }
