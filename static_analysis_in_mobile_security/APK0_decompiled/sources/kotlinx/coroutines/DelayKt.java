    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo7122scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m7052delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m7053toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m7053toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m6887compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m6991getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6906getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
