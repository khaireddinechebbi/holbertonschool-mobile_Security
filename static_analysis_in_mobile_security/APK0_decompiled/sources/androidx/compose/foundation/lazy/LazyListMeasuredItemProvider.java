...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m5218getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, !isVertical ? Constraints.m5217getMaxHeightimpl(constraints) : Integer.MAX_VALUE, 5, null);
    }
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        ...
        List placeables = this.measureScope.mo645measure0kLqBqw(index, this.childConstraints);
