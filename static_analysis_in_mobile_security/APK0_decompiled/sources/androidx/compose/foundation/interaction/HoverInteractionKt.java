...
public final class HoverInteractionKt {
    public static final State<Boolean> collectIsHoveredAsState(InteractionSource $this$collectIsHoveredAsState, Composer $composer, int $changed) {
        ...
        boolean invalid$iv$iv = $composer.changed($this$collectIsHoveredAsState) | $composer.changed(isHovered);
        Object it$iv$iv2 = $composer.rememberedValue();
        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv2 = new HoverInteractionKt$collectIsHoveredAsState$1$1($this$collectIsHoveredAsState, isHovered, null);
            $composer.updateRememberedValue(value$iv$iv2);
        } else {
            value$iv$iv2 = it$iv$iv2;
        }
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect($this$collectIsHoveredAsState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv$iv2, $composer, ($changed & 14) | 64);
        if (ComposerKt.isTraceInProgress()) {
