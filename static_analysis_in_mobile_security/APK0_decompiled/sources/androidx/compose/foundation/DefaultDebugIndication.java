    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope $this$drawIndication) {
            ...
            if (!this.isPressed.getValue().booleanValue()) {
                ...
                m2969copywmQWz5c = Color.m2969copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r2) : 0.1f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(Color.INSTANCE.m2997getBlack0d7_KjU()) : 0.0f);
                DrawScope.CC.m3522drawRectnJ9OG0$default($this$drawIndication, m2969copywmQWz5c, 0L, $this$drawIndication.mo3442getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
                return;
            }
            m2969copywmQWz5c2 = Color.m2969copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(r2) : 0.3f, (r12 & 2) != 0 ? Color.m2977getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(Color.INSTANCE.m2997getBlack0d7_KjU()) : 0.0f);
            DrawScope.CC.m3522drawRectnJ9OG0$default($this$drawIndication, m2969copywmQWz5c2, 0L, $this$drawIndication.mo3442getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
        }
    }
