...
public final class BottomSheetScaffoldKt {
    ...
    */
    public static final void m1327BottomSheetScaffold6cEcpDs(final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r47, androidx.compose.ui.Modifier r48, androidx.compose.material3.BottomSheetScaffoldState r49, float r50, androidx.compose.ui.graphics.Shape r51, long r52, long r54, float r56, float r57, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r58, boolean r59, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r60, kotlin.jvm.functions.Function3<? super androidx.compose.material3.SnackbarHostState, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r61, long r62, long r64, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.PaddingValues, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r66, androidx.compose.runtime.Composer r67, final int r68, final int r69, final int r70) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BottomSheetScaffoldKt.m1327BottomSheetScaffold6cEcpDs(kotlin.jvm.functions.Function3, androidx.compose.ui.Modifier, androidx.compose.material3.BottomSheetScaffoldState, float, androidx.compose.ui.graphics.Shape, long, long, float, float, kotlin.jvm.functions.Function2, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1329StandardBottomSheet8oydGBM(final androidx.compose.material3.SheetState r35, final float r36, final boolean r37, final float r38, final androidx.compose.ui.graphics.Shape r39, final long r40, final long r42, final float r44, final float r45, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r47, androidx.compose.runtime.Composer r48, final int r49, final int r50) {
        /*
            Method dump skipped, instructions count: 980
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BottomSheetScaffoldKt.m1329StandardBottomSheet8oydGBM(androidx.compose.material3.SheetState, float, boolean, float, androidx.compose.ui.graphics.Shape, long, long, float, float, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1328BottomSheetScaffoldLayoutPxNyym8(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function3<? super Integer, ? super Composer, ? super Integer, Unit> function32, final Function2<? super Composer, ? super Integer, Unit> function22, final float sheetPeekHeight, final Function0<Float> function0, final SheetState sheetState, final long containerColor, final long contentColor, Composer $composer, final int $changed) {
        ...
        Composer $composer2;
        Composer $composer3;
        Composer $composer4 = $composer.startRestartGroup(-1120561936);
        ComposerKt.sourceInformation($composer4, "C(BottomSheetScaffoldLayout)P(4,9!2,8,6:c#ui.unit.Dp,5,7,2:c#ui.graphics.Color,3:c#ui.graphics.Color)328@14299L1935,328@14282L1952:BottomSheetScaffold.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($changed & 7168) == 0) {
            $dirty |= $composer4.changedInstance(function32) ? 2048 : 1024;
        }
        if ((57344 & $changed) == 0) {
        ...
        if ((29360128 & $changed) == 0) {
            $dirty |= $composer4.changed(sheetState) ? 8388608 : 4194304;
        }
        if ((234881024 & $changed) == 0) {
            $dirty |= $composer4.changed(containerColor) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
        }
        final int $dirty2 = (1879048192 & $changed) == 0 ? $dirty | ($composer4.changed(contentColor) ? 536870912 : 268435456) : $dirty;
        if (($dirty2 & 1533916891) != 306783378 || !$composer4.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
            ...
            Object[] keys$iv = {function32, function0, function2, modifier, Color.m2961boximpl(containerColor), Color.m2961boximpl(contentColor), function3, Dp.m5272boximpl(sheetPeekHeight), function22, sheetState};
                    ...
                    public final MeasureResult m1332invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        final Placeable sheetPlaceable = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot, ComposableLambdaKt.composableLambdaInstance(-1192048628, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$sheetPlaceable$1
                            ...
                            public final void invoke(Composer $composer5, int $changed2) {
                                ComposerKt.sourceInformation($composer5, "C334@14581L25:BottomSheetScaffold.kt#uh7d8r");
                                ...
                                function33.invoke(Integer.valueOf(layoutHeight), $composer5, Integer.valueOf((i2 >> 6) & 112));
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        ...
                        if (function23 != null) {
                            ...
                            placeable = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.TopBar, ComposableLambdaKt.composableLambdaInstance(-873203005, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$topBarPlaceable$1$1
                                ...
                                public final void invoke(Composer $composer5, int $changed2) {
                                    ComposerKt.sourceInformation($composer5, "C340@14892L8:BottomSheetScaffold.kt#uh7d8r");
                                    if (($changed2 & 11) == 2 && $composer5.getSkipping()) {
                                        $composer5.skipToGroupEnd();
                                        return;
                                    }
                                    ...
                                    function23.invoke($composer5, Integer.valueOf((i3 >> 3) & 14));
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                        ...
                        final Placeable bodyPlaceable = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot2, ComposableLambdaKt.composableLambdaInstance(-1459220575, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1
                            ...
                            public final void invoke(Composer $composer5, int $changed2) {
                                ComposerKt.sourceInformation($composer5, "C347@15198L194:BottomSheetScaffold.kt#uh7d8r");
                                if (($changed2 & 11) != 2 || !$composer5.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                    ...
                                    ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer5, 1725620860, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
                                        ...
                                        public final void invoke(Composer $composer6, int $changed3) {
                                            ComposerKt.sourceInformation($composer6, "C351@15345L45:BottomSheetScaffold.kt#uh7d8r");
                                            ...
                                            function35.invoke(PaddingKt.m484PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f2, 7, null), $composer6, Integer.valueOf((i4 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
                                    ...
                                    SurfaceKt.m1806SurfaceT9BRK9s(modifier3, null, j3, j4, 0.0f, 0.0f, null, composableLambda, $composer5, (i5 & 14) | 12582912 | ((i5 >> 18) & 896) | ((i5 >> 18) & 7168), 114);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        final Placeable snackbarPlaceable = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.Snackbar, function22).get(0).mo4225measureBRTryo0(looseConstraints);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2
            ...
            public final void invoke(Composer composer, int i2) {
                BottomSheetScaffoldKt.m1328BottomSheetScaffoldLayoutPxNyym8(Modifier.this, function2, function3, function32, function22, sheetPeekHeight, function0, sheetState, containerColor, contentColor, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
