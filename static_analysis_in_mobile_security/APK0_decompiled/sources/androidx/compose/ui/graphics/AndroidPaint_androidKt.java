...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2857setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int mode) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3374setBlendModeGB0RdKg(setNativeBlendMode, mode);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2824toPorterDuffModes9anfk8(mode)));
        }
    }
    ...
    public static final void m2858setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long value) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m3025toArgb8_81llA(value));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2862setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int value) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m3234equalsimpl0(value, PaintingStyle.INSTANCE.m3239getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m3239getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m3238getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint $this$getNativeStrokeCap) {
        ...
        return StrokeCap.INSTANCE.m3324getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m2860setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int value) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m3320equalsimpl0(value, StrokeCap.INSTANCE.m3326getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m3320equalsimpl0(value, StrokeCap.INSTANCE.m3325getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m3320equalsimpl0(value, StrokeCap.INSTANCE.m3324getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint $this$getNativeStrokeJoin) {
        ...
        return StrokeJoin.INSTANCE.m3335getMiterLxFBmk8();
    }

    /* renamed from: setNativeStrokeJoin-kLtJ_vA, reason: not valid java name */
    public static final void m2861setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int value) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m3330equalsimpl0(value, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m3330equalsimpl0(value, StrokeJoin.INSTANCE.m3334getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m3330equalsimpl0(value, StrokeJoin.INSTANCE.m3336getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        ...
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m3068getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m3066getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2859setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int value) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m3061equalsimpl0(value, FilterQuality.INSTANCE.m3068getNonefv9h1I()));
    }
