...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3362getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3055getAutoNrFUSI();
    private long size = Size.INSTANCE.m2808getUnspecifiedNHjbRc();
    ...
    public void mo3137setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo3140setTransformOrigin__ExYCQ(long j) {
    ...
    public void mo3138setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m3283setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3137setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3139setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3140setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3362getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3138setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3055getAutoNrFUSI());
        m3283setSizeuvyYCjk(Size.INSTANCE.m2808getUnspecifiedNHjbRc());
    }
}
