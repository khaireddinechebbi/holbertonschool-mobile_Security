...
.method public final invoke(Landroidx/compose/ui/input/pointer/PointerInputScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;
    ...
    .local v1, "this":Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;->L$0:Ljava/lang/Object;
    ...
    iget-object v3, v1, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;->this$0:Landroidx/compose/foundation/text/selection/SelectionManager;

    new-instance v4, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1$1;

    iget-object v5, v1, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;->$block:Lkotlin/jvm/functions/Function0;

    invoke-direct {v4, v5}, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1$1;-><init>(Lkotlin/jvm/functions/Function0;)V
    ...
    iput v6, v1, Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;->label:I

    invoke-static {v3, v2, v4, v5}, Landroidx/compose/foundation/text/selection/SelectionManager;->access$detectNonConsumingTap(Landroidx/compose/foundation/text/selection/SelectionManager;Landroidx/compose/ui/input/pointer/PointerInputScope;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local v1    # "this":Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;
    .restart local v0    # "this":Landroidx/compose/foundation/text/selection/SelectionManager$onClearSelectionRequested$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
