...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo7071tryReceivePtdJZtk = receiveChannel.mo7071tryReceivePtdJZtk();
            if (ChannelResult.m7086isSuccessimpl(mo7071tryReceivePtdJZtk)) {
                return (E) ChannelResult.m7082getOrThrowimpl(mo7071tryReceivePtdJZtk);
            }
            Throwable m7080exceptionOrNullimpl = ChannelResult.m7080exceptionOrNullimpl(mo7071tryReceivePtdJZtk);
            if (m7080exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m7080exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m7081getOrNullimpl(r3)
                return r3
            */
