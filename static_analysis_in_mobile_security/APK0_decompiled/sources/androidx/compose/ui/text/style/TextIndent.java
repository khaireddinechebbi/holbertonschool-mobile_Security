...
public final class TextIndent {
    ...
    */
    ...
    public static /* synthetic */ TextIndent m5154copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5155copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m5155copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m5452equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m5452equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m5456hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m5456hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5462toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5462toStringimpl(this.restLine)) + ')';
    }
}
