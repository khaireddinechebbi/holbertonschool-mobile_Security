...
.method public static final AnimatedContent(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/Alignment;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function4;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "C(AnimatedContent)P(3,4,1,2)692@32995L7,693@33023L106,698@33218L51,699@33291L62,786@37539L58,787@37631L45,797@37946L52,788@37681L323:AnimatedContent.kt#xbi5r1"
    ...
    .local v5, "transitionSpec":Lkotlin/jvm/functions/Function1;
    :cond_15
    if-eqz v6, :cond_16
    ...
    .line 692
    const-string v1, "androidx.compose.animation.AnimatedContent (AnimatedContent.kt:681)"
    ...
    .line 695
    .local v3, "$i$a$-remember-AnimatedContentKt$AnimatedContent$rootScope$1":I
    move/from16 p4, v0
    ...
    invoke-direct {v0, v9, v7, v8}, Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;-><init>(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/Alignment;Landroidx/compose/ui/unit/LayoutDirection;)V

    .line 867
    .end local v3    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$rootScope$1":I
    nop
    ...
    .local v6, "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    and-int/lit8 v0, v14, 0xe
    ...
    .line 699
    .local v10, "$i$a$-remember-AnimatedContentKt$AnimatedContent$currentlyVisible$1":I
    move-object/from16 v18, v0
    ...
    .line 874
    .end local v10    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$currentlyVisible$1":I
    nop
    ...
    .local v10, "currentlyVisible":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    and-int/lit8 v0, v14, 0xe
    ...
    .line 700
    .local v1, "$i$a$-remember-AnimatedContentKt$AnimatedContent$contentMap$1":I
    ...
    .line 881
    .end local v1    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$contentMap$1":I
    ...
    .line 705
    .local v4, "contentMap":Ljava/util/Map;
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/animation/core/Transition;->getCurrentState()Ljava/lang/Object;
    ...
    .line 719
    :cond_23
    invoke-virtual {v6, v7}, Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;->setContentAlignment$animation_release(Landroidx/compose/ui/Alignment;)V

    .line 720
    invoke-virtual {v6, v8}, Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;->setLayoutDirection$animation_release(Landroidx/compose/ui/unit/LayoutDirection;)V
    ...
    .line 729
    .local v17, "$i$a$-indexOfFirst-AnimatedContentKt$AnimatedContent$id$1":I
    ...
    .line 887
    .end local v17    # "$i$a$-indexOfFirst-AnimatedContentKt$AnimatedContent$id$1":I
    ...
    .line 891
    .end local p1    # "$i$f$indexOfFirst":I
    ...
    .end local v1    # "$i$f$indexOfFirst":I
    .restart local p1    # "$i$f$indexOfFirst":I
    ...
    invoke-virtual {v10, v0, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateList;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "stateForContent":Ljava/lang/Object;
    const/16 v18, 0x0
    ...
    new-instance v8, Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$6$1;

    move-object/from16 p2, v0

    .end local v0    # "stateForContent":Ljava/lang/Object;
    .local p2, "stateForContent":Ljava/lang/Object;
    move-object v0, v8
    ...
    .end local v4    # "contentMap":Ljava/util/Map;
    .local v9, "contentMap":Ljava/util/Map;
    move-object v4, v5

    move-object v11, v5

    .end local v5    # "transitionSpec":Lkotlin/jvm/functions/Function1;
    ...
    .end local v6    # "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    .local v14, "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    .local v22, "$dirty":I
    move-object v6, v10
    ...
    .local v23, "contentAlignment":Landroidx/compose/ui/Alignment;
    ...
    .end local p2    # "stateForContent":Ljava/lang/Object;
    ...
    .end local v0    # "index$iv":I
    .end local v9    # "contentMap":Ljava/util/Map;
    ...
    .end local v23    # "contentAlignment":Landroidx/compose/ui/Alignment;
    ...
    .restart local v4    # "contentMap":Ljava/util/Map;
    .restart local v5    # "transitionSpec":Lkotlin/jvm/functions/Function1;
    .restart local v6    # "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    ...
    .end local v7    # "contentAlignment":Landroidx/compose/ui/Alignment;
    .end local v8    # "layoutDirection":Landroidx/compose/ui/unit/LayoutDirection;
    .restart local v9    # "contentMap":Ljava/util/Map;
    .restart local v11    # "transitionSpec":Lkotlin/jvm/functions/Function1;
    .local v14, "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    .restart local v21    # "$this$fastForEach$iv":Ljava/util/List;
    .restart local v22    # "$dirty":I
    .restart local v23    # "contentAlignment":Landroidx/compose/ui/Alignment;
    ...
    .line 787
    .local v8, "$i$a$-remember-AnimatedContentKt$AnimatedContent$contentTransform$1":I
    ...
    .line 902
    .end local v8    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$contentTransform$1":I
    ...
    invoke-virtual {v14, v0, v12, v1}, Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;->createSizeAnimationModifier$animation_release(Landroidx/compose/animation/ContentTransform;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/Modifier;

    move-result-object v1

    .line 790
    .local v1, "sizeModifier":Landroidx/compose/ui/Modifier;
    ...
    .local p2, "contentTransform":Landroidx/compose/animation/ContentTransform;
    invoke-virtual/range {v17 .. v17}, Landroidx/compose/runtime/Composer$Companion;->getEmpty()Ljava/lang/Object;
    ...
    .line 798
    .local v0, "$i$a$-remember-AnimatedContentKt$AnimatedContent$7":I
    move/from16 p3, v0

    .end local v0    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$7":I
    .local p3, "$i$a$-remember-AnimatedContentKt$AnimatedContent$7":I
    new-instance v0, Landroidx/compose/animation/AnimatedContentMeasurePolicy;

    invoke-direct {v0, v14}, Landroidx/compose/animation/AnimatedContentMeasurePolicy;-><init>(Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;)V

    .line 909
    .end local p3    # "$i$a$-remember-AnimatedContentKt$AnimatedContent$7":I
    nop
    ...
    .end local v1    # "sizeModifier":Landroidx/compose/ui/Modifier;
    .local p3, "sizeModifier":Landroidx/compose/ui/Modifier;
    ...
    .line 793
    .local v24, "$i$a$-forEach-AnimatedContentKt$AnimatedContent$8$1":I
    ...
    invoke-interface {v1, v3, v2}, Landroidx/compose/runtime/Composer;->startMovableGroup(ILjava/lang/Object;)V

    const-string v2, "793@37870L8"
    ...
    .line 941
    .end local v24    # "$i$a$-forEach-AnimatedContentKt$AnimatedContent$8$1":I
    ...
    .restart local v3    # "$i$a$-Layout-AnimatedContentKt$AnimatedContent$8":I
    :cond_34
    move-object/from16 v25, v0
    ...
    .restart local v20    # "skippableUpdate$iv$iv":Lkotlin/jvm/functions/Function3;
    .restart local v26    # "$i$a$-Layout-AnimatedContentKt$AnimatedContent$8":I
    ...
    .line 800
    .end local v9    # "contentMap":Ljava/util/Map;
    .end local v10    # "currentlyVisible":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    .end local v14    # "rootScope":Landroidx/compose/animation/AnimatedContentTransitionScopeImpl;
    .end local p1    # "layoutDirection":Landroidx/compose/ui/unit/LayoutDirection;
    .end local p2    # "contentTransform":Landroidx/compose/animation/ContentTransform;
    .end local p3    # "sizeModifier":Landroidx/compose/ui/Modifier;
    :cond_35
    :goto_22
...
.method public static final AnimatedContent(Ljava/lang/Object;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/Alignment;Ljava/lang/String;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function4;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "C(AnimatedContent)P(5,4,6,1,3,2)140@7413L58,141@7487L136:AnimatedContent.kt#xbi5r1"
    ...
    .line 131
    sget-object v0, Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$1;->INSTANCE:Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$1;
    ...
    .line 131
    .end local p2    # "transitionSpec":Lkotlin/jvm/functions/Function1;
    .local v19, "transitionSpec":Lkotlin/jvm/functions/Function1;
    :goto_10
    if-eqz v6, :cond_19
    ...
    .line 136
    .end local p3    # "contentAlignment":Landroidx/compose/ui/Alignment;
    .local v20, "contentAlignment":Landroidx/compose/ui/Alignment;
    :goto_11
    if-eqz v8, :cond_1a
    ...
    .line 138
    sget-object v0, Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$2;->INSTANCE:Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$2;
    ...
    .local v9, "contentKey":Lkotlin/jvm/functions/Function1;
    :cond_1b
    invoke-static {}, Landroidx/compose/runtime/ComposerKt;->isTraceInProgress()Z
    ...
    const-string v2, "androidx.compose.animation.AnimatedContent (AnimatedContent.kt:127)"
    ...
    invoke-static {v10, v14, v13, v0, v2}, Landroidx/compose/animation/core/TransitionKt;->updateTransition(Ljava/lang/Object;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)Landroidx/compose/animation/core/Transition;
    ...
    .line 149
    .end local v15    # "transition":Landroidx/compose/animation/core/Transition;
    :cond_1d
    move-object v15, v9

    .end local v9    # "contentKey":Lkotlin/jvm/functions/Function1;
    .local v15, "contentKey":Lkotlin/jvm/functions/Function1;
    :goto_12
    ...
    :cond_1e
    new-instance v18, Landroidx/compose/animation/AnimatedContentKt$AnimatedContent$3;
