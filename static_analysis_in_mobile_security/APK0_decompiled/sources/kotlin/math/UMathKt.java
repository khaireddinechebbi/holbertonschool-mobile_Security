...
public final class UMathKt {
    ...
    private static final int m6775minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m6757minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m6776mineb3DHEI(long a, long b) {
        return UComparisonsKt.m6765minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m6773maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m6745maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m6774maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m6753maxOfeb3DHEI(a, b);
    }
}
