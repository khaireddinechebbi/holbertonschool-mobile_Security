...
public abstract class Placeable implements Measured {
    ...
    public Placeable() {
        ...
        this.apparentToRealOffset = IntOffset.INSTANCE.m5402getZeronOccac();
    }
    ...
    public static abstract class PlacementScope {
        ...
        public final void placeRelative(Placeable $this$placeRelative, int x, int y, float zIndex) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                ...
                $this$placeRelative.mo4226placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(position$iv$iv) + IntOffset.m5392getXimpl(other$iv$iv$iv), IntOffset.m5393getYimpl(position$iv$iv) + IntOffset.m5393getYimpl(other$iv$iv$iv)), zIndex, null);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelative.apparentToRealOffset;
            $this$placeRelative.mo4226placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(position$iv) + IntOffset.m5392getXimpl(other$iv$iv$iv2), IntOffset.m5393getYimpl(position$iv) + IntOffset.m5393getYimpl(other$iv$iv$iv2)), zIndex, null);
        }
        ...
        public final void placeRelativeWithLayer(Placeable $this$placeRelativeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                ...
                $this$placeRelativeWithLayer.mo4226placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(position$iv$iv) + IntOffset.m5392getXimpl(other$iv$iv$iv), IntOffset.m5393getYimpl(position$iv$iv) + IntOffset.m5393getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelativeWithLayer.apparentToRealOffset;
            $this$placeRelativeWithLayer.mo4226placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5392getXimpl(position$iv) + IntOffset.m5392getXimpl(other$iv$iv$iv2), IntOffset.m5393getYimpl(position$iv) + IntOffset.m5393getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
        }
