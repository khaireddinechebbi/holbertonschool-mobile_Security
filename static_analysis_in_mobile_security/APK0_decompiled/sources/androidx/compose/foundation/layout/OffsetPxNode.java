...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public OffsetPxNode(Function1<? super Density, IntOffset> offset, boolean rtlAware) {
    ...
    public MeasureResult mo239measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                long offsetValue = OffsetPxNode.this.getOffset().invoke(measure).getPackedValue();
                if (OffsetPxNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeable, IntOffset.m5392getXimpl(offsetValue), IntOffset.m5393getYimpl(offsetValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeable, IntOffset.m5392getXimpl(offsetValue), IntOffset.m5393getYimpl(offsetValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
