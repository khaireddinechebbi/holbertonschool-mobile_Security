...
public interface PlatformResolveInterceptor {
    ...
    int mo4818interceptFontStyleT2F_aPo(int fontStyle);

    /* renamed from: interceptFontSynthesis-Mscr08Y */
    int mo4819interceptFontSynthesisMscr08Y(int fontSynthesis);
    ...
    public final /* synthetic */ class CC {
        ...
        public static int m4890$default$interceptFontStyleT2F_aPo(PlatformResolveInterceptor _this, int fontStyle) {
            return fontStyle;
        }

        /* renamed from: $default$interceptFontSynthesis-Mscr08Y, reason: not valid java name */
        public static int m4891$default$interceptFontSynthesisMscr08Y(PlatformResolveInterceptor _this, int fontSynthesis) {
    ...
    public static final class Companion {
        ...
        private static final PlatformResolveInterceptor Default = new PlatformResolveInterceptor() { // from class: androidx.compose.ui.text.font.PlatformResolveInterceptor$Companion$Default$1
            ...
            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontStyle-T2F_aPo */
            public /* synthetic */ int mo4818interceptFontStyleT2F_aPo(int i) {
                return PlatformResolveInterceptor.CC.m4890$default$interceptFontStyleT2F_aPo(this, i);
            }

            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontSynthesis-Mscr08Y */
            public /* synthetic */ int mo4819interceptFontSynthesisMscr08Y(int i) {
                return PlatformResolveInterceptor.CC.m4891$default$interceptFontSynthesisMscr08Y(this, i);
            }
