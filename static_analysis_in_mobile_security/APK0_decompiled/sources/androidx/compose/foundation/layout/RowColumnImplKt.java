    ...
    public static final MeasurePolicy m512rowColumnMeasurePolicyTDGSqEk(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, final float arrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1
            ...
            public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                final RowColumnMeasureHelperResult measureResult = rowColumnMeasureHelper.m514measureWithoutPlacing_EkL_Y(measure, constraints, 0, measurables.size());
                ...
                return MeasureScope.CC.layout$default(measure, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1$measure$1
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                return ((Number) MinIntrinsicWidthMeasureBlock.invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$minIntrinsicWidth.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                return ((Number) MinIntrinsicHeightMeasureBlock.invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$minIntrinsicHeight.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                return ((Number) MaxIntrinsicWidthMeasureBlock.invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$maxIntrinsicWidth.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                return ((Number) MaxIntrinsicHeightMeasureBlock.invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$maxIntrinsicHeight.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
        };
    }
