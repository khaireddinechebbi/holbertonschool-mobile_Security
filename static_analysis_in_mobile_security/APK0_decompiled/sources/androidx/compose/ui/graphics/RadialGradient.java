    ...
    */
    public /* synthetic */ RadialGradient(java.util.List r10, java.util.List r11, long r12, float r14, int r15, int r16, kotlin.jvm.internal.DefaultConstructorMarker r17) {
        ...
        L8:
            ...
            int r0 = r0.m3344getClamp3opZhB0()
            r7 = r0
            goto L15
        L14:
            r7 = r15
    ...
    public Shader mo2940createShaderuvyYCjk(long size) {
        ...
        if (f == Float.POSITIVE_INFINITY) {
            f = Size.m2799getMinDimensionimpl(size) / 2;
        }
        return ShaderKt.m3288RadialGradientShader8uybcMk(Offset, f, list, list2, this.tileMode);
    }
