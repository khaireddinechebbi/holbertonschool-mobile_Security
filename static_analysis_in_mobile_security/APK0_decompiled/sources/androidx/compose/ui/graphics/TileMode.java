...
public final class TileMode {
    ...
    private static final int Clamp = m3338constructorimpl(0);
    private static final int Repeated = m3338constructorimpl(1);
    private static final int Mirror = m3338constructorimpl(2);
    private static final int Decal = m3338constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m3337boximpl(int i) {
        return new TileMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3338constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m3339equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3341hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3344getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0, reason: not valid java name */
        public final int m3347getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0, reason: not valid java name */
        public final int m3346getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0, reason: not valid java name */
        public final int m3345getDecal3opZhB0() {
    ...
    public static String m3342toStringimpl(int arg0) {
        return m3340equalsimpl0(arg0, Clamp) ? "Clamp" : m3340equalsimpl0(arg0, Repeated) ? "Repeated" : m3340equalsimpl0(arg0, Mirror) ? "Mirror" : m3340equalsimpl0(arg0, Decal) ? "Decal" : "Unknown";
    }
