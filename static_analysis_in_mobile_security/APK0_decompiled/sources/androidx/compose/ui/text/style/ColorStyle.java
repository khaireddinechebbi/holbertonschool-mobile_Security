...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5042copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5044copy8_81llA(j);
    }
    ...
    public final ColorStyle m5044copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m2972equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public final long m5045getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m2973getAlphaimpl(mo5041getColor0d7_KjU());
    }
}
