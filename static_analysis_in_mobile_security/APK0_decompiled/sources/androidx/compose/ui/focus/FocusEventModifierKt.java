...
public final class FocusEventModifierKt {
    public static final Modifier onFocusEvent(Modifier $this$onFocusEvent, Function1<? super FocusState, Unit> onFocusEvent) {
        Intrinsics.checkNotNullParameter($this$onFocusEvent, "<this>");
        Intrinsics.checkNotNullParameter(onFocusEvent, "onFocusEvent");
        return $this$onFocusEvent.then(new FocusEventElement(onFocusEvent));
    }
}
