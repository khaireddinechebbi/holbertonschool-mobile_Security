...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(new Pair(IntOffset.m5383boximpl(startCoordinates), IntOffset.m5383boximpl(endCoordinates)), firstIsSelectionStart, lastIsSelectionEnd);
        }
    }
}
