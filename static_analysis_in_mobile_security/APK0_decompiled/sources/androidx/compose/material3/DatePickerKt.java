...
public final class DatePickerKt {
    ...
    public static final void DatePicker(final DatePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
                ...
                headline = i7 != 0 ? ComposableLambdaKt.composableLambda($composer2, 1578326756, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePicker$4
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            int i9 = $dirty;
                            datePickerDefaults.DatePickerHeadline(datePickerState, datePickerFormatter, padding, $composer3, (i9 & 14) | 3456 | ((i9 >> 3) & 112), 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            final int i9 = $dirty;
            m1476DateEntryContainerau3_HiA(modifier2, title, headline, showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1702543532, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePicker$5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int m1482getDisplayModejFl4v0 = DatePickerState.this.m1482getDisplayModejFl4v0();
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePicker$5$1$1
                                ...
                                public final void m1480invokevCnGnXg(int displayMode) {
                                    DatePickerState.this.getStateData().m1725switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1478DisplayModeToggleButtontER2X8s(padding, m1482getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int i10 = i9;
                        DatePickerKt.SwitchableDateEntryContent(datePickerState, datePickerFormatter2, function13, datePickerColors2, $composer3, (i10 & 14) | ((i10 >> 3) & 112) | ((i10 >> 3) & 896) | ((i10 >> 12) & 7168));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final void m1476DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors colors, final TextStyle headlineTextStyle, final float headerMinHeight, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
            ...
            m1477DatePickerHeaderpc5RIQQ(Modifier.INSTANCE, function2, colors.getTitleContentColor(), colors.getHeadlineContentColor(), headerMinHeight, ComposableLambdaKt.composableLambda($composer2, -229007058, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        $composer3.enableReusing();
                        skippableUpdate$iv$iv$iv3.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer3)), $composer3, Integer.valueOf(($changed$iv$iv$iv3 >> 3) & 112));
                        $composer3.startReplaceableGroup(2058660585);
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer3, -962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer $composer4, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                        ...
                                        Modifier modifier$iv4 = RowScope.CC.weight$default(RowScope.this, Modifier.INSTANCE, 1.0f, false, 2, null);
                                        ...
                                        skippableUpdate$iv$iv$iv4.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv4 >> 3) & 112));
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1476DateEntryContainerau3_HiA(Modifier.this, function2, function22, function23, colors, headlineTextStyle, headerMinHeight, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1478DisplayModeToggleButtontER2X8s(final Modifier modifier, final int displayMode, final Function1<? super DisplayMode, Unit> onDisplayModeChange, Composer $composer, final int $changed) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1478DisplayModeToggleButtontER2X8s(Modifier.this, displayMode, onDisplayModeChange, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void SwitchableDateEntryContent(final DatePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int m1482getDisplayModejFl4v0 = state.m1482getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1498boximpl(m1482getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    invoke2(semanticsPropertyReceiver);
                    return Unit.INSTANCE;
    ...
    */
    ...
    public static final void m1477DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long titleContentColor, final long headlineContentColor, final float minHeight, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
                            ...
                            TextKt.ProvideTextStyle(textStyle, ComposableLambdaKt.composableLambda($composer3, -2006650069, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$1$1.1
                                ...
                                public final void invoke(Composer $composer4, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                        ...
                                        Updater.m2610setimpl($this$Layout_u24lambda_u2d0$iv$iv2, viewConfiguration$iv$iv2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                                        $composer4.enableReusing();
                                        skippableUpdate$iv$iv$iv2.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer4)), $composer4, Integer.valueOf(($changed$iv$iv$iv2 >> 3) & 112));
                                        $composer4.startReplaceableGroup(2058660585);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
            ...
            public final void invoke(Composer composer, int i3) {
                DatePickerKt.m1477DatePickerHeaderpc5RIQQ(Modifier.this, function2, titleContentColor, headlineContentColor, minHeight, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void HorizontalMonthsList(final Function1<? super Long, Unit> function1, final StateData stateData, final LazyListState lazyListState, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function12, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        Composer $composer3;
        Object value$iv$iv;
        Composer $composer4 = $composer.startRestartGroup(1933363608);
        ComposerKt.sourceInformation($composer4, "C(HorizontalMonthsList)P(4,5,3,1,2)1282@53204L168,1298@53968L40,1299@54015L738,1288@53377L1376,1323@54789L62,1323@54759L92:DatePicker.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
            $dirty |= $composer4.changedInstance(function1) ? 4 : 2;
        }
        if (($changed & 112) == 0) {
            $dirty |= $composer4.changed(stateData) ? 32 : 16;
        }
        if (($changed & 896) == 0) {
            $dirty |= $composer4.changed(lazyListState) ? 256 : 128;
        }
        if (($changed & 7168) == 0) {
            $dirty |= $composer4.changed(dateFormatter) ? 2048 : 1024;
        }
        if ((57344 & $changed) == 0) {
            $dirty |= $composer4.changedInstance(function12) ? 16384 : 8192;
        }
        if ((458752 & $changed) == 0) {
            $dirty |= $composer4.changed(colors) ? 131072 : 65536;
        }
        final int $dirty2 = $dirty;
        if ((374491 & $dirty2) != 74898 || !$composer4.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
            ...
            boolean invalid$iv$iv = $composer4.changed(key1$iv2);
            ...
            FlingBehavior rememberSnapFlingBehavior$material3_release = DatePickerDefaults.INSTANCE.rememberSnapFlingBehavior$material3_release(lazyListState, null, $composer4, (($dirty2 >> 6) & 14) | 384, 2);
                ...
                value$iv$iv2 = new Function1<LazyListScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$HorizontalMonthsList$2$1
                    ...
                    public final void invoke2(LazyListScope LazyRow) {
                        ...
                        LazyListScope.CC.items$default(LazyRow, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(-65053693, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$HorizontalMonthsList$2$1.1
                            ...
                            public final void invoke(LazyItemScope items, int it, Composer $composer5, int $changed2) {
                                Intrinsics.checkNotNullParameter(items, "$this$items");
                                ComposerKt.sourceInformation($composer5, "C1306@54250L487:DatePicker.kt#uh7d8r");
                                int $dirty3 = $changed2;
                                if (($changed2 & 14) == 0) {
                                ...
                                if (($dirty3 & 731) != 146 || !$composer5.getSkipping()) {
                                    ...
                                    skippableUpdate$iv$iv$iv.invoke(SkippableUpdater.m2594boximpl(SkippableUpdater.m2595constructorimpl($composer5)), $composer5, Integer.valueOf(($changed$iv$iv$iv >> 3) & 112));
                                    $composer5.startReplaceableGroup(2058660585);
                                    int i3 = ($changed$iv$iv$iv >> 9) & 14;
                                    ComposerKt.sourceInformationMarkerStart($composer5, -1253629305, "C72@3384L9:Box.kt#2w3rfo");
                                    BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                                    int i4 = ((0 >> 6) & 112) | 6;
                                    ComposerKt.sourceInformationMarkerStart($composer5, 1656167412, "C1309@54344L379:DatePicker.kt#uh7d8r");
                                    int i5 = i2 << 3;
                                    int i6 = i2 << 6;
                                    DatePickerKt.Month(month, function15, calendarDate2, stateData3, false, function16, datePickerFormatter2, datePickerColors2, $composer5, (i5 & 112) | 24576 | (i6 & 7168) | (i5 & 458752) | (3670016 & (i2 << 9)) | (29360128 & i6));
                                    ComposerKt.sourceInformationMarkerEnd($composer5);
                                    ComposerKt.sourceInformationMarkerEnd($composer5);
            ...
            $composer2.endReplaceableGroup();
            LazyDslKt.LazyRow(semantics$default, lazyListState, null, false, null, null, rememberSnapFlingBehavior$material3_release, false, (Function1) value$iv$iv2, $composer2, ($dirty2 >> 3) & 112, 188);
            int i = (($dirty2 >> 6) & 14) | ($dirty2 & 112);
            $composer3 = $composer2;
            $composer3.startReplaceableGroup(511388516);
            ComposerKt.sourceInformation($composer3, "CC(remember)P(1,2):Composables.kt#9igjgp");
            boolean invalid$iv$iv2 = $composer3.changed(lazyListState) | $composer3.changed(stateData);
            Object it$iv$iv2 = $composer3.rememberedValue();
            if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
            ...
            $composer3.endReplaceableGroup();
            EffectsKt.LaunchedEffect(lazyListState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv$iv, $composer3, (($dirty2 >> 6) & 14) | 64);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), DatePickerModalTokens.INSTANCE.getSelectionYearLabelTextFont()), ComposableLambdaKt.composableLambda($composer2, -145469688, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        final LazyGridState lazyGridState = LazyGridStateKt.rememberLazyGridState(Math.max(0, (displayedYear - StateData.this.getYearRange().getFirst()) - 3), 0, $composer3, 0, 2);
                        ...
                        if (Color.m2972equalsimpl0(colors.getContainerColor(), MaterialTheme.INSTANCE.getColorScheme($composer3, 6).m1390getSurface0d7_KjU())) {
                            ...
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            containerColor = ColorSchemeKt.m1431surfaceColorAtElevation3ABfNKs(colorScheme, ((Dp) consume).m5288unboximpl());
                        } else {
                        ...
                        Modifier semantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m160backgroundbw27NRU$default(modifier, containerColor, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        final int i2 = i;
                        final DatePickerColors datePickerColors = colors;
                        LazyGridDslKt.LazyVerticalGrid(fixed, semantics$default, lazyGridState, null, false, arrangement.m394spacedBy0680j_4(f), spaceEvenly, null, false, new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(LazyGridScope LazyVerticalGrid) {
                                ...
                                LazyGridScope.CC.items$default(LazyVerticalGrid, count, null, null, null, ComposableLambdaKt.composableLambdaInstance(1369226173, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(4);
                                    ...
                                    /*
                                        ...
                                        To view partially-correct add '--show-bad-code' argument
                                    */
                                    public final void invoke(androidx.compose.foundation.lazy.grid.LazyGridItemScope r25, final int r26, androidx.compose.runtime.Composer r27, int r28) {
                                        /*
                ...
                public final void invoke(RowScope TextButton, Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 81) != 16 || !$composer3.getSkipping()) {
                        ...
                        if (expanded) {
                            ...
                            String m1797getStringNWtq28 = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1756getDatePickerSwitchToDaySelectionadMyvUU(), $composer3, 6);
                            $composer3.endReplaceableGroup();
                            str = m1797getStringNWtq28;
                        } else {
                            $composer3.startReplaceableGroup(1071182591);
                            ComposerKt.sourceInformation($composer3, "1852@75759L50");
                            String m1797getStringNWtq282 = Strings_androidKt.m1797getStringNWtq28(Strings.INSTANCE.m1760getDatePickerSwitchToYearSelectionadMyvUU(), $composer3, 6);
                            $composer3.endReplaceableGroup();
                            str = m1797getStringNWtq282;
                        }
