...
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(Icons.Sharp $this$DateRange) {
        ...
        ImageVector.Builder $this$_get_DateRange__u24lambda_u241 = new ImageVector.Builder("Sharp.DateRange", Dp.m5274constructorimpl(24.0f), Dp.m5274constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        $this$PathData_u24lambda_u240$iv$iv$iv.moveTo(21.0f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(3.0f, 4.0f);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.lineTo(21.0f, 4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
