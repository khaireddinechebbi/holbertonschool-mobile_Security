...
public final class LayoutIntrinsics {
    ...
    public final float getMaxIntrinsicWidth() {
        ...
        Float desiredWidth = getBoringMetrics() != null ? Float.valueOf(r0.width) : null;
        if (desiredWidth == null) {
            CharSequence charSequence = this.charSequence;
            desiredWidth = Float.valueOf((float) Math.ceil(Layout.getDesiredWidth(charSequence, 0, charSequence.length(), this.textPaint)));
        }
        shouldIncreaseMaxIntrinsic = LayoutIntrinsicsKt.shouldIncreaseMaxIntrinsic(desiredWidth.floatValue(), this.charSequence, this.textPaint);
