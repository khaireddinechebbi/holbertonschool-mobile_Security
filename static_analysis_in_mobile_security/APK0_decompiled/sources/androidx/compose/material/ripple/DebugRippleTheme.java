...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1133defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2042140174, $changed, -1, "androidx.compose.material.ripple.DebugRippleTheme.defaultColor (RippleTheme.kt:214)");
        }
        long m1300defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1300defaultRippleColor5vOe2sY(Color.INSTANCE.m2997getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1300defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1629816343, $changed, -1, "androidx.compose.material.ripple.DebugRippleTheme.rippleAlpha (RippleTheme.kt:217)");
        }
        RippleAlpha m1299defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1299defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2997getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1299defaultRippleAlphaDxMtmZc;
    }
}
