...
public final class LazyStaggeredGridKt {
    ...
    public static final void m671LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Modifier modifier, PaddingValues contentPadding, boolean reverseLayout, FlingBehavior flingBehavior, boolean userScrollEnabled, float mainAxisSpacing, float crossAxisSpacing, final Function1<? super LazyStaggeredGridScope, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        PaddingValues contentPadding2 = (i & 16) != 0 ? PaddingKt.m480PaddingValues0680j_4(Dp.m5274constructorimpl(0)) : contentPadding;
        ...
        float mainAxisSpacing2 = (i & 256) != 0 ? Dp.m5274constructorimpl(0) : mainAxisSpacing;
        float crossAxisSpacing2 = (i & 512) != 0 ? Dp.m5274constructorimpl(0) : crossAxisSpacing;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(Composer composer, int i2) {
                LazyStaggeredGridKt.m671LazyStaggeredGridLJWHXA8(LazyStaggeredGridState.this, orientation, slots, modifier3, paddingValues, reverseLayout3, flingBehavior4, z, f, f2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
