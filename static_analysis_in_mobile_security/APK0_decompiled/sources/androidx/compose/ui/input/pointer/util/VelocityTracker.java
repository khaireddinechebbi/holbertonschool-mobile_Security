...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m2747getZeroF1C5BW0();
    ...
    public final void m4201setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m4198addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2731getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2732getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m4199calculateVelocity9UxMQ8M() {
