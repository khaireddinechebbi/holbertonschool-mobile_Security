...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> {
        ...
        public final KeyframeEntity<T> atFraction(T t, float fraction) {
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
        ...
        Map $this$mapValues$iv = this.config.getKeyframes$animation_core_release();
        ...
        for (Object element$iv$iv$iv : $this$associateByTo$iv$iv$iv) {
            ...
            destination$iv$iv.put(it$iv$iv.getKey(), ((KeyframeEntity) it.getValue()).toPair$animation_core_release(converter.getConvertToVector()));
        }
    ...
    public static final class KeyframeEntity<T> {
        ...
        public boolean equals(Object other) {
            return (other instanceof KeyframeEntity) && Intrinsics.areEqual(((KeyframeEntity) other).value, this.value) && Intrinsics.areEqual(((KeyframeEntity) other).easing, this.easing);
        }
