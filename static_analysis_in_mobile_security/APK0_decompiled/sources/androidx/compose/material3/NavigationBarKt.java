        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                    ...
                    MeasureResult m1627placeLabelAndIconzUg2_y0;
                    MeasureResult m1626placeIconX9ElhV4;
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                            ...
                            for (Object element$iv3 : $this$first$iv) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                    ...
                                    labelPlaceable = null;
                                    if (function24 == null) {
                                        m1626placeIconX9ElhV4 = NavigationBarKt.m1626placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        return m1626placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(labelPlaceable);
                                    m1627placeLabelAndIconzUg2_y0 = NavigationBarKt.m1627placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    return m1627placeLabelAndIconzUg2_y0;
                                }
                                measurables = list;
            ...
            if (function24 != null) {
                ...
                Modifier modifier$iv3 = PaddingKt.m489paddingVpY3zN4$default(alpha, Dp.m5274constructorimpl(arg0$iv / 2), 0.0f, 2, null);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
