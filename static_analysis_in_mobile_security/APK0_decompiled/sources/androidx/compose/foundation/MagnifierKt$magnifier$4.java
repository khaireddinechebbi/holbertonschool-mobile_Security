        ...
        if (it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                ...
                public final long m219invokeF1C5BW0() {
                    ...
                    if (OffsetKt.m2750isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$1(anchorPositionInRoot$delegate)) && OffsetKt.m2750isSpecifiedk4lQ0M(sourceCenterOffset)) {
                        return Offset.m2736plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(anchorPositionInRoot$delegate), sourceCenterOffset);
                    }
        ...
        if (it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                ...
                public final Boolean invoke() {
                    return Boolean.valueOf(OffsetKt.m2750isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$8(sourceCenterInRoot$delegate)));
                }
            });
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (invoke$lambda$6 != null) {
                        invoke$lambda$6.invoke(DpSize.m5360boximpl($this$invokeSuspend_u24lambda_u241_u24lambda_u240.mo325toDpSizekrfVVM(IntSizeKt.m5444toSizeozmzZPI(newSize))));
                    }
                    ...
                    try {
                        ...
                        if (FlowKt.collect(SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                            ...
                            public final void invoke2() {
                                long m2746getUnspecifiedF1C5BW0;
                                if (MagnifierKt$magnifier$4.invoke$lambda$10(state)) {
                                    ...
                                    if (OffsetKt.m2750isSpecifiedk4lQ0M(it)) {
                                        m2746getUnspecifiedF1C5BW0 = Offset.m2736plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState2), it);
                                    } else {
                                        m2746getUnspecifiedF1C5BW0 = Offset.INSTANCE.m2746getUnspecifiedF1C5BW0();
                                    }
                                    platformMagnifier.mo244updateWko1d7g(invoke$lambda$8, m2746getUnspecifiedF1C5BW0, MagnifierKt$magnifier$4.invoke$lambda$5(state4));
                                    long size = PlatformMagnifier.this.mo243getSizeYbymL2g();
                                    ...
                                    if (!IntSize.m5432equalsimpl0(size, longRef.element)) {
                                        ...
                                        if (invoke$lambda$62 != null) {
                                            invoke$lambda$62.invoke(DpSize.m5360boximpl($this$invoke_u24lambda_u242_u24lambda_u241.mo325toDpSizekrfVVM(IntSizeKt.m5444toSizeozmzZPI(size))));
                                            return;
                                        }
                                        return;
                                    }
