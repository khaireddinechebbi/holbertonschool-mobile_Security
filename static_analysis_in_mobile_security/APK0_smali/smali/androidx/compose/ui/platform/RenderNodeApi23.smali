...
.method public constructor <init>(Landroidx/compose/ui/platform/AndroidComposeView;)V
    ...
    iput v1, p0, Landroidx/compose/ui/platform/RenderNodeApi23;->internalCompositingStrategy:I

    .line 44
    nop

    .line 45
    sget-boolean v1, Landroidx/compose/ui/platform/RenderNodeApi23;->needToValidateAccess:Z
    ...
    .line 55
    .local v1, "displayListCanvas":Landroid/view/DisplayListCanvas;
    invoke-virtual {v0}, Landroid/view/RenderNode;->getScaleX()F

    move-result v2

    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setScaleX(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setScaleY(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setTranslationX(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setTranslationY(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setElevation(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setRotation(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setRotationX(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setRotationY(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setCameraDistance(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setPivotX(F)Z
    ...
    invoke-virtual {v0, v2}, Landroid/view/RenderNode;->setPivotY(F)Z
    ...
    invoke-virtual {v0, v3}, Landroid/view/RenderNode;->setAlpha(F)Z
    ...
    .line 73
    invoke-direct {p0, v0}, Landroidx/compose/ui/platform/RenderNodeApi23;->verifyShadowColorProperties(Landroid/view/RenderNode;)V
    ...
    .line 79
    .end local v1    # "displayListCanvas":Landroid/view/DisplayListCanvas;
    :cond_0
...
.method public record(Landroidx/compose/ui/graphics/CanvasHolder;Landroidx/compose/ui/graphics/Path;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v4, p2, v8, v6, v7}, Landroidx/compose/ui/graphics/Canvas$-CC;->clipPath-mtrdD-E$default(Landroidx/compose/ui/graphics/Canvas;Landroidx/compose/ui/graphics/Path;IILjava/lang/Object;)V
