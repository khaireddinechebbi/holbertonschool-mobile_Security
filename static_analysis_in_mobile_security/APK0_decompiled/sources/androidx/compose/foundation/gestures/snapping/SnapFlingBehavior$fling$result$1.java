    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (abs <= Math.abs(f)) {
                    this.label = 1;
                    shortSnap = this.this$0.shortSnap(this.$this_fling, this.$initialVelocity, this.$onRemainingScrollOffsetUpdate, this);
                ...
                this.label = 2;
                longSnap = this.this$0.longSnap(this.$this_fling, this.$initialVelocity, this.$onRemainingScrollOffsetUpdate, this);
