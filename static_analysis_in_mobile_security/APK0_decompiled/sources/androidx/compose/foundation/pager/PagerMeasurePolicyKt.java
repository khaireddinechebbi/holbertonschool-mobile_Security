...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m713rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean reverseLayout, final Orientation orientation, final int beyondBoundsPageCount, final float pageSpacing, final PageSize pageSize, final Alignment.Horizontal horizontalAlignment, final Alignment.Vertical verticalAlignment, final Function0<Integer> pageCount, Composer $composer, int $changed, int $changed1) {
        ...
        Object[] keys$iv = {contentPadding, Dp.m5272boximpl(pageSpacing), pageSize, state, contentPadding, Boolean.valueOf(reverseLayout), orientation, horizontalAlignment, verticalAlignment, pageCount};
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m714invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final PagerMeasureResult m714invoke0kLqBqw(final LazyLayoutMeasureScope $this$null, final long containerConstraints) {
                    int i;
                    int i2;
                    int i3;
                    int m5218getMaxWidthimpl;
                    ...
                    if (isVertical) {
                        i = $this$null.mo321roundToPx0680j_4(contentPadding.mo437calculateLeftPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                        i = $this$null.mo321roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, $this$null.getLayoutDirection()));
                    }
                    int startPadding = i;
                    if (isVertical) {
                        i2 = $this$null.mo321roundToPx0680j_4(contentPadding.mo438calculateRightPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                    ...
                    if (isVertical) {
                        m5218getMaxWidthimpl = Constraints.m5217getMaxHeightimpl(containerConstraints) - totalVerticalPadding;
                    } else {
                        m5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl(containerConstraints) - totalHorizontalPadding;
                    }
                    int mainAxisAvailableSize = m5218getMaxWidthimpl;
                    ...
                    if (Orientation.this == Orientation.Vertical) {
                        i4 = Constraints.m5218getMaxWidthimpl(contentConstraints);
                    } else {
                        i4 = calculateMainAxisPageSize;
                    }
                    if (Orientation.this != Orientation.Vertical) {
                        i5 = Constraints.m5217getMaxHeightimpl(contentConstraints);
                    } else {
                        i5 = calculateMainAxisPageSize;
                    }
                    pagerState.m717setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, i4, 0, i5, 5, null));
                                        ...
                                        try {
                                            ...
                                            PagerMeasureResult it = PagerMeasureKt.m712measurePagerntgEbfI($this$null, pageCount.invoke().intValue(), itemProvider, mainAxisAvailableSize, beforeContentPadding, afterContentPadding, spaceBetweenPages, firstVisiblePage, firstVisiblePageOffset, state.getScrollToBeConsumed(), contentConstraints, Orientation.this, verticalAlignment, horizontalAlignment, reverseLayout, visualItemOffset, calculateMainAxisPageSize, beyondBoundsPageCount, pinnedPages, new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1.2
                                                ...
                                                public final MeasureResult invoke(int width, int height, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                                    ...
                                                    return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m5232constrainWidthK40F9xA(containerConstraints, totalHorizontalPadding + width), ConstraintsKt.m5231constrainHeightK40F9xA(containerConstraints, totalVerticalPadding + height), MapsKt.emptyMap(), placement);
                                                }
                                            });
