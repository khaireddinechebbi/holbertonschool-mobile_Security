...
public final class TabRowKt {
    ...
    */
    public static final void m1841TabRowpAZo6Ak(final int r28, androidx.compose.ui.Modifier r29, long r30, long r32, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material3.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 492
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m1841TabRowpAZo6Ak(int, androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1840ScrollableTabRowsKfQg0A(final int selectedTabIndex, Modifier modifier, long containerColor, long contentColor, float edgePadding, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, final int $changed, final int i) {
        ...
        if ((23967451 & $dirty) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                divider = i7 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1460getLambda2$material3_release() : function2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(clipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public final MeasureResult m1842invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                                ...
                                int minTabWidth = SubcomposeLayout.mo321roundToPx0680j_4(f3);
                                ...
                                return MeasureScope.CC.layout$default(SubcomposeLayout, accumulator$iv2, accumulator$iv, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabRowKt.ScrollableTabRow.2.1.1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        for (Object element$iv4 : $this$forEach$iv2) {
                                            ...
                                            m5208copyZbe2FdA = Constraints.m5208copyZbe2FdA(j, (r12 & 1) != 0 ? Constraints.m5220getMinWidthimpl(j) : i14, (r12 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(j) : i14, (r12 & 4) != 0 ? Constraints.m5219getMinHeightimpl(j) : 0, (r12 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(j) : 0);
                                            Placeable placeable = it3.mo4225measureBRTryo0(m5208copyZbe2FdA);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabRowKt.m1840ScrollableTabRowsKfQg0A(selectedTabIndex, modifier4, j, j2, f2, function33, function23, tabs, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
