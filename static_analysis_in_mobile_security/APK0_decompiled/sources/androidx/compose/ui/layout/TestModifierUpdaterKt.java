    ...
    public static final void TestModifierUpdaterLayout(final kotlin.jvm.functions.Function1<? super androidx.compose.ui.layout.TestModifierUpdater, kotlin.Unit> r16, androidx.compose.runtime.Composer r17, final int r18) {
        ...
        L47:
            ...
            androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1 r5 = new androidx.compose.ui.layout.MeasurePolicy() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1
                ...
                public /* synthetic */ int maxIntrinsicHeight(androidx.compose.ui.layout.IntrinsicMeasureScope r1, java.util.List r2, int r3) {
                    /*
                        r0 = this;
                        int r1 = androidx.compose.ui.layout.MeasurePolicy.CC.$default$maxIntrinsicHeight(r0, r1, r2, r3)
                        return r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.maxIntrinsicHeight(androidx.compose.ui.layout.IntrinsicMeasureScope, java.util.List, int):int");
                }

                @Override // androidx.compose.ui.layout.MeasurePolicy
                public /* synthetic */ int maxIntrinsicWidth(androidx.compose.ui.layout.IntrinsicMeasureScope r1, java.util.List r2, int r3) {
                    /*
                        r0 = this;
                        int r1 = androidx.compose.ui.layout.MeasurePolicy.CC.$default$maxIntrinsicWidth(r0, r1, r2, r3)
                        return r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.maxIntrinsicWidth(androidx.compose.ui.layout.IntrinsicMeasureScope, java.util.List, int):int");
                }

                @Override // androidx.compose.ui.layout.MeasurePolicy
                public /* synthetic */ int minIntrinsicHeight(androidx.compose.ui.layout.IntrinsicMeasureScope r1, java.util.List r2, int r3) {
                    /*
                        r0 = this;
                        int r1 = androidx.compose.ui.layout.MeasurePolicy.CC.$default$minIntrinsicHeight(r0, r1, r2, r3)
                        return r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.minIntrinsicHeight(androidx.compose.ui.layout.IntrinsicMeasureScope, java.util.List, int):int");
                }

                @Override // androidx.compose.ui.layout.MeasurePolicy
                public /* synthetic */ int minIntrinsicWidth(androidx.compose.ui.layout.IntrinsicMeasureScope r1, java.util.List r2, int r3) {
                    /*
                        r0 = this;
                        int r1 = androidx.compose.ui.layout.MeasurePolicy.CC.$default$minIntrinsicWidth(r0, r1, r2, r3)
                        return r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.minIntrinsicWidth(androidx.compose.ui.layout.IntrinsicMeasureScope, java.util.List, int):int");
                }

                @Override // androidx.compose.ui.layout.MeasurePolicy
                /* renamed from: measure-3p2s80s */
                public final androidx.compose.ui.layout.MeasureResult mo11measure3p2s80s(androidx.compose.ui.layout.MeasureScope r9, java.util.List<? extends androidx.compose.ui.layout.Measurable> r10, long r11) {
                    /*
                        r8 = this;
                        ...
                        int r2 = androidx.compose.ui.unit.Constraints.m5218getMaxWidthimpl(r11)
                        int r3 = androidx.compose.ui.unit.Constraints.m5217getMaxHeightimpl(r11)
                        r4 = 0
                        ...
                        r7 = 0
                        r1 = r9
                        androidx.compose.ui.layout.MeasureResult r10 = androidx.compose.ui.layout.MeasureScope.CC.layout$default(r1, r2, r3, r4, r5, r6, r7)
                        return r10
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1.mo11measure3p2s80s(androidx.compose.ui.layout.MeasureScope, java.util.List, long):androidx.compose.ui.layout.MeasureResult");
                }
            }
        ...
        L83:
            r3.useNode()
        L86:
            androidx.compose.runtime.Composer r9 = androidx.compose.runtime.Updater.m2603constructorimpl(r3)
            r10 = 0
            ...
            androidx.compose.runtime.Updater.m2610setimpl(r9, r5, r11)
            androidx.compose.ui.node.ComposeUiNode$Companion r11 = androidx.compose.ui.node.ComposeUiNode.INSTANCE
        ...
        Lc4:
            ...
            androidx.compose.runtime.Updater.m2607initimpl(r9, r4)
            r3.endNode()
