...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m3308constructorimpl(0);
    private static final int Rotate = m3308constructorimpl(1);
    private static final int Morph = m3308constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3307boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3308constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3309equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3310equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m3309equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3311hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3316getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m3315getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m3314getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3312toStringimpl(int arg0) {
        return m3310equalsimpl0(arg0, Translate) ? "Translate" : m3310equalsimpl0(arg0, Rotate) ? "Rotate" : m3310equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }
