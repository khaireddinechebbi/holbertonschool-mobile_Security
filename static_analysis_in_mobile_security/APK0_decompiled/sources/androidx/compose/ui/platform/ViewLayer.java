...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3362getCenterSzJe1aQ();
    ...
    */
    ...
    public void mo4492resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m3357getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m3358getPivotFractionYimpl(this.mTransformOrigin) * height);
    ...
    public void mo4491movegyyYBs(long position) {
        int left = IntOffset.m5392getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m5393getYimpl(position);
        if (top != getTop()) {
    ...
    public void destroy() {
        ...
        boolean recycle = this.ownerView.recycle$ui_release(this);
        if (Build.VERSION.SDK_INT >= 23 || shouldUseDispatchDraw || !recycle) {
    ...
    public long mo4490mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m4559calculateInverseMatrixbWbORWo = this.matrixCache.m4559calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m3208mapMKHz9U(this.matrixCache.m4560calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            float[] matrix = this.matrixCache.m4559calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m3210mapimpl(this.matrixCache.m4560calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4493transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m3219timesAssign58bKbWc(matrix, this.matrixCache.m4560calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4488inverseTransform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] inverse = this.matrixCache.m4559calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
