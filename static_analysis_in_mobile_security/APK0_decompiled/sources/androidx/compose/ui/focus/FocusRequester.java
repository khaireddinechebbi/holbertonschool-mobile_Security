...
public final class FocusRequester {
    ...
    public final boolean focus$ui_release() {
        ...
        boolean success$iv;
        boolean m2692findChildCorrespondingToFocusEnterOMvw8;
        ...
        MutableVector this_$iv$iv4 = this_$iv.focusRequesterNodes;
        int size$iv$iv = this_$iv$iv4.getSize();
        if (size$iv$iv > 0) {
            int i$iv$iv = 0;
            Object[] content$iv$iv = this_$iv$iv4.getContent();
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv.getAggregateChildKindSet() & m4443constructorimpl) != 0) {
                                ...
                                while (node != null) {
                                    ...
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (focusProperties.getCanFocus()) {
                                            ...
                                            m2692findChildCorrespondingToFocusEnterOMvw8 = FocusTransactionsKt.requestFocus(it$iv);
                                            success$iv = success$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            success$iv = success$iv2;
                                            m2692findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m2692findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m2659getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequester$focus$1$1
                                        ...
                                        if (m2692findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv2 = true;
                                            this_$iv$iv = this_$iv$iv4;
                                            break;
                                        }
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & m4443constructorimpl) != 0) && (node instanceof DelegatingNode)) {
    ...
    */
    ...
    private final boolean findFocusTarget(Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        MutableVector this_$iv4 = this.focusRequesterNodes;
        ...
        if (size$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv.getAggregateChildKindSet() & m4443constructorimpl) != 0) {
                            ...
                            if ((node$iv$iv.getKindSet() & m4443constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if (node2 instanceof FocusTargetNode) {
                                        ...
                                        if (((this_$iv$iv$iv2.getKindSet() & m4443constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                                            int count$iv$iv2 = 0;
