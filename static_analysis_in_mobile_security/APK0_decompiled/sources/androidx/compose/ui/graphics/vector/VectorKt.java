...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m3324getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m3335getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m2913getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3006getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m3255getNonZeroRgk1Os();
    ...
    public static final List<PathNode> PathData(Function1<? super PathBuilder, Unit> block) {
        ...
        block.invoke($this$PathData_u24lambda_u240);
