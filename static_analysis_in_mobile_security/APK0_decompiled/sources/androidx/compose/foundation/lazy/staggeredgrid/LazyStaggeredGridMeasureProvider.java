...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m682childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        int end;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5228fixedWidthOenEA2s(end);
        }
        return Constraints.INSTANCE.m5227fixedHeightOenEA2s(end);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m683getAndMeasurejy6DScQ(int index, long span) {
        ...
        List placeables = this.measureScope.mo645measure0kLqBqw(index, m682childConstraintsJhjzzOo((int) (span >> 32), $i$f$unpackInt2 - ((int) (span >> 32))));
