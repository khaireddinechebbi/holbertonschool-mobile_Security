...
final class MouseWheelScrollElement extends ModifierNodeElement<MouseWheelScrollNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.scrollingLogicState.hashCode();
        return (result * 31) + this.mouseWheelScrollConfig.hashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MouseWheelScrollElement) && Intrinsics.areEqual(this.scrollingLogicState, ((MouseWheelScrollElement) other).scrollingLogicState) && Intrinsics.areEqual(this.mouseWheelScrollConfig, ((MouseWheelScrollElement) other).mouseWheelScrollConfig);
    }
