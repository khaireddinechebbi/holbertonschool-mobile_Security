...
public final class FocusPropertiesKt {
    public static final Modifier focusProperties(Modifier $this$focusProperties, Function1<? super FocusProperties, Unit> scope) {
        Intrinsics.checkNotNullParameter($this$focusProperties, "<this>");
        Intrinsics.checkNotNullParameter(scope, "scope");
        return $this$focusProperties.then(new FocusPropertiesElement(scope));
    }
}
