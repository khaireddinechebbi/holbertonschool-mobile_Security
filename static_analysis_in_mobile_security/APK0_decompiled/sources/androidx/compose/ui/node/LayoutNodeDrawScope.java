...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void drawContent() {
        ...
        if (nextDrawNode == null) {
            NodeCoordinator m4340requireCoordinator64DMado = DelegatableNodeKt.m4340requireCoordinator64DMado(drawModifierNode, NodeKind.m4443constructorimpl(4));
            if (m4340requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                nodeCoordinator = m4340requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(nodeCoordinator);
            } else {
                nodeCoordinator = m4340requireCoordinator64DMado;
            }
            nodeCoordinator.performDraw(canvas);
            return;
        }
        int m4443constructorimpl = NodeKind.m4443constructorimpl(4);
        ...
        while (node != 0) {
            if (node instanceof DrawModifierNode) {
                ...
                int i4 = 1;
                if (!((node.getKindSet() & m4443constructorimpl) != 0) || !(node instanceof DelegatingNode)) {
                    layoutNodeDrawScope = layoutNodeDrawScope4;
                    i = i3;
                } else {
                    int i5 = 0;
    ...
    public final void m4378drawx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode) {
        ...
        while (node != 0) {
            if (node instanceof DrawModifierNode) {
                m4379drawDirectx_KDEd0$ui_release(canvas, size, coordinator, node);
