...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof RadioButtonColors) && Color.m2972equalsimpl0(this.selectedColor, ((RadioButtonColors) other).selectedColor) && Color.m2972equalsimpl0(this.unselectedColor, ((RadioButtonColors) other).unselectedColor) && Color.m2972equalsimpl0(this.disabledSelectedColor, ((RadioButtonColors) other).disabledSelectedColor) && Color.m2972equalsimpl0(this.disabledUnselectedColor, ((RadioButtonColors) other).disabledUnselectedColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2978hashCodeimpl(this.selectedColor);
        return (((((result * 31) + Color.m2978hashCodeimpl(this.unselectedColor)) * 31) + Color.m2978hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2978hashCodeimpl(this.disabledUnselectedColor);
    }
}
