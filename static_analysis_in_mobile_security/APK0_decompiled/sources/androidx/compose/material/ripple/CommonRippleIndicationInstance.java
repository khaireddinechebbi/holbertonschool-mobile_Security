...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        m1290drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m2720boximpl(interaction.getPressPosition()) : null;
        RippleAnimation rippleAnimation = new RippleAnimation(origin, this.radius, this.bounded, null);
    ...
    private final void m1290drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            if (!(alpha == 0.0f)) {
                m2969copywmQWz5c = Color.m2969copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2973getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m2977getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2976getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2974getBlueimpl(color) : 0.0f);
                ripple.m1291draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, m2969copywmQWz5c);
            }
        }
    }
