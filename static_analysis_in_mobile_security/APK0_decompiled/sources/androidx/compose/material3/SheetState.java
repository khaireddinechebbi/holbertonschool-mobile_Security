...
public final class SheetState {
    ...
    public SheetState(boolean skipPartiallyExpanded, SheetValue initialValue, Function1<? super SheetValue, Boolean> confirmValueChange, boolean skipHiddenState) {
    ...
    public final Object show(Continuation<? super Unit> continuation) {
        ...
        Object animateTo$material3_release$default = animateTo$material3_release$default(this, targetValue, 0.0f, continuation, 2, null);
        return animateTo$material3_release$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$material3_release$default : Unit.INSTANCE;
    }
    ...
    public final Object animateTo$material3_release(SheetValue targetValue, float velocity, Continuation<? super Unit> continuation) {
        Object animateTo = this.swipeableState.animateTo(targetValue, velocity, continuation);
    ...
    public final Object settle$material3_release(float velocity, Continuation<? super Unit> continuation) {
        Object obj = this.swipeableState.settle(velocity, continuation);
