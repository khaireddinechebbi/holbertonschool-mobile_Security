...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m602boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m603constructorimpl(long j) {
        return j;
    }
    ...
    public static final boolean m605equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m607hashCodeimpl(long j) {
        return FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m608toStringimpl(long j) {
        return "GridItemSpan(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m604equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m607hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m608toStringimpl(this.packedValue);
    }
    ...
    public static final int m606getCurrentLineSpanimpl(long arg0) {
        return (int) arg0;
    }
}
