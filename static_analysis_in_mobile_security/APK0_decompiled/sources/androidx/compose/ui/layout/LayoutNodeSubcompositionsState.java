...
public final class LayoutNodeSubcompositionsState {
    ...
    public LayoutNodeSubcompositionsState(LayoutNode root, SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.intermediateMeasurePolicy = new Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$intermediateMeasurePolicy$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, Constraints constraints) {
                return m4247invoke0kLqBqw(subcomposeIntermediateMeasureScope, constraints.getValue());
            }

            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
            public final MeasureResult m4247invoke0kLqBqw(SubcomposeIntermediateMeasureScope $this$null, long it) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                return $this$null.getLookaheadMeasurePolicy().invoke($this$null, Constraints.m5206boximpl(it));
            }
        };
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState2 == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m4215getLambda1$ui_release(), null, 4, null);
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (!isIntermediate) {
                    ...
                    intermediateMeasureScopeImpl.m4245setLookaheadConstraintsBRTryo0(constraints);
                    final MeasureResult result = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m5206boximpl(constraints));
                    ...
                    intermediateMeasureScopeImpl2.m4246setLookaheadSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
                ...
                return intermediateMeasurePolicy$ui_release.invoke(intermediateMeasureScopeImpl3, Constraints.m5206boximpl(constraints));
            }
        };
    }
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
            ...
            public void mo4248premeasure0kLqBqw(int index, long constraints) {
                Map map;
                map = LayoutNodeSubcompositionsState.this.precomposeMap;
                ...
                if (node2 != null && node2.isAttached()) {
                    ...
                    if (!node2.isPlaced()) {
                        ...
                        LayoutNodeKt.requireOwner(node2).mo4498measureAndLayout0kLqBqw(node2.getChildren$ui_release().get(index), constraints);
    ...
    final class IntermediateMeasureScopeImpl implements SubcomposeIntermediateMeasureScope, MeasureScope {
        ...
        public void m4246setLookaheadSizeozmzZPI(long j) {
        ...
        public void m4245setLookaheadConstraintsBRTryo0(long j) {
